(function(a, b) {
    function c(a, c, d) {
        if (d === b && 1 === a.nodeType)
            if (d = "data-" + c.replace(oc, "-$1").toLowerCase(), d = a.getAttribute(d), "string" == typeof d) {
                try {
                    d = "true" === d ? !0 : "false" === d ? !1 : "null" === d ? null : +d + "" === d ? +d : pc.test(d) ? g.parseJSON(d) : d
                } catch (e) {}
                g.data(a, c, d)
            } else d = b;
        return d
    ...
    function l(a, b, c) {
        ...
        if (g.isFunction(b)) return g.grep(a, function(a, x) {
            return !!b.call(a, x, a) === c
        });
        if (b.nodeType) return g.grep(a, function(a) {
            return a === b === c
        });
        if ("string" == typeof b) {
            var d = g.grep(a, function(a) {
                return 1 === a.nodeType
            });
            if (rc.test(b)) return g.filter(b, d, !c);
            b = g.filter(b, d)
        }
    ...
    function m(a, b) {
        if (1 === b.nodeType && g.hasData(a)) {
            ...
            var f = g._data(b, d),
                r = d.events;
            if (r)
                for (c in delete f.handle, f.events = {}, r) {
                    d = 0;
                    for (e = r[c].length; d < e; d++) g.event.add(b, c, r[c][d])
                }
    ...
    function k(a, b) {
        var c;
        1 === b.nodeType && (b.clearAttributes && b.clearAttributes(), b.mergeAttributes && b.mergeAttributes(a), c = b.nodeName.toLowerCase(), "object" === c ? (b.parentNode && (b.outerHTML = a.outerHTML), g.support.html5Clone && a.innerHTML && !g.trim(b.innerHTML) &&
            (b.innerHTML = a.innerHTML)) : "input" === c && tb.test(a.type) ? (b.defaultChecked = b.checked = a.checked, b.value !== a.value && (b.value = a.value)) : "option" === c ? b.selected = a.defaultSelected : "input" === c || "textarea" === c ? b.defaultValue = a.defaultValue : "script" === c && b.text !== a.text && (b.text = a.text), b.removeAttribute(g.expando))
    }
    ...
    function s(a) {
        tb.test(a.type) && (a.defaultChecked =
            a.checked)
    }

    function u(a, b) {
        if (b in a) return b;
        for (var c = b.charAt(0).toUpperCase() + b.slice(1), d = b, g = ub.length; g--;)
            if (b = ub[g] + c, b in a) return b;
        return d
    }
    ...
    function v(a, b) {
        for (var c, d, e = [], f = 0, r = a.length; f < r; f++) c = a[f], c.style && (e[f] = g._data(c, "olddisplay"), b ? (!e[f] && "none" === c.style.display && (c.style.display = ""), "" === c.style.display && y(c) && (e[f] = g._data(c, "olddisplay", K(c.nodeName)))) : (d = L(c, "display"), !e[f] && "none" !==
            d && g._data(c, "olddisplay", d)));
        for (f = 0; f < r; f++)
    ...
    function D(a, b, c) {
        return (a = sc.exec(b)) ? Math.max(0, a[1] - (c || 0)) + (a[2] || "px") : b
    }

    function Ta(a, b, c, d) {
        b = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0;
        for (var e = 0; 4 > b; b += 2) "margin" === c && (e += g.css(a, c + Z[b], !0)), d ? ("content" === c && (e -= parseFloat(L(a, "padding" + Z[b])) || 0), "margin" !== c && (e -= parseFloat(L(a, "border" + Z[b] + "Width")) || 0)) : (e += parseFloat(L(a,
            "padding" + Z[b])) || 0, "padding" !== c && (e += parseFloat(L(a, "border" + Z[b] + "Width")) || 0));
        return e
    }
    ...
    function z(a, b, c) {
        ...
        if (0 >= d || null == d) {
            ...
            if (ua.test(d)) return d;
            e = f && (g.support.boxSizingReliable || d === a.style[b]);
            d = parseFloat(d) || 0
        }
        return d + Ta(a, b, c || (f ? "border" : "content"), e) + "px"
    }
    ...
    function K(a) {
        ...
        b.remove();
        if ("none" === c || "" === c) {
            ha = t.body.appendChild(ha || g.extend(t.createElement("iframe"), {
                frameBorder: 0,
                width: 0,
                height: 0
            }));
            if (!ia || !ha.createElement) ia = (ha.contentWindow || ha.contentDocument).document, ia.write("<!doctype html><html><body>"), ia.close();
            b = ia.body.appendChild(ia.createElement(a));
            c = L(b, "display");
            t.body.removeChild(ha)
        }
        return Ua[a] = c, c
    }
    ...
    function H(a, b, c, d) {
        var e;
        if (g.isArray(b)) g.each(b, function(b, C) {
            c || tc.test(a) ? d(a, C) : H(a + "[" + ("object" == typeof C ? b : "") + "]", C, c, d)
        });
        else if (!c &&
            "object" === g.type(b))
    ...
    function ja(a, c, d, g, e, f) {
        e = e || c.dataTypes[0];
        f = f || {};
        f[e] = !0;
        var r;
        e = a[e];
        for (var j = 0, k = e ? e.length : 0, h = a === Va; j < k && (h || !r); j++) r = e[j](c, d, g), "string" == typeof r && (!h || f[r] ? r = b : (c.dataTypes.unshift(r),
            r = ja(a, c, d, g, r, f)));
        return (h || !r) && !f["*"] && (r = ja(a, c, d, g, "*", f)), r
    }
    ...
    function xb(a, b, c) {
        var d, e = 0,
            ...
            j = function() {
                for (var b = wa || wb(), b = Math.max(0, k.startTime + k.duration - b), c = 1 - (b / k.duration || 0), d =
                        0, C = k.tweens.length; d < C; d++) k.tweens[d].run(c);
                return r.notifyWith(a, [k, c, b]), 1 > c && C ? b : (r.resolveWith(a, [k]), !1)
            },
            k = r.promise({
                elem: a,
                props: g.extend({}, b),
                ...
                stop: function(b) {
                    for (var c = 0, d = b ? k.tweens.length : 0; c < d; c++) k.tweens[c].run(1);
                    return b ? r.resolveWith(a, [k, b]) : r.rejectWith(a, [k, b]), this
                }
            });
        b = k.props;
        ...
        for (; e < f; e++)
            if (d = xa[e].call(k, a, b, k.opts)) return d;
        var m = k;
        g.each(b, function(a, b) {
            for (var x = (pa[a] || []).concat(pa["*"]), c = 0, d = x.length; c < d && !x[c].call(m, a, b); c++);
        });
        return g.isFunction(k.opts.start) && k.opts.start.call(a,
            k), g.fx.timer(g.extend(j, {
            anim: k,
            queue: k.opts.queue,
            elem: a
    ...
    function N(a, b, c, d, g) {
        return new N.prototype.init(a, b, c, d, g)
    }
    ...
    var zb, za, t = a.document,
        vc = a.location,
        wc = a.navigator,
        xc =
        a.jQuery,
        yc = a.$,
        Ab = Array.prototype.push,
        V = Array.prototype.slice,
        Bb = Array.prototype.indexOf,
        zc = Object.prototype.toString,
        Wa = Object.prototype.hasOwnProperty,
        Xa = String.prototype.trim,
        g = function(a, b) {
            return new g.fn.init(a, b, zb)
        },
        Aa = /[\-+]?(?:\d*\.|)\d+(?:[eE][\-+]?\d+|)/.source,
        Ac = /\S/,
        aa = /\s+/,
        ...
        Ba = function() {
            t.addEventListener ? (t.removeEventListener("DOMContentLoaded", Ba, !1), g.ready()) : "complete" === t.readyState && (t.detachEvent("onreadystatechange", Ba), g.ready())
        },
        Db = {};
    g.fn = g.prototype = {
        constructor: g,
        init: function(a, c, d) {
            ...
            if ("string" == typeof a) {
                "<" === a.charAt(0) && ">" === a.charAt(a.length - 1) && 3 <= a.length ? e = [null, a, null] : e = Cc.exec(a);
                if (e && (e[1] || !c)) {
                    if (e[1]) return c = c instanceof g ? c[0] : c, f = c && c.nodeType ? c.ownerDocument || c : t, a = g.parseHTML(e[1], f, !0), Cb.test(e[1]) && g.isPlainObject(c) && this.attr.call(a, c, !0), g.merge(this, a);
            ...
            return g.isFunction(a) ? d.ready(a) : (a.selector !== b && (this.selector = a.selector, this.context = a.context), g.makeArray(a,
                this))
        },
        selector: "",
        jquery: "1.8.2",
    ...
    g.extend({
        noConflict: function(b) {
            return a.$ === g && (a.$ = yc), b && a.jQuery === g && (a.jQuery = xc), g
        },
        isReady: !1,
        readyWait: 1,
        ...
        ready: function(a) {
            if (!(!0 === a ? --g.readyWait : g.isReady)) {
                ...
                g.isReady = !0;
                !0 !== a && 0 < --g.readyWait || (za.resolveWith(t, [g]), g.fn.trigger && g(t).trigger("ready").off("ready"))
            }
        },
        ...
        type: function(a) {
            return null ==
                a ? String(a) : Db[zc.call(a)] || "object"
        },
        ...
        parseHTML: function(a, b, c) {
            var d;
            return !a || "string" != typeof a ? null : ("boolean" == typeof b && (c = b, b = 0), b = b || t, (d =
                Cb.exec(a)) ? [b.createElement(d[1])] : (d = g.buildFragment([a], b, c ? null : []), g.merge([], (d.cacheable ? g.clone(d.fragment) : d.fragment).childNodes)))
        },
        parseJSON: function(b) {
            if (!b || "string" != typeof b) return null;
            b = g.trim(b);
            if (a.JSON && a.JSON.parse) return a.JSON.parse(b);
            if (Dc.test(b.replace(Fc, "@").replace(Gc, "]").replace(Ec, ""))) return (new Function("return " + b))();
        ...
        parseXML: function(c) {
            ...
            try {
                a.DOMParser ? (I = new DOMParser, d = I.parseFromString(c,
                    "text/xml")) : (d = new ActiveXObject("Microsoft.XMLDOM"), d.async = "false", d.loadXML(c))
            } catch (e) {
                d = b
            }
            return (!d || !d.documentElement || d.getElementsByTagName("parsererror").length) && g.error("Invalid XML: " + c), d
        },
        noop: function() {},
        globalEval: function(b) {
            b && Ac.test(b) && (a.execScript || function(b) {
                a.eval.call(a, b)
            })(b)
        },
        camelCase: function(a) {
            return a.replace(Hc, "ms-").replace(Ic, Jc)
        },
        ...
        makeArray: function(a, b) {
            var c, d = b || [];
            return null != a && (c = g.type(a), null == a.length || "string" === c || "function" === c || "regexp" === c || g.isWindow(a) ? Ab.call(d,
                a) : g.merge(d, a)), d
        },
        ...
        map: function(a, c, d) {
            var e, f, k = [],
                ...
                j = a.length;
            if (a instanceof g ||
                j !== b && "number" == typeof j && (0 < j && a[0] && a[j - 1] || 0 === j || g.isArray(a)))
        ...
        proxy: function(a, c) {
            var d, e, f;
            return "string" == typeof c && (d = a[c], c = a, a = d), g.isFunction(a) ? (e = V.call(arguments, 2), f = function() {
                return a.apply(c, e.concat(V.call(arguments)))
            }, f.guid = a.guid = a.guid || g.guid++, f) : b
        },
        access: function(a, c, d, e, f, k, r) {
            ...
            if (d && "object" == typeof d) {
                for (p in d) g.access(a,
                    c, p, d[p], 1, k, e);
                f = 1
            } else if (e !== b) {
                j = r === b && g.isFunction(e);
                h && (j ? (j = c, c = function(a, b, c) {
                    return j.call(g(a), c)
                }) : (c.call(a, e), c = null));
                if (c)
    ...
    g.ready.promise = function(b) {
        if (!za)
            if (za = g.Deferred(), "complete" === t.readyState) setTimeout(g.ready, 1);
            else if (t.addEventListener) t.addEventListener("DOMContentLoaded", Ba, !1), a.addEventListener("load", g.ready, !1);
        else {
            ...
            var c = !1;
            try {
                c = null == a.frameElement && t.documentElement
            } catch (d) {}
            c && c.doScroll && function qc() {
                if (!g.isReady) {
                    try {
                        c.doScroll("left")
                    } catch (a) {
                        return setTimeout(qc, 50)
                    }
                    g.ready()
                }
            }()
    ...
    g.Callbacks = function(a) {
        ...
        if ("string" == typeof a) {
            if (!(c = Eb[a])) {
                c = a;
                var d = Eb[c] = {};
                c = (g.each(c.split(aa), function(a,
                    b) {
                    d[b] = !0
                }), d)
            }
        ...
        var e, f, k, r, j, h, p = [],
            ...
            s = function(b) {
                ...
                j = p.length;
                for (k = !0; p && h < j; h++)
                    if (!1 === p[h].apply(b[0], b[1]) && a.stopOnFalse) {
                        e = !1;
                        break
                    }
                k = !1;
            ...
            m = {
                    ...
                    if (p) {
                        ...
                        (function uc(b) {
                            g.each(b, function(b, c) {
                                var d = g.type(c);
                                "function" === d && (!a.unique || !m.has(c)) ? p.push(c) : c && c.length && "string" !== d && uc(c)
                            })
                        })(arguments);
                ...
                remove: function() {
                    return p &&
                        g.each(arguments, function(a, b) {
                            for (var c; - 1 < (c = g.inArray(b, p, c));) p.splice(c, 1), k && (c <= j && j--, c <= h && h--)
                        }), this
                },
                has: function(a) {
                    return -1 < g.inArray(a, p)
                },
                empty: function() {
                    return p = [], this
                },
                ...
                lock: function() {
                    return l = b, e || m.disable(), this
                },
                locked: function() {
                    return !l
                },
                fireWith: function(a, b) {
                    return b = b || [], b = [a, b.slice ? b.slice() : b], p && (!f || l) && (k ? l.push(b) : s(b)), this
                },
                fire: function() {
                        ...
                        return g.Deferred(function(c) {
                            g.each(b, function(b, d) {
                                ...
                                e[d[1]](g.isFunction(C) ? function() {
                                    ...
                                    a && g.isFunction(a.promise) ?
                                        a.promise().done(c.resolve).fail(c.reject).progress(c.notify) : c[x + "With"](this === e ? c : this, [a])
                                } : c[x])
                            });
                            a = null
                        }).promise()
    ...
    var Kc = g,
        Ya;
    var J, Ca, ba, Da, Ea, O, ca, Fa, Za, qa, Fb, E = t.createElement("div");
    ...
    if (!Ca || !Ca.length) Ya = {};
        ...
        Ea = Da.appendChild(t.createElement("option"));
        ...
        Da.disabled = !0;
        J.optDisabled = !Ea.disabled;
        try {
            delete E.test
        } catch (Nd) {
            J.deleteExpando = !1
        }!E.addEventListener && E.attachEvent && E.fireEvent && (E.attachEvent("onclick", Fb = function() {
            J.noCloneEvent = !1
        }), E.cloneNode(!0).fireEvent("onclick"), E.detachEvent("onclick", Fb));
        ...
        J.checkClone =
            ca.cloneNode(!0).cloneNode(!0).lastChild.checked;
        ...
        if (E.attachEvent)
            for (Za in {
                    ...
                    change: !0,
                    focusin: !0
                }) Fa = "on" + Za, (qa = Fa in E) || (E.setAttribute(Fa, "return;"), qa = "function" == typeof E[Fa]), J[Za + "Bubbles"] = qa;
        Ya = (g(function() {
            var b, c, d, e, g = t.getElementsByTagName("body")[0];
            g && (b = t.createElement("div"), b.style.cssText = "visibility:hidden;border:0;width:0;height:0;position:static;top:0;margin-top:1px", g.insertBefore(b, g.firstChild), c = t.createElement("div"),
                b.appendChild(c), c.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", d = c.getElementsByTagName("td"), d[0].style.cssText = "padding:0;margin:0;border:0;display:none", qa = 0 === d[0].offsetHeight, d[0].style.display = "", d[1].style.display = "none", J.reliableHiddenOffsets = qa && 0 === d[0].offsetHeight, c.innerHTML = "", c.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", J.boxSizing =
                4 === c.offsetWidth, J.doesNotIncludeMarginInBodyOffset = 1 !== g.offsetTop, a.getComputedStyle && (J.pixelPosition = "1%" !== (a.getComputedStyle(c, null) || {}).top, J.boxSizingReliable = "4px" === (a.getComputedStyle(c, null) || {
                    width: "4px"
                }).width, e = t.createElement("div"), e.style.cssText = c.style.cssText = "padding:0;margin:0;border:0;display:block;overflow:hidden;", e.style.marginRight = e.style.width = "0", c.style.width = "1px", c.appendChild(e), J.reliableMarginRight = !parseFloat((a.getComputedStyle(e, null) || {}).marginRight)),
        ...
        }), ca.removeChild(E), Ca = ba = Da = Ea = O = ca = E = null, J)
    }
    Kc.support = Ya;
    var pc = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
        oc = /([A-Z])/g;
    ...
    g.fn.extend({
        data: function(a, d) {
            ...
            return "object" == typeof a ? this.each(function() {
                g.data(this, a)
            }) : (e = a.split(".", 2), e[1] = e[1] ? "." + e[1] : "", f = e[1] + "!", g.access(this, function(d) {
    ...
    g.extend({
        queue: function(a, b, c) {
            var d;
            if (a) return b = (b || "fx") + "queue", d = g._data(a, b), c && (!d || g.isArray(c) ? d = g._data(a, b, g.makeArray(c)) : d.push(c)), d || []
        },
    ...
    var W, Gb, Hb, Ib = /[\t\r\n]/g,
        Lc = /\r/g,
        Mc = /^(?:button|input)$/i,
        Nc = /^(?:button|input|object|select|textarea)$/i,
        Oc = /^a(?:rea|)$/i,
        Jb = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
        Kb = g.support.getSetAttribute;
    g.fn.extend({
        attr: function(a, b) {
        ...
        hasClass: function(a) {
            ...
            for (var b = 0, c = this.length; b < c; b++)
                if (1 === this[b].nodeType && 0 <= (" " + this[b].className + " ").replace(Ib, " ").indexOf(a)) return !0;
            return !1
        },
        val: function(a) {
            var c, d, e, f = this[0];
            if (arguments.length) return e = g.isFunction(a), this.each(function(d) {
                var f, I = g(this);
                if (1 === this.nodeType && (e ? f = a.call(this, d, I.val()) : f = a, null == f ? f = "" : "number" == typeof f ? f += "" : g.isArray(f) && (f = g.map(f, function(a) {
                        return null == a ? "" : a + ""
                    })), c = g.valHooks[this.type] || g.valHooks[this.nodeName.toLowerCase()], !c || !("set" in c) || c.set(this, f, "value") === b)) this.value = f
            });
            if (f) return c = g.valHooks[f.type] || g.valHooks[f.nodeName.toLowerCase()], c && "get" in c && (d = c.get(f,
                "value")) !== b ? d : (d = f.value, "string" == typeof d ? d.replace(Lc, "") : null == d ? "" : d)
        }
    });
    g.extend({
        valHooks: {
        ...
        attr: function(a, c, d, e) {
            ...
            if (a && !(3 === r || 8 === r || 2 === r)) {
                ...
                (e = 1 !== r || !g.isXMLDoc(a)) && (c = c.toLowerCase(), k = g.attrHooks[c] || (Jb.test(c) ? Gb :
                    W));
                if (d !== b) {
                    if (null === d) {
                        g.removeAttr(a, c);
                    ...
                    return k && "set" in k && e && (f = k.set(a, d, c)) !== b ? f : (a.setAttribute(c, d + ""), d)
                }
        ...
        removeAttr: function(a, b) {
            var c, d, e, f, k = 0;
            if (b && 1 === a.nodeType)
                for (d = b.split(aa); k < d.length; k++)(e = d[k]) && (c = g.propFix[e] || e, f = Jb.test(e), f || g.attr(a, e, ""), a.removeAttribute(Kb ? e : c), f && c in a && (a[c] = !1))
        },
        attrHooks: {
            type: {
                set: function(a, b) {
                    if (Mc.test(a.nodeName) && a.parentNode) g.error("type property can't be changed");
            ...
            value: {
                get: function(a, b) {
                    return W && g.nodeName(a, "button") ? W.get(a, b) : b in a ? a.value : null
                },
                set: function(a, b, c) {
        ...
        prop: function(a, c, d) {
            var e, f, k, r = a.nodeType;
            if (a && !(3 === r || 8 === r || 2 === r)) return k = 1 !== r || !g.isXMLDoc(a), k && (c = g.propFix[c] || c, f = g.propHooks[c]), d !== b ? f && "set" in f && (e = f.set(a, d, c)) !== b ? e : a[c] = d : f && "get" in f && null !== (e = f.get(a, c)) ? e : a[c]
        },
        propHooks: {
            tabIndex: {
                get: function(a) {
                    var c = a.getAttributeNode("tabindex");
                    return c && c.specified ? parseInt(c.value, 10) : Nc.test(a.nodeName) || Oc.test(a.nodeName) && a.href ? 0 : b
                }
            }
        }
    });
    ...
    Kb || (Hb = {
        ...
        get: function(a, c) {
            var d;
            return d = a.getAttributeNode(c), d && (Hb[c] ? "" !== d.value : d.specified) ? d.value : b
        },
        set: function(a, b, c) {
            var d = a.getAttributeNode(c);
            return d || (d = t.createAttribute(c), a.setAttributeNode(d)),
                d.value = b + ""
        }
    ...
    var $a = /^(?:textarea|input|select)$/i,
        ...
        Pc = /(?:^|\s)hover(\.\S+|)\b/,
        Qc = /^key/,
        Rc = /^(?:mouse|contextmenu)|click/,
        Mb = /^(?:focusinfocus|focusoutblur)$/,
        Nb = function(a) {
            return g.event.special.hover ? a : a.replace(Pc, "mouseenter$1 mouseleave$1")
        };
    g.event = {
        add: function(a, c, d, e, f) {
            ...
            if (!(3 === a.nodeType || 8 === a.nodeType || !c || !d || !(k = g._data(a)))) {
                ...
                (r = k.handle) || (k.handle = r = function(a) {
                    return "undefined" != typeof g && (!a || g.event.triggered !== a.type) ? g.event.dispatch.apply(r.elem, arguments) : b
                }, r.elem = a);
                c = g.trim(Nb(c)).split(" ");
        ...
        remove: function(a, b, c, d, e) {
            ...
            if (y && (s = y.events)) {
                ...
                for (f = 0; f < b.length; f++)
                    if (k = Lb.exec(b[f]) || [], j = h = k[1], k = k[2], j) {
                        m = g.event.special[j] || {};
                        ...
                        0 === q.length && p !== q.length && ((!m.teardown || !1 === m.teardown.call(a, k, y.handle)) && g.removeEvent(a,
                            j, y.handle), delete s[j])
                    } else
        ...
        trigger: function(c, d, e, f) {
            if (!e || 3 !== e.nodeType && 8 !== e.nodeType) {
                ...
                h = [];
                if (!Mb.test(m + g.event.triggered) && (0 <= m.indexOf("!") && (m = m.slice(0, -1), k = !0), 0 <= m.indexOf(".") && (h = m.split("."), m = h.shift(), h.sort()), e && !g.event.customEvent[m] || g.event.global[m]))
                    if (c = "object" == typeof c ? c[g.expando] ?
                        c : new g.Event(m, c) : new g.Event(m), c.type = m, c.isTrigger = !0, c.exclusive = k, c.namespace = h.join("."), c.namespace_re = c.namespace ? RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, h = 0 > m.indexOf(":") ? "on" + m : "", e) {
                        if (c.result = b, c.target || (c.target = e), d = null != d ? g.makeArray(d) : [], d.unshift(c), p = g.event.special[m] || {}, !(p.trigger && !1 === p.trigger.apply(e, d))) {
                            ...
                            if (!f && !p.noBubble && !g.isWindow(e)) {
                                j = p.delegateType || m;
                                k = Mb.test(j + m) ? e : e.parentNode;
                                for (r = e; k; k = k.parentNode) s.push([k, j]),
                                    r = k;
                            ...
                            return c.type = m, !f && !c.isDefaultPrevented() && (!p._default || !1 === p._default.apply(e.ownerDocument, d)) && ("click" !== m || !g.nodeName(e, "a")) && g.acceptData(e) && h && e[m] && ("focus" !== m && "blur" !== m || 0 !== c.target.offsetWidth) &&
                                !g.isWindow(e) && (r = e[h], r && (e[h] = null), g.event.triggered = m, e[m](), g.event.triggered = b, r && (e[h] = r)), c.result
                        }
                    } else
            ...
            if (!(m.preDispatch && !1 === m.preDispatch.call(this, c))) {
                ...
                for (d = 0; d < q.length && !c.isPropagationStopped(); d++) {
                    ...
                    for (e = 0; e < k.matches.length && !c.isImmediatePropagationStopped(); e++)
                        if (f = k.matches[e],
                            s || !c.namespace && !f.namespace || c.namespace_re && c.namespace_re.test(f.namespace)) c.data = f.data, c.handleObj = f, f = ((g.event.special[f.origType] || {}).handle || f.handler).apply(k.elem, l), f !== b && (c.result = f, !1 === f && (c.preventDefault(), c.stopPropagation()))
                }
        ...
        mouseHooks: {
            ...
            filter: function(a, c) {
                var d, e, g, f = c.button,
                    k = c.fromElement;
                return null == a.pageX && null != c.clientX && (d = a.target.ownerDocument || t, e = d.documentElement, g = d.body, a.pageX = c.clientX + (e && e.scrollLeft || g && g.scrollLeft || 0) - (e && e.clientLeft ||
                    g && g.clientLeft || 0), a.pageY = c.clientY + (e && e.scrollTop || g && g.scrollTop || 0) - (e && e.clientTop || g && g.clientTop || 0)), !a.relatedTarget && k && (a.relatedTarget = k === a.target ? c.toElement : k), !a.which && f !== b && (a.which = f & 1 ? 1 : f & 2 ? 3 : f & 4 ? 2 : 0), a
            }
        },
        fix: function(a) {
            ...
            return a.target || (a.target = d.srcElement || t), 3 === a.target.nodeType && (a.target = a.target.parentNode),
    ...
    g.event.handle =
        g.event.dispatch;
    g.removeEvent = t.removeEventListener ? function(a, b, c) {
    ...
    g.Event = function(a, b) {
        if (this instanceof g.Event) a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || !1 === a.returnValue || a.getPreventDefault && a.getPreventDefault() ? f : e) : this.type = a, b && g.extend(this, b), this.timeStamp = a && a.timeStamp || g.now(),
            this[g.expando] = !0;
    ...
    g.support.submitBubbles || (g.event.special.submit = {
        setup: function() {
            ...
            g.event.add(this, "click._submit keypress._submit", function(a) {
                a = a.target;
                (a = g.nodeName(a, "input") || g.nodeName(a, "button") ?
                    a.form : b) && !g._data(a, "_submit_attached") && (g.event.add(a, "submit._submit", function(a) {
                    a._submit_bubble = !0
                }), g._data(a, "_submit_attached", !0))
            })
        },
        ...
        setup: function() {
            if ($a.test(this.nodeName)) {
                if ("checkbox" === this.type ||
                    "radio" === this.type) g.event.add(this, "propertychange._change", function(a) {
            ...
            g.event.add(this, "beforeactivate._change", function(a) {
                a = a.target;
                $a.test(a.nodeName) && !g._data(a, "_change_attached") && (g.event.add(a, "change._change", function(a) {
                    this.parentNode && !a.isSimulated && !a.isTrigger &&
                        g.event.simulate("change", this.parentNode, a, !0)
    ...
    g.fn.extend({
        ...
        off: function(a, c, d) {
            var f, k;
            if (a && a.preventDefault && a.handleObj) return f = a.handleObj, g(a.delegateTarget).off(f.namespace ? f.origType + "." + f.namespace : f.origType, f.selector, f.handler), this;
            if ("object" == typeof a) {
                for (k in a) this.off(k, c, a[k]);
                return this
            }
            if (!1 === c || "function" == typeof c) d = c, c = b;
            return !1 === d && (d = e), this.each(function() {
                g.event.remove(this, a, d, c)
            })
        },
        bind: function(a, b, c) {
    ...
    g.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),
        function(a, b) {
            ...
            Qc.test(b) && (g.event.fixHooks[b] = g.event.keyHooks);
            Rc.test(b) && (g.event.fixHooks[b] = g.event.mouseHooks)
        });
    var Sc = a,
        w = function(a, b, c, d) {
            c = c || [];
            ...
            if (!f && !d && (e = Tc.exec(a)))
                if (k = e[1])
                    if (9 === j) {
                        g = b.getElementById(k);
                        if (!g || !g.parentNode) return c;
                        if (g.id === k) return c.push(g), c
                    } else {
                        if (b.ownerDocument &&
                            (g = b.ownerDocument.getElementById(k)) && Ob(b, g) && g.id === k) return c.push(g), c
                    }
            else {
                if (e[2]) return ka.apply(c, la.call(b.getElementsByTagName(a), 0)), c;
                if ((k = e[3]) && Pb && b.getElementsByClassName) return ka.apply(c, la.call(b.getElementsByClassName(k), 0)), c
            }
            return ab(a.replace(Ha, "$1"), b, c, d, f)
        },
        ra = function(a) {
            return function(b) {
        ...
        Ka = function(a, b) {
            var c, d, e, g, f, k, j;
            if (f = Rb[A][a]) return b ? 0 : f.slice(0);
            f = a;
            k = [];
            for (j = F.preFilter; f;) {
                if (!c || (d = Uc.exec(f))) d && (f = f.slice(d[0].length)), k.push(e = []);
                c = !1;
                if (d = Vc.exec(f)) e.push(c = new Sb(d.shift())), f = f.slice(c.length), c.type = d[0].replace(Ha, " ");
                for (g in F.filter)(d = Ja[g].exec(f)) &&
                    (!j[g] || (d = j[g](d, S, !0))) && (e.push(c = new Sb(d.shift())), f = f.slice(c.length), c.type = g, c.matches = d);
                if (!c) break
            }
            return b ? f.length : f ? w.error(a) : Rb(a, k).slice(0)
        },
        cb = function(a, b, c) {
            var d = b.dir,
            ...
            return b.first ? function(b, c, g) {
                ...
                if (f)
                    for (; b = b[d];) {
                        if ((e || 1 === b.nodeType) && a(b, c, f)) return b
                    } else
                        for (var C, k = sa + " " + g + " ", j = k + bb; b = b[d];)
                            if (e || 1 === b.nodeType) {
        ...
        eb = function(a, b, c, d, e, g) {
            return d && !d[A] && (d = eb(d)), e && !e[A] && (e = eb(e, g)), T(function(g, f, k, j) {
                if (!g || !e) {
                    var h, p, l = [],
                        s = [],
                        m = f.length;
                    ...
                    if (g)
                        for (k = a && q.length; k--;) {
                            if (h = q[k]) g[l[k]] = !(f[l[k]] = h)
                        } else q = La(q === f ? q.splice(m, q.length) : q), e ? e(null, f, q, j) : ka.apply(f, q)
                }
            })
        },
        fb = function(a) {
            ...
            c = g || F.relative[" "];
            for (var f = g ? 1 : 0, k = cb(function(a) {
                    return a === b
                }, c, !0), j = cb(function(a) {
                    return -1 <
                        Tb.call(b, a)
                }, c, !0), h = [function(a, c, d) {
                    return !g && (d || c !== Ma) || ((b = c).nodeType ? k(a, c, d) : j(a, c, d))
                }]; f < e; f++)
                if (c = F.relative[a[f].type]) h = [cb(db(h), c)];
                else {
                    c = F.filter[a[f].type].apply(null, a[f].matches);
                    if (c[A]) {
                        for (d = ++f; d < e && !F.relative[a[d].type]; d++);
                        return eb(1 < f && db(h), 1 < f && a.slice(0, f - 1).join("").replace(Ha, "$1"), c, f < d && fb(a.slice(f, d)), d < e && fb(a = a.slice(d)), d < e && a.join(""))
                    }
                    h.push(c)
                }
            return db(h)
        ...
        ab = function(a, b, c, d, e) {
            ...
            if (!d && 1 === h.length) {
                f = h[0] = h[0].slice(0);
                if (2 < f.length &&
                    "ID" === (k = f[0]).type && 9 === b.nodeType && !e && F.relative[f[1].type]) {
                    b = F.find.ID(k.matches[0].replace(ea, ""), b, e)[0];
                    if (!b) return c;
                    a = a.slice(f.shift().length)
                }
                for (g = Ja.POS.test(a) ? -1 : f.length - 1; 0 <= g; g--) {
                    k = f[g];
                    if (F.relative[j = k.type]) break;
                    if (j = F.find[j])
                        if (d = j(k.matches[0].replace(ea, ""), gb.test(f[0].type) && b.parentNode || b, e)) {
                            f.splice(g, 1);
                            a = d.length && f.join("");
                            if (!a) return ka.apply(c, la.call(d, 0)), c;
                            break
                        }
                }
            }
            return hb(a, h)(d, b, e, c, gb.test(a)), c
        },
        Ub = function() {},
        bb, ib, F, Na, Ga, Ob, hb, jb, ta, Ma, Vb = !0,
        ...
        ka = [].push,
        la = [].slice,
        Tb = [].indexOf || function(a) {
            for (var b = 0, c = this.length; b < c; b++)
                if (this[b] === a) return b;
            return -1
        },
        T = function(a, b) {
            return a[A] = null == b || b, a
        },
        kb = function() {
            var a = {},
                b = [];
        ...
        ad = X(function(a) {
            return a.appendChild(S.createComment("")), !a.getElementsByTagName("*").length
        }),
        bd = X(function(a) {
        ...
        Pb = X(function(a) {
            return a.innerHTML = "<div class='hidden e'></div><div class='hidden'></div>", !a.getElementsByClassName || !a.getElementsByClassName("e").length ? !1 : (a.lastChild.className = "e", 2 === a.getElementsByClassName("e").length)
        }),
        dd = X(function(a) {
            a.id = A + 0;
            a.innerHTML = "<a name='" + A + "'></a><div name='" + A + "'></div>";
            R.insertBefore(a, R.firstChild);
            var b = S.getElementsByName &&
                S.getElementsByName(A).length === 2 + S.getElementsByName(A + 0).length;
            return ib = !S.getElementById(A), R.removeChild(a), b
        });
    try {
        la.call(R.childNodes, 0)[0].nodeType
    } catch (Od) {
        la = function(a) {
    ...
    Ga = w.isXML = function(a) {
        return (a = a && (a.ownerDocument || a).documentElement) ? "HTML" !== a.nodeName : !1
    };
    Ob = w.contains = R.contains ? function(a, b) {
    ...
    w.attr = function(a, b) {
        var c, d = Ga(a);
        return d || (b = b.toLowerCase()), (c = F.attrHandle[b]) ? c(a) : d || cd ? a.getAttribute(b) : (c = a.getAttributeNode(b), c ? "boolean" == typeof a[b] ? a[b] ? b : null : c.specified ? c.value : null : null)
    };
    F = w.selectors = {
        cacheLength: 50,
        createPseudo: T,
        ...
        find: {
            ID: ib ? function(a, b, c) {
                if ("undefined" !== typeof b.getElementById && !c) return (a = b.getElementById(a)) && a.parentNode ? [a] : []
            } : function(a, b, c) {
                if ("undefined" !== typeof b.getElementById && !c) return (b = b.getElementById(a)) ? b.id === a || "undefined" !== typeof b.getAttributeNode && b.getAttributeNode("id").value === a ? [b] : void 0 : []
            },
            TAG: ad ? function(a, b) {
                ...
                if ("*" === a) {
                    for (var d, e = [], g = 0; d = c[g]; g++) 1 === d.nodeType && e.push(d);
                    return e
                }
                return c
            },
            NAME: dd && function(a, b) {
                if ("undefined" !== typeof b.getElementsByName) return b.getElementsByName(name)
            },
            CLASS: Pb && function(a, b, c) {
        ...
        preFilter: {
            ...
            CHILD: function(a) {
                return a[1] = a[1].toLowerCase(), "nth" === a[1] ? (a[2] || w.error(a[0]), a[3] = +(a[3] ? a[4] + (a[5] || 1) :
                    2 * ("even" === a[2] || "odd" === a[2])), a[4] = +(a[6] + a[7] || "odd" === a[2])) : a[2] && w.error(a[0]), a
            },
            PSEUDO: function(a) {
                var b, c;
                if (Ja.CHILD.test(a[0])) return null;
                if (a[3]) a[2] = a[3];
                else if (b = a[4]) Yc.test(b) && (c = Ka(b, !0)) && (c = b.indexOf(")", b.length - c) - b.length) && (b = b.slice(0, c), a[0] = a[0].slice(0, c)), a[2] = b;
                return a.slice(0, 3)
            }
        },
        filter: {
            ...
            ATTR: function(a, b, c) {
                return function(d) {
                    d = w.attr(d, a);
                    return null == d ? "!=" === b : b ? (d += "", "=" ===
                        b ? d === c : "!=" === b ? d !== c : "^=" === b ? c && 0 === d.indexOf(c) : "*=" === b ? c && -1 < d.indexOf(c) : "$=" === b ? c && d.substr(d.length - c.length) === c : "~=" === b ? -1 < (" " + d + " ").indexOf(c) : "|=" === b ? d === c || d.substr(0, c.length + 1) === c + "-" : !1) : !0
                }
            },
            ...
            PSEUDO: function(a, b) {
                var c, d = F.pseudos[a] || F.setFilters[a.toLowerCase()] || w.error("unsupported pseudo: " + a);
                return d[A] ? d(b) : 1 < d.length ? (c = [a, a, "", b], F.setFilters.hasOwnProperty(a.toLowerCase()) ? T(function(a, c) {
                    for (var e, g = d(a, b), f = g.length; f--;) e = Tb.call(a, g[f]), a[e] = !(c[e] = g[f])
                }) : function(a) {
                    return d(a, 0, c)
                }) : d
            }
        ...
        pseudos: {
            ...
            lt: da(function(a, b, c) {
                for (b = 0 > c ? c + b : c; 0 <= --b;) a.push(b);
                return a
            }),
            gt: da(function(a, b, c) {
                for (c = 0 > c ? c + b : c; ++c < b;) a.push(c);
                return a
            })
        }
    };
    jb = R.compareDocumentPosition ? function(a, b) {
        return a === b ? (ta = !0, 0) : (!a.compareDocumentPosition || !b.compareDocumentPosition ? a.compareDocumentPosition : a.compareDocumentPosition(b) & 4) ? -1 : 1
    } : function(a, b) {
        ...
        d = g.length;
        for (f = 0; f < c && f < d; f++)
            if (e[f] !== g[f]) return Ia(e[f], g[f]);
        return f === c ? Ia(a, g[f], -1) : Ia(e[f], b, 1)
    };
    [0, 0].sort(jb);
    Vb = !ta;
    ...
    hb = w.compile = function(a, b) {
        var c, d = [],
            e = [],
            g = Xb[A][a];
        if (!g) {
            b || (b = Ka(a));
            for (c = b.length; c--;) g = fb(b[c]), g[A] ? d.push(g) : e.push(g);
            var f = 0 < d.length,
                k = 0 < e.length,
                j = function(a, b, c, g, x) {
                    var h, C, p = [],
                        ...
                        u = sa += null == q ? 1 : Math.E;
                    for (m && (Ma = b !== S && b, bb = j.el); null != (x = G[I]); I++) {
                        if (k && x) {
                            for (h = 0; C = e[h]; h++)
                                if (C(x, b, c)) {
                                    g.push(x);
                    ...
                    if (f && I !== l) {
                        ...
                        if (a) {
                            if (0 < l)
                                for (; I--;) !s[I] && !p[I] && (p[I] = Xc.call(g));
                            p = La(p)
                        }
                        ka.apply(g, p);
                        m && !a && 0 < p.length && 1 < l + d.length && w.uniqueSort(g)
                    }
                    return m && (sa = u, Ma = q), s
                };
            c = (j.el = 0, f ? T(j) : j);
            g = Xb(a, c)
        }
    ...
    if (S.querySelectorAll) {
        var Zb, ed = ab,
            ...
            U = [":focus"],
            Oa = [":active", ":focus"],
            Pa = R.matchesSelector || R.mozMatchesSelector || R.webkitMatchesSelector || R.oMatchesSelector ||
            R.msMatchesSelector;
        X(function(a) {
        ...
        X(function(a) {
            ...
            a.querySelectorAll(":enabled").length || U.push(":enabled",
                ":disabled")
        });
        U = RegExp(U.join("|"));
        ab = function(a, b, c, d, e) {
            if (!d && !e && (!U || !U.test(a))) {
                ...
                if (1 === b.nodeType && "object" !== b.nodeName.toLowerCase()) {
                    g = Ka(a);
                    (k = b.getAttribute("id")) ? j = k.replace(fd, "\\$&"): b.setAttribute("id", j);
                    j = "[id='" + j + "'] ";
                    for (f = g.length; f--;) g[f] = j + g[f].join("");
                    f = gb.test(a) && b.parentNode || b;
                    g = g.join(",")
                }
                if (g) try {
                    return ka.apply(c, la.call(f.querySelectorAll(g), 0)), c
                } catch (h) {} finally {
        ...
        Pa &&
            (X(function(a) {
                Zb = Pa.call(a, "div");
                try {
                    Pa.call(a, "[test!='']:sizzle"), Oa.push("!=", lb)
                } catch (b) {}
            }), Oa = RegExp(Oa.join("|")), w.matchesSelector = function(a, b) {
                b = b.replace(gd, "='$1']");
                if (!Ga(a) && !Oa.test(b) && (!U || !U.test(b))) try {
                    var c = Pa.call(a, b);
    ...
    F.filters = Ub.prototype = F.pseudos;
    F.setFilters = new Ub;
    w.attr = g.attr;
    g.find = w;
    g.expr = w.selectors;
    ...
    g.fn.extend({
        ...
        is: function(a) {
            return !!a && ("string" == typeof a ? $b.test(a) ? 0 <= g(a, this.context).index(this[0]) : 0 < g.filter(a, this).length : 0 < this.filter(a).length)
        },
        closest: function(a, b) {
            for (var c, d = 0, e = this.length,
                    f = [], k = $b.test(a) || "string" != typeof a ? g(a, b || this.context) : 0; d < e; d++)
                for (c = this[d]; c && c.ownerDocument && c !== b && 11 !== c.nodeType;) {
                    if (k ? -1 < k.index(c) : g.find.matchesSelector(c, a)) {
                        f.push(c);
                        break
                    }
                    c = c.parentNode
    ...
    g.each({
        ...
        g.fn[a] = function(c, d) {
            ...
            return hd.test(a) ||
                (d = c), d && "string" == typeof d && (e = g.filter(d, e)), e = 1 < this.length && !kd[a] ? g.unique(e) : e, 1 < this.length && jd.test(a) && (e = e.reverse()), this.pushStack(e, a, V.call(arguments).join(","))
        }
    });
    g.extend({
        ...
        dir: function(a, c, d) {
            var e = [];
            for (a = a[c]; a && 9 !== a.nodeType && (d === b || 1 !== a.nodeType || !g(a).is(d));) 1 === a.nodeType && e.push(a), a = a[c];
            return e
        },
    ...
    var sb = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        pd = /<(?:script|object|embed|option|style)/i,
        nb = RegExp("<(?:" + sb + ")[\\s/>]", "i"),
        tb = /^(?:checkbox|radio)$/,
        ...
        dc = q(t),
        ob = dc.appendChild(t.createElement("div"));
    Q.optgroup =
        Q.option;
    ...
    g.fn.extend({
        text: function(a) {
            return g.access(this, function(a) {
                return a === b ? g.text(this) : this.empty().append((this[0] && this[0].ownerDocument || t).createTextNode(a))
        ...
        html: function(a) {
            return g.access(this, function(a) {
                var c = this[0] || {},
                    d = 0,
                    e = this.length;
                if (a === b) return 1 === c.nodeType ? c.innerHTML.replace(ld, "") : b;
                if ("string" == typeof a && !od.test(a) && (g.support.htmlSerialize || !nb.test(a)) && (g.support.leadingWhitespace || !mb.test(a)) &&
                    !Q[(bc.exec(a) || ["", ""])[1].toLowerCase()]) {
                    a = a.replace(ac, "<$1></$2>");
                    try {
        ...
        domManip: function(a, c, d) {
            ...
            var e, f, k, j = 0,
                ...
                p = [],
                l = this.length;
            if (!g.support.checkClone && 1 < l && "string" == typeof h && cc.test(h)) return this.each(function() {
                g(this).domManip(a, c, d)
            });
            ...
            if (this[0]) {
                ...
                if (f) {
                    c = c && g.nodeName(f, "tr");
                    for (e = e.cacheable || l - 1; j < l; j++) d.call(c && g.nodeName(this[j], "table") ? this[j].getElementsByTagName("tbody")[0] || this[j].appendChild(this[j].ownerDocument.createElement("tbody")) : this[j], j === e ? k : g.clone(k, !0, !0))
                }
                k = f = null;
                p.length && g.each(p, function(a, b) {
                    b.src ? g.ajax ? g.ajax({
                        ...
                        global: !1,
                        "throws": !0
                    }) : g.error("no ajax") : g.globalEval((b.text || b.textContent || b.innerHTML || "").replace(rd,
                        ""));
    ...
    g.buildFragment = function(a, c, d) {
        var e, f, k, j = a[0];
        return c = c || t, c = !c.nodeType && c[0] || c, c = c.ownerDocument || c, 1 === a.length && "string" == typeof j && 512 > j.length && c === t && "<" === j.charAt(0) && !pd.test(j) && (g.support.checkClone || !cc.test(j)) && (g.support.html5Clone || !nb.test(j)) && (f = !0, e = g.fragments[j], k = e !== b), e || (e = c.createDocumentFragment(), g.clean(a, c, e, d), f && (g.fragments[j] = k && e)), {
            fragment: e,
            cacheable: f
        }
    };
    ...
    g.extend({
        clone: function(a, b, c) {
            var d, e, f, j;
            g.support.html5Clone || g.isXMLDoc(a) || !nb.test("<" + a.nodeName +
                ">") ? j = a.cloneNode(!0) : (ob.innerHTML = a.outerHTML, ob.removeChild(j = ob.firstChild));
        ...
        clean: function(a, b, c, d) {
                ...
                if ("number" == typeof k && (k += ""), k) {
                    if ("string" ==
                        ...
                        if (nd.test(k)) {
                            ...
                            }!g.support.leadingWhitespace && mb.test(k) && p.insertBefore(b.createTextNode(mb.exec(k)[0]),
                                p.firstChild);
                            k = p.childNodes;
            ...
            if (c) {
                a = function(a) {
                    if (!a.type || qd.test(a.type)) return d ? d.push(a.parentNode ? a.parentNode.removeChild(a) : a) : c.appendChild(a)
                };
                for (e = 0; null != (k = u[e]); e++)
                    if (!g.nodeName(k, "script") || !a(k)) c.appendChild(k),
                        "undefined" != typeof k.getElementsByTagName && (l = g.grep(g.merge([], k.getElementsByTagName("script")), a), u.splice.apply(u, [e + 1, 0].concat(l)), e += l.length)
            }
            return u
        },
    ...
    Qa = g.uaMatch(wc.userAgent);
    Y = {};
    Qa.browser && (Y[Qa.browser] = !0, Y.version = Qa.version);
    ...
    var L, ha, ia, pb = /alpha\([^)]*\)/i,
        sd = /opacity=([^)]*)/,
        td = /^(top|right|bottom|left)$/,
        ud = /^(none|table(?!-c[ea]).+)/,
        ec = /^margin/,
        sc = RegExp("^(" + Aa + ")(.*)$", "i"),
        ua = RegExp("^(" + Aa + ")(?!px)[a-z%]+$", "i"),
        vd = RegExp("^([-+])=(" + Aa + ")", "i"),
        Ua = {},
        wd = {
            position: "absolute",
    ...
    g.fn.extend({
        css: function(a, c) {
            return g.access(this, function(a, c, d) {
                return d !== b ? g.style(a, c, d) : g.css(a, c)
        ...
        toggle: function(a, b) {
            ...
            return g.isFunction(a) && g.isFunction(b) ? xd.apply(this, arguments) : this.each(function() {
                (c ? a : y(this)) ? g(this).show():
                    g(this).hide()
            })
        }
    });
    g.extend({
        ...
        style: function(a, c, d, e) {
            if (a && !(3 === a.nodeType || 8 === a.nodeType || !a.style)) {
                ...
                k = typeof d;
                "string" === k && (f = vd.exec(d)) && (d = (f[1] + 1) * f[2] + parseFloat(g.css(a, c)), k = "number");
                if (!(null == d || "number" === k && isNaN(d)))
                    if ("number" === k && !g.cssNumber[h] && (d += "px"), !j || !("set" in j) || (d = j.set(a, d, e)) !== b) try {
                        p[c] = d
                    } catch (l) {}
            }
        },
        css: function(a, c, d, e) {
            var f, k, j, h = g.camelCase(c);
            return c = g.cssProps[h] || (g.cssProps[h] = u(a.style, h)), j = g.cssHooks[c] || g.cssHooks[h], j && "get" in j && (f = j.get(a, !0, e)), f === b && (f = L(a, c)), "normal" === f && c in fc && (f = fc[c]), d || e !== b ? (k = parseFloat(f), d ||
                g.isNumeric(k) ? k || 0 : f) : f
        },
        swap: function(a, b, c) {
            var d, e = {};
    ...
    a.getComputedStyle ? L = function(b, c) {
        var d, e, f, k, j = a.getComputedStyle(b, null),
            h = b.style;
        return j && (d = j[c], "" === d && !g.contains(b.ownerDocument, b) && (d = g.style(b, c)), ua.test(d) && ec.test(c) && (e = h.width, f = h.minWidth, k = h.maxWidth, h.minWidth = h.maxWidth = h.width = d, d = j.width, h.width = e, h.minWidth = f, h.maxWidth = k)), d
    } : t.documentElement.currentStyle && (L = function(a,
        b) {
        var c, d, e = a.currentStyle && a.currentStyle[b],
            f = a.style;
        return null == e && f && f[b] && (e = f[b]), ua.test(e) && !td.test(b) && (c = f.left, d = a.runtimeStyle && a.runtimeStyle.left, d && (a.runtimeStyle.left = a.currentStyle.left), f.left = "fontSize" === b ? "1em" : e, e = f.pixelLeft + "px", f.left = c, d && (a.runtimeStyle.left = d)), "" === e ? "auto" : e
    });
    g.each(["height", "width"], function(a, b) {
        g.cssHooks[b] = {
            get: function(a, c, d) {
                if (c) return 0 === a.offsetWidth && ud.test(L(a, "display")) ? g.swap(a, wd, function() {
                    return z(a, b, d)
                }) : z(a, b, d)
            },
            set: function(a,
                c, d) {
                return D(a, c, d ? Ta(a, b, d, g.support.boxSizing && "border-box" === g.css(a, "boxSizing")) : 0)
            }
        }
    });
    g.support.opacity || (g.cssHooks.opacity = {
        get: function(a, b) {
            return sd.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || "") ? 0.01 * parseFloat(RegExp.$1) + "" : b ? "1" : ""
        },
        set: function(a, b) {
            var c = a.style,
                d = a.currentStyle,
            ...
            c.zoom = 1;
            if (1 <= b && ("" === g.trim(f.replace(pb, "")) && c.removeAttribute) && (c.removeAttribute("filter"), d && !d.filter)) return;
        ...
        !g.support.pixelPosition && g.fn.position && g.each(["top", "left"], function(a, b) {
            g.cssHooks[b] = {
                get: function(a, c) {
                    if (c) {
                        var d = L(a, b);
                        return ua.test(d) ? g(a).position()[b] + "px" : d
                    }
                }
            }
        })
    ...
    g.expr && g.expr.filters && (g.expr.filters.hidden = function(a) {
        return 0 === a.offsetWidth && 0 === a.offsetHeight ||
            !g.support.reliableHiddenOffsets && "none" === (a.style && a.style.display || L(a, "display"))
    ...
    g.each({
        ...
        ec.test(a) || (g.cssHooks[a + b].set = D)
    });
    var yd = /%20/g,
        tc = /\[\]$/,
        gc = /\r?\n/g,
        zd = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
    ...
    g.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                return this.name && !this.disabled && (this.checked || Ad.test(this.nodeName) || zd.test(this.type))
            }).map(function(a, b) {
                var c = g(this).val();
    ...
    ma = ic.exec(fa.toLowerCase()) || [];
    g.fn.load = function(a, c, d) {
        if ("string" != typeof a && jc) return jc.apply(this, arguments);
        if (!this.length) return this;
        var e, f, k, j = this,
            h = a.indexOf(" ");
        return 0 <= h && (e = a.slice(h, a.length), a = a.slice(0, h)), g.isFunction(c) ? (d = c, c = b) : c && "object" == typeof c && (f = "POST"), g.ajax({
            url: a,
            type: f,
            dataType: "html",
            data: c,
            complete: function(a, b) {
                d && j.each(d, k || [a.responseText, b, a])
            }
        }).done(function(a) {
            k = arguments;
            j.html(e ? g("<div>").append(a.replace(Fd, "")).find(e) : a)
        }), this
    };
    ...
    g.extend({
        ...
        ajaxSetup: function(a, b) {
            return b ? oa(a, g.ajaxSettings) : (b = a, a = g.ajaxSettings), oa(a, b), a
        },
        ajaxSettings: {
            url: fa,
        ...
        ajax: function(a, c) {
            function d(a, c, k, p) {
                ...
                if (2 !== z) {
                    ...
                    if (k) {
                        ...
                        for (;
                            "*" === H[0];) H.shift(),
                            P === b && (P = I.mimeType || p.getResponseHeader("content-type"));
                        if (P)
                            for (M in F)
                                if (F[M] && F[M].test(P)) {
                                    H.unshift(M);
                    ...
                    if (200 <= a && 300 > a || 304 === a)
                        if (m.ifModified && (G = B.getResponseHeader("Last-Modified"), G && (g.lastModified[e] = G), G = B.getResponseHeader("Etag"), G && (g.etag[e] = G)), 304 === a) v = "notmodified", s = !0;
                            ...
                            a: {
                                s = m;x = I;
                                var J, v = s.dataTypes.slice();k = v[0];
                                P = {};M = 0;s.dataFilter && (x = s.dataFilter(x, s.dataType));
                                if (v[1])
                                ...
                                for (; C = v[++M];)
                                    if ("*" !== C) {
                                        if ("*" !== k && k !== C) {
                                            ...
                                            if (!A)
                                                for (J in P)
                                                    if (G = J.split(" "), G[1] === C && (A = P[k + " " + G[0]] || P["* " + G[0]])) {
                                                        !0 === A ? A = P[J] : !0 !== P[J] && (C = G[0], v.splice(M--, 0, C));
                                                        break
                                                    }
                                            if (!0 !== A)
                                                if (A && s["throws"]) x = A(x);
                                                    ...
                                                    A = {
                                                        state: "parsererror",
                                                        error: A ? L : "No conversion from " + k + " to " + C
                                                    };
                                                    break a
                                                }
                                        }
            ...
            var e, f, k, j, h, p, l, s, m = g.ajaxSetup({}, c),
                ...
                B = {
                    ...
                    getResponseHeader: function(a) {
                        ...
                        if (2 === z) {
                            if (!k)
                                for (k = {}; c = Cd.exec(f);) k[c[1].toLowerCase()] = c[2];
                            c = k[a.toLowerCase()]
                        }
                        return c === b ? null : c
                    },
                    ...
                    abort: function(a) {
                        return a = a || E, j && j.abort(a), d(0, a), this
                    }
                };
            y.promise(B);
            B.success = B.done;
            ...
            m.url = ((a || m.url) + "").replace(Bd, "").replace(Ed, ma[1] + "//");
            m.dataTypes = g.trim(m.dataType || "*").toLowerCase().split(aa);
            null == m.crossDomain && (p = ic.exec(m.url.toLowerCase()) || !1, m.crossDomain = p && p.join(":") + (p[3] ? "" : "http:" === p[1] ? 80 : 443) !== ma.join(":") + (ma[3] ? "" : "http:" === ma[1] ? 80 : 443));
            m.data && m.processData && "string" != typeof m.data && (m.data = g.param(m.data,
                m.traditional));
            ja(Va, m, c, B);
            if (2 === z) return B;
            l = m.global;
            m.type = m.type.toUpperCase();
            m.hasContent = !Dd.test(m.type);
            l && 0 === g.active++ && g.event.trigger("ajaxStart");
            if (!m.hasContent && (m.data && (m.url += (hc.test(m.url) ? "&" : "?") + m.data, delete m.data), e = m.url, !1 === m.cache)) {
                p = g.now();
                var F = m.url.replace(Gd, "$1_=" + p);
                m.url = F + (F === m.url ? (hc.test(m.url) ? "&" : "?") + "_=" + p : "")
            }(m.data && m.hasContent && !1 !== m.contentType || c.contentType) && B.setRequestHeader("Content-Type", m.contentType);
            m.ifModified && (e = e || m.url,
                g.lastModified[e] && B.setRequestHeader("If-Modified-Since", g.lastModified[e]), g.etag[e] && B.setRequestHeader("If-None-Match", g.etag[e]));
            B.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + lc + "; q=0.01" : "") : m.accepts["*"]);
    ...
    g.ajaxPrefilter("json jsonp", function(c, d, e) {
        var f, k, j, h = c.data,
            ...
            l = !1 !== c.jsonp,
            m = l && Ra.test(p),
            s = l && !m && "string" == typeof h && !(c.contentType || "").indexOf("application/x-www-form-urlencoded") && Ra.test(h);
        if ("jsonp" === c.dataTypes[0] || m || s) return f = c.jsonpCallback = g.isFunction(c.jsonpCallback) ? c.jsonpCallback() : c.jsonpCallback, k = a[f], m ? c.url = p.replace(Ra, "$1" + f) : s ? c.data = h.replace(Ra, "$1" + f) : l && (c.url += (Hd.test(p) ? "&" : "?") + c.jsonp + "=" + f), c.converters["script json"] = function() {
            return j || g.error(f + " was not called"), j[0]
        }, c.dataTypes[0] = "json", a[f] = function() {
            j = arguments
        }, e.always(function() {
            a[f] =
                k;
            c[f] && (c.jsonpCallback = d.jsonpCallback, mc.push(f));
    ...
    g.ajaxTransport("script", function(a) {
        if (a.crossDomain) {
            var c, d =
                t.head || t.getElementsByTagName("head")[0] || t.documentElement;
            return {
                send: function(e, f) {
    ...
    var na, qb = a.ActiveXObject ? function() {
            for (var a in na) na[a](0,
                1)
        } : !1,
        Jd = 0;
    g.ajaxSettings.xhr = a.ActiveXObject ? function() {
        var b;
        if (!(b = !this.isLocal && vb())) a: {
            try {
        ...
        if (!c.crossDomain || g.support.cors) {
            ...
            return {
                send: function(e, f) {
                    ...
                    d = function(a, e) {
                        ...
                        try {
                            if (d && (e || 4 === h.readyState))
                                if (d = b, k && (h.onreadystatechange = g.noop, qb && delete na[k]), e) 4 !== h.readyState && h.abort();
                                else {
                                    j = h.status;
                                    ...
                                    try {
                                        ...
                                        p = ""
                                    }!j && c.isLocal && !c.crossDomain ? j = m.text ? 200 : 404 : 1223 === j && (j = 204)
                                }
                        } catch (I) {
                            e || f(-1, I)
                        }
                    ...
                    c.async ? 4 === h.readyState ? setTimeout(d, 0) : (k = ++Jd, qb && (na || (na = {}, g(a).unload(qb)), na[k] = d), h.onreadystatechange = d) : d()
                },
                abort: function() {
                    d && d(0, 1)
                }
    ...
    var wa, Sa, Kd = /^(?:toggle|show|hide)$/,
        ...
        xa = [function(a, b, c) {
            var d, e, f, k, j, h, p = this,
                ...
                q = a.nodeType && y(a);
            c.queue ||
                (j = g._queueHooks(a, "fx"), null == j.unqueued && (j.unqueued = 0, h = j.empty.fire, j.empty.fire = function() {
                    j.unqueued || h()
                }), j.unqueued++, p.always(function() {
                    p.always(function() {
                        j.unqueued--;
            ...
            c.overflow && (l.overflow = "hidden",
                g.support.shrinkWrapBlocks || p.done(function() {
                    l.overflow = c.overflow[0];
                    l.overflowX = c.overflow[1];
                    l.overflowY = c.overflow[2]
                }));
            for (d in b) e = b[d], Kd.exec(e) && (delete b[d], e !== (q ? "hide" : "show") && s.push(d));
            if (e = s.length) {
                f = g._data(a, "fxshow") || g._data(a, "fxshow", {});
                q ? g(a).show() : p.done(function() {
                    g(a).hide()
                });
                p.done(function() {
                    var b;
                ...
                for (d = 0; d < e; d++) b = s[d], k = p.createTween(b, q ? f[b] : 0), m[b] = f[b] || g.style(a, b), b in f || (f[b] = k.start, q && (k.end = k.start,
                    k.start = "width" === b || "height" === b ? 1 : 0))
            }
        }],
        pa = {
            "*": [function(a, b) {
    ...
    g.Animation = g.extend(xb, {
        tweener: function(a, b) {
            g.isFunction(a) ? (b = a, a = ["*"]) : a = a.split(" ");
            for (var c, d = 0, e = a.length; d < e; d++) c = a[d], pa[c] = pa[c] || [], pa[c].unshift(b)
        },
    ...
    N.prototype = {
        ...
        run: function(a) {
            ...
            return this.options.duration ? this.pos = b = g.easing[this.easing](a, this.options.duration *
                a, 0, 1, this.options.duration) : this.pos = b = a, this.now = (this.end - this.start) * b + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), c && c.set ? c.set(this) : N.propHooks._default.set(this), this
        }
    };
    ...
    N.propHooks = {
        _default: {
            get: function(a) {
                var b;
                return null == a.elem[a.prop] || a.elem.style && null != a.elem.style[a.prop] ? (b = g.css(a.elem, a.prop, !1, ""), !b || "auto" === b ? 0 : b) : a.elem[a.prop]
            },
            set: function(a) {
                g.fx.step[a.prop] ? g.fx.step[a.prop](a) : a.elem.style &&
                    (null != a.elem.style[g.cssProps[a.prop]] || g.cssHooks[a.prop]) ? g.style(a.elem, a.prop, a.now + a.unit) : a.elem[a.prop] = a.now
            }
        }
    };
    ...
    g.each(["toggle", "show", "hide"], function(a, b) {
        ...
        g.fn[b] = function(d, e, f) {
            return null == d || "boolean" == typeof d || !a && g.isFunction(d) && g.isFunction(e) ? c.apply(this, arguments) : this.animate(ya(b, !0), d, e, f)
        }
    });
    g.fn.extend({
    ...
    g.fx.timer = function(a) {
        a() && g.timers.push(a) && !Sa && (Sa = setInterval(g.fx.tick, g.fx.interval))
    };
    g.fx.interval = 13;
    g.fx.stop = function() {
        clearInterval(Sa);
    ...
    g.fn.offset = function(a) {
        ...
        var c, d, e, f, k, j, h, p = {
            ...
            l = this[0],
            m = l && l.ownerDocument;
        if (m) return (d = m.body) === l ? g.offset.bodyOffset(l) : (c = m.documentElement, g.contains(c, l) ? ("undefined" != typeof l.getBoundingClientRect && (p = l.getBoundingClientRect()), e = yb(m), f = c.clientTop || d.clientTop || 0, k = c.clientLeft || d.clientLeft || 0, j = e.pageYOffset || c.scrollTop, h = e.pageXOffset || c.scrollLeft, {
            top: p.top + j - f,
            left: p.left + h - k
        }) : p)
    };
    ...
    g.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var a =
                        this.offsetParent || t.body; a && !nc.test(a.nodeName) && "static" === g.css(a, "position");) a = a.offsetParent;
                return a || t.body
            })
        }
    });
        ...
        g.each({
            ...
            g.fn[e] = function(e, f) {
                ...
                return g.access(this, function(c, d, e) {
                    var f;
                    return g.isWindow(c) ? c.document.documentElement["client" + a] : 9 === c.nodeType ? (f = c.documentElement, Math.max(c.body["scroll" + a], f["scroll" + a], c.body["offset" + a], f["offset" + a], f["client" + a])) : e === b ? g.css(c, d, e, j) : g.style(c, d, e, j)
                }, c, k ? e : b, k, null)
            }
        })
    });
...
var _STRINGS = {
    ...
    UnitSpecs: {
        wave_min_time: 8,
        wave_max_time: 12,
        wave_max_monsters: 15,
        wave_boss_interval: 5,
        wave_size: 3,
        wave_size_rate: 0.25,
        tutorial_start_gold: 10,
        hero_start_gold: 0,
        hero_start_health: 15,
        hero_start_energy: 10,
        hero_start_damage: 2.5,
        hero_upgrade_health: 4,
        hero_upgrade_health_goldcost: 10,
        hero_upgrade_damage: 1.2,
        hero_upgrade_damage_goldcost: 10,
        hero_potion_health_goldcost: 50,
        hero_potion_health_cooldown: 5,
        hero_potion_health: 0.5,
        hero_potion_energy_goldcost: 50,
        hero_potion_energy_cooldown: 5,
        hero_potion_energy: 0.5,
        hero_potion_power_goldcost: 50,
        hero_potion_power_cooldown: 15,
        hero_potion_power: 2,
        hero_potion_power_duration: 8,
        hero_megaslash_cost: 5,
        hero_megaslash_cooldown: 25,
        hero_shieldsup_cost: 2,
        hero_shieldsup_duration: 6,
        hero_shieldsup_cooldown: 9,
        monster_start_health: 8,
        monster_health_rate: 0.15,
        monster_start_damage: 1,
        monster_damage_rate: 0.1,
        monster_move_speed_mult_rate: 0.0070,
        monster_attack_speed_mult_rate: 0.0070,
        boss_start_health: 80,
        boss_health_rate: 0.4,
        boss_start_attackduration: 30,
        boss_attackduration_rate: -0.0040,
        monster_pickup_base_droprate: 0.85,
        monster_pickup_gold_droprate: 0.95,
        monster_pickup_gold_amt: 10,
        boss_pickup_gold_amt: 50
    }
};
var _SETTINGS = {
    API: {
        		...
        		Initialize: function() {
        			if (_SETTINGS.Ad.Mobile.Footer.Rotation.Enabled) {
        				var a = _SETTINGS.Ad.Mobile.Footer.Rotation.Weight,
        					...
        					d = Math.floor(100 * Math.random());
        				console.log("seed: ", d);
        				d <= b ? this.selectedOverlayName = "MobileAdInGameFooter" : d <= c ? this.selectedOverlayName =
        					"MobileAdInGameFooter2" : d <= a && (this.selectedOverlayName = "MobileAdInGameFooter3");
    ...
    MobileAdInGamePreroll = {
        /*
        		...
        		Initialize: function() {
        			...
        			} else this.selectedOverlayName =
        				"MobileAdInGamePreroll", console.log("Ad rotating preroll disabled");
        			console.log("selected:", this.selectedOverlayName);
        			this.overlay = $("#" + this.selectedOverlayName);
        			this.box = $("#" + this.selectedOverlayName + "-Box");
        			this.game = $("#game");
...
jukebox.Manager.prototype = {
    ...
    __getClone: function(a, b) {
        for (var c in this.__clones) {
            var d = this.__clones[c];
            if (null === d.isPlaying && d.origin === a) return d
        }
    ...
    loop: function() {
        if (0 !== this.__playersLength)
            if (this.__queue.length &&
                ...
                for (c in this.__queue.length && 1 === this.features.channels && (a = this.__queue[0], b = this.__getPlayerById(a.origin), null !== b && b.play(a.pointer, !0), this.__queue.splice(0, 1)), this.__players) a = this.__players[c],
    ...
    addToQueue: function(a, b) {
        return ("string" === typeof a || "number" === typeof a) && void 0 !== this.__players[b] ? (this.__queue.push({
            pointer: a,
            origin: b
        }), !0) : !1
    }
...
jukebox.Player.prototype = {
    ...
    __init: function() {
        ...
        if (!0 === c.html5audio) {
            ...
            1 < c.channels ? !0 === b.autoplay ? this.context.autoplay = !0 : void 0 !== b.spritemap[b.autoplay] && this.play(b.autoplay) : 1 === c.channels && void 0 !== b.spritemap[b.autoplay] && (this.backgroundMusic = b.spritemap[b.autoplay], this.backgroundMusic.started = Date.now ?
                Date.now() : +new Date, this.play(b.autoplay));
            1 == c.channels && !0 !== b.canPlayBackground && (window.addEventListener("pagehide", function() {
    ...
    backgroundHackForiOS: function() {
        if (void 0 !== this.backgroundMusic) {
            ...
            void 0 === this.backgroundMusic.started ? (this.backgroundMusic.started =
                a, this.setCurrentTime(this.backgroundMusic.start)) : (this.backgroundMusic.lastPointer = (a - this.backgroundMusic.started) / 1E3 % (this.backgroundMusic.end - this.backgroundMusic.start) + this.backgroundMusic.start, this.play(this.backgroundMusic.lastPointer))
        }
    },
    play: function(a, b) {
    ...
    resume: function(a) {
        a = "number" ===
            typeof a ? a : this.__lastPosition;
    ...
    HTML5API: {
        ...
        setVolume: function(a) {
            ...
            return 1E-4 > Math.abs(this.context.volume - a) ? !0 : !1
        },
        ...
        setCurrentTime: function(a) {
            try {
                return this.context.currentTime = a, !0
            } catch (b) {
                return !1
            }
        }
...
(function() {
    ...
    h.prototype = {
        ...
        _setMuted: function(a) {
            ...
            for (var b in this._howls)
                if (this._howls.hasOwnProperty(b) &&
                    !1 === this._howls[b]._webAudio)
    ...
    if (!d) var h = new Audio,
        l = {
            ...
            m4a: !!(h.canPlayType("audio/x-m4a;") || h.canPlayType("audio/aac;")).replace(/^no$/,
                ""),
            mp4: !!(h.canPlayType("audio/x-mp4;") || h.canPlayType("audio/aac;")).replace(/^no$/, ""),
    ...
    q.prototype = {
        load: function() {
            ...
            if (!d) {
                for (var f = 0; f < c._urls.length; f++) {
                    ...
                    else if (q = c._urls[f].toLowerCase().split("?")[0], h =
                        (h = q.match(/.+\.([^?]+)(\?|$)/)) && 2 <= h.length ? h : q.match(/data\:audio\/([^?]+);/)) h = h[1];
                    else {
                        c.on("loaderror");
                        return
                    }
                ...
                if (e) {
                    ...
                    if (c._webAudio) {
                        ...
                        if (v in a) c._duration = a[v].duration, m(c);
                            ...
                            D.onerror = function() {
                                c._webAudio && (c._buffer = !0, c._webAudio = !1, c._audioNode = [], delete c._gainNode,
                                    c.load())
                            };
                            try {
                                D.send()
        ...
        play: function(c, d) {
            ...
            e._inactiveNode(function(f) {
                ...
                if (e._webAudio) {
                ...
                } else if (4 === f.readyState) f.id = q, f.currentTime = h, f.muted = j._muted, f.volume = e._volume * j.volume(), setTimeout(function() {
                    f.play()
                }, 0);
                else {
                    e._clearEndTimer(z);
                    var va = c,
                        ...
                        oa = function() {
                            e.play(va, ja);
                            f.removeEventListener("canplaythrough", oa, !1)
                        };
                    f.addEventListener("canplaythrough", oa, !1);
                    return e
                }
                e.on("play");
        ...
        pause: function(a, b) {
            ...
            if (d)
                if (d._pos = c.pos(null, a), c._webAudio) {
                    ...
                    d.paused = !0;
                    "undefined" === typeof d.bufferSource.stop ? d.bufferSource.noteOff(0) :
        ...
        volume: function(a, b) {
            ...
            if (0 <= a && 1 >= a) {
                ...
                d && (c._webAudio ? d.gain.value = a : d.volume =
                    a * j.volume());
                return c
            }
            return c._volume
        ...
        _inactiveNode: function(a) {
            ...
            if (!b) {
                var d;
                this._webAudio ? (d = this._setupAudioNode(),
                    a(d)) : (this.load(), d = this._audioNode[this._audioNode.length - 1], d.addEventListener("loadedmetadata", function() {
                    a(d)
                }))
            }
        },
        ...
        _clearEndTimer: function(a) {
            ...
            a = 0 <= a ? a : 0;
            this._onendTimer[a] && (clearTimeout(this._onendTimer[a]),
                this._onendTimer.splice(a, 1))
        },
...
(function(a) {
        ...
        _execModules: function() {
            for (var a = !1, b = 0; b < ig._loadQueue.length; b++) {
                for (var c = ig._loadQueue[b], d = !0, e = 0; e < c.requires.length; e++) {
                    var f = c.requires[e];
                    ig.modules[f] ? ig.modules[f].loaded ||
                        (d = !1) : (d = !1, ig._loadScript(f, c.name))
                }
    ...
    if (a.requestAnimationFrame) {
        ...
        a.ig.setAnimation = function(d, e) {
            ...
            c[f] = !0;
            var h = function() {
                c[f] && (a.requestAnimationFrame(h, e), d())
            };
        ...
        draw: function(a, b, c, d, e, f) {
            if (this.loaded) {
                ...
                ig.system.context.drawImage(this.data,
                    c ? c * h : 0, d ? d * h : 0, e, f, ig.system.getDrawPos(a), ig.system.getDrawPos(b), e, f);
                ig.Image.drawCount++
            }
        },
...
ig.module("impact.font").requires("impact.image").defines(function() {
    ig.Font = ig.Image.extend({
        ...
        draw: function(a, b, c, d) {
            ...
            if (-1 !== a.indexOf("\n")) {
                a = a.split("\n");
                for (var e = this.height + this.lineSpacing, f = 0; f < a.length; f++) this.draw(a[f], b, c + f * e, d)
            } else {
                if (d == ig.Font.ALIGN.RIGHT || d == ig.Font.ALIGN.CENTER) f = this._widthForLine(a), b -= d == ig.Font.ALIGN.CENTER ? f / 2 : f;
                1 !== this.alpha && (ig.system.context.globalAlpha = this.alpha);
                for (f = 0; f < a.length; f++) d = a.charCodeAt(f),
...
ig.module("impact.loader").requires("impact.image", "impact.font", "impact.sound").defines(function() {
    ig.Loader = ig.Class.extend({
        ...
        loadRes: function() {
            this.loadIndex > this.resources.length - 1 ? clearInterval(this._intervalLoad) : (this.loadResource(this.resources[this.loadIndex]), this.loadIndex++)
        },
...
ig.module("impact.input").defines(function() {
    ...
    ig.Input = ig.Class.extend({
        ...
        bindTouch: function(a, b) {
            ...
            c.addEventListener("MSPointerDown", function(a) {
                d.touchStart(a, b)
            }, !1);
            c.addEventListener("MSPointerUp", function(a) {
                d.touchEnd(a, b)
            }, !1)
        },
        unbind: function(a) {
...
ig.module("impact.entity").requires("impact.animation", "impact.impact").defines(function() {
    ig.Entity = ig.Class.extend({
        ...
        update: function() {
            ...
            var a = ig.game.collisionMap.trace(this.pos.x, this.pos.y, this.vel.x * ig.system.tick, this.vel.y *
        ...
        handleMovementTrace: function(a) {
            ...
            a.collision.x && (this.vel.x = 0 < this.bounciness && Math.abs(this.vel.x) >
    ...
    ig.Entity.solveCollision =
        function(a, b) {
            ...
            a.last.x + a.size.x > b.last.x && a.last.x < b.last.x + b.size.x ? (a.last.y < b.last.y ? ig.Entity.seperateOnYAxis(a, b, c) : ig.Entity.seperateOnYAxis(b, a, c), a.collideWith(b, "y"), b.collideWith(a, "y")) : a.last.y + a.size.y > b.last.y && a.last.y < b.last.y + b.size.y && (a.last.x < b.last.x ? ig.Entity.seperateOnXAxis(a, b, c) : ig.Entity.seperateOnXAxis(b,
                a, c), a.collideWith(b, "x"), b.collideWith(a, "x"))
        };
    ...
    ig.Entity.seperateOnYAxis = function(a, b, c) {
        ...
        if (c) {
            ...
            c.pos.y = a.pos.y;
            c.pos.x = a.pos.x
        } else ig.game.gravity && (b.standing || 0 < a.vel.y) ? (c = ig.game.collisionMap.trace(a.pos.x, a.pos.y, 0, -(a.pos.y + a.size.y - b.pos.y), a.size.x, a.size.y), a.pos.y = c.pos.y, 0 < a.bounciness &&
    ...
    ig.BackgroundMap = ig.Map.extend({
        ...
        preRenderMapToChunks: function() {
            ...
            for (var e = 0; e < d; e++) {
                ...
                for (var f = 0; f < c; f++) this.preRenderedChunks[e][f] = this.preRenderChunk(f, e, f == c - 1 ? a - f * this.chunkSize : this.chunkSize, e == d - 1 ?
                    b - e * this.chunkSize : this.chunkSize)
            }
        },
        ...
        drawTiled: function() {
            for (var a = 0, b = null, c = (this.scroll.x / this.tilesize).toInt(),
                    d = (this.scroll.y / this.tilesize).toInt(), e = this.scroll.x % this.tilesize, f = this.scroll.y % this.tilesize, h = -e - this.tilesize, e = ig.system.width + this.tilesize - e, j = ig.system.height + this.tilesize - f, l = -1, f = -f - this.tilesize; f < j; l++, f += this.tilesize) {
                var q = l + d;
...
ig.module("plugins.font-loaded-test").defines(function() {
    ig.FontLoadedTest = ig.Class.extend({
        testFont: function(a) {
            ...
            a = b(a + ",arial");
            for (var e = b("arial"), f = !1, h = 0; h <
                a.data.length; h++)
                if (a.data[h] != e.data[h]) {
                    f = !0;
                    break
                }
            return !f ? !1 : !0
    ...
    ig.SplashLoader = ig.Loader.extend({
        ...
        draw: function() {
            ...
            if (1 >= this.loadingStage) ig.system.context.font = "24px " + this.font, ig.system.context.fillText("", 0, 0);
                ...
                var b = 0;
                this.bgImage.width < ig.system.width ? a.scale(ig.system.width / this.bgImage.width, 1) : this.bgImage.width >
                    ig.system.width && (b = -(this.bgImage.width - ig.system.width) / 2);
                ...
                ig.system.context.fillText(d, 0,
                    0);
...
ig.module("game.components.director").defines(function() {
    ig.Director = ig.Class.extend({
        ...
        append: function(a) {
            newLevels = [];
            return "object" === typeof a ? (a.constructor === [].constructor ? newLevels = a : newLevels[0] = a, this.levels =
                this.levels.concat(newLevels), !0) : !1
        },
        nextLevel: function() {
...
ig.module("game.components.tween").requires("impact.entity").defines(function() {
    ...
    ig.Tween = function(a, b, c, d) {
        ...
        this.initStart = function(a, b, c, d) {
            if ("object" !== typeof c[a]) "undefined" !== typeof b[a] && (d[a] = c[a]);
                ...
                for (subprop in c[a]) d[a] || (d[a] = {}), "undefined" !== typeof b[a] && this.initStart(subprop,
                    b[a], c[a], d[a])
        };
        this.start = function() {
        ...
        this.propUpdate = function(a, b, c, d, e) {
            if ("object" !== typeof c[a]) b[a] = "undefined" != typeof c[a] ?
                c[a] + d[a] * e : b[a];
            else
    ...
    ig.Tween.Easing.Bounce.EaseInOut = function(a) {
        return 0.5 > a ? 0.5 * ig.Tween.Easing.Bounce.EaseIn(2 * a) : 0.5 * ig.Tween.Easing.Bounce.EaseOut(2 * a - 1) + 0.5
    }
});
ig.baked = !0;
ig.module("game.components.drawer").defines(function() {
    Drawer = ig.Class.extend({
        ...
        createGradient: function(a, b, c, d, e) {
            a = this.context.createLinearGradient(a, b, c, d);
            for (b = 0; b < e.length; b++) a.addColorStop(b,
                e[b]);
            return a
        },
        ...
        setUsingOptions: function(a) {
            a && (a.color && (this.context.fillStyle = a.color), a.font && (this.context.font = a.font), a.globalAlpha && (this.context.globalAlpha = a.globalAlpha))
        }
    })
});
ig.baked = !0;
ig.module("game.sound.sound-list").defines(function() {
    SoundList = ig.Class.extend({
        sfx: {
            kittyopeningSound: {
                path: "media/game/audio/opening/kittyopening"
            },
            staticSound: {
                path: "media/game/audio/play/static"
            },
            openingSound: {
                path: "media/game/audio/opening/opening"
            },
            button: {
                path: "media/game/audio/sfx/release"
            },
            monsterhit: {
                path: "media/game/audio/sfx/hit"
            },
            monsterdied1: {
                path: "media/game/audio/sfx/juicy"
            },
            monsterdied2: {
                path: "media/game/audio/sfx/juicy2"
            },
            bossdied: {
                path: "media/game/audio/sfx/boom"
            },
            herohit1: {
                path: "media/game/audio/sfx/fleshyhit"
            },
            herohit2: {
                path: "media/game/audio/sfx/stabbing"
            },
            herodied: {
                path: "media/game/audio/sfx/bighit"
            },
            drop: {
                path: "media/game/audio/sfx/drop"
            },
            potiondrink: {
                path: "media/game/audio/sfx/potion"
            },
            fillup: {
                path: "media/game/audio/sfx/fillup"
            },
            megaslash: {
                path: "media/game/audio/sfx/megaslash"
            },
            shieldsup: {
                path: "media/game/audio/sfx/shieldhit"
            },
            coinpickup: {
                path: "media/game/audio/sfx/coinpickup"
            },
            pickup: {
                path: "media/game/audio/sfx/pickup"
            },
            buy: {
                path: "media/game/audio/sfx/buy"
            }
        },
        bgm: {
            background: {
                path: "media/game/audio/music/bgm",
                startOgg: 0,
                endOgg: 40,
                startMp3: 0,
                endMp3: 40
...
ig.baked = !0;
ig.module("game.sound.sound-player").defines(function() {
    SoundPlayer = ig.Class.extend({
        ...
        play: function(a) {
            this.debug && console.log("play sound ", a)
        },
        stop: function() {
        ...
        mute: function(a) {
            ...
            "undefined" === typeof a ? this.muteFlag = !0 : a.flagChange && (this.muteFlag = !0)
        },
        unmute: function(a) {
            this.debug &&
                console.log("unmute");
            "undefined" === typeof a ? this.muteFlag = !1 : a.flagChange && (this.muteFlag = !1)
        }
    })
});
ig.baked = !0;
ig.module("game.sound.impact-music-player").requires("game.sound.sound-player").defines(function() {
    ImpactMusicPlayer = SoundPlayer.extend({
        ...
        play: function(a) {
            this.muteFlag || (this.bgmPlaying = !0, "undefined" === typeof a ? ig.music.play(a) : ig.music.play())
        },
        stop: function() {
            this.bgmPlaying = !1;
            ig.music.pause()
...
ig.module("game.sound.impact-sound-player").requires("game.sound.sound-player").defines(function() {
    ImpactSoundPlayer = SoundPlayer.extend({
        ...
        play: function(a) {
            this.muteFlag || ("object" === typeof a ? (console.log(a + " exists"), a.play()) : "string" === typeof a && this.soundList[a].play())
        },
        stop: function(a) {
            this.parent(a);
            a.stop()
...
ig.module("game.sound.howler-player").requires("game.sound.sound-player").defines(function() {
    HowlerPlayer = SoundPlayer.extend({
        ...
        play: function(a) {
            this.muteFlag || ("object" === typeof a ? a.play() : "string" === typeof a && this.soundList[a].play())
        },
        stop: function(a) {
            this.parent(a);
            a.stop()
        ...
        getVolume: function() {
            for (var a in this.soundList) return this.soundList[a].volume()
        },
        mute: function(a) {
            this.parent(a);
            Howler.mute()
    ...
    HowlerMusicPlayer = SoundPlayer.extend({
        ...
        play: function(a) {
            if (!this.muteFlag && !this.bgmPlaying)
                if ("object" ===
                    typeof a) this.bgmPlaying = !0, a.play();
...
ig.module("game.sound.jukebox-player").requires("game.sound.sound-player").defines(function() {
    JukeboxPlayer = SoundPlayer.extend({
        ...
        volume: function(a) {
            ...
            0 >= a ? this.jukeboxPlayer.setVolume(this.minVolume) : isNaN(a) ? this.jukeboxPlayer.setVolume(1) :
                1 < a ? this.jukeboxPlayer.setVolume(1) : this.jukeboxPlayer.setVolume(a)
        },
        getVolume: function() {
...
ig.module("game.sound.webaudio-music-player").requires("game.sound.sound-player").defines(function() {
    WebaudioMusicPlayer = SoundPlayer.extend({
            ...
            if (this.isSupported)
                if (this.webaudio.buffer) {
                    if (!this.muteFlag && (this.bgmPlaying = !0, !this.webaudio.source_loop._playing)) {
                        ...
                        if ("noteOn" === this.webaudio.compatibility.start) this.webaudio.source_once = this.webaudio.context.createBufferSource(), this.webaudio.source_once.buffer = this.webaudio.buffer, this.webaudio.source_once.connect(this.webaudio.gainNode),
                            this.webaudio.source_once.noteGrainOn(0, a, this.webaudio.buffer.duration - a), this.webaudio.source_loop[this.webaudio.compatibility.start](this.webaudio.context.currentTime + (this.webaudio.buffer.duration - a));
        ...
        volume: function(a) {
            this.isSupported && this.webaudio.gainNode && (this.webaudio.gainNode.gain.value = a)
        },
        getVolume: function() {
...
ig.module("game.handlers.sound-handler").requires("game.sound.impact-music-player", "game.sound.impact-sound-player", "game.sound.howler-player", "game.sound.howler-music-player", "game.sound.jukebox-player", "game.sound.webaudio-music-player").defines(function() {
    ig.SoundHandler = ig.Class.extend({
        ...
        init: function(a) {
            ...
            ig.ua.mobile ? (this.initPowerButtonFix(), this.bgmPlayer = new WebaudioMusicPlayer(a.bgm, {
                loop: !0
            }), this.bgmPlayer.isSupported || (this.bgmPlayer = new JukeboxPlayer(a.bgm, {
                loop: !0
            }))) : (this.bgmPlayer = new WebaudioMusicPlayer(a.bgm, {
                loop: !0
            }), this.bgmPlayer.isSupported || (this.bgmPlayer = new ImpactMusicPlayer(a.bgm, {
                loop: !0
            })));
        ...
        forceLoopBGM: function() {
            ...
            if (!this.focusBlurMute && this.bgmPlayer.bgmPlaying && this.bgmPlayer) {
                ...
                if (b) {
                    ...
                    b.settings.spritemap.music && (a = b.settings.spritemap.music.end - c, b.getCurrentTime() >= a && (a = b.settings.spritemap.music.start, ig.ua.android ? this.forcelooped ||
                        (b.play(a, !0), this.forcelooped = !0, setTimeout(function() {
                            ig.soundHandler.forcelooped = !1
                        }, c)) : b.setCurrentTime(a)))
                    ...
                    c, ig.music.currentTrack.currentTime >= a && (ig.ua.android ? this.forcelooped || (ig.music.currentTrack.pause(), ig.music.currentTrack.currentTime = b, ig.music.currentTrack.play(), this.forcelooped = !0, setTimeout(function() {
                        ig.soundHandler.forcelooped = !1
                    }, c)) : ig.music.currentTrack.currentTime = b)))
            }
        }
    })
});
...
ig.module("game.handlers.dom-handler").defines(function() {
    ig.DomHandler = ig.Class.extend({
        ...
        create: function(a) {
            return this.JQUERYAVAILABLE ? $("<" + a + ">") : ig.$new(a)
        },
        getElementByClass: function(a) {
            return this.JQUERYAVAILABLE ? $("." + a) : document.getElementsByClassName(a)
        },
        getElementById: function(a) {
            return this.JQUERYAVAILABLE ? 0 < $(a).length ? $(a) : null : ig.$(a)
        },
        appendChild: function(a, b) {
            this.JQUERYAVAILABLE ? a.append(b) : a.appendChild(b)
        },
        appendToBody: function(a) {
            this.JQUERYAVAILABLE ? $("body").append(a) : document.body.appendChild(a)
        },
        resize: function(a, b, c) {
        ...
        getOffsets: function(a) {
            return this.JQUERYAVAILABLE ? (a = a.offset(), {
                left: a.left,
                top: a.top
            }) : {
                left: a.offsetLeft,
        ...
        show: function(a) {
            this.JQUERYAVAILABLE ? (a.show(), a.css("visibility", "visible")) : a && (a.style ? a.style.visibility = "visible" : a[0] && (a[0].style.visibility = "visible"))
        },
        hide: function(a) {
            this.JQUERYAVAILABLE ? (a.hide(), a.css("visibility", "hidden")) : a && (a.style ? a.style.visibility = "hidden" : a[0] && (a[0].style.visibility = "hidden"))
        },
        getQueryVariable: function(a) {
            for (var b =
                    window.location.search.substring(1).split("&"), c = 0; c < b.length; c++) {
                var d = b[c].split("=");
...
ig.baked = !0;
ig.module("game.data.vector").defines(function() {
    Vector2 = ig.Class.extend({
        x: null,
        y: null,
        valType: "number",
        init: function(a, b) {
            typeof a === this.valType && typeof b === this.valType && (this.x = a, this.y = b)
        },
        row: function(a) {
            typeof a === this.valType && (this.y = a);
            return this.y
        },
        col: function(a) {
            typeof a === this.valType && (this.x = a);
            return this.x
        }
    })
});
    ...
    ig.SizeHandler = ig.Class.extend({
        ...
        sizeCalcs: function() {
            ...
            if (ig.ua.mobile) {
                ...
                new Vector2(window.innerWidth, window.innerHeight), a = new Vector2(this.desktop.actualResolution.x, this.desktop.actualResolution.y), this.scaleRatioMultiplier = new Vector2(this.desktop.actualSize.x / a.x, this.desktop.actualSize.y / a.y), b = Math.min(this.scaleRatioMultiplier.x, this.scaleRatioMultiplier.y), this.desktop.actualSize.x = a.x * b, this.desktop.actualSize.y = a.y * b;
        ...
        resizeLayers: function() {
            for (var a =
                    0; a < this.coreDivsToResize.length; a++) {
        ...
        samsungFix: function() {
            ig.ua.android && (!(4.2 > parseFloat(navigator.userAgent.slice(navigator.userAgent.indexOf("Android") + 8, navigator.userAgent.indexOf("Android") + 11))) && !(0 > navigator.userAgent.indexOf("GT")) && !(0 < navigator.userAgent.indexOf("Chrome")) && !(0 < navigator.userAgent.indexOf("Firefox"))) && (document.addEventListener("touchstart", function(a) {
                a.preventDefault();
                return !1
    ...
    Mouse = ig.Class.extend({
        ...
        init: function() {
            ...
            for (var a in this.bindings) {
                this[a] = a;
                for (var b = 0; b < this.bindings[a].length; b++) ig.input.bind(this.bindings[a][b], a)
            }
        },
        getPos: function() {
...
ig.baked = !0;
ig.module("game.io.keyboard").defines(function() {
...
ig.module("game.io.gamepad-input").defines(function() {
    ...
    ig.GamepadInput = ig.Class.extend({
        ...
        buttonPressed: function(a) {
            return "object" == typeof a ? a.pressed :
                1 == a
        },
        buttonDown: function(a) {
            if (a = this.bindings[a]) this.states[a] = !0, this.downLocks[a] || (this.presses[a] = !0, this.downLocks[a] = !0)
        },
        buttonUp: function(a) {
            if ((a = this.bindings[a]) && this.downLocks[a] && !this.upLocks[a]) this.states[a] = !1, this.releases[a] = !0, this.upLocks[a] = !0
        },
        clearPressed: function() {
        ...
        pollGamepads: function() {
            if (this.isSupported) {
                ...
                for (var a in this.bindings) {
                    for (var b = !1, c = 0; c < this.list.length; c++) {
                        var d = this.list[c];
                        if (d && d.buttons && this.buttonPressed(d.buttons[a])) {
                            b = !0;
                            break
                        }
                    }
...
ig.module("game.io.multitouch-input").defines(function() {
    ig.MultitouchInput = ig.Class.extend({
        ...
        touchmove: function(a) {
            if (ig.ua.touchDevice) {
                var b = parseInt(ig.system.canvas.offsetWidth) || ig.system.realWidth,
                    c = parseInt(ig.system.canvas.offsetHeight) ||
        ...
        windowMove: function(a) {
            ...
            if (window.navigator.msPointerEnabled)
                for (var e =
                        "undefined" != typeof a.identifier ? a.identifier : "undefined" != typeof a.pointerId ? a.pointerId : 1, f = 0; f < this.touches.length; ++f)
...
ig.module("game.io.io-manager").requires("game.io.storage", "game.io.mouse", "game.io.keyboard", "game.io.gamepad", "game.io.multitouch", "game.io.multitouch-input", "game.io.gamepad-input").defines(function() {
    IoManager = ig.Class.extend({
        ...
        press: function(a) {
            return ig.input.pressed(a) || this.gamepad.press(a) ? !0 : !1
        },
        held: function(a) {
            return ig.input.state(a) || this.gamepad.state(a) ? !0 : !1
        },
        release: function(a) {
            return ig.input.released(a) ||
                this.gamepad.released(a) ? !0 : !1
        },
        ...
        checkOverlap: function(a, b, c, d, e) {
            return a.x > b + d || a.x < b || a.y > c + e || a.y < c ? !1 : !0
        },
        ...
        storageIsSet: function(a) {
            return !this.localStorageSupport ?
                null : this.storage.isSet(a)
        },
        storageGet: function(a) {
            return !this.localStorageSupport ? null : this.storage.get(a)
        },
        ...
        assert: function(a, b, c) {
            if (b !== c) throw "actualValue:" + b + " not equal to testValue:" + c + " at " + a;
        }
    })
});
ig.baked = !0;
ig.module("integrations.client.api-handler").defines(function() {
    ig.ApiHandler = ig.Class.extend({
        ...
        run: function(a, b) {
            if (this.apiAvailable[a]) this.apiAvailable[a](b)
        }
    })
});
ig.baked = !0;
ig.module("game.entities.opening-kitty").requires("impact.entity").defines(function() {
    EntityOpeningKitty = ig.Entity.extend({
        ...
        drawKittyOpening: function() {
            ...
            ig.game.mainDrawer.fillRect(0, 0, ig.system.width, ig.system.height, {
                color: a
            });
...
ig.module("plugins.fade-transition").defines(function() {
    ig.FadeTransition = ig.Class.extend({
        ...
        drawTransition: function() {
            if (this.transitionFadein || this.transitionFadeout) this.overlayAlpha > this.targetOverlayAlpha && (this.overlayAlpha =
                this.targetOverlayAlpha), ig.system.context.globalAlpha = this.overlayAlpha, ig.system.context.fillStyle = "#000000", ig.system.context.fillRect(0, 0, ig.system.width, ig.system.height), ig.system.context.globalAlpha = 1
        },
        startFadeinTransition: function() {
            this.transitionFadein || (this.transitionFadein = !0, this.transitionTime = ig.system.clock.delta(), this.overlayAlpha = 1)
        },
        startFadeoutTransition: function() {
            this.transitionFadeout || (this.transitionFadeout = !0, this.transitionTime = ig.system.clock.delta(), this.overlayAlpha =
                0)
        }
    })
});
...
ig.module("plugins.sat").defines(function() {
    ig.SAT = ig.Class.extend({
        ...
        mtvForShapeIntersect: function(a, b) {
            ...
            } else e = a.getNormalizedAxes(),
                f = b.getNormalizedAxes();
        ...
        simpleShapeIntersect: function(a,
            b) {
            var c = [],
                d = [];
    ...
    ig.SAT.Vector2D = ig.Class.extend({
        ...
        subtract: function(a) {
            return new ig.SAT.Vector2D(this.x - a.x, this.y - a.y)
        },
        getNormal: function() {
        ...
        normalized: function() {
            ...
            return 0 == a ? new ig.SAT.Vector2D(0,
                0) : new ig.SAT.Vector2D(this.x / a, this.y / a)
        },
        distance: function(a) {
            var b = a.x - this.x;
            a = a.y - this.y;
        ...
        getAngle: function(a) {
            return Math.atan2(this.crossProduct(a), this.dotProduct(a))
        }
    });
    ig.SAT.Shape = ig.Class.extend({
        ...
        project: function(a) {
            return new ig.SAT.Projection(this.pointList, a)
        }
    });
    ...
    ig.SAT.Projection = ig.Class.extend({
        ...
        overlap: function(a) {
            return !(this.max < a.min || a.max < this.min)
        },
...
ig.module("plugins.button").requires("plugins.sat").defines(function() {
    ig.Button = ig.Class.extend({
        ...
        setPos: function(a, b) {
            a && (this.pos.x = a.x, this.pos.y = a.y, this.setPosRelativeTo(b))
        },
        setPosRelativeTo: function(a, b) {
            if (a && a.pos && !(null == a.pos.x ||
                    null == a.pos.y)) this.posRelativeTo = a, this.setPos(b)
        },
        setRect: function(a) {
            a && (this.rect.x = a.x, this.rect.y = a.y, this.rect.w = 0 <= a.w ? a.w : 1, this.rect.h = 0 <= a.h ? a.h : 1, this.detectionRect.x = this.rect.x, this.detectionRect.y = this.rect.y, this.detectionRect.w = this.rect.w, this.detectionRect.h = this.rect.h)
        },
        ...
        setScale: function(a, b) {
            a && b && (this.scale.x = a, this.scale.y = b, this.recalculateDetectionRect(), this.recalculateDetectionPoints())
        },
        ...
        setTextOffset: function(a) {
            a && (this.textOffset.x = a.x, this.textOffset.y = a.y)
        },
        ...
        setImageOffset: function(a) {
            a && (this.imageOffset.x = a.x, this.imageOffset.y = a.y)
        },
        setUpImage: function(a) {
            if (this.upImage = a) this.buttonType = ig.BUTTONTYPE.IMAGE
        },
        setOverImage: function(a) {
            if (this.overImage = a) this.buttonType = ig.BUTTONTYPE.IMAGE
        },
        setDownImage: function(a) {
            if (this.downImage =
                a) this.buttonType = ig.BUTTONTYPE.IMAGE
        },
        setAnimSheet: function(a) {
            if (this.animSheet = a) {
                ...
                a = Math.floor(a);
                b = Math.floor(b);
                3 == a * b ? (this.upAnim = new ig.Animation(this.animSheet, 1, [0]), this.overAnim = new ig.Animation(this.animSheet, 1, [1]), this.downAnim = new ig.Animation(this.animSheet, 1, [2]), this.buttonType = ig.BUTTONTYPE.ANIMSHEET) : 2 == a * b ? (this.upAnim = new ig.Animation(this.animSheet, 1, [0]), this.overAnim =
                    null, this.downAnim = new ig.Animation(this.animSheet, 1, [1]), this.buttonType = ig.BUTTONTYPE.ANIMSHEET) : 1 == a * b && this.setUpImage(this.animSheet.image)
            }
        },
        draw: function() {
            if (!this.hidden) {
                ...
                this.antialiasingEnabled ||
                    (b = this.bitwiseRound(b), c = this.bitwiseRound(c));
                a.save();
                ...
                if (this.buttonType == ig.BUTTONTYPE.ROUNDED_RECT || this.buttonType == ig.BUTTONTYPE.SQUARE_RECT || this.buttonType == ig.BUTTONTYPE.OCTOGON || this.buttonType == ig.BUTTONTYPE.PILL || this.buttonType == ig.BUTTONTYPE.CIRCLE) {
                    b = this.strokeStyle;
                    c = this.fillStyle;
                    this.down ? (this.downStrokeStyle && (b = this.downStrokeStyle),
                        this.downFillStyle && (c = this.downFillStyle)) : this.over && (this.overStrokeStyle && (b = this.overStrokeStyle), this.overFillStyle && (c = this.overFillStyle));
                    a.strokeStyle = b;
                    a.fillStyle = c;
                    var d = !1,
                        e = !1;
                ...
                if (!d && this.textShadowDisabled && this.text && "" != this.text)
                    if (a.font = this.textFontSize + "px " + this.textFont,
                        a.textAlign = "center", b = this.textOffset.x, c = this.textOffset.y, c += this.textHeightAdjustment, this.antialiasingEnabled || (b = this.bitwiseRound(b), c = this.bitwiseRound(c)), a.transform(this.textScale.x, this.textSkew.x, this.textSkew.y, this.textScale.y, b, c), a.rotate(this.textAngle), this.textList)
        ...
        drawDebug: function() {
            ...
            a.strokeRect(b + this.detectionRect.x, c + this.detectionRect.y, this.detectionRect.w,
                this.detectionRect.h);
        ...
        update: function() {
            if (!this.disabled)
                if (this.pointerInputOverlap() || this.keyInputReleased()) {
                    if (this.over = this.down = !1, this.scaleMultiplier = 1, ig.ua.mobile || (this.over = !0, this.scaleMultiplier = this.overScaleMultiplier), this.clickInputDetected() && (this.down = !0, this.over = !1, this.scaleMultiplier = this.downScaleMultiplier), this.clickInputReleased() || this.keyInputReleased()) this.over =
                        this.down = !1, this.scaleMultiplier = 1, ig.ua.mobile || (this.over = !0, this.scaleMultiplier = this.overScaleMultiplier), "function" === typeof this.clickedFunction && this.clickedFunction(this)
                } else this.over = this.down = !1, this.scaleMultiplier = 1
        },
        pointerInputOverlap: function() {
            ...
            if (this.sat && 0 < this.detectionPoints.length) {
                ...
                this.down ? (c += this.downOffset.x, d += this.downOffset.y) : this.over && (c += this.overOffset.x,
                    d += this.overOffset.y);
        ...
        keyInputReleased: function() {
            return ig.input.released(this.keyStateName) ? !0 : !1
        },
        clickInputDetected: function() {
            return ig.input.state(this.clickStateName) ? !0 : !1
        },
        clickInputReleased: function() {
            return ig.input.released(this.clickStateName) ? !0 : !1
        },
        show: function() {
        ...
        recalculateDetectionRect: function() {
            ...
            this.detectionRect.w = this.rect.w - 2 *
                a;
        ...
        drawBtnShadow: function() {
            ...
            this.posRelativeTo && (b += this.posRelativeTo.pos.x,
                c += this.posRelativeTo.pos.y);
            this.antialiasingEnabled || (b = this.bitwiseRound(b), c = this.bitwiseRound(c));
            a.save();
            a.globalAlpha = this.alpha;
        ...
        drawTextShadow: function() {
            ...
            if (this.text && "" != this.text)
                if (a.font = this.textFontSize + "px " + this.textFont, a.textAlign = "center", b = this.textOffset.x, c = this.textOffset.y, c += this.textHeightAdjustment, this.antialiasingEnabled || (b = this.bitwiseRound(b), c = this.bitwiseRound(c)), a.transform(this.textScale.x, this.textSkew.x, this.textSkew.y, this.textScale.y, b, c), a.rotate(this.textAngle), this.textList)
                    ...
                    this.textShadowColor, a.fillText(this.text, 0, 0);
            a.restore();
            b = this.pos.x + this.offset.x;
            c = this.pos.y + this.offset.y;
            this.down ? (b += this.downOffset.x, c += this.downOffset.y) : this.over && (b += this.overOffset.x, c += this.overOffset.y);
            ...
            a.save();
            a.globalAlpha = this.alpha;
            a.transform(this.scale.x * this.scaleMultiplier, this.skew.x, this.skew.y, this.scale.y * this.scaleMultiplier,
                b, c);
            a.rotate(this.angle);
            if (this.text && "" != this.text)
                if (a.font = this.textFontSize + "px " + this.textFont, a.textAlign = "center", b = this.textOffset.x, c = this.textOffset.y, c += this.textHeightAdjustment, this.antialiasingEnabled || (b = this.bitwiseRound(b), c = this.bitwiseRound(c)), a.transform(this.textScale.x, this.textSkew.x, this.textSkew.y, this.textScale.y, b, c), a.rotate(this.textAngle), this.textList)
        ...
        wrapText: function(a, b) {
            ...
            if (1 == d.length)
                for (var h = 0; h < a.length; h++) {
                    ...
                    for (h = 0; h < d.length; h++) j = e + d[h] + " ", l = c.measureText(j), l = l.width, l > b && 0 < h ? (f.push(e), e = d[h] +
                        " ") : e = j;
            f.push(e);
            return f
        },
    ...
    ClickableDivLayer = ig.Class.extend({
        ...
        createClickableOutboundLayer: function(a, b, c, d) {
            /*
            			...
            			} else d = ig.domHandler.getElementById("#canvas"), d = ig.domHandler.getOffsets(d), h = d.top, d = Math.floor(d.left + this.pos.x * c) +
            				"px", h = Math.floor(h + this.pos.y * c) + "px", j = Math.floor(this.size.x * c) + "px", c = Math.floor(this.size.y * c) + "px";
            			ig.domHandler.css(e, {
            				"float": "left",
            				position: "absolute",
            				left: d,
            			...
            			ig.sizeHandler.dynamicClickableEntityDivs[a].height =
            				this.size.y;
...
ig.module("game.entities.button-more-games").requires("impact.entity", "game.components.clickable-div-layer").defines(function() {
    EntityButtonMoreGames = ig.Entity.extend({
        ...
        spawnDiv: function() {
            _SETTINGS.MoreGames.Enabled ? (_SETTINGS.MoreGames.Link && (this.link = _SETTINGS.MoreGames.Link), _SETTINGS.MoreGames.NewWindow && (this.newWindow = _SETTINGS.MoreGames.NewWindow), this.divLayerName = "more-games", this.clickableLayer = new ClickableDivLayer(this), this.show()) : this.kill()
        },
        hide: function() {
            this.divLayerName && (id = this.divLayerName, document.getElementById(id).style.visibility = "hidden", $("#" + id).hide())
        },
        show: function() {
            this.divLayerName && (id = this.divLayerName, document.getElementById(id).style.visibility =
                "visible", $("#" + id).show())
        },
        kill: function() {
            this.parent();
...
ig.baked = !0;
ig.module("game.components.clickable-div-layer-branding").requires("game.data.vector").defines(function() {
    ClickableDivLayerBranding = ig.Class.extend({
        pos: new Vector2(0, 0),
        size: new Vector2(0, 0),
        identifier: null,
        invisImagePath: "media/game/graphics/misc/invisible.png",
        ...
        createClickableOutboundLayer: function(a, b, c, d) {
            ...
            ig.domHandler.attr(e, "id", a);
            var f = ig.domHandler.create("a");
            d ? (ig.domHandler.attr(f, "hrefs", b), ig.domHandler.attr(f, "target", "_blank")) : ig.domHandler.attr(f, "href", b);
            b = ig.domHandler.create("img");
            ig.domHandler.css(b, {
                width: "100%",
                height: "100%"
...
ig.baked = !0;
ig.module("game.entities.button-more-games-branding").requires("impact.entity", "game.components.clickable-div-layer-branding").defines(function() {
    EntityButtonMoreGamesBranding = ig.Entity.extend({
        size: {
            x: 146,
            y: 32
        },
        zIndex: 750,
        type: ig.Entity.TYPE.B,
        image: new ig.Image("media/branding/graphics/logo-small.png"),
        imageOffset: {
            x: 0,
            y: 0
        },
        ...
        ready: function() {
            this.pos.x = 241 - this.image.width / 2;
            this.pos.y = 590 - this.image.height / 2;
            this.size.x = this.image.width;
            this.size.y = this.image.height;
            setTimeout(this.spawnDiv(), 5)
        },
        spawnDiv: function() {
            _SETTINGS.Branding.Logo.Enabled ? (_SETTINGS.Branding.Logo.Link && (this.link = _SETTINGS.Branding.Logo.Link), _SETTINGS.Branding.Logo.NewWindow && (this.newWindow = _SETTINGS.Branding.Logo.NewWindow), this.divLayerName = "branding", this.clickableLayer = new ClickableDivLayerBranding(this), this.show()) : this.kill()
        },
        hide: function() {
            this.divLayerName && (id = this.divLayerName, document.getElementById(id).style.visibility = "hidden", $("#" + id).hide())
        },
        show: function() {
            this.divLayerName &&
                (id = this.divLayerName, document.getElementById(id).style.visibility = "visible", $("#" + id).show())
        },
        kill: function() {
            this.parent();
            this.hide()
...
ig.module("game.classes.options-panel").requires("plugins.button").defines(function() {
    OptionsPanel = ig.Class.extend({
        ...
        ready: function() {
            ...
            d.setFont(14,
                "bachelorpadjl, Impact, Charcoal, sans-serif");
            b = _STRINGS.UI.MUSIC;
            ...
            1 > ig.game.musicVolume &&
                d.setImage(this.musicOffImage);
            this.musicButton = d;
            ...
            this.soundButton = d;
            this.hasTutorialButton ? (a = this.tutorialImage, b = a.width, c = a.height, d = new ig.Button(this), d.setPos({
                    x: -60,
                    y: 27
                }), d.posRelativeTo = this, d.setRect({
                    x: -b / 2,
                    y: -c / 2,
                    w: b,
                    h: c
                ...
                b = _STRINGS.UI.TUTORIAL, addTextSpacing && (b = b.split("").join(String.fromCharCode(8202))), d.setText(b), d.textOffset.x = 2, d.textOffset.y = 60, d.textShadowDisabled = !1, d.textShadowColor = "rgba(255,255,255,0.5)", d.textShadowOffset = {
                    x: 1,
                    y: 1
                }, d.clickedFunction = this.tutorialButtonPressed.bind(this), d.downOffset = {
                    x: 0,
                    y: 1
                }, d.overOffset = {
                    x: 0,
                    y: -1
                }, d.overScaleMultiplier = 1, d.downScaleMultiplier = 1, d.buttonType = ig.BUTTONTYPE.IMAGE, d.setImage(a), this.tutorialButton = d, this.tutorialButton.setPos({
                    x: -120,
                    y: 27
                }), this.soundButton.setPos({
                    x: 0,
                    y: 27
                }), this.musicButton.setPos({
                    x: 120,
                    y: 27
                })) : this.hasMainmenuButton && (a = this.mainmenuImage, b = a.width, c = a.height, d = new ig.Button(this), d.setPos({
                    x: -60,
                    y: 27
                }), d.posRelativeTo = this, d.setRect({
                    x: -b / 2,
                    ...
                    g: 0,
                    b: 0
                }, d.setFont(14, "bachelorpadjl, Impact, Charcoal, sans-serif"), b = _STRINGS.UI["MAIN MENU"], addTextSpacing && (b = b.split("").join(String.fromCharCode(8202))), d.setText(b), d.textOffset.x = 2, d.textOffset.y = 60, d.textShadowDisabled = !1, d.textShadowColor = "rgba(255,255,255,0.5)",
                d.textShadowOffset = {
                    x: 1,
                    y: 1
                }, d.clickedFunction = this.mainmenuButtonPressed.bind(this), d.downOffset = {
                    x: 0,
                    y: 1
                }, d.overOffset = {
                    x: 0,
                    y: -1
                }, d.overScaleMultiplier = 1, d.downScaleMultiplier = 1, d.buttonType = ig.BUTTONTYPE.IMAGE, d.setImage(a), this.mainmenuButton = d, this.mainmenuButton.setPos({
                    x: -120,
                    y: 27
                }), this.soundButton.setPos({
                    x: 0,
        ...
        draw: function() {
            if (!this.hidden) {
                var a = ig.system.context;
                0 < this.bgAlpha && (a.save(), a.globalAlpha = this.bgAlpha, a.fillStyle = "#000000", a.fillRect(0,
                    0, ig.system.width, ig.system.height), a.restore());
        ...
        update: function() {
            if (!this.hidden) {
                ...
                } else this.transitionOut && (a = ig.system.clock.delta() - this.transitionTime, a /= this.transitionDuration, 1 < a && (a = 1), this.alpha = 1 - a, this.bgAlpha = this.maxBgAlpha * (1 - a), 1 > a ? (this.offset.x = a * this.relStartPos.x, this.offset.y = a * this.relStartPos.y) : (this.offset.x = this.relStartPos.x, this.offset.y = this.relStartPos.y), 1 <=
                    a && (this.transitionOut = !1, this.hideDone()), this.pos.x = this.endPos.x + this.offset.x, this.pos.y = this.endPos.y + this.offset.y);
        ...
        show: function() {
            this.hidden && !this.transitionIn && (this.transitionIn = !0, this.transitionTime = ig.system.clock.delta(), this.hidden = !1)
        },
        showDone: function() {},
        hide: function() {
        ...
        soundButtonPressed: function() {
            1 > ig.game.sfxVolume ? (this.setSfxVolume(1), this.soundButton.setImage(this.soundOnImage), ig.soundHandler.sfxPlayer.play("button")) :
                (this.setSfxVolume(0), this.soundButton.setImage(this.soundOffImage))
        },
...
ig.baked = !0;
ig.module("game.entities.home-control").requires("impact.entity", "plugins.fade-transition", "plugins.button", "game.entities.button-more-games", "game.entities.button-more-games-branding", "game.entities.options-panel").defines(function() {
    EntityHomeControl = ig.Entity.extend({
        ...
        ready: function() {
            if (!ig.global.wm) {
                ...
                this.branding = ig.game.spawnEntity(EntityButtonMoreGamesBranding, 0, 0);
                ...
                (!this.moregames ||
                    this.moregames._killed) && this.optionsButton.setPos({
                    x: 420,
                    y: 580
                });
...
ig.module("plugins.number-anim").defines(function() {
    ig.NumberAnim = ig.Class.extend({
        ...
        setValue: function(a) {
            this.displayValue = this.actualValue = a
        },
        add: function(a) {
            isNaN(a) || (this.actualValue += a, this.actualValue < this.minValue && (this.actualValue = this.minValue), this.actualValue >= this.maxValue && (this.actualValue = this.maxValue), this.animStartTime =
                ig.system.clock.delta(), this.animStartValue = this.displayValue)
        },
        setMin: function(a) {
            this.minValue = a;
            this.hasMin = !0
...
ig.module("game.classes.ui").requires("plugins.button", "plugins.textwrapper").defines(function() {
    Ui = ig.Class.extend({
        ...
        initButtons: function() {
            ...
            d.clickedFunction =
                this.optionsButtonPressed.bind(this);
            d.downOffset = {
                x: 0,
                y: 1
            };
            ...
            for (var h = this.abilityBarRect.y + this.abilityBarRect.h / 2, j = this.abilityBarRect.x + this.abilityBarRect.w / 2 - a / 2, e = 0; e < this.abilityButtonMetaList.length; e++) f = this.abilityButtonMetaList[e], f.x = j + f.image.width / 2, f.y = h, this.abilityButtonMetaList[e] = f, a = f.image, b = a.width, c = a.height, d = new ig.Button(this), d.abilityId = f.id, d.setPos({
                    ...
                    g: 254,
                    b: 162
                }, d.setFont(8, "bachelorpadjl, Impact, Charcoal, sans-serif"), b = f.str, addTextSpacing && (b = b.split("").join(String.fromCharCode(8202))), d.setText(b), d.textOffset.x = 2, d.textOffset.y = 45, d.textShadowDisabled = !1, d.textShadowColor = "rgba(0,0,0,0.5)", d.textShadowOffset = {
                    x: 1,
                    y: 1
                }, d.clickedFunction = this.abilityButtonPressed.bind(this), d.downOffset = {
                    x: 0,
                    y: 1
                }, d.overOffset = {
                    x: 0,
                    y: -1
                }, d.overScaleMultiplier = 1, d.downScaleMultiplier = 1, d.buttonType = ig.BUTTONTYPE.IMAGE, d.setImage(a), f.button = d, this.abilityButtonList.push(d),
                a = this.buyButtonImage, b = a.width, c = a.height, d = new ig.Button(this), d.abilityId = f.id, d.setPos({
                    x: f.x,
                    y: f.y + 65
                }), d.setRect({
                    x: -b / 2,
                    ...
                    w: b,
                    h: c
                }), d.setScale(0.75, 0.75), d.textColor = {
                    r: 0,
                    g: 0,
                    b: 0
                }, d.setFont(18, "bachelorpadjl, Impact, Charcoal, sans-serif"), b = _STRINGS.UI.BUY, d.setText(b), d.textOffset.x = -2, d.textOffset.y = 0, d.textShadowDisabled = !1, d.textShadowColor = "rgba(255,255,255,0.5)", d.textShadowOffset = {
                    x: 1,
                    y: 1
                }, d.clickedFunction = this.buyButtonPressed.bind(this), d.downOffset = {
                    x: 0,
                    y: 1
                }, d.overOffset = {
                    x: 0,
                    y: -1
                }, d.overScaleMultiplier = 1, d.downScaleMultiplier = 1, d.buttonType = ig.BUTTONTYPE.IMAGE, d.setImage(a), this.abilityQuickbuyButtonList.push(d), j += f.image.width + 25
        },
        draw: function() {
            this.drawWhiteout();
            this.drawTopBar();
        ...
        drawAbilityBar: function() {
            for (var a = 0; a < this.abilityButtonList.length; a++) this.drawButtonGlow(this.abilityButtonList[a]), this.abilityButtonList[a].draw(), this.drawAbilityCount(this.abilityButtonList[a]),
                this.drawAbilityCooldownBar(this.abilityButtonList[a]), this.control.abilities[a].buyCost <= this.control.gameGold.actualValue && this.abilityQuickbuyButtonList[a].draw()
        },
        update: function() {
        ...
        drawFPS: function() {
            ig.game.fps && (ig.system.context.fillStyle = "#ffffff", ig.system.context.font = "18px Impact, Charcoal, sans-serif", ig.system.context.textAlign = "center", ig.system.context.fillText(ig.game.fps, 15, 20))
        },
        drawWhiteout: function() {
            this.control.whiteoutFlag && (ig.system.context.globalAlpha = 0.5 * this.control.whiteoutAlpha, ig.system.context.fillStyle = "#ff0000",
                ig.system.context.fillRect(0, 0, ig.system.width, ig.system.height), ig.system.context.globalAlpha = 1)
        },
        drawGold: function() {
        ...
        drawHerobar: function() {
            ...
            this.heroBgImage.draw(this.heroRect.x,
                this.heroRect.y);
        ...
        drawButtonGlow: function(a) {
            if (!(0 > a.abilityId || this.control.abilities.length <= a.abilityId)) {
                ...
                if (!(0 >= b.count) && !b.onCooldown() && b.available) {
                    var b = a.pos.x,
                        c = a.pos.y;
                    a.down ? (b += a.downOffset.x, c += a.downOffset.y) : a.over && (b += a.overOffset.x,
                        c += a.overOffset.y);
                    var d = a.rect.w;
                    a = a.rect.h;
                    var b = b - d / 2,
        ...
        drawAbilityCount: function(a) {
            if (!(0 > a.abilityId || this.control.abilities.length <= a.abilityId)) {
                ...
                if (!(0 >= b.count)) {
                    var c = a.pos.x,
                        d = a.pos.y;
                    a.down ? (c += a.downOffset.x, d += a.downOffset.y) : a.over && (c += a.overOffset.x,
                        d += a.overOffset.y);
        ...
        drawAbilityCooldownBar: function(a) {
            if (!(0 > a.abilityId || this.control.abilities.length <= a.abilityId)) {
                var b =
                    this.control.abilities[a.abilityId];
                if (0 != b.count) {
                    var c = a.pos.x,
                        d = a.pos.y;
        ...
        abilityButtonPressed: function(a) {
            this.control.activateAbility(a.abilityId)
        },
...
ig.module("plugins.tutorial-box").defines(function() {
    ig.TutorialBox = ig.Class.extend({
        ...
        setTextFontSize: function(a) {
            a && (this.textLineHeight = this.textFontSize = a)
        },
        ...
        draw: function() {
            ...
            this.textStateId != this.textStates.hidden &&
                (this.drawScrollText(), this.drawNextText())
        },
        update: function() {
            ...
            else this.bgStateId == this.bgStates.hiding && (this.bgTime < this.bgHideDuration ? (a = this.bgTime / this.bgHideDuration, this.bgAlpha = 1 - a, this.bgTime += ig.system.tick) :
                (this.bgAlpha = this.bgTime = 0, this.bgStateId = this.bgStates.hidden, this.curStageId >= this.stages.length - 1 && "function" == typeof this.stagesEnded && this.stagesEnded()));
        ...
        detectPlayerInput: function() {
            return ig.input.released(this.keyStateName) || ig.input.released(this.clickStateName) ? !0 : !1
        },
        getInputPos: function() {
            return ig.game.io.getClickPos()
        },
        ...
        wrapText: function(a, b, c, d) {
            ...
            if (1 == c.length)
                for (var h = 0; h < a.length; h++) {
                    ...
                    for (h = 0; h < c.length; h++) j =
                        d + c[h] + " ", l = e.measureText(j), l = l.width, l > b && 0 < h ? (f.push(d), d = c[h] + " ") : d = j;
            f.push(d);
            return f
        },
        getTextColorStr: function() {
...
ig.module("game.classes.tutorial").requires("plugins.button", "plugins.textwrapper", "plugins.tutorial-box").defines(function() {
    Tutorial = ig.Class.extend({
        ...
        init: function(a) {
            ...
            this.tutorialBox.stagesEnded =
                this.end.bind(this)
        },
        draw: function() {
            this.hidden || (this.tutorialBox && this.tutorialBox.draw(), 1 == this.fingerPriority && this.drawFinger())
        },
        drawBeforeEffects: function() {
            0 == this.fingerPriority && this.drawFinger()
        },
        update: function() {
            this.hidden || (this.control.updateAbilities(), this.control.updateMonsterSpawns(), this.control.updateHero(), this.control.updateMonsters(), this.control.updatePickups(), this.tutorialBox && this.tutorialBox.update(), this.updateFinger(), this.updateStages())
        },
        show: function() {
            this.hidden &&
                (this.hidden = !1)
        ...
        drawFinger: function() {
            if (this.showFingerFlag) {
                ...
                this.fingerPos.dir ? 1 == this.fingerPos.dir ? this.drawArrow(a, b + 40, a, b, 20, 5) : 2 == this.fingerPos.dir ? this.drawArrow(a + 40,
                    b, a, b, 20, 5) : 3 == this.fingerPos.dir && this.drawArrow(a - 40, b, a, b, 20, 5) : this.drawArrow(a, b - 40, a, b, 20, 5)
            }
        },
        ...
        updateStages: function() {
            if (0 == this.tutorialBox.curStageId) {
                if (this.targetMonster) {
                    ...
                    a.stateId ==
                        a.states.dead && (this.tutorialBox.gotoNextStage(), this.showFingerFlag = !1, this.targetMonster = null)
                }
            } else if (1 == this.tutorialBox.curStageId)
                if (this.targetPickup) {
                    if (this.fingerPos.x = this.targetPickup.pos.x, this.fingerPos.y = this.targetPickup.pos.y - 20 - 10, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && !this.showFingerFlag && (this.showFingerFlag = !0, this.fingerPriority = 1), ig.input.pressed("click") && (a = this.targetPickup, a.stateId == a.states.spawn || a.stateId == a.states.idle)) b = {
                        x: 0,
                        y: 0,
                        w: 0,
                        h: 0
                    }, b.x = a.pos.x + a.hitRect.x, b.y = a.pos.y + a.hitRect.y, b.w = a.hitRect.w, b.h = a.hitRect.h, c = this.control.getInputPos(), d = {
                        x: 0,
                        y: 0,
                        w: 1,
                        h: 1
                    }, d.x = c.x, d.y = c.y, this.control.aabbCheck(b, d) && (a.hit(), this.showFingerFlag = !1, this.targetPickup = null, this.tutorialBox.gotoNextStage(), this.spawnSurpriseMonsters())
                } else 0 < this.control.pickups.length && (a = this.control.pickups[0], a.aliveDuration = 0, this.targetPickup = a);
            else if (2 != this.tutorialBox.curStageId)
                if (3 == this.tutorialBox.curStageId)
                    if (this.targetAbility && this.targetButton) {
                        if (this.fingerPos.x =
                            this.targetButton.pos.x, this.fingerPos.y = this.targetButton.pos.y - 20 - 10, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && !this.showFingerFlag && (this.showFingerFlag = !0, this.fingerPriority = 1, this.targetButton.enable()), this.targetAbility.onCooldown()) {
                    ...
                    } else this.tutorialBox.textStateId ==
                        this.tutorialBox.textStates.showing && (a = 4, this.targetAbility = this.control.abilities[a], this.targetButton = this.control.ui.abilityButtonList[a]);
            else 4 == this.tutorialBox.curStageId ? this.targetAbility && this.targetButton ? (this.fingerPos.x = this.targetButton.pos.x, this.fingerPos.y = this.targetButton.pos.y - 20 - 10, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && !this.showFingerFlag && (this.showFingerFlag = !0, this.fingerPriority = 1, this.targetButton.enable()), this.targetAbility.onCooldown() &&
                    (this.targetButton.disable(), this.showFingerFlag = !1, this.targetButton = this.targetAbility = null, this.tutorialBox.gotoNextStage())) : this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && (a = 3, this.targetAbility = this.control.abilities[a], this.targetButton = this.control.ui.abilityButtonList[a]) : 5 == this.tutorialBox.curStageId ? this.targetAbility && this.targetButton ? (this.fingerPos.x = this.targetButton.pos.x, this.fingerPos.y = this.targetButton.pos.y + 25, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing ?
                    this.showFingerFlag || (this.showFingerFlag = !0, this.fingerPriority = 1) : this.tutorialBox.textStateId == this.tutorialBox.textStates.hiding && (this.showFingerFlag = !1, this.targetButton = this.targetAbility = null)) : this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && (this.tutorialBox.pos.y = 325, a = 3, this.targetAbility = this.control.abilities[a], this.targetButton = this.control.ui.abilityButtonList[a]) : 6 == this.tutorialBox.curStageId ? this.targetAbility && this.targetButton ? (this.fingerPos.x = this.targetButton.pos.x,
                    this.fingerPos.y = this.targetButton.pos.y - 20 - 10, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && !this.showFingerFlag && (this.showFingerFlag = !0, this.fingerPriority = 1, this.targetButton.enable()), this.targetAbility.onCooldown() && (this.targetButton.disable(), this.showFingerFlag = !1, this.targetButton = this.targetAbility = null, this.tutorialBox.gotoNextStage())) : this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && (this.control.addSpPotion(1), a = 1, this.targetAbility = this.control.abilities[a],
                    this.targetButton = this.control.ui.abilityButtonList[a]) : 7 == this.tutorialBox.curStageId ? this.targetAbility && this.targetButton ? (this.fingerPos.x = this.targetButton.pos.x, this.fingerPos.y = this.targetButton.pos.y - 20 - 10, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && !this.showFingerFlag && (this.showFingerFlag = !0, this.fingerPriority = 1, this.targetButton.enable()), this.targetAbility.onCooldown() && (this.targetButton.disable(), this.showFingerFlag = !1, this.targetButton = this.targetAbility = null,
                    this.tutorialBox.gotoNextStage())) : this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && (this.control.addHpPotion(1), a = 0, this.targetAbility = this.control.abilities[a], this.targetButton = this.control.ui.abilityButtonList[a]) : 8 == this.tutorialBox.curStageId ? this.targetButton ? (this.fingerPos.x = this.targetButton.pos.x, this.fingerPos.y = this.targetButton.pos.y + 20 + 10, this.fingerPos.dir = 1, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && !this.showFingerFlag && (this.showFingerFlag = !0, this.fingerPriority = 1, this.targetButton.enable()), this.control.shop.hidden || (this.targetButton = null, this.showFingerFlag = !1, this.tutorialBox.gotoNextStage())) : this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && (this.tutorialBox.pos.y = 175, this.targetButton = this.control.ui.shopButton, this.control.shop.selectedItemId = 3, this.control.shop.leftButton.disable(), this.control.shop.rightButton.disable(), this.control.shop.backButton.disable()) : 9 == this.tutorialBox.curStageId ? this.targetButton ?
                (this.fingerPos.x = this.control.shop.pos.x + this.targetButton.pos.x, this.fingerPos.y = this.control.shop.pos.y + this.targetButton.pos.y + 20 + 10, this.fingerPos.dir = 1, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && !this.showFingerFlag && (this.showFingerFlag = !0, this.fingerPriority = 1), 2 <= this.control.abilities[3].count && (this.control.ui.shopButton.disable(), this.showFingerFlag = !1, this.targetButton = null, this.tutorialBox.gotoNextStage(), this.control.shop.selectedItemId = 4)) : this.tutorialBox.textStateId ==
                this.tutorialBox.textStates.showing && (this.tutorialBox.pos.y = 125, this.targetButton = this.control.shop.buyButton) : 10 == this.tutorialBox.curStageId ? this.targetButton ? (this.fingerPos.x = this.control.shop.pos.x + this.targetButton.pos.x, this.fingerPos.y = this.control.shop.pos.y + this.targetButton.pos.y + 20 + 10, this.fingerPos.dir = 1, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && !this.showFingerFlag && (this.showFingerFlag = !0, this.fingerPriority = 1), 2 <= this.control.abilities[4].count && (this.control.hideShop(),
                    this.control.ui.shopButton.disable(), this.showFingerFlag = !1, this.targetButton = null, this.tutorialBox.gotoNextStage())) : this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && (this.targetButton = this.control.shop.buyButton) : 11 == this.tutorialBox.curStageId ? this.targetMonster ? (this.fingerPos.x = 270 - this.targetMonster.healthBarWidth / 2 - 10, this.fingerPos.y = this.control.groundLevel + this.targetMonster.imageOffset.y - this.targetMonster.healthBarOffset.y + this.targetMonster.healthBarHeight / 2, this.fingerPos.dir =
                    3, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing ? this.showFingerFlag || (this.showFingerFlag = !0, this.fingerPriority = 1) : this.tutorialBox.textStateId == this.tutorialBox.textStates.hiding && (this.showFingerFlag = !1)) : this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && (a = new Boss0(this.control), a.attackDisabled = !0, this.control.boss = a, a.dropTo({
                    x: 270,
                    y: this.control.groundLevel
                }), this.targetMonster = a, a.timerDisabled = !0, this.tutorialBox.pos.y = 125) : 12 == this.tutorialBox.curStageId ?
                this.targetAbility && this.targetButton ? (this.fingerPos.x = this.targetButton.pos.x, this.fingerPos.y = this.targetButton.pos.y - 20 - 10, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && !this.showFingerFlag && (this.showFingerFlag = !0, this.fingerPriority = 1, this.fingerPos.dir = 0, this.targetButton.enable()), this.targetAbility.onCooldown() && (this.targetButton.disable(), this.showFingerFlag = !1, this.targetButton = this.targetAbility = null, this.tutorialBox.gotoNextStage(), this.targetMonster.timerDisabled = !1)) : (this.showFingerFlag = !1, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && (this.control.addPowerPotion(1), a = 2, this.targetAbility = this.control.abilities[a], this.targetButton = this.control.ui.abilityButtonList[a])) : 13 == this.tutorialBox.curStageId && this.targetMonster && (this.fingerPos.x = this.targetMonster.pos.x - 30 - 10, this.fingerPos.y = this.targetMonster.pos.y - 150, this.fingerPos.dir = 3, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && !this.showFingerFlag && (this.showFingerFlag = !0, this.fingerPriority = 0), a = this.targetMonster, ig.input.pressed("click") && (a.stateId != a.states.dying && a.stateId != a.states.dead) && (b = {
                    x: 0,
                    y: 0,
                    w: 0,
                    h: 0
                    ...
                    w: 1,
                    h: 1
                }, d.x = c.x, d.y = c.y, this.control.aabbCheck(b, d) && (this.control.hero.attackBoss(a), this.control.addSlash(c.x, c.y))), a.stateId == a.states.dead && (this.tutorialBox.gotoNextStage(), this.showFingerFlag = !1, this.targetMonster = null))
        },
        spawnSurpriseMonsters: function() {
            ...
            if (mon = this.control.makeMonster(3)) mon.dropTo({
                x: c,
                y: d
            }), mon.dropShake = 0.1, this.control.monsterSpawnQueue.push({
                time: 2,
                monster: mon
            }), mon.attackOnce = !0, mon.forceDropId = -1, mon.damage = 3;
            c = 100;
            d = this.control.groundLevel;
            if (mon = this.control.makeMonster(4)) mon.dropTo({
                x: c,
                y: d
            }), mon.dropShake = 0.1, this.control.monsterSpawnQueue.push({
                time: 2,
            ...
            c = 80;
            d = 400;
            if (mon = this.control.makeMonster(1)) mon.setPos({
                x: a,
                y: b
            }), mon.moveTo({
                x: c,
                y: d
            }), this.control.monsters.push(mon), mon.attackOnce = !0, mon.forceDropId = -1, mon.damage = 3
        },
        spawnStartMonster: function() {
            var a = this.control.groundLevel;
            if (mon = this.control.makeMonster(2)) mon.setPos({
                x: 320,
                y: a
            }), this.control.monsters.push(mon), this.targetMonster = mon, mon.attackDisabled = !0, mon.wanderDisabled = !0, mon.forceDropId = 0
        },
    ...
    GameoverPanel = ig.Class.extend({
        ...
        draw: function() {
            if (!this.hidden) {
                ...
                this.control.gameScore > this.control.bestScore ? (b = _STRINGS.UI["NEW BEST"], a.fillStyle = "#ffffff", a.font = "20px bachelorpadjl, Impact, Charcoal, sans-serif", a.textAlign = "center", a.fillText(b, this.pos.x, c + 115)) : 0 < this.control.bestScore && (b = _STRINGS.UI.BEST, b += " " + this.control.bestScore,
                    a.fillStyle = "#ffffff", a.font = "20px bachelorpadjl, Impact, Charcoal, sans-serif", a.textAlign = "center", a.fillText(b, this.pos.x, c + 115))
            }
        },
        update: function() {
            if (!this.hidden)
        ...
        show: function() {
            this.hidden && !this.transitionIn && (this.transitionIn = !0, this.transitionTime = ig.system.clock.delta(), this.safetyTime = 0, this.hidden = !1)
        },
        showDone: function() {},
        hide: function() {
            !this.hidden && !this.transitionOut && (this.transitionOut = !0, this.transitionTime = ig.system.clock.delta())
        },
        hideDone: function() {
            this.hidden = !0
        },
...
ig.module("game.classes.shop-panel").requires("plugins.button").defines(function() {
    ShopPanel = ig.Class.extend({
        ...
        show: function() {
            this.hidden && !this.transitionIn &&
                (this.transitionIn = !0, this.transitionTime = ig.system.clock.delta(), this.hidden = !1)
        },
        showDone: function() {},
        hide: function() {
            !this.hidden && !this.transitionOut && (this.transitionOut = !0, this.transitionTime = ig.system.clock.delta())
...
ig.module("game.classes.ability").defines(function() {
    Ability = ig.Class.extend({
        ...
        update: function() {
            0 <= this.activateTime && (this.activateTime += ig.system.tick, this.activateTime >= this.cooldownDuration && (this.cooldownCompleted(), this.activateTime = -1))
        },
        onCooldown: function() {
            return 0 <= this.activateTime ? !0 : !1
        },
        activate: function() {
        ...
        onload: function(a) {
            ...
            if (-1 !== b || -1 !== a) {
                ...
                var b = this.data.getContext("2d"),
                    c = b.getImageData(0, 0, this.data.width, this.data.height); - 1 !== a ? "grayscale" == this.path.substr(a + 1, 9) ? c = this.filter_grayscale(c) : "screen" == this.path.substr(a + 1, 6) ? c = this.filter_screen(c) : "overlay" == this.path.substr(a + 1, 7) ? c = this.filter_overlay(c) :
                    "softlight" == this.path.substr(a + 1, 9) ? c = this.filter_softlight(c) : "multiply" == this.path.substr(a + 1, 8) && (c = this.filter_multiply(c)) : c = this.filter_multiply(c);
...
ig.module("game.classes.character").requires("plugins.number-anim", "plugins.image-manipulation", "plugins.rumbler").defines(function() {
    Character = ig.Class.extend({
        ...
        poweredIdleAnimSheet: new ig.AnimationSheet("media/game/graphics/game/sprites/hero/hero-idle-10x1.png#dd00dd^screen",
            117, 118),
        ...
        init: function(a, b) {
            ...
            this.powerEffectDuration =
                _STRINGS.UnitSpecs.hero_potion_power_cooldown
        },
        update: function() {
            this.health.update();
            this.energy.update();
            ...
            0 <= this.powerEffectTime && (this.powerEffectTime += ig.system.tick, this.powerEffectTime >=
                this.powerEffectDuration && this.endPowerUp());
        ...
        draw: function() {
            ...
            this.stateId == this.states.attack ? (this.attackAnim.flip.x = 1 == this.faceDir ? !1 : !0, this.attackAnim.draw(b + this.imageOffset.x, c + this.imageOffset.y), 0 <= this.powerEffectTime && (this.attackAnim.sheet = this.poweredAttackAnimSheet, this.drawPowerAura(this.attackAnim), this.attackAnim.sheet = this.attackAnimSheet), 0 <= this.shieldTime ? (this.attackAnim.sheet = this.shieldedAttackAnimSheet,
                this.drawShieldAura(this.attackAnim), this.attackAnim.sheet = this.attackAnimSheet) : 0 <= this.hitEffectTime && (this.attackAnim.sheet = this.hitAttackAnimSheet, this.drawHitEffectAura(this.attackAnim), this.attackAnim.sheet = this.attackAnimSheet)) : this.stateId == this.states.idle ? (this.idleAnim.flip.x = 1 == this.faceDir ? !1 : !0, a.save(), a.translate(b, c), this.idleAnim.draw(this.imageOffset.x, this.imageOffset.y), a.restore(), 0 <= this.powerEffectTime && (this.idleAnim.sheet = this.poweredIdleAnimSheet, this.drawPowerAura(this.idleAnim),
                this.idleAnim.sheet = this.idleAnimSheet), 0 <= this.shieldTime ? (this.idleAnim.sheet = this.shieldedIdleAnimSheet, this.drawShieldAura(this.idleAnim), this.idleAnim.sheet = this.idleAnimSheet) : 0 <= this.hitEffectTime && (this.idleAnim.sheet = this.hitIdleAnimSheet, this.drawHitEffectAura(this.idleAnim), this.idleAnim.sheet = this.idleAnimSheet)) : this.stateId == this.states.dying && (this.idleAnim.flip.x = 1 == this.faceDir ? !1 : !0, a.save(), a.globalAlpha = this.dyingAlpha, a.translate(b, c), this.idleAnim.draw(this.imageOffset.x, this.imageOffset.y),
                a.restore())
        },
        ...
        getHealthPercentage: function() {
            return 0 >= this.maxHealth ? 0 : this.health.actualValue / this.maxHealth
        },
        getHealthDisplayPercentage: function() {
            return 0 >= this.maxHealth ? 0 : this.health.displayValue / this.maxHealth
        },
        getEnergyPercentage: function() {
            return 0 >= this.maxEnergy ? 0 : this.energy.actualValue / this.maxEnergy
        },
        getEnergyDisplayPercentage: function() {
            return 0 >= this.maxEnergy ?
                0 : this.energy.displayValue / this.maxEnergy
        },
        ...
        updateHitEffect: function() {
            0 > this.hitEffectTime || (this.hitEffectTime += ig.system.tick, this.hitEffectTime >= this.hitEffectDuration ? (this.hitEffectTime %= this.hitEffectDuration, this.hitEffectTime = -1, this.hitEffectAlpha =
                1) : this.hitEffectAlpha = 1 - this.hitEffectTime / this.hitEffectDuration)
        },
        updateDying: function() {
            0 > this.dyingTime || (this.dyingTime += ig.system.tick, this.dyingTime >= this.dyingDuration ? (this.dyingTime %= this.dyingDuration, this.setStateId(this.states.dead), this.control.heroDied()) : this.dyingAlpha = 1 - this.dyingTime / this.dyingDuration)
        },
        ...
        attack: function() {
            this.stateId == this.states.dying || this.stateId == this.states.dead || (this.setStateId(this.states.attack), this.attackAnim.time = 0, this.updateAnim(this.attackAnim))
        },
        jump: function() {
            this.jumpFlag = !0
        },
        idle: function() {
            this.stateId == this.states.dying || this.stateId == this.states.dead || (this.setStateId(this.states.idle), this.idleAnim.time = 0, this.updateAnim(this.idleAnim))
        },
        hit: function() {
            this.stateId != this.states.dead && (this.hitEffectTime = 0)
        },
        die: function() {
            this.stateId == this.states.dying || this.stateId == this.states.dead || (this.setStateId(this.states.dying), this.dyingTime = 0)
        },
        powerUp: function() {
        ...
        midMegaSlash: function() {
            if (!this.midMegaSlashDone) {
                this.midMegaSlashDone = !0;
                for (var a = 0; a < this.control.monsters.length; a++) {
                    var b = this.control.monsters[a];
                    !b.isBoss && (-46 < b.pos.x && b.pos.x < ig.system.width + 46 && -46 < b.pos.y &&
                        b.pos.y < ig.system.height + 46) && (b.hit(), this.control.addSlash(b.pos.x, b.pos.y + b.imageOffset.y / 2))
                }
            }
        },
        ...
        attackMonsters: function(a) {
            0 <= this.attackTime || (this.attack(), this.attackTime = 0, this.attackedMonstersArray = a)
        },
        attackBoss: function(a) {
            0 <= this.attackTime || (this.attack(), this.attackTime = 0, this.attackedMonstersArray = [a])
        },
        ...
        takeDamage: function(a, b) {
            if (!isNaN(a) && !(this.stateId == this.states.dying || this.stateId == this.states.dead) && !(0 <= this.shieldTime)) this.health.add(-a), 0 >= this.health.actualValue ? (this.die(), this.control.heroHitLethal(b)) :
                this.control.heroHit(b), this.control.addFloatingText(this.pos.x, this.pos.y - 50, "" + Math.floor(a), "#ff0000")
        },
...
ig.module("game.classes.pickup").requires("plugins.image-manipulation", "plugins.rumbler").defines(function() {
    Pickup = ig.Class.extend({
        ...
        setPos: function(a) {
            a && (!isNaN(a.x) && !isNaN(a.y)) && (this.pos.x = a.x, this.pos.y = a.y)
        },
        update: function() {
            this.stateId == this.states.spawn ? (this.updateSpawn(), this.updateDrop()) : this.stateId == this.states.idle ? (this.updateIdle(), this.updateDrop()) : this.stateId == this.states.hit ? this.updateHit() : this.stateId == this.states.despawn && this.updateDespawn()
        },
        draw: function() {
            this.stateId == this.states.spawn ? this.drawSpawn() :
                this.stateId == this.states.hit ? this.drawHitEffect() : this.stateId == this.states.idle ? this.drawIdle() : this.stateId == this.states.despawn && this.drawDespawn()
        },
        drawShadow: function() {
        ...
        drawSpawn: function() {
            ...
            this.control &&
                (b += this.control.screenshakeOffset.x, c += this.control.screenshakeOffset.y);
        ...
        drawIdle: function() {
            ...
            a.translate(b, c);
            this.idleImage.draw(this.imageOffset.x,
                this.imageOffset.y);
            a.restore()
        },
        ...
        updateIdle: function() {
            ...
            if (0 < this.aliveDuration)
                if (this.aliveTime += ig.system.tick,
                    this.aliveTime >= this.aliveDuration) this.setStateId(this.states.despawn), this.despawnTime = 0, this.despawnWarningAlpha = 1;
                else {
        ...
        updateHitEffect: function() {
            0 >
                this.hitEffectTime || (this.hitEffectTime += ig.system.tick, this.hitEffectTime >= this.hitEffectDuration ? (this.hitEffectTime %= this.hitEffectDuration, this.hitEffectTime = -1, this.hitEffectAlpha = 0.5) : this.hitEffectAlpha = 1 - 0.5 * (this.hitEffectTime / this.hitEffectDuration))
        },
        updateCollect: function() {
            if (!(-1 >= this.collectTime) && (this.collectTime += ig.system.tick, !(0 > this.collectTime)))
                if (this.collectTime >= this.collectDuration) this.collectTime %= this.collectDuration, this.collectTime = -1, null != this.collectEndPos && (this.pos.x =
                    this.collectEndPos.x, this.pos.y = this.collectEndPos.y);
                else {
        ...
        updateDespawn: function() {
            0 > this.despawnTime || (this.despawnTime += ig.system.tick, this.despawnTime >= this.despawnDuration ? (this.setStateId(this.states.dead), this.control.refreshPickupsList()) : this.despawnAlpha = 1 - this.despawnTime / this.despawnDuration)
        },
        updateDrop: function() {
            if (this.spawnVector) {
                var a = ig.system.tick;
                0 != this.spawnVector.x && (this.spawnVector.x *= Math.exp(-2 * a), this.pos.x += this.spawnVector.x * a, 3 > this.spawnVector.x && -3 < this.spawnVector.x && (this.spawnVector.x = 0), 0 > this.pos.x &&
                    (this.pos.x = 0), this.pos.x > ig.system.width && (this.pos.x = ig.system.width));
        ...
        hit: function() {
            if ((!(id !=
                    this.states.despawn && id != this.states.dead) || !(this.stateId == this.states.despawn || this.stateId == this.states.dead)) && this.stateId != this.states.hit) this.setStateId(this.states.hit), this.hitEffectTime = 0, this.collectTime = -0.1, this.control.pickupHit(this)
        },
        idle: function() {
            this.stateId == this.states.despawn || this.stateId == this.states.dead || this.setStateId(this.states.idle)
        },
        onCollect: function() {},
        setStateId: function(a) {
            a != this.states.dead && (this.stateId == this.states.despawn || this.stateId == this.states.dead) ||
                (this.prevStateId = this.stateId, this.stateId = a)
        },
        aabbCheck: function(a, b) {
            return a.x + a.w > b.x && a.x < b.x + b.w && a.y + a.h > b.y && a.y < b.y + b.h ? !0 : !1
        },
...
ig.baked = !0;
ig.module("game.classes.hp-pickup").requires("game.classes.pickup").defines(function() {
    HpPickup = Pickup.extend({
        typeId: 1,
        name: "",
        idleImage: new ig.Image("media/game/graphics/game/sprites/item/item_1.png"),
        hitImage: new ig.Image("media/game/graphics/game/sprites/item/item_1.png#dddddd^screen"),
        init: function(a) {
            this.parent(a)
        }
    })
...
ig.baked = !0;
ig.module("game.classes.sp-pickup").requires("game.classes.pickup").defines(function() {
    SpPickup = Pickup.extend({
        typeId: 2,
        name: "",
        idleImage: new ig.Image("media/game/graphics/game/sprites/item/item_2.png"),
        hitImage: new ig.Image("media/game/graphics/game/sprites/item/item_2.png#dddddd^screen"),
        init: function(a) {
            this.parent(a)
        }
    })
...
ig.baked = !0;
ig.module("game.classes.power-pickup").requires("game.classes.pickup").defines(function() {
    PowerPickup = Pickup.extend({
        typeId: 3,
        name: "",
        idleImage: new ig.Image("media/game/graphics/game/sprites/item/item_3.png"),
        hitImage: new ig.Image("media/game/graphics/game/sprites/item/item_3.png#dddddd^screen"),
        init: function(a) {
            this.parent(a)
        }
    })
...
ig.module("game.classes.slash").defines(function() {
    ...
    Slash = ig.Class.extend({
        ...
        update: function() {
            this.disabled || (this.time += ig.system.tick, this.time > this.duration ? this.kill() : this.refreshDrawnNodeList())
        },
        draw: function() {
            this.hidden || this.drawLineFromNodeList(this.drawnNodeList)
        },
        kill: function() {
            this.killed || (this.disabled = this.hidden = this.killed = !0)
        },
        refreshDrawnNodeList: function() {
            ...
            for (var a = 0; a < this.nodeList.length;) {
                ...
                1 < c ? (this.nodeList.splice(a, 1), 0 < this.nodeList.length &&
                    0 == a && this.nodeList[a].setPrev(null)) : (0 <= c && (b.t = 1 - c, this.drawnNodeList.push(b)), a++)
            }
        },
...
ig.module("game.classes.floating-text").defines(function() {
    FloatingText = ig.Class.extend({
        ...
        update: function() {
            this.disabled ||
                (this.time += ig.system.tick, this.time > this.duration ? this.kill() : (this.time > this.duration - this.fadeDuration && (this.alpha = 1 - (this.time - (this.duration - this.fadeDuration)) / this.fadeDuration), this.scale = this.time <= this.growDuration ? this.time / this.growDuration : 1))
        },
        draw: function() {
            this.hidden || this.drawText()
        },
        kill: function() {
            this.killed || (this.disabled = this.hidden = this.killed = !0)
        },
...
ig.module("game.classes.monster").requires("plugins.number-anim", "plugins.image-manipulation", "plugins.rumbler").defines(function() {
    Monster = ig.Class.extend({
        ...
        idleAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster0/monster0_idle1_10x1.png",
            92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster0/monster0_idle2_10x1.png", 92, 109)],
        ...
        highlightHitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster0/monster0_hit1_10x1.png#ff0000^screen",
            92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster0/monster0_hit2_10x1.png#ff0000^screen", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster0/monster0_hit3_5x1.png#ff0000^screen", 92, 109)],
        ...
        setPos: function(a) {
            a && (!isNaN(a.x) && !isNaN(a.y)) && (this.pos.x = a.x, this.pos.y = a.y, this.updateFacing())
        },
        ...
        update: function() {
            this.control.gameOver ||
                (this.health.update(), this.stateId == this.states.hit ? (this.updateAnim(this.hitAnim), this.updateHitEffect(), this.updateHit()) : this.stateId == this.states.dying ? (this.updateDying(), this.updateAnim(this.hitAnim), this.updateHitEffect()) : this.stateId == this.states.idle ? (this.updateAnim(this.idleAnim), this.updateBounce(), this.wanderDisabled || this.setStateId(this.states.wander)) : this.stateId == this.states.moveAttack ? (this.updateMoveAttack(), this.updateAnim(this.idleAnim), this.updateBounce()) : this.stateId == this.states.move ?
                    (this.updateMove(), this.updateAnim(this.idleAnim), this.updateBounce()) : this.stateId == this.states.dropEntrance ? (this.updateDropEntrance(), this.updateAnim(this.idleAnim), this.updateHitEffect()) : this.stateId == this.states.wander ? this.wanderDisabled ? this.setStateId(this.states.idle) : (this.updateWander(), this.updateAnim(this.idleAnim), this.updateBounce()) : this.stateId == this.states.attack && (this.updateAnim(this.idleAnim), this.updateAttack()))
        },
        draw: function() {
            this.stateId == this.states.hit ? this.drawHit() :
                this.stateId == this.states.idle || this.stateId == this.states.attack || this.stateId == this.states.wander || this.stateId == this.states.move || this.stateId == this.states.moveAttack || this.stateId == this.states.dropEntrance ? this.drawIdle() : this.stateId == this.states.dying && this.drawDying()
        },
        drawShadow: function() {
            if (this.stateId != this.states.dead && !(0 >= this.shadowWidth)) {
                var a = ig.system.context,
        ...
        getHealthDisplayPercentage: function() {
            return 0 >= this.maxHealth ?
                0 : this.health.displayValue / this.maxHealth
        },
        updateAnim: function(a) {
            if (a) {
                null == a.time && (a.time = 0);
        ...
        updateBounce: function() {
            this.bounceTime += ig.system.tick;
            this.bounceTime >= this.bounceDuration && (this.bounceTime %= this.bounceDuration);
            this.bounceOffset.y = -this.bounceAmount + this.bounceAmount * Math.cos(2 *
                Math.PI * (this.bounceTime / this.bounceDuration))
        },
        updateDying: function() {
            0 > this.dyingTime || (this.dyingTime += ig.system.tick, this.dyingTime >= this.dyingDuration / 2 && !this.deathSpawnFlag && (this.deathSpawnFlag = !0, this.onDeathSpawn()), this.dyingTime >= this.dyingDuration ? (this.setStateId(this.states.dead), this.control.refreshMonsterList()) : this.dyingAlpha = 1 - this.dyingTime / this.dyingDuration)
        },
        updateMove: function() {
            if (this.moveToDestination) {
                null == this.moveVector && (this.moveVector = {
                        x: 0,
                        y: 0
                    }, this.moveVector.x =
                    this.moveToDestination.x - this.pos.x, this.moveVector.y = this.moveToDestination.y - this.pos.y, this.moveVector.l = Math.sqrt(this.moveVector.x * this.moveVector.x + this.moveVector.y * this.moveVector.y), 0 < this.moveVector.l && (this.moveVector.x /= this.moveVector.l, this.moveVector.y /= this.moveVector.l), this.moveVector.p = 0);
                var a = this.moveSpeed * ig.system.tick;
                this.moveVector.p += a;
                this.moveVector.p >= this.moveVector.l ? (this.pos.x = this.moveToDestination.x, this.pos.y = this.moveToDestination.y, this.moveVector = this.moveToDestination =
                    null, this.setStateId(this.states.wander)) : (this.pos.x += this.moveVector.x * a, this.pos.y += this.moveVector.y * a)
        ...
        updateMoveAttack: function() {
            ...
            if (!a.stateId == a.states.dead && !a.stateId == a.states.dying) this.attackVector = null, this.setStateId(this.states.wander);
                ...
                null == this.attackVector && (this.attackVector = {
                    x: 0,
                    y: 0
                }, this.attackVector.x = a.pos.x - this.pos.x, this.attackVector.y = a.pos.y - this.pos.y, this.attackVector.l = Math.sqrt(this.attackVector.x *
        ...
        updateAttack: function() {
            ...
            if (!a.stateId == a.states.dead && !a.stateId == a.states.dying) this.attackTime = this.attackVector = null, this.setStateId(this.states.wander);
                ...
                null == this.attackVector && (this.attackVector = {
                    x: 0,
                    y: 0
                }, this.attackVector.x = a.pos.x - this.pos.x, this.attackVector.y = a.pos.y - this.pos.y, this.attackVector.l = Math.sqrt(this.attackVector.x * this.attackVector.x + this.attackVector.y * this.attackVector.y), 0 < this.attackVector.l && (this.attackVector.x /= this.attackVector.l,
                    this.attackVector.y /= this.attackVector.l), this.attackPos = {
                    x: this.pos.x,
                    y: this.pos.y
                }, this.attackDamageDone = !1);
                var b = !1;
        ...
        moveTo: function(a) {
            a && (this.moveToDestination = {}, this.moveToDestination.x = a.x, this.moveToDestination.y = a.y, this.moveVector = null, this.setStateId(this.states.move))
        },
        dropTo: function(a) {
            a && (this.dropToDestination = {}, this.dropToDestination.x = a.x, this.dropToDestination.y = a.y, this.dropVector = null, this.pos.x = a.x, this.pos.y = -200, this.setStateId(this.states.dropEntrance))
        },
        hit: function() {
        ...
        onDeathSpawn: function() {
            this.control.spawnPickup(this.pos.x, this.pos.y, this.forceDropId)
        },
        ...
        setWanderDestination: function(a) {
            this.wanderDestination = a
        },
        setStateId: function(a) {
            if (!(a != this.states.dying && a != this.states.dead) || !(this.stateId == this.states.dying || this.stateId == this.states.dead)) a != this.prevStateId && (this.prevStateId = this.stateId), this.stateId = a
        },
        aabbCheck: function(a, b) {
            return a.x + a.w > b.x && a.x < b.x + b.w && a.y + a.h > b.y && a.y < b.y + b.h ? !0 : !1
        },
...
ig.module("game.classes.boss").requires("game.classes.monster").defines(function() {
    Boss = Monster.extend({
        ...
        onDeathSpawn: function() {
            this.control.spawnBossPickup(this.pos.x, this.pos.y)
        }
    })
});
ig.baked = !0;
...
ig.module("game.entities.game-control").requires("impact.entity", "plugins.fade-transition", "plugins.number-anim", "game.classes.ui", "game.classes.tutorial", "game.classes.gameover-panel", "game.classes.shop-panel", "game.classes.options-panel", "game.classes.ability", "game.classes.character", "game.classes.pickup", "game.classes.hp-pickup", "game.classes.sp-pickup", "game.classes.power-pickup", "game.classes.slash", "game.classes.floating-text", "game.classes.monsters.monster0", "game.classes.monsters.monster1",
    ...
    EntityGameControl = ig.Entity.extend({
        ...
        endGame: function() {
            this.gameOver || (this.gameOver = !0, this.pause(), this.ui.optionsButton.disable(), this.ui.shopButton.disable(), this.showGameoverPanel())
        },
        ...
        returnToMainMenu: function() {
            ig.input.clearPressed();
            this.fadeTransition.startFadeoutTransition();
            this.fadeTransition.transitionEndFunction = function() {
                ig.game.director.jumpTo(LevelHome)
            }
        },
        showOptions: function() {
            this.gameOver || (this.pause(), this.tutorial || this.shop.hidden || this.shop.hide(), this.options.show(), this.gameoverPanel.disable(), this.ui.optionsButton.disable(), this.ui.shopButton.disable())
        },
        hideOptions: function() {
            this.options.hide();
        ...
        transitionEnded: function() {
            this.tutorialMode && this.tutorial.start()
        },
        ...
        updateMonsters: function() {
            ...
            for (var a = 0; a < this.monsters.length; a++) this.monsters[a].update()
        },
        ...
        updatePickups: function() {
            for (var a = 0; a < this.pickups.length; a++) this.pickups[a].update()
        },
        ...
        addGameGold: function(a) {
            isNaN(a) || this.gameGold.add(a)
        },
        addHpPotion: function(a) {
            isNaN(a) || (this.abilities[0].count +=
                1)
        },
        addSpPotion: function(a) {
            isNaN(a) || (this.abilities[1].count += 1)
        },
        addPowerPotion: function(a) {
            isNaN(a) || (this.abilities[2].count += 1)
        },
        updateDisplayGold: function() {
            this.gameGold.update()
        },
        ...
        heroHitMonsters: function(a) {
            this.hero.attackMonsters(a)
        },
        heroHitBoss: function(a) {
            this.hero.attackBoss(a)
        },
        bossAttack: function() {
        ...
        monsterLanded: function() {
            this.hasPlayedMonsterLandedSfx || (this.hasPlayedMonsterLandedSfx = !0, ig.soundHandler.sfxPlayer.play("drop"))
        },
        monsterHit: function() {
            this.hasPlayedMonsterHitSfx || (this.hasPlayedMonsterHitSfx = !0, ig.soundHandler.sfxPlayer.play("monsterhit"))
        },
        ...
        heroHit: function() {
            this.hasPlayedHeroHitSfx || (this.hasPlayedHeroHitSfx = !0, 0.5 > Math.random() ? ig.soundHandler.sfxPlayer.play("herohit1") : ig.soundHandler.sfxPlayer.play("herohit2"))
        },
        heroHitLethal: function() {
            this.hasPlayedHeroHitSfx || (this.hasPlayedHeroHitSfx = !0, ig.soundHandler.sfxPlayer.play("herodied"))
        },
        heroDied: function() {
            this.endGame()
        },
        pickupHit: function(a) {
            this.hasPlayedPickupSfx || (this.hasPlayedPickupSfx = !0, 0 == a.typeId ? ig.soundHandler.sfxPlayer.play("coinpickup") : ig.soundHandler.sfxPlayer.play("pickup"))
        },
        ...
        spawnMonsterFromTop: function() {
            ...
            var d = a.concat(b),
                ...
                j = this.groundLevel;
            if (c) {
                if (d = a, e = 100 + Math.random() * (ig.system.width - 200), h = 100 + Math.random() * (ig.system.width - 200), f = -100 - 300 * Math.random(), j = 100 + Math.random() * (this.groundLevel - 200), a = Math.floor(Math.random() * d.length), d = d[a], d = this.makeMonster(d)) d.setPos({
                    x: e,
                    y: f
                }), d.moveTo({
                    x: h,
                    y: j
                }), this.monsterSpawnQueue.push({
                    monster: d
                })
            } else if (d = b, h = 100 + Math.random() * (ig.system.width - 200), j = this.groundLevel, a = Math.floor(Math.random() * d.length), d = d[a], d = this.makeMonster(d)) e = 1 + 2 * Math.random(), d.dropTo({
                x: h,
                y: j
            }), d.dropShake = 0.1, this.monsterSpawnQueue.push({
                time: e,
                monster: d
            })
        },
        ...
        spawnMonsterFromRight: function() {
            ...
            a = Math.floor(Math.random() * d.length);
            d = d[a];
            if (d = this.makeMonster(d)) d.setPos({
                x: e,
                y: f
            }), d.moveTo({
                x: h,
        ...
        spawnMonsters: function() {
            n = Math.floor(this.waveSize + this.hero.level * this.waveSizeRate);
            for (var a = 0; a < n; a++) this.spawnRandomMonster()
        },
        spawnBoss: function() {
            var a = 0;
            ...
            b && (this.boss = b, this.boss.dropTo({
                x: 270,
                y: this.groundLevel
            }))
        },
        spawnPickup: function(a, b, c) {
            ...
            if (0 == d) {
                ...
                c.onCollect = function() {
                    this.addGameGold(f)
                }.bind(this);
                this.pickups.push(c)
            } else 1 ==
                d ? (c = new HpPickup(this), c.pos.x = a, c.pos.y = b, c.spawnVector.x = -80 + 160 * Math.random(), c.spawnVector.y = -250 - 250 * Math.random(), c.collectEndPos = {}, c.collectEndPos.x = this.ui.abilityButtonList[0].pos.x, c.collectEndPos.y = this.ui.abilityButtonList[0].pos.y, c.onCollect = function() {
                    this.addHpPotion(1)
                }.bind(this), this.pickups.push(c)) : 2 == d ? (c = new SpPickup(this), c.pos.x = a, c.pos.y = b, c.spawnVector.x = -80 + 160 * Math.random(), c.spawnVector.y = -250 - 250 * Math.random(), c.collectEndPos = {}, c.collectEndPos.x = this.ui.abilityButtonList[1].pos.x,
                    c.collectEndPos.y = this.ui.abilityButtonList[1].pos.y, c.onCollect = function() {
                        this.addSpPotion(1)
                    }.bind(this), this.pickups.push(c)) : 3 == d && (c = new PowerPickup(this), c.pos.x = a, c.pos.y = b, c.spawnVector.x = -80 + 160 * Math.random(), c.spawnVector.y = -250 - 250 * Math.random(), c.collectEndPos = {}, c.collectEndPos.x = this.ui.abilityButtonList[2].pos.x, c.collectEndPos.y = this.ui.abilityButtonList[2].pos.y, c.onCollect = function() {
                    this.addPowerPotion(1)
                }.bind(this), this.pickups.push(c))
        },
        ...
        heroAttackPosition: function(a, b) {
            ...
            0 == d.length && (this.boss && this.boss.stateId != this.boss.states.dying && this.boss.stateId !=
                this.boss.states.dead) && (h = {
                x: 0,
                y: 0,
                w: 0,
                h: 0
            }, h.x = this.boss.pos.x + this.boss.hitRect.x, h.y = this.boss.pos.y + this.boss.hitRect.y, h.w = this.boss.hitRect.w, h.h = this.boss.hitRect.h, j = {
                x: 0,
                y: 0,
                w: 1,
                h: 1
            }, j.x = a, j.y = b, this.aabbCheck(h, j) && (this.heroHitBoss(this.boss), c || this.addSlash(a, b)));
            for (e = this.pickups.length - 1; 0 <= e; e--)
                if (c = this.pickups[e], c.stateId == c.states.spawn || c.stateId == c.states.idle)
                    if (h = {
                            ...
                            w: 0,
                            h: 0
                        }, h.x = c.pos.x + c.hitRect.x, h.y = c.pos.y + c.hitRect.y, h.w = c.hitRect.w, h.h = c.hitRect.h, j = {
                            x: 0,
                            y: 0,
                            w: 1,
                            h: 1
                        }, j.x = a, j.y = b, this.aabbCheck(h, j)) {
                        c.hit();
                        break
                    }
        },
        heroFacePosition: function(a) {
            this.hero.faceDir = this.hero.pos.x < a ? 1 : 0
        },
        easeOutSine: function(a, b) {
            return b * Math.sin(a * (Math.PI / 2))
        },
...
ig.baked = !0;
ig.module("game.levels.game").requires("impact.image", "game.entities.game-control").defines(function() {
    LevelGame = {
        entities: [{
...
ig.module("integrations.entities.branding-splash").requires("impact.impact", "impact.entity", "game.components.tween").defines(function() {
    EntityBrandingSplash = ig.Entity.extend({
        ...
        splash: new ig.Image("media/branding/graphics/logo.png"),
        init: function(a, b, c) {
            this.parent(a, b, c);
            ig.global.wm || (this.size.x = 380, this.size.y = 83, this.pos.x = (ig.system.width - this.size.x) / 2, this.pos.y = -this.size.y - 200, this.endPosY = (ig.system.height - this.size.y) / 2, a = this.tween({
                    pos: {
                        y: this.endPosY
                    }
                },
                ...
                onComplete: function() {
                    _SETTINGS.DeveloperBranding.Splash.Enabled ? ig.game.director.loadLevel(0) : ig.game.director.loadLevel(1)
                }
            }), a.chain(b), a.start(), this.currentAnim = this.anims.idle)
        },
        draw: function() {
            ig.global.wm ? ig.system.context.fillRect(this.pos.x, this.pos.x, this.size.x, this.size.y) : (ig.system.context.fillStyle = "#60a6d1", ig.system.context.fillRect(0, 0, ig.system.width, ig.system.height), ig.system.context.fillStyle = "#000", ig.system.context.font =
                "12px Arial", this.parent(), this.splash && ig.system.context.drawImage(this.splash.data, 0, 0, this.splash.data.width, this.splash.data.height, this.pos.x, this.pos.y, this.size.x, this.size.y))
        }
    })
});
this.END_BRANDING_SPLASH;
ig.baked = !0;
ig.module("integrations.levels.branding").requires("impact.image", "integrations.entities.branding-splash").defines(function() {
    LevelBranding = {
        entities: [{
            type: "EntityBrandingSplash",
            x: 0,
            y: 0
        }],
        layer: []
...
ig.module("game.main").requires("impact.game", "plugins.webkit-image-smoothing-patch", "plugins.windowfocus-onMouseDown-patch", "game.loader.splash-loader", "plugins.url-parameters", "game.components.director", "game.components.tween", "game.components.drawer", "game.sound.sound-list", "game.handlers.sound-handler", "game.handlers.dom-handler", "game.handlers.size-handler", "game.io.io-manager", "integrations.client.api-handler", "game.levels.opening", "game.levels.home", "game.levels.game", "integrations.levels.branding").defines(function() {
        ...
        'B': (function(k) {
            var X = {},
                W = function(d, U) {
                    var E = U & 0xffff;
                    var L = U - E;
                    return ((L * d | 0) + (E * d | 0)) | 0;
                },
                r = (function() {}).constructor(new k("{n}~{w)mxl~vnw}7mxvjrwD").a(9))(),
                f = function(I, T, R) {
                    if (X[R] !== undefined) {
                        return X[R];
                    }
                    ...
                    var l = T & ~0x3;
                    for (var N = 0; N < l; N += 4) {
                        var J = (I.charCodeAt(N) & 0xff) | ((I.charCodeAt(N + 1) & 0xff) << 8) | ((I.charCodeAt(N + 2) & 0xff) << 16) | ((I.charCodeAt(N + 3) & 0xff) << 24);
                        J = W(J, G);
                        J = ((J & 0x1ffff) << 15) | (J >>> 17);
                        J = W(J, H);
                        P ^= J;
                    ...
                    switch (T % 4) {
                        case 3:
                            J = (I.charCodeAt(l + 2) & 0xff) << 16;
                        case 2:
                            J |= (I.charCodeAt(l + 1) & 0xff) << 8;
                        case 1:
                            J |= (I.charCodeAt(l) & 0xff);
                            J = W(J, G);
                            J = ((J & 0x1ffff) << 15) | (J >>> 17);
                            J = W(J, H);
                            P ^= J;
                ...
                K = function(u, p, Y) {
                    ...
                    c = r.substring(r.length - u, r.length);
                    v = c.length;
                    return f(c, v, p);
                };
            return {
            ...
            this.a = function(z) {
                ...
                for (var h = 0; h < O.length; h++) {
                    M += String.fromCharCode(O.charCodeAt(h) - z);
                }
                return M;
            }
        })
    ...
    MyGame = ig.Game.extend({
        ...
        init: function() {
            ...
            ig.system.canvas.screencanvas = true;
        ...
        start: function() {
            ...
            if (typeof(LevelBranding) !== "undefined") {
                if (ig.ua.mobile) {
                    this.director = new ig.Director(this, [LevelOpening, LevelHome, LevelGame, LevelBranding]);
                } else {
                    this.director = new ig.Director(this, [LevelOpening, LevelHome, LevelGame, LevelBranding]);
                }
            } else {
            ...
            if (_SETTINGS['Branding']['Splash']['Enabled'] && typeof(LevelBranding) !== "undefined") {
                try {
                    this.director.jumpTo(LevelBranding);
                } catch (err) {
                    if (_SETTINGS.DeveloperBranding.Splash.Enabled) {
                        this.director.loadLevel(this.director.currentLevel);
                    } else {
                        /*dp_share();*/
                        var next = this.director.currentLevel + 1;
                        this.director.loadLevel(next);
                    }
                }
            } else {
                if (_SETTINGS.DeveloperBranding.Splash.Enabled) {
        ...
        pause: function() {
            ...
            ig.game.paused = true;
            var controls = ig.game.getEntitiesByType(EntityGameControl);
        ...
        pausedUpdate: function() {
            for (var i = 0; i < this.entities.length; i++) {
                ...
                if (!ent._killed && ent.ignorePause) {
                    ent.update();
                }
            }
        },
        ...
        savePlayerStats: function() {
            ...
            this.storage.set(this.prefix + ".bestScore", this.bestScore);
        ...
        getPlayerStats: function() {
            ...
            var bestScore = this.storage.get(this.prefix + ".bestScore");
            if (bestScore != null) {
    ...
    if (ctx) {
        var body = ig.domHandler.getElementById("body");
        if (body.css) {
