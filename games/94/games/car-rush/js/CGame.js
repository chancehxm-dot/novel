function CGame(oData, iLevel) {
    ...
    this._ambientCollision = function() {
        if (_oPlayer.isOutOfRoad()) {
            for (var n = 0; n < _oPlayer.getPlayerSegment().sprites.length; n++) {
                var sprite = _oPlayer.getPlayerSegment().sprites[n];
                ...
                if (bOverlap) {
                    ...
                    _oPlayer.setPosition(Util.increase(_oPlayer.getPlayerSegment().p1.world.z, -PLAYER_Z_FROMCAMERA, TRACK_LENGTH)); // stop in front of sprite (at front of segment)
    ...
    this._carsCollision = function() {
        var car;
        var carW;
        for (var n = 0; n < _oPlayer.getPlayerSegment().cars.length; n++) {
            car = _oPlayer.getPlayerSegment().cars[n];
