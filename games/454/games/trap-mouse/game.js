...
// window._bd_share_config={common:{bdText:"我在玩《诱捕小老鼠》，你敢来挑战我吗？",bdDesc:"我爱h5游戏源码，游戏AND源码，一个也不能少~",bdUrl:"http://www.52h5game.com/game/youbuxiaolaoshu/",bdPic:"http://www.52h5game.com/images/logo.png"},share:[{"bdSize":16}],slide:[{bdImg:0,bdPos:"right",bdTop:100}]};with(document){0[(getElementsByTagName("head")[0]||body).appendChild(createElement("script")).src="http://bdimg.share.baidu.com/static/api/js/share.js?cdnversion="+~(-new Date()/3600000)]};
(function(e) {
    "use strict";
    function t() {}
    function n(e) {
    ...
    var m; (function(e) {
        ...
        function C(e) {
            ...
            function(e) {
                ...
                function(i, a, r) {
                    var s;
                    y(a) && "fulfilled" === (s = a.inspect()).state ? e[r] = s.value: (++t, f(a,
                    function(i) {
                        e[r] = i,
                        0 === --t && n.resolve(e)
                    },
        ...
        c.allResolved = u(x, "allResolved", "allSettled"),
        ...
        c.nsend = c.nmcall = c.ninvoke = function(e, t) {
            ...
            i = d();
            return n.push(i.makeNodeResolver()),
            c(e).dispatch("post", [t, n]).fail(i.reject),
            i.promise
        },
    ...
    v.getJSONP = function() {
        ...
        n = {
            ...
            send: function(i) {
                ...
                r = n.set.data || 0; (i || a || r) && (e += /\?/.test(e) ? "&": "?", i && (e += r ? r + "=" + encodeURIComponent(i) : i, a && (e += "&")), a && (e += a + "=" + t));
    ...
    S.getBrandingConfig = function(e) {
        return new Promise(function(t) {
            return y.getBrandingConfig(e).then(t,
            function(e) {
                t(e),
    ...
    n.prototype.put = function(e, t) {
        ...
        i = e.split("."), a = i.length, r = 0; a - 1 > r; r++) {
            var s = i[r];
            n[s] || (n[s] = {}),
            n = n[s]
        }
    ...
    r.prototype.getFriends = function(e) {
        var t = this.messenger;
        if (!this.moduleReady) throw Error("This method cannot be called before the API is loaded");
        this.IS_MASTER ? "function" == typeof SpilGames ? SpilGames(["JSLib"],
        function(e) {
            e && "function" == typeof e ? e("api.friend.list",
            function(e) {
    ...
    l.prototype._setupEvents = function() {
        ...
        function(t) {
            t.subscribe("ad.request.accepted",
            function(t) { ! 0 === t && (SpilGames("game.ad.accepted", !0), e._postMessage(!0, void 0, "ad.request.accepted"))
            }),
            t.subscribe("ad.complete",
            function() {
    ...
    c.prototype.init = function(e) {
        ...
        this.data && this.data.portal ? (this.siteId = this.data.portal.siteId ? this.data.portal.siteId: null, this.channelId = this.data.portal.channelId ? this.data.portal.channelId: null) : (this.siteId = null, this.channelId = null),
    ...
    c.prototype._sendSETEvent = function(e, t, n) {
        return this.IS_STANDALONE ? v.submitData("ok.txt", t, n) : this.messenger && (this.IS_SLAVE || v.isWrapped()) && this.messenger.post("tracker.event." + e, t, n),
        t
    },
    ...
    c.prototype.trackGameAPIEvent = function(e, t) {
        t.appid = this.gamePlayTracking.gid,
    ...
    d.prototype.getLogo = function(e) {
        ...
        e && "object" == typeof e && (i = v.validateSchema(a, e), i.error && (n.error = i.error)),
        n
    },
    ...
    g.prototype._postMessage = function(e, t, n) {
        var i, a;
        i = v.isArray(e) && "function" == typeof e[e.length - 1] ? this._callbacks.push(e.pop()) - 1 : t,
        a = new p({
            type: n || "jslib",
            callbackId: i,
            data: e
        }).encode(),
        this._target.postMessage(a, "*")
    },
    ...
    f.prototype.loadAPI = function(e, t) {
        function i(t) {
            return u.IS_MASTER && (t = a(t)),
            u.isReady = !0,
            u.Branding.moduleReady = !0,
            u.__.EventTracking.moduleReady = !0,
            u.GameBreak.moduleReady = !0,
            u.Game.moduleReady = !0,
            u.Score.moduleReady = !0,
            u.Award.moduleReady = !0,
            u.User.moduleReady = !0,
            u.Friends.moduleReady = !0,
            u.GameEvent.moduleReady = !0,
            u.Branding.init({
                data: t
            }),
            u.Game.init({
        ...
        function r() {
            u.__.messenger.requestFromParent("GameAPI.data", {},
            function(e) {
                i(e)
            })
        }
        function s() {
            ...
            u.IS_MASTER = !0,
            u.IS_SLAVE = !0,
            u.__.dataStore = new n({
                isMaster: !0
            }),
            t = t || null,
            S.setupStandaloneMode(t,
            function(e) {
                u.__.dataStore._setCache(a(e)),
                i(e)
            })
        }
        function o() {
            u.__.messenger.requestFromParent("GameAPI.isReady", {},
            function(e) {
                l && clearTimeout(l),
                e.isready ? r() : 5 > d ? (d++, setTimeout(o, 500)) : r()
            })
        }
        var l, u = this,
        ...
        null], null, "log"), this.IS_STANDALONE ? s() : this.IS_MASTER ? S.getGameConfig().then(function(e) {
            S.getBrandingConfig(e).then(function(t) {
                e && !e.isError && (e.branding = t.branding, u.__.dataStore._setCache(a(e))),
                i(e)
            })
        }) : (l = setTimeout(s, 600), o()), void 0)
    };
    var _ = new f(n, g, d, c, l);
    "function" == typeof define && define.amd && define("GameAPI", _),
    e.GameAPI = _
})(window),
function() {
    "use strict";
