...
(function(b, c) {
    function d(b, t, p) {
        if (p === c && 1 === b.nodeType)
            if (p = "data-" + t.replace(tc, "-$1").toLowerCase(), p = b.getAttribute(p), "string" == typeof p) {
                try {
                    p = "true" === p ? !0 : "false" === p ? !1 : "null" === p ? null : +p + "" === p ? +p : uc.test(p) ? f.parseJSON(p) : p
                } catch (d) {}
                f.data(b, t, p)
            } else p = c;
        return p
    ...
    function r(b, c, p) {
        c = c || 0;
        if (f.isFunction(c)) return f.grep(b,
            function(b, u) {
                return !!c.call(b, u, b) === p
            });
        if (c.nodeType) return f.grep(b,
            function(b) {
                return b === c === p
            });
        if ("string" == typeof c) {
    ...
    function z(b, c) {
        if (1 === c.nodeType && f.hasData(b)) {
            ...
            var e = f._data(c, d),
                s = d.events;
            if (s)
                for (p in delete e.handle, e.events = {},
                    s) {
                    d = 0;
                    for (y = s[p].length; d < y; d++) f.event.add(c, p, s[p][d])
                }
            e.data && (e.data = f.extend({},
                e.data))
        }
    }
    ...
    function E(b, c) {
        for (var p, d, y = [], e = 0, s = b.length; e < s; e++) p = b[e],
            p.style && (y[e] = f._data(p, "olddisplay"), c ? (!y[e] && "none" === p.style.display && (p.style.display = ""), "" === p.style.display && M(p) && (y[e] = f._data(p, "olddisplay", P(p.nodeName)))) : (d = Q(p, "display"), !y[e] && "none" !== d && f._data(p, "olddisplay", d)));
        for (e = 0; e < s; e++)
    ...
    function Ya(b, c, p, d) {
        ...
        for (var y = 0; 4 > c; c += 2) "margin" === p && (y += f.css(b, p + ea[c], !0)),
            d ? ("content" === p && (y -= parseFloat(Q(b, "padding" + ea[c])) || 0), "margin" !== p && (y -= parseFloat(Q(b, "border" + ea[c] + "Width")) || 0)) : (y += parseFloat(Q(b, "padding" + ea[c])) || 0, "padding" !== p && (y += parseFloat(Q(b, "border" + ea[c] + "Width")) || 0));
        return y
    }
    ...
    function P(b) {
        ...
        c.remove();
        if ("none" === p || "" === p) {
            ma = A.body.appendChild(ma || f.extend(A.createElement("iframe"), {
                frameBorder: 0,
                width: 0,
                height: 0
            }));
            if (!na || !ma.createElement) na = (ma.contentWindow || ma.contentDocument).document,
    ...
    function N(b, c, p, d) {
        var y;
        if (f.isArray(c)) f.each(c,
            function(c, t) {
                p || xc.test(b) ? d(b, t) : N(b + "[" + ("object" == typeof t ? c : "") + "]", t, p, d)
            });
    ...
    function oa(b, t, p, d, f, e) {
        ...
        f = b[f];
        for (var l = 0,
                g = f ? f.length : 0, m = b === $a; l < g && (m || !s); l++) s = f[l](t, p, d),
            "string" == typeof s && (!m || e[s] ? s = c : (t.dataTypes.unshift(s), s = oa(b, t, p, d, s, e)));
        return (m || !s) && !e["*"] && (s = oa(b, t, p, d, "*", e)),
            s
    }
    ...
    function Cb(b, c, p) {
        var d, y = 0,
            ...
            l = function() {
                for (var c = Ba || Bb(), c = Math.max(0, g.startTime + g.duration - c), t = 1 - (c / g.duration || 0), p = 0, d = g.tweens.length; p < d; p++) g.tweens[p].run(t);
                return s.notifyWith(b, [g, t, c]),
                    1 > t && d ? c : (s.resolveWith(b, [g]), !1)
            },
            g = s.promise({
                elem: b,
                props: f.extend({},
                ...
                createTween: function(c, t) {
                    ...
                    return g.tweens.push(p),
                        p
                },
                stop: function(c) {
                    for (var t = 0,
                            p = c ? g.tweens.length : 0; t < p; t++) g.tweens[t].run(1);
                    return c ? s.resolveWith(b, [g, c]) : s.rejectWith(b, [g, c]),
                        this
                }
            });
        c = g.props;
    ...
    function Da(b, c) {
        var p, d = {
            ...
            f = 0;
        for (c = c ? 1 : 0; 4 > f; f += 2 - c) p = ea[f],
            d["margin" + p] = d["padding" + p] = b;
    ...
    var Eb, Ea, A = b.document,
        ...
        Ga = function() {
            A.addEventListener ? (A.removeEventListener("DOMContentLoaded", Ga, !1), f.ready()) : "complete" === A.readyState && (A.detachEvent("onreadystatechange", Ga), f.ready())
        },
        Ib = {};
    f.fn = f.prototype = {
        constructor: f,
        init: function(b, t, p) {
            ...
            if ("string" == typeof b) {
                ...
                if (d && (d[1] || !t)) {
                    if (d[1]) return t = t instanceof f ? t[0] : t,
                        y = t && t.nodeType ? t.ownerDocument || t : A,
                        b = f.parseHTML(d[1], y, !0),
                        Hb.test(d[1]) && f.isPlainObject(t) && this.attr.call(b, t, !0),
                        f.merge(this, b);
        ...
        pushStack: function(b, c, p) {
            ...
            return b.prevObject = this,
                ...
                "find" === c ? b.selector = this.selector + (this.selector ? " " : "") + p : c && (b.selector = this.selector + "." + c + "(" + p + ")"),
                b
        },
        each: function(b, c) {
    ...
    f.extend = f.fn.extend = function() {
        var b, t, p, d, y, e, s = arguments[0] || {},
            g = 1,
            l = arguments.length,
            m = !1;
        "boolean" == typeof s && (m = s, s = arguments[1] || {},
            g = 2);
        ...
        for (l === g && (s = this, --g); g < l; g++)
            if (null != (b = arguments[g]))
                for (t in b) p = s[t],
                    d = b[t],
                    s !== d && (m && d && (f.isPlainObject(d) || (y = f.isArray(d))) ? (y ? (y = !1, e = p && f.isArray(p) ? p : []) : e = p && f.isPlainObject(p) ? p : {},
                        s[t] = f.extend(m, e, d)) : d !== c && (s[t] = d));
        return s
    };
    f.extend({
        ...
        ready: function(b) {
            if (!(!0 === b ? --f.readyWait : f.isReady)) {
                ...
                f.isReady = !0;
                !0 !== b && 0 < --f.readyWait || (Ea.resolveWith(A, [f]), f.fn.trigger && f(A).trigger("ready").off("ready"))
            }
        },
        ...
        parseHTML: function(b, c, p) {
            var d;
            return !b || "string" != typeof b ? null : ("boolean" == typeof c && (p = c, c = 0), c = c || A, (d = Hb.exec(b)) ? [c.createElement(d[1])] : (d = f.buildFragment([b], c, p ? null : []), f.merge([], (d.cacheable ? f.clone(d.fragment) : d.fragment).childNodes)))
        },
        ...
        parseXML: function(u) {
            ...
            if (!u || "string" != typeof u) return null;
            try {
                b.DOMParser ? (p = new DOMParser, t = p.parseFromString(u, "text/xml")) : (t = new ActiveXObject("Microsoft.XMLDOM"), t.async = "false", t.loadXML(u))
            } catch (d) {
                t = c
            }
            return (!t || !t.documentElement || t.getElementsByTagName("parsererror").length) && f.error("Invalid XML: " + u),
                t
        },
        noop: function() {},
        globalEval: function(u) {
            u && Ec.test(u) && (b.execScript ||
                function(u) {
                    b.eval.call(b, u)
                })(u)
        },
        ...
        each: function(b, t, p) {
            ...
            if (p)
                if (s)
                    for (d in b) {
                        if (!1 === t.apply(b[d], p)) break
                    } else
                        for (; y < e && !1 !== t.apply(b[y++], p););
                else if (s)
                for (d in b) {
                    if (!1 === t.call(b[d], d, b[d])) break
                } else
        ...
        makeArray: function(b, c) {
            var p, d = c || [];
            return null != b && (p = f.type(b), null == b.length || "string" === p || "function" === p || "regexp" === p || f.isWindow(b) ? Fb.call(d, b) : f.merge(d, b)),
                d
        },
        ...
        map: function(b, t, d) {
            ...
            if (b instanceof f || g !== c && "number" == typeof g && (0 < g && b[0] && b[g - 1] || 0 === g || f.isArray(b)))
                for (; s < g; s++) B = t(b[s], s, d),
                    null != B && (D[D.length] = B);
            else
                for (e in b) B = t(b[e], e, d),
                    null != B && (D[D.length] = B);
        ...
        proxy: function(b, t) {
            var d, B, e;
            return "string" == typeof t && (d = b[t], t = b, b = d),
                f.isFunction(b) ? (B = aa.call(arguments, 2), e = function() {
                        return b.apply(t, B.concat(aa.call(arguments)))
                    },
    ...
    f.ready.promise = function(c) {
        if (!Ea)
            ...
            else if (A.addEventListener) A.addEventListener("DOMContentLoaded", Ga, !1),
            b.addEventListener("load", f.ready, !1);
        else {
            A.attachEvent("onreadystatechange", Ga);
            b.attachEvent("onload", f.ready);
            var t = !1;
            try {
                t = null == b.frameElement && A.documentElement
            } catch (d) {}
            t && t.doScroll &&
                function y() {
                    if (!f.isReady) {
    ...
    f.Callbacks = function(b) {
        ...
        var B, e, D, s, g, l, m = [],
            ...
            j = function(c) {
                ...
                g = m.length;
                for (D = !0; m && l < g; l++)
                    if (!1 === m[l].apply(c[0], c[1]) && b.stopOnFalse) {
                        B = !1;
                        break
                    }
                D = !1;
            ...
            x = {
                    ...
                    if (m) {
                        ...
                        (function yc(c) {
                            f.each(c,
                                function(c, t) {
                                    var d = f.type(t);
                                    "function" === d && (!b.unique || !x.has(t)) ? m.push(t) : t && t.length && "string" !== d && yc(t)
                                })
                        })(arguments);
                ...
                remove: function() {
                    return m && f.each(arguments,
                            function(b, c) {
                                for (var u; - 1 < (u = f.inArray(c, m, u));) m.splice(u, 1),
                                    D && (u <= g && g--, u <= l && l--)
                            }),
                        this
                },
    ...
    f.extend({
        ...
        when: function(b) {
            ...
            return e || g.resolveWith(n, d),
                g.promise()
        }
    });
    var Oc = f,
        cb;
    var O, Ha, ha, Ia, Ja, T, ia, Ka, db, va, Kb, J = A.createElement("div");
        ...
        data: function(b, t, d, B) {
            if (f.acceptData(b)) {
                ...
                if (j && n[j] && (B || n[j].data) || !(l && d === c)) {
                    ...
                    return e = n[j],
                        B || (e.data || (e.data = {}), e = e.data),
                        d !== c && (e[f.camelCase(t)] = d),
                        l ? (g = e[t], null == g && (g = e[f.camelCase(t)])) : g = e,
                        g
                }
            }
        },
        ...
        data: function(b, t) {
            ...
            if (b === c) {
                if (this.length && (n = f.data(l), 1 === l.nodeType && !f._data(l, "parsedAttrs"))) {
                    y = l.attributes;
                    for (s = y.length; m < s; m++) g = y[m].name,
                        g.indexOf("data-") || (g = f.camelCase(g.substring(5)), d(l, g, n[g]));
            ...
            return "object" == typeof b ? this.each(function() {
                f.data(this, b)
            }) : (p = b.split(".", 2), p[1] = p[1] ? "." + p[1] : "", e = p[1] + "!", f.access(this,
                function(t) {
                    if (t === c) return n = this.triggerHandler("getData" + e, [p[0]]),
                        n === c && l && (n = f.data(l, b), n = d(l, b, n)),
                        n === c && p[1] ? this.data(p[0]) : n;
                    p[1] = t;
                    this.each(function() {
                        var c = f(this);
                        c.triggerHandler("setData" + e, p);
                        f.data(this, b, t);
                        c.triggerHandler("changeData" + e, p)
                    })
                },
    ...
    f.fn.extend({
        queue: function(b, t) {
            var d = 2;
            return "string" != typeof b && (t = b, b = "fx", d--),
                arguments.length < d ? f.queue(this[0], b) : t === c ? this : this.each(function() {
    ...
    f.fn.extend({
        ...
        removeClass: function(b) {
            ...
            if (b && "string" == typeof b || b === c) {
                ...
                for (l = this.length; s < l; s++)
                    if (e = this[s], 1 === e.nodeType && e.className) {
        ...
        toggleClass: function(b, c) {
            ...
            return f.isFunction(b) ? this.each(function(d) {
                ...
                if ("string" === d)
                    for (var y, g = 0,
                            s = f(this), l = c, m = b.split(fa); y = m[g++];) l = e ? l : !s.hasClass(y),
                        s[l ? "addClass" : "removeClass"](y);
                else if ("undefined" === d || "boolean" === d) this.className && f._data(this, "__className__", this.className),
        ...
        val: function(b) {
            var d, p, e, y = this[0];
            if (arguments.length) return e = f.isFunction(b),
                this.each(function(p) {
                    var s, y = f(this);
                    if (1 === this.nodeType && (e ? s = b.call(this, p, y.val()) : s = b, null == s ? s = "" : "number" == typeof s ? s += "" : f.isArray(s) && (s = f.map(s,
                            function(b) {
                                return null == b ? "" : b + ""
                            })), d = f.valHooks[this.type] || f.valHooks[this.nodeName.toLowerCase()], !d || !("set" in d) || d.set(this, s, "value") === c)) this.value = s
                });
            if (y) return d = f.valHooks[y.type] || f.valHooks[y.nodeName.toLowerCase()],
                d && "get" in d && (p = d.get(y, "value")) !== c ? p : (p = y.value, "string" == typeof p ? p.replace(Pc, "") : null == p ? "" : p)
        }
    });
    f.extend({
        valHooks: {
        ...
        attr: function(b, d, p, e) {
            ...
            if (b && !(3 === s || 8 === s || 2 === s)) {
                ...
                (e = 1 !== s || !f.isXMLDoc(b)) && (d = d.toLowerCase(), g = f.attrHooks[d] || (Ob.test(d) ? Lb : ba));
                if (p !== c) {
                    if (null === p) {
                        f.removeAttr(b, d);
                        return
        ...
        prop: function(b, d, p) {
            ...
            if (b && !(3 === s || 8 === s || 2 === s)) return g = 1 !== s || !f.isXMLDoc(b),
                g && (d = f.propFix[d] || d, y = f.propHooks[d]),
                p !== c ? y && "set" in y && (e = y.set(b, p, d)) !== c ? e : b[d] = p : y && "get" in y && null !== (e = y.get(b, d)) ? e : b[d]
        },
        propHooks: {
            tabIndex: {
                get: function(b) {
    ...
    Lb = {
        ...
        set: function(b, c, d) {
            var e;
            return !1 === c ? f.removeAttr(b, d) : (e = f.propFix[d] || d, e in b && (b[e] = !0), b.setAttribute(d, d.toLowerCase())),
                d
        }
    };
    Pb || (Mb = {
        ...
        ba = f.valHooks.button = {
            get: function(b, d) {
                var f;
                return f = b.getAttributeNode(d),
                    f && (Mb[d] ? "" !== f.value : f.specified) ? f.value : c
            },
            set: function(b, c, d) {
        ...
        f.each(["width", "height"],
            function(b, c) {
                f.attrHooks[c] = f.extend(f.attrHooks[c], {
                    set: function(b, u) {
                        if ("" === u) return b.setAttribute(c, "auto"),
                            u
                    }
                })
        ...
        add: function(b, d, p, e, y) {
            ...
            if (!(3 === b.nodeType || 8 === b.nodeType || !d || !p || !(g = f._data(b)))) {
                ...
                (s = g.handle) || (g.handle = s = function(b) {
                        return "undefined" != typeof f && (!b || f.event.triggered !== b.type) ? f.event.dispatch.apply(s.elem, arguments) : c
                    },
                    s.elem = b);
                d = f.trim(Sb(d)).split(" ");
            ...
            if (I && (r = I.events)) {
                ...
                for (l = 0; l < c.length; l++)
                    if (s = Qb.exec(c[l]) || [], m = n = s[1], s = s[2], m) {
                        ...
                        for (x = 0; x < z.length; x++) q = z[x],
                            (g || n === q.origType) && (!d || d.guid === q.guid) && (!s || s.test(q.namespace)) && (!e || e === q.selector || "**" === e && q.selector) && (z.splice(x--, 1), q.selector && z.delegateCount--, v.remove && v.remove.call(b, q));
                        0 === z.length && j !== z.length && ((!v.teardown || !1 === v.teardown.call(b, s, I.handle)) && f.removeEvent(b, m, I.handle), delete r[m])
                    } else
        ...
        trigger: function(u, d, p, e) {
            if (!p || 3 !== p.nodeType && 8 !== p.nodeType) {
                ...
                if (!Rb.test(r + f.event.triggered) && (0 <= r.indexOf("!") && (r = r.slice(0, -1), g = !0), 0 <= r.indexOf(".") && (m = r.split("."), r = m.shift(), m.sort()), p && !f.event.customEvent[r] || f.event.global[r]))
                    if (u = "object" == typeof u ? u[f.expando] ? u : new f.Event(r, u) : new f.Event(r), u.type = r, u.isTrigger = !0, u.exclusive = g, u.namespace = m.join("."), u.namespace_re = u.namespace ? RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, m = 0 > r.indexOf(":") ? "on" + r : "", p) {
                        if (u.result = c, u.target || (u.target = p), d = null != d ? f.makeArray(d) : [], d.unshift(u), n = f.event.special[r] || {}, !(n.trigger && !1 === n.trigger.apply(p, d))) {
                            ...
                            for (l = 0; l < x.length && !u.isPropagationStopped(); l++) g = x[l][0],
                                u.type = x[l][1],
                                (j = (f._data(g, "events") || {})[u.type] && f._data(g, "handle")) && j.apply(g, d),
                                (j = m && g[m]) && f.acceptData(g) && j.apply && !1 === j.apply(g, d) && u.preventDefault();
                            return u.type = r, !e && !u.isDefaultPrevented() && (!n._default || !1 === n._default.apply(p.ownerDocument, d)) && ("click" !== r || !f.nodeName(p, "a")) && f.acceptData(p) && m && p[r] && ("focus" !== r && "blur" !== r || 0 !== u.target.offsetWidth) && !f.isWindow(p) && (s = p[m], s && (p[m] = null), f.event.triggered = r, p[r](), f.event.triggered = c, s && (p[m] = s)),
                                u.result
                        }
                    } else
            ...
            if (!(r.preDispatch && !1 === r.preDispatch.call(this, u))) {
                if (n && (!u.button || "click" !== u.type))
                    for (p = u.target; p != this; p = p.parentNode || this)
                        if (!0 !== p.disabled || "click" !== u.type) {
                            g = {};
                            l = [];
                            for (d = 0; d < n; d++) e = m[d],
                                s = e.selector,
                                g[s] === c && (g[s] = e.needsContext ? 0 <= f(s, this).index(p) : f.find(s, this, null, [p]).length),
                                g[s] && l.push(e);
                            l.length && v.push({
                                elem: p,
                                matches: l
                ...
                for (d = 0; d < v.length && !u.isPropagationStopped(); d++) {
                    ...
                    for (p = 0; p < g.matches.length && !u.isImmediatePropagationStopped(); p++)
                        if (e = g.matches[p], x || !u.namespace && !e.namespace || u.namespace_re && u.namespace_re.test(e.namespace)) u.data = e.data,
                            u.handleObj = e,
                            e = ((f.event.special[e.origType] || {}).handle || e.handler).apply(g.elem, j),
                            e !== c && (u.result = e, !1 === e && (u.preventDefault(), u.stopPropagation()))
                }
                return r.postDispatch && r.postDispatch.call(this, u),
                    u.result
            }
        },
        ...
        mouseHooks: {
            ...
            filter: function(b, d) {
                var f, e, g, l = d.button,
                    s = d.fromElement;
                return null == b.pageX && null != d.clientX && (f = b.target.ownerDocument || A, e = f.documentElement, g = f.body, b.pageX = d.clientX + (e && e.scrollLeft || g && g.scrollLeft || 0) - (e && e.clientLeft || g && g.clientLeft || 0), b.pageY = d.clientY + (e && e.scrollTop || g && g.scrollTop || 0) - (e && e.clientTop || g && g.clientTop || 0)), !b.relatedTarget && s && (b.relatedTarget = s === b.target ? d.toElement : s), !b.which && l !== c && (b.which = l & 1 ? 1 : l & 2 ? 3 : l & 4 ? 2 : 0),
                    b
            }
        },
        fix: function(b) {
            ...
            b = f.Event(e);
            for (c = l.length; c;) d = l[--c],
                b[d] = e[d];
            return b.target || (b.target = e.srcElement || A),
    ...
    f.Event = function(b, c) {
        if (this instanceof f.Event) b && b.type ? (this.originalEvent = b, this.type = b.type, this.isDefaultPrevented = b.defaultPrevented || !1 === b.returnValue || b.getPreventDefault && b.getPreventDefault() ? j : g) : this.type = b,
            c && f.extend(this, c),
            ...
            f.event.special[b] = {
                ...
                handle: function(b) {
                    var d, u = b.relatedTarget,
                        e = b.handleObj;
                    if (!u || u !== this && !f.contains(this, u)) b.type = e.origType,
    ...
    f.support.submitBubbles || (f.event.special.submit = {
        setup: function() {
            ...
            f.event.add(this, "click._submit keypress._submit",
                function(b) {
                    b = b.target;
                    (b = f.nodeName(b, "input") || f.nodeName(b, "button") ? b.form : c) && !f._data(b, "_submit_attached") && (f.event.add(b, "submit._submit",
                        function(b) {
                            b._submit_bubble = !0
    ...
    f.support.changeBubbles || (f.event.special.change = {
        setup: function() {
            if (eb.test(this.nodeName)) {
                if ("checkbox" === this.type || "radio" === this.type) f.event.add(this, "propertychange._change",
                        function(b) {
            ...
            f.event.add(this, "beforeactivate._change",
                function(b) {
                    b = b.target;
                    eb.test(b.nodeName) && !f._data(b, "_change_attached") && (f.event.add(b, "change._change",
                        function(b) {
    ...
    f.support.focusinBubbles || f.each({
        ...
        function(b, c) {
            ...
            f.event.special[c] = {
                setup: function() {
                    0 === d++ && A.addEventListener(b, e, !0)
                },
                teardown: function() {
                    0 === --d && A.removeEventListener(b, e, !0)
                }
            }
        });
    f.fn.extend({
        on: function(b, d, p, e, l) {
            ...
            return 1 === l && (m = e, e = function(b) {
                    ...
                    e.guid = m.guid || (m.guid = f.guid++)),
                this.each(function() {
                    f.event.add(this, b, e, p, d)
                })
        },
        ...
        off: function(b, d, p) {
            ...
            if (b && b.preventDefault && b.handleObj) return e = b.handleObj,
                f(b.delegateTarget).off(e.namespace ? e.origType + "." + e.namespace : e.origType, e.selector, e.handler),
                this;
            if ("object" == typeof b) {
                for (l in b) this.off(l, d, b[l]);
                return this
            }
            if (!1 === d || "function" == typeof d) p = d,
                d = c;
            return !1 === p && (p = g),
                this.each(function() {
                    f.event.remove(this, b, p, d)
                })
        },
        bind: function(b, c, d) {
        ...
        toggle: function(b) {
            var c = arguments,
                ...
                g = function(d) {
                    ...
                    return f._data(this, "lastToggle" + b.guid, p + 1),
                        d.preventDefault(),
                        c[p].apply(this, arguments) || !1
                };
    ...
    var Wc = b,
            ...
            if (!s && !f && (e = Xc.exec(b)))
                if (l = e[1])
                    if (9 === m) {
                        ...
                        if (g.id === l) return d.push(g),
                            d
                    } else {
                        if (c.ownerDocument && (g = c.ownerDocument.getElementById(l)) && Tb(c, g) && g.id === l) return d.push(g),
                            d
                    }
            else {
                if (e[2]) return pa.apply(d, qa.call(c.getElementsByTagName(b), 0)),
                    d;
                if ((l = e[3]) && Ub && c.getElementsByClassName) return pa.apply(d, qa.call(c.getElementsByClassName(l), 0)),
                    d
            }
        ...
        Pa = function(b, c) {
            ...
            l = [];
            for (m = K.preFilter; s;) {
                if (!d || (f = Yc.exec(s))) f && (s = s.slice(f[0].length)),
                    l.push(e = []);
                d = !1;
                if (f = Zc.exec(s)) e.push(d = new Xb(f.shift())),
                    s = s.slice(d.length),
                    d.type = f[0].replace(Ma, " ");
                for (g in K.filter)(f = Oa[g].exec(s)) && (!m[g] || (f = m[g](f, X, !0))) && (e.push(d = new Xb(f.shift())), s = s.slice(d.length), d.type = g, d.matches = f);
                if (!d) break
            }
        ...
        hb = function(b, c, d) {
            ...
            return c.first ?
                function(c, d, t) {
                    for (; c = c[f];)
                        if (e || 1 === c.nodeType) return b(c, d, t)
                } : function(c, d, t) {
                    if (t)
                        for (; c = c[f];) {
                            if ((e || 1 === c.nodeType) && b(c, d, t)) return c
                        } else
                            for (var p, l = xa + " " + g + " ",
                                    m = l + gb; c = c[f];)
                                if (e || 1 === c.nodeType) {
                                    if ((p = c[G]) === m) return c.sizset;
                                    if ("string" == typeof p && 0 === p.indexOf(l)) {
                                        if (c.sizset) return c
                                    } else {
                                        c[G] = m;
                                        if (b(c, d, t)) return c.sizset = !0,
                                            c;
                                        c.sizset = !1
                                    }
                                }
            ...
            return f && !f[G] && (f = jb(f)),
                ...
                Y(function(g, l, m, n) {
                    if (!g || !e) {
                        ...
                        if (g)
                            for (m = b && q.length; m--;) {
                                if (j = q[m]) g[D[m]] = !(l[D[m]] = j)
                            } else q = Qa(q === l ? q.splice(v, q.length) : q),
                                e ? e(null, l, q, n) : pa.apply(l, q)
                    }
                })
        },
        kb = function(b) {
            ...
            for (var l = g ? 1 : 0, m = hb(function(b) {
                    ...
                    return !g && (u || d !== Ra) || ((c = d).nodeType ? m(b, d, u) : n(b, d, u))
                }]; l < e; l++)
        ...
        fb = function(b, c, d, f, e) {
            ...
            if (!f && 1 === j.length) {
                l = j[0] = j[0].slice(0);
                if (2 < l.length && "ID" === (m = l[0]).type && 9 === c.nodeType && !e && K.relative[l[1].type]) {
                    c = K.find.ID(m.matches[0].replace(ka, ""), c, e)[0];
                    if (!c) return d;
                ...
                for (g = Oa.POS.test(b) ? -1 : l.length - 1; 0 <= g; g--) {
                    ...
                    if (n = K.find[n])
                        if (f = n(m.matches[0].replace(ka, ""), lb.test(l[0].type) && c.parentNode || c, e)) {
                            l.splice(g, 1);
                            b = f.length && l.join("");
                            if (!b) return pa.apply(d, qa.call(f, 0)),
                                d;
                            break
                        }
                }
            }
            return mb(b, j)(f, c, e, d, lb.test(b)),
                d
        },
        Zb = function() {},
        gb,
        ...
        hd = ca(function(b) {
            ...
            var c = X.getElementsByName && X.getElementsByName(G).length === 2 + X.getElementsByName(G + 0).length;
            return nb = !X.getElementById(G),
                W.removeChild(b),
                c
        });
    try {
    ...
    C.attr = function(b, c) {
        ...
        return f || (c = c.toLowerCase()),
            (d = K.attrHandle[c]) ? d(b) : f || gd ? b.getAttribute(c) : (d = b.getAttributeNode(c), d ? "boolean" == typeof b[c] ? b[c] ? c : null : d.specified ? d.value : null : null)
    };
    K = C.selectors = {
        cacheLength: 50,
        createPseudo: Y,
        ...
        preFilter: {
            ...
            CHILD: function(b) {
                return b[1] = b[1].toLowerCase(),
                    "nth" === b[1] ? (b[2] || C.error(b[0]), b[3] = +(b[3] ? b[4] + (b[5] || 1) : 2 * ("even" === b[2] || "odd" === b[2])), b[4] = +(b[6] + b[7] || "odd" === b[2])) : b[2] && C.error(b[0]),
                    b
            },
            PSEUDO: function(b) {
                var c, d;
                ...
                if (b[3]) b[2] = b[3];
                else if (c = b[4]) bd.test(c) && (d = Pa(c, !0)) && (d = c.indexOf(")", c.length - d) - c.length) && (c = c.slice(0, d), b[0] = b[0].slice(0, d)),
                    b[2] = c;
                return b.slice(0, 3)
            }
        },
        filter: {
            ...
            ATTR: function(b, c, d) {
                return function(f) {
                    f = C.attr(f, b);
                    return null == f ? "!=" === c : c ? (f += "", "=" === c ? f === d : "!=" === c ? f !== d : "^=" === c ? d && 0 === f.indexOf(d) : "*=" === c ? d && -1 < f.indexOf(d) : "$=" === c ? d && f.substr(f.length - d.length) === d : "~=" === c ? -1 < (" " + f + " ").indexOf(d) : "|=" === c ? f === d || f.substr(0, d.length + 1) === d + "-" : !1) : !0
                }
            },
            ...
            PSEUDO: function(b, c) {
                ...
                return f[G] ? f(c) : 1 < f.length ? (d = [b, b, "", c], K.setFilters.hasOwnProperty(b.toLowerCase()) ? Y(function(b, d) {
                    for (var u, e = f(b, c), p = e.length; p--;) u = Yb.call(b, e[p]),
                        b[u] = !(d[u] = e[p])
                }) : function(b) {
                    return f(b, 0, d)
                }) : f
    ...
    mb = C.compile = function(b, c) {
        ...
        if (!g) {
            c || (c = Pa(b));
            for (d = c.length; d--;) g = kb(c[d]),
                g[G] ? f.push(g) : e.push(g);
            var l = 0 < f.length,
                m = 0 < e.length,
    ...
    if (X.querySelectorAll) {
        ...
        fb = function(b, c, d, f, e) {
            if (!f && !e && (!Z || !Z.test(b))) {
                ...
                if (g) try {
                    return pa.apply(d, qa.call(l.querySelectorAll(g), 0)),
                        d
                } catch (j) {} finally {
        ...
        }), Ta = RegExp(Ta.join("|")), C.matchesSelector = function(b, c) {
            c = c.replace(kd, "='$1']");
    ...
    f.fn.extend({
        ...
        closest: function(b, c) {
            ...
            return l = 1 < l.length ? f.unique(l) : l,
        ...
        function(b, c) {
            f.fn[b] = function(d, e) {
                ...
                return ld.test(b) || (e = d),
                    ...
                    g = 1 < this.length && !nd[b] ? f.unique(g) : g,
                    1 < this.length && md.test(b) && (g = g.reverse()),
                    this.pushStack(g, b, aa.call(arguments).join(","))
            }
        });
    f.extend({
        ...
        dir: function(b, d, e) {
            var g = [];
            for (b = b[d]; b && 9 !== b.nodeType && (e === c || 1 !== b.nodeType || !f(b).is(e));) 1 === b.nodeType && g.push(b),
                b = b[d];
            return g
        },
    ...
    f.fn.extend({
        text: function(b) {
            return f.access(this,
                function(b) {
                    return b === c ? f.text(this) : this.empty().append((this[0] && this[0].ownerDocument || A).createTextNode(b))
                },
        ...
        remove: function(b, c) {
            for (var d, e = 0; null != (d = this[e]); e++)
                if (!b || f.filter(b, [d]).length) !c && 1 === d.nodeType && (f.cleanData(d.getElementsByTagName("*")), f.cleanData([d])),
            ...
            return f.access(this,
                function(b) {
                    ...
                    if ("string" == typeof b && !rd.test(b) && (f.support.htmlSerialize || !sb.test(b)) && (f.support.leadingWhitespace || !rb.test(b)) && !V[(gc.exec(b) || ["", ""])[1].toLowerCase()]) {
                        ...
                        try {
                            for (; e < g; e++) d = this[e] || {},
                                1 === d.nodeType && (f.cleanData(d.getElementsByTagName("*")), d.innerHTML = b);
                            d = 0
                        } catch (l) {}
                    }
        ...
        domManip: function(b, d, e) {
            ...
            var g, l, m, s = 0,
                ...
                j = [],
                x = this.length;
            if (!f.support.checkClone && 1 < x && "string" == typeof n && hc.test(n)) return this.each(function() {
    ...
    f.buildFragment = function(b, d, e) {
        ...
        return d = d || A,
            d = !d.nodeType && d[0] || d,
            d = d.ownerDocument || d,
            1 === b.length && "string" == typeof s && 512 > s.length && d === A && "<" === s.charAt(0) && !sd.test(s) && (f.support.checkClone || !hc.test(s)) && (f.support.html5Clone || !sb.test(s)) && (l = !0, g = f.fragments[s], m = g !== c),
            g || (g = d.createDocumentFragment(), f.clean(b, d, g, e), l && (f.fragments[s] = m && g)), {
                fragment: g,
                cacheable: l
            }
    };
    ...
    f.each({
        ...
        function(b, c) {
            f.fn[b] = function(d) {
                ...
                if ((null == e || e && 11 === e.nodeType && 1 === e.childNodes.length) && 1 === m) return d[c](this[0]),
                    this;
                for (; g < m; g++) e = (0 < g ? this.clone(!0) : this).get(),
                    f(d[g])[c](e),
                    l = l.concat(e);
    ...
    f.extend({
        clone: function(b, c, d) {
            var e, g, n, s;
            f.support.html5Clone || f.isXMLDoc(b) || !sb.test("<" + b.nodeName + ">") ? s = b.cloneNode(!0) : (tb.innerHTML = b.outerHTML, tb.removeChild(s = tb.firstChild));
                    ...
                    if ("string" == typeof m)
                        if (qd.test(m)) {
                            ...
                            if (!f.support.tbody) {
                                ...
                                for (l = n.length - 1; 0 <= l; --l) f.nodeName(n[l], "tbody") && !n[l].childNodes.length && n[l].parentNode.removeChild(n[l])
                            }!f.support.leadingWhitespace && rb.test(m) && r.insertBefore(c.createTextNode(rb.exec(m)[0]), r.firstChild);
                            m = r.childNodes;
        ...
        cleanData: function(b, c) {
            for (var d, e, g, l, m = 0,
                    n = f.expando,
                    j = f.cache,
                    x = f.support.deleteExpando,
                    r = f.event.special; null != (g = b[m]); m++)
                if (c || f.acceptData(g))
                    if (d = (e = g[n]) && j[e]) {
                        if (d.events)
    ...
    f.extend({
        ...
        style: function(b, d, e, g) {
            if (b && !(3 === b.nodeType || 8 === b.nodeType || !b.style)) {
                ...
                if (!(null == e || "number" === m && isNaN(e)))
                    if ("number" === m && !f.cssNumber[j] && (e += "px"), !n || !("set" in n) || (e = n.set(b, e, g)) !== c) try {
                        x[d] = e
                    } catch (r) {}
            }
        },
        css: function(b, d, e, g) {
            var l, m, n, j = f.camelCase(d);
            return d = f.cssProps[j] || (f.cssProps[j] = I(b.style, j)),
                n = f.cssHooks[d] || f.cssHooks[j],
                n && "get" in n && (l = n.get(b, !0, g)),
                l === c && (l = Q(b, d)),
                "normal" === l && d in kc && (l = kc[d]),
                e || g !== c ? (m = parseFloat(l), e || f.isNumeric(m) ? m || 0 : l) : l
        },
        swap: function(b, c, d) {
            var f, e = {};
            for (f in c) e[f] = b.style[f],
                b.style[f] = c[f];
            d = d.call(b);
    ...
    b.getComputedStyle ? Q = function(c, d) {
        var e, g, l, m, n = b.getComputedStyle(c, null),
            j = c.style;
        return n && (e = n[d], "" === e && !f.contains(c.ownerDocument, c) && (e = f.style(c, d)), za.test(e) && jc.test(d) && (g = j.width, l = j.minWidth, m = j.maxWidth, j.minWidth = j.maxWidth = j.width = e, e = n.width, j.width = g, j.minWidth = l, j.maxWidth = m)),
            e
    } : A.documentElement.currentStyle && (Q = function(b, c) {
        var d, f, e = b.currentStyle && b.currentStyle[c],
            g = b.style;
        return null == e && g && g[c] && (e = g[c]),
            za.test(e) && !wd.test(c) && (d = g.left, f = b.runtimeStyle && b.runtimeStyle.left, f && (b.runtimeStyle.left = b.currentStyle.left), g.left = "fontSize" === c ? "1em" : e, e = g.pixelLeft + "px", g.left = d, f && (b.runtimeStyle.left = f)),
            "" === e ? "auto" : e
    });
    f.each(["height", "width"],
        function(b, c) {
            f.cssHooks[c] = {
                get: function(b, d, e) {
                    if (d) return 0 === b.offsetWidth && xd.test(Q(b, "display")) ? f.swap(b, zd,
                        function() {
                            return F(b, c, e)
                        }) : F(b, c, e)
                },
    ...
    f(function() {
        ...
        !f.support.pixelPosition && f.fn.position && f.each(["top", "left"],
            function(b, c) {
                f.cssHooks[c] = {
                    get: function(b, d) {
                        if (d) {
    ...
    f.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var d = f(this).val();
                return null == d ? null : f.isArray(d) ? f.map(d,
                    function(b) {
                        return {
                            name: c.name,
                            value: b.replace(lc, "\r\n")
    ...
    f.param = function(b, d) {
        ...
        if (f.isArray(b) || b.jquery && !f.isPlainObject(b)) f.each(b,
            function() {
    ...
    f.fn.load = function(b, d, e) {
        ...
        var g, l, m, n = this,
            j = b.indexOf(" ");
        return 0 <= j && (g = b.slice(j, b.length), b = b.slice(0, j)),
            f.isFunction(d) ? (e = d, d = c) : d && "object" == typeof d && (l = "POST"),
            f.ajax({
                url: b,
                type: l,
                dataType: "html",
                ...
                complete: function(b, c) {
                    e && n.each(e, m || [b.responseText, c, b])
                }
            }).done(function(b) {
                m = arguments;
                n.html(g ? f("<div>").append(b.replace(Id, "")).find(g) : b)
            }),
            this
    };
    ...
    f.each(["get", "post"],
        function(b, d) {
            f[d] = function(b, e, g, l) {
                return f.isFunction(e) && (l = l || g, g = e, e = c),
                    f.ajax({
                        type: d,
                        url: b,
                        data: e,
    ...
    f.extend({
        ...
        ajaxSetup: function(b, c) {
            return c ? ta(b, f.ajaxSettings) : (c = b, b = f.ajaxSettings),
                ta(b, c),
                b
        },
        ajaxSettings: {
        ...
        ajax: function(b, d) {
            function e(b, d, m, p) {
                ...
                if (2 !== F) {
                    ...
                    if (200 <= b && 300 > b || 304 === b)
                        if (q.ifModified && (D = H.getResponseHeader("Last-Modified"), D && (f.lastModified[g] = D), D = H.getResponseHeader("Etag"), D && (f.etag[g] = D)), 304 === b) E = "notmodified",
                            u = !0;
                        else {
                            var G;
                            a: {
                                ...
                                for (; x = E[++R];)
                                    if ("*" !== x) {
                                        if ("*" !== m && m !== x) {
                                            ...
                                            if (!G)
                                                for (O in U)
                                                    if (D = O.split(" "), D[1] === x && (G = U[m + " " + D[0]] || U["* " + D[0]])) {
                                                        !0 === G ? G = U[O] : !0 !== U[O] && (x = D[0], E.splice(R--, 0, x));
                                                        break
                                                    }
                                            if (!0 !== G)
                                                if (G && u["throws"]) t = G(t);
                                                    ...
                                                    G = {
                                                        state: "parsererror",
                                                        error: G ? Q : "No conversion from " + m + " to " + x
                                                    };
                                                    break a
                                                }
                                        }
            ...
            d = d || {};
            var g, l, m, n, j, x, r, v, q = f.ajaxSetup({},
                    d),
                z = q.context || q,
            ...
            if (!q.hasContent && (q.data && (q.url += (mc.test(q.url) ? "&" : "?") + q.data, delete q.data), g = q.url, !1 === q.cache)) {
                x = f.now();
                var K = q.url.replace(Jd, "$1_=" + x);
                q.url = K + (K === q.url ? (mc.test(q.url) ? "&" : "?") + "_=" + x : "")
            }(q.data && q.hasContent && !1 !== q.contentType || d.contentType) && H.setRequestHeader("Content-Type", q.contentType);
            q.ifModified && (g = g || q.url, f.lastModified[g] && H.setRequestHeader("If-Modified-Since", f.lastModified[g]), f.etag[g] && H.setRequestHeader("If-None-Match", f.etag[g]));
    ...
    f.ajaxPrefilter("json jsonp",
        function(d, e, g) {
            ...
            if ("jsonp" === d.dataTypes[0] || q || v) return l = d.jsonpCallback = f.isFunction(d.jsonpCallback) ? d.jsonpCallback() : d.jsonpCallback,
                m = b[l],
                q ? d.url = x.replace(Wa, "$1" + l) : v ? d.data = j.replace(Wa, "$1" + l) : r && (d.url += (Kd.test(x) ? "&" : "?") + d.jsonp + "=" + l),
                d.converters["script json"] = function() {
                    return n || f.error(l + " was not called"),
                        n[0]
                },
                d.dataTypes[0] = "json",
                b[l] = function() {
    ...
    f.ajaxTransport("script",
        function(b) {
            if (b.crossDomain) {
                var d, f = A.head || A.getElementsByTagName("head")[0] || A.documentElement;
                return {
                    send: function(e, g) {
        ...
        if (!d.crossDomain || f.support.cors) {
            ...
            return {
                send: function(g, l) {
                    ...
                    if (d.xhrFields)
                        for (n in d.xhrFields) j[n] = d.xhrFields[n];
                    ...
                    try {
                        for (n in g) j.setRequestHeader(n, g[n])
                    } catch (x) {}
                        ...
                        try {
                            if (e && (g || 4 === j.readyState))
                                if (e = c, m && (j.onreadystatechange = f.noop, vb && delete sa[m]), g) 4 !== j.readyState && j.abort();
                                    ...
                                    try {
                                        r.text = j.responseText
                                    } catch (v) {}
                                    try {
                                        p = j.statusText
                                    } catch (z) {
                                        p = ""
                                    }!n && d.isLocal && !d.crossDomain ? n = r.text ? 200 : 404 : 1223 === n && (n = 204)
                                }
                        } catch (I) {
                            g || l(-1, I)
                        }
                    ...
                    d.async ? 4 === j.readyState ? setTimeout(e, 0) : (m = ++Md, vb && (sa || (sa = {},
                        f(b).unload(vb)), sa[m] = e), j.onreadystatechange = e) : e()
                },
                abort: function() {
                    e && e(0, 1)
                }
    ...
    var Ba, Xa, Nd = /^(?:toggle|show|hide)$/,
        ...
        Ca = [function(b, c, d) {
            var e, g, l, m, n, j, x = this,
                ...
                v = [],
                z = b.nodeType && M(b);
            d.queue || (n = f._queueHooks(b, "fx"), null == n.unqueued && (n.unqueued = 0, j = n.empty.fire, n.empty.fire = function() {
                n.unqueued || j()
            ...
            d.overflow && (r.overflow = "hidden", f.support.shrinkWrapBlocks || x.done(function() {
                r.overflow = d.overflow[0];
                r.overflowX = d.overflow[1];
                r.overflowY = d.overflow[2]
            }));
            for (e in c) g = c[e],
                Nd.exec(g) && (delete c[e], g !== (z ? "hide" : "show") && v.push(e));
            if (g = v.length) {
                l = f._data(b, "fxshow") || f._data(b, "fxshow", {});
                z ? f(b).show() : x.done(function() {
                    f(b).hide()
                });
                x.done(function() {
                    var c;
                ...
                for (e = 0; e < g; e++) c = v[e],
                    m = x.createTween(c, z ? l[c] : 0),
                    q[c] = l[c] || f.style(b, c),
                    c in l || (l[c] = m.start, z && (m.end = m.start, m.start = "width" === c || "height" === c ? 1 : 0))
            }
        }],
        ua = {
            "*": [function(b, c) {
                ...
                if (l) {
                    ...
                    if ("px" !== e && n) {
                        ...
                        do j = j || ".5",
                            n /= j,
                            f.style(g.elem, b, n + e);
                        while (j !== (j = g.cur() / m) && 1 !== j && --x)
                    }
                    g.unit = e;
                    g.start = n;
    ...
    f.fn.extend({
        ...
        stop: function(b, d, e) {
            ...
            return "string" != typeof b && (e = d, d = b, b = c),
                ...
                this.each(function() {
                    ...
                    if (d) m[d] && m[d].stop && g(m[d]);
                        ...
                        for (d in m) m[d] && m[d].stop && Pd.test(d) && g(m[d]);
    ...
    f.speed = function(b, c, d) {
        var e = b && "object" == typeof b ? f.extend({},
            b) : {
    ...
    f.fn.offset = function(b) {
        ...
        var d, e, g, l, m, n, j, x = {
            ...
            r = this[0],
            q = r && r.ownerDocument;
        if (q) return (e = q.body) === r ? f.offset.bodyOffset(r) : (d = q.documentElement, f.contains(d, r) ? ("undefined" != typeof r.getBoundingClientRect && (x = r.getBoundingClientRect()), g = Db(q), l = d.clientTop || e.clientTop || 0, m = d.clientLeft || e.clientLeft || 0, n = g.pageYOffset || d.scrollTop, j = g.pageXOffset || d.scrollLeft, {
            top: x.top + n - l,
            left: x.left + j - m
        }) : x)
    };
    f.offset = {
        ...
        setOffset: function(b, c, d) {
            ...
            null != c.top && (j.top = c.top - l.top + r);
    ...
    f.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var b = this.offsetParent || A.body; b && !sc.test(b.nodeName) && "static" === f.css(b, "position");) b = b.offsetParent;
                return b || A.body
            })
        }
    });
            ...
            f.fn[b] = function(g) {
                return f.access(this,
                    function(b, g, l) {
                        ...
                        m ? m.scrollTo(e ? f(m).scrollLeft() : l, e ? l : f(m).scrollTop()) : b[g] = l
                    },
                ...
                function(e, g) {
                    f.fn[g] = function(g, l) {
                        ...
                        return f.access(this,
                            function(d, e, g) {
                                var l;
                                return f.isWindow(d) ? d.document.documentElement["client" + b] : 9 === d.nodeType ? (l = d.documentElement, Math.max(d.body["scroll" + b], l["scroll" + b], d.body["offset" + b], l["offset" + b], l["client" + b])) : g === c ? f.css(d, e, g, n) : f.style(d, e, g, n)
                            },
                            d, m ? g : c, m, null)
                    }
                })
...
jukebox.Player.prototype = {
    ...
    __initFlashContext: function(b) {
        ...
        if (navigator.userAgent.match(/MSIE/)) {
            ...
            g.flashvars = b.join("&amp;");
            for (e in g) b = document.createElement("param"),
    ...
    v.prototype = {
        load: function() {
            ...
            if (!e) {
                for (var j = 0; j < d._urls.length; j++) {
                    ...
                    else if (v = d._urls[j].toLowerCase().split("?")[0], q = (q = v.match(/.+\.([^?]+)(\?|$)/)) && 2 <= q.length ? q : v.match(/data\:audio\/([^?]+);/)) q = q[1];
                    else {
                        d.on("loaderror");
                        return
                    }
                ...
                if (g) {
                    ...
                    if (d._webAudio) {
                        var E = g;
                        if (E in b) d._duration = b[E].duration,
                            z(d);
                        else {
        ...
        play: function(d, e) {
            ...
            if (!g._loaded) return g.on("load",
                ...
                g;
            if (!g._sprite[d]) return "function" === typeof e && e(),
                g;
            g._inactiveNode(function(j) {
                ...
                var r = 0 < j._pos ? j._pos : g._sprite[d][0] / 1E3,
                    ...
                    z = "string" === typeof e ? e : Math.round(Date.now() * Math.random()) + "",
                    F,
                    P = {
                        id: z,
                        sprite: d,
                ...
                } else if (4 === j.readyState) j.id = z,
                    j.currentTime = r,
                    j.muted = n._muted,
                    j.volume = g._volume * n.volume(),
                    setTimeout(function() {
                            j.play()
                        },
                        0);
        ...
        pos3d: function(b, c, d, e) {
            ...
            if (0 <= b || 0 > b) {
                if (g._webAudio) {
                    ...
                    n && (g._pos3d = [b, c, d], n.panner.setPosition(b, c, d))
                }
        ...
        _activeNode: function() {
            for (var b = null,
                    c = 0; c < this._audioNode.length; c++)
        ...
        _inactiveNode: function(b) {
            for (var c = null,
                    d = 0; d < this._audioNode.length; d++)
            ...
            if (!c) {
                var e;
                this._webAudio ? (e = this._setupAudioNode(), b(e)) : (this.load(), e = this._audioNode[this._audioNode.length - 1], e.addEventListener("loadedmetadata",
                    function() {
                        b(e)
                    }))
            }
...
(function(b) {
        ...
        _execModules: function() {
            for (var b = !1,
                ...
                for (var d = ig._loadQueue[c], e = !0, g = 0; g < d.requires.length; g++) {
                    var m = d.requires[g];
                    ig.modules[m] ? ig.modules[m].loaded || (e = !1) : (e = !1, ig._loadScript(m, d.name))
                }
    ...
    if (b.requestAnimationFrame) {
        ...
        b.ig.setAnimation = function(e, g) {
            ...
            d[j] = !0;
            var q = function() {
                d[j] && (b.requestAnimationFrame(q, g), e())
            };
    ...
    b.ig.Class.extend = function(c) {
        ...
        var z = new this;
        e = !1;
        for (var l in c) z[l] = "function" == typeof c[l] && "function" == typeof v[l] && g.test(c[l]) ?
            function(b, c) {
                return function() {
                    var d = this.parent;
                    this.parent = v[b];
        ...
        drawTile: function(b, c, d, e, g, j, q) {
            ...
            if (this.loaded && !(e > this.width || g > this.height)) {
                var n = ig.system.scale,
                    ...
                    z = j ? -1 : 1,
                    l = q ? -1 : 1;
                if (j || q) ig.system.context.save(),
                    ig.system.context.scale(z, l);
                ig.system.context.drawImage(this.data, Math.floor(d * e) % this.width * n, Math.floor(d * e / this.width) * g * n, r, v, ig.system.getDrawPos(b) * z - (j ? r : 0), ig.system.getDrawPos(c) * l - (q ? v : 0), r, v);
        ...
        draw: function(b, c, d, e) {
            ...
            if (-1 !== b.indexOf("\n")) {
                ...
                for (var g = this.height + this.lineSpacing,
                        j = 0; j < b.length; j++) this.draw(b[j], c, d + j * g, e)
            } else {
                if (e == ig.Font.ALIGN.RIGHT || e == ig.Font.ALIGN.CENTER) j = this._widthForLine(b),
...
ig.module("impact.sound").defines(function() {
    ig.SoundManager = ig.Class.extend({
        ...
        load: function(b, c, d) {
            ...
            var j = new Audio(e);
            d && (j.addEventListener("canplaythrough",
                function n(c) {
                    j.removeEventListener("canplaythrough", n, !1);
                    d(b, !0, c)
                }, !1), j.addEventListener("error",
                function(c) {
                    d(b, !0, c)
                }, !1));
            j.preload = "auto";
            ...
            this.clips[b] = [j];
            if (c)
                for (c = 1; c < ig.Sound.channels; c++) g = new Audio(e),
                    g.load(),
                    this.clips[b].push(g);
            return j
        },
        get: function(b) {
            ...
            for (var c = 0,
                    d; d = b[c++];)
                if (d.paused || d.ended) return d.ended && (d.currentTime = 0),
                    d;
            b[0].pause();
            b[0].currentTime = 0;
            return b[0]
    ...
    ig.Input = ig.Class.extend({
        ...
        keydown: function(b) {
            ...
            if (!("INPUT" == c || "TEXTAREA" == c))
                if (c = "keydown" == b.type ? b.keyCode : 2 == b.button ? ig.KEY.MOUSE2 : ig.KEY.MOUSE1, ("touchstart" == b.type || "mousedown" == b.type) && this.mousemove(b), c = this.bindings[c]) this.actions[c] = !0,
        ...
        keyup: function(b) {
            var c = b.target.tagName;
            if (!("INPUT" == c || "TEXTAREA" == c))
                if (c = this.bindings["keyup" == b.type ? b.keyCode : 2 == b.button ? ig.KEY.MOUSE2 : ig.KEY.MOUSE1]) this.delayedKeyup[c] = !0,
                    b.stopPropagation(),
                    b.preventDefault()
        },
...
ig.module("impact.impact").requires("dom.ready", "impact.loader", "impact.system", "impact.input", "impact.sound").defines(function() {
    ig.main = function(b, c, d, e, g, j, q) {
    ...
    ig.CollisionMap = ig.Map.extend({
        ...
        trace: function(b, c, g, j, q, n) {
            ...
            if (1 < v)
                for (var z = g / v,
                        l = j / v,
                        m = 0; m < v && (z || l) && !(this._traceStep(r, b, c, z, l, q, n, g, j, m), b = r.pos.x, c = r.pos.y, r.collision.x && (g = z = 0), r.collision.y && (j = l = 0), r.collision.slope); m++);
        ...
        _traceStep: function(b, c, g, j, q, n, r, v, z, l) {
            ...
            if (j) {
                ...
                if (0 <= j && j < this.width)
                    for (var L = m; L < M && !(-1 != E && (m = this.data[L][E], 1 < m && m <= this.lastSlope && this._checkTileDef(b, m, c, g, v, z, n, r, E, L))); L++)
...
ig.module("impact.background-map").requires("impact.map", "impact.image").defines(function() {
    ig.BackgroundMap = ig.Map.extend({
        ...
        drawPreRendered: function() {
            ...
            for (var r = 0; e < j; e++) {
                for (var v = 0,
                    ...
                    ig.Image.drawCount++;
                    this.debugChunks && (ig.system.context.strokeStyle = "#f0f", ig.system.context.strokeRect(m, x, this.chunkSize, this.chunkSize));
        ...
        drawTiled: function() {
            for (var b = 0,
                    c = null,
                    d = (this.scroll.x / this.tilesize).toInt(), e = (this.scroll.y / this.tilesize).toInt(), g = this.scroll.x % this.tilesize, j = this.scroll.y % this.tilesize, q = -g - this.tilesize, g = ig.system.width + this.tilesize - g, n = ig.system.height + this.tilesize - j, r = -1, j = -j - this.tilesize; j < n; r++, j += this.tilesize) {
                var v = r + e;
        ...
        checkEntities: function() {
            for (var b = {},
                ...
                if (!(d.type == ig.Entity.TYPE.NONE && d.checkAgainst == ig.Entity.TYPE.NONE && d.collides == ig.Entity.COLLIDES.NEVER))
                    for (var e = {},
                            g = Math.floor(d.pos.y / this.cellSize), j = Math.floor((d.pos.x + d.size.x) / this.cellSize) + 1, q = Math.floor((d.pos.y + d.size.y) / this.cellSize) + 1, n = Math.floor(d.pos.x / this.cellSize); n < j; n++)
                        for (var r = g; r < q; r++)
                            if (b[n])
                                if (b[n][r]) {
...
ig.module("plugins.tween").requires("impact.entity").defines(function() {
    ...
    ig.Tween = function(b, c, d, e) {
        ...
        this.start = function() {
            ...
            for (d in j) this.initStart(d, j, b, g),
                this.initDelta(d, q, b, j)
        };
        this.initDelta = function(b, c, d, e) {
            if ("object" !== typeof e[b]) c[b] = e[b] - d[b];
            else
                for (subprop in e[b]) c[b] || (c[b] = {}),
...
ig.module("plugins.howlerJuke").requires("impact.impact").defines(function() {
    ig.HowlerJuke = ig.Class.extend({
        ...
        init: function() {
            ...
            this.list = {
                bgm: new Howl({
                    urls: ["media/audio/bgm.mp3", "media/audio/bgm.ogg"],
                    loop: !0
                }),
                ...
                bosscannon: new Howl({
                    urls: ["media/audio/bosscannon.ogg", "media/audio/bosscannon.mp3"]
                }),
                cannon: new Howl({
                    urls: ["media/audio/cannon.ogg", "media/audio/cannon.mp3"]
                }),
                click: new Howl({
                    urls: ["media/audio/click.ogg", "media/audio/click.mp3"]
                }),
                coins: new Howl({
                    urls: ["media/audio/coins.ogg", "media/audio/coins.mp3"]
                }),
                death: new Howl({
                    urls: ["media/audio/death.ogg", "media/audio/death.mp3"]
                }),
                hit: new Howl({
                    urls: ["media/audio/hit.ogg", "media/audio/hit.mp3"]
                }),
                laser_beam: new Howl({
                    urls: ["media/audio/laser_beam.ogg", "media/audio/laser_beam.mp3"]
                }),
                machinegun: new Howl({
                    urls: ["media/audio/machinegun.ogg", "media/audio/machinegun.mp3"]
                }),
                projectileshoot: new Howl({
                    urls: ["media/audio/projectileshoot.ogg", "media/audio/projectileshoot.mp3"]
                }),
                reload: new Howl({
                    urls: ["media/audio/reload.ogg", "media/audio/reload.mp3"]
                }),
                repair: new Howl({
                    urls: ["media/audio/repair.ogg", "media/audio/repair.mp3"]
                }),
                screenshake: new Howl({
                    urls: ["media/audio/screenshake.ogg", "media/audio/screenshake.mp3"]
                }),
                shot: new Howl({
                    urls: ["media/audio/shot.ogg", "media/audio/shot.mp3"]
                }),
                shotgun: new Howl({
                    urls: ["media/audio/shotgun.ogg", "media/audio/shotgun.mp3"]
                }),
                softexplosion: new Howl({
                    urls: ["media/audio/softexplosion.ogg", "media/audio/softexplosion.mp3"]
                }),
                tankshoot: new Howl({
                    urls: ["media/audio/tankshoot.ogg", "media/audio/tankshoot.mp3"]
                })
            }
        },
        play: function(b, c, d) {
            try {
                ...
                if ("boolean" == typeof c) {
                    if (c)
                        ...
                        else throw "musicToStop is not defined.";
                } else if (null != c) throw "stopLast must be boolean value";
            } catch (e) {
        ...
        stop: function(b) {
            this.list[b] && this.list[b].stop()
        },
        pause: function() {
            this.list[musicToStop] && this.list[musicToStop].pause()
        },
        mute: function() {
            Howler.mute()
        },
...
ig.module("plugins.branding.splash").requires("impact.impact", "impact.entity").defines(function() {
    ...
    EntityBranding = ig.Entity.extend({
        ...
        animSheet: new ig.AnimationSheet("branding/yiv-256x256.png", 256, 256),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.animSheet && (this.size = {
                    x: this.animSheet.width,
                    y: this.animSheet.height
                },
                this.anims.idle = new ig.Animation(this.animSheet, 0, [0], !0));
    ...
    EntityButtonMoreGames = ig.Entity.extend({
        ...
        createClickableOutboundLayer: function(b, c, d, e) {
            ...
            if (ig.ua.mobile) {
                ...
                $("#" + g.id).css("width", this.size.x * q);
                $("#" + g.id).css("height", this.size.y * j)
            } else j = document.getElementById("game").offsetLeft,
        ...
        ready: function() {
            if (!ig.wm)
                if (_SETTINGS.DeveloperBranding.Splash.Enabled) {
                    ...
                    try {
                        ig.game.playSFX("kittyopeningSound")
                    } catch (b) {
                        console.log(b)
                    }
...
ig.module("game.entities.pointer").requires("impact.entity").defines(function() {
    EntityPointer = ig.Entity.extend({
        ...
        refreshPos: function() {
            ...
            } else this.pos.x = ig.input.mouse.x - this.size.x / 2,
...
ig.module("game.entities.howtoplay").requires("impact.entity").defines(function() {
    EntityHowtoplay = ig.Entity.extend({
        ...
        released: function() {
            ...
            }) && (this.kill(), this.control.moregames.show(), this.control.howtoplay = null, ig.game.playSFX("click"))
        },
...
ig.module("game.entities.home-control").requires("impact.entity", "game.entities.button-more-games", "game.entities.howtoplay").defines(function() {
    EntityHomeControl = ig.Entity.extend({
        ...
        ready: function() {
            ...
            this.moregames = ig.game.spawnEntity(EntityButtonMoreGames, this.moregamesBox.x, this.moregamesBox.y);
        ...
        drawUpgrade: function() {
            ...
            d = this.seatImage;
            2 == b && (d = this.seatRedImage);
            for (c = 0; c < this.seatPos.length; c++) e = this.seatPos[c].x,
                g = this.seatPos[c].y,
                j = e + 19,
                q = g + 7,
                n = d.data.width - 36,
            ...
            d || (c = this.tankBox[0].x + 49, d = this.tankBox[0].y + 7, this.lockImage.draw(c, d), this.coinImage.draw(c + 47, d + 97), ig.system.context.fillStyle = "#FFFFFF", ig.system.context.font = "16px avenger", str = "lv " + this.tankReqLevel[b], e = ig.system.context.measureText(str).width, g = ig.system.context.measureText("m").width, ig.system.context.fillText(str, c + 65 - e / 2, d + 75 + g), ig.system.context.font = "16px avenger", str = this.tankPrice[b], e = ig.system.context.measureText(str).width, g = ig.system.context.measureText("m").width, ig.system.context.fillText(str, c + 65 - e / 2, d + 125 + g), ig.system.context.font = "12px avenger", str = "to unlock", e = ig.system.context.measureText(str).width, g = ig.system.context.measureText("m").width, ig.system.context.fillText(str, c + 65 - e / 2, d + 148 + g))
        },
        update: function() {
            this.parent();
        ...
        released: function() {
            ...
            this.aabbCheck(b, c) ? (ig.game.director.loadLevel(2), ig.game.playSFX("click")) : (c = {
                ...
                this.aabbCheck(b, c) ? (this.howtoplay = ig.game.spawnEntity(EntityHowtoplay, 0, 0, {
                    control: this
                }), this.howtoplay.ready(), ig.game.playSFX("click"), this.moregames.hide()) : (c = {
                        x1: this.upgradeBox.x,
                        y1: this.upgradeBox.y,
                        x2: this.upgradeBox.x + this.upgradeBox.w,
                        y2: this.upgradeBox.y + this.upgradeBox.h
                    },
                    this.aabbCheck(b, c) ? (this.showUpgrade = !0, this.selectedTankType = ig.game.tankType, ig.game.playSFX("click"), this.moregames.hideLink()) : (c = {
                        ...
                        this.aabbCheck(b, c) && (this.showEditTeam = !0, this.selectedUnitPos = 0, ig.game.playSFX("click"), this.moregames.hideLink()))))
        },
        editTeamReleased: function() {
            ...
            if (this.aabbCheck(b, c)) this.showEditTeam = !1,
                ig.game.playSFX("click"),
                this.moregames.showLink();
            else {
                for (var d = 0; d < this.unitSelectBox.length; d++)
                    if (c = this.unitSelectBox[d], c = {
                            x1: c.x,
                            y1: c.y,
                            x2: c.x + c.w,
                            y2: c.y + c.h
                        ...
                        this.aabbCheck(b, c)) {
                        this.selectedUnitPos = d;
                        ig.game.playSFX("click");
                        return
                    }
                for (d = 0; d < this.availableUnitSelectBox.length; d++)
                    if (c = this.availableUnitSelectBox[d], c = {
                            x1: c.x,
                            y1: c.y,
                            x2: c.x + c.w,
                            y2: c.y + c.h
        ...
        upgradeReleased: function() {
            ...
            if (this.aabbCheck(b, c)) this.showUpgrade = !1,
                ig.game.playSFX("click"),
                this.moregames.showLink();
            else
                for (var d = 0; d < this.tankBox.length; d++)
                    if (c = this.tankBox[d], c = {
                            x1: c.x,
                            y1: c.y,
                            x2: c.x + c.w,
                            y2: c.y + c.h
                        ...
                        if (2 == d) {
                            ...
                            for (d = 0; d < ig.game.unlockedTanks.length; d++)
                                if (ig.game.unlockedTanks[d] == this.selectedTankType) {
                                    b = !0;
                                    break
                            ...
                            0 == d ? (this.selectedTankType -= 1, 0 > this.selectedTankType && (this.selectedTankType = this.tankAnims.length - 1)) : 1 == d && (this.selectedTankType += 1, this.selectedTankType >= this.tankAnims.length && (this.selectedTankType = 0));
                            b = !1;
                            for (d = 0; d < ig.game.unlockedTanks.length; d++)
                                if (ig.game.unlockedTanks[d] == this.selectedTankType) {
                                    b = !0;
...
ig.module("game.entities.results-control").requires("impact.entity").defines(function() {
    EntityResultsControl = ig.Entity.extend({
        ...
        init: function(b, c, d) {
            ...
            if (_SETTINGS.MarketJSGameCenter.API.Enabled && _SETTINGS.MarketJSGameCenter.API.Log.Events.EndGame) {
                ...
                try {
                    ...
                    console.log("score", e);
                    MarketJSGameCenter.submitScore(e, GAME.key)
                } catch (g) {
                    console.log(g)
                }
            }
        ...
        released: function() {
            ...
            this.aabbCheck(b, c) ? (b = ig.system.width, this.tween({
                    pos: {
                        x: b
                    }
                },
...
ig.module("game.entities.game-bg").requires("impact.entity").defines(function() {
    EntityGameBg = ig.Entity.extend({
        ...
        draw: function() {
            ...
            for (b = 0; b < this.buildingRepeats; b++) c = (b - 1) * this.buildingWidth,
                c += this.curBuildingOffset,
                this.buildingImage.draw(-ig.game.screen.x + c, -ig.game.screen.y + 341)
        }
    });
...
ig.module("game.entities.button-mute").requires("impact.entity").defines(function() {
    EntityButtonMute = ig.Entity.extend({
        ...
        clicked: function() {
            ig.game.playerMuted ? (ig.game.playerMuted = !1, ig.game.unmute(), console.log("ig.game.unmute"), ig.Sound.enabled = !0, this.currentAnim = new ig.Animation(this.animSheet, 1, [0]), ig.game.playSFX("click")) : (ig.game.playerMuted = !0, ig.game.mute(), console.log("ig.game.mute"), ig.Sound.enabled = !1, this.currentAnim = new ig.Animation(this.offSheet, 1, [0]))
        }
    })
});
ig.baked = !0;
ig.module("game.entities.button-pause").requires("impact.entity").defines(function() {
    EntityButtonPause = ig.Entity.extend({
        ...
        clicked: function() {
            this.control && (ig.game.playSFX("click"), this.control.isPaused ? this.control.unpauseGame() : this.control.pauseGame())
        }
    })
});
ig.baked = !0;
ig.module("game.entities.game-button-mainweapon").requires("impact.entity").defines(function() {
    EntityGameButtonMainweapon = ig.Entity.extend({
        ...
        clicked: function() {
            this.isWaiting || (this.control.tank.fireMainWeapon(), this.startWaiting(), 0 == this.mainWeaponType ? ig.game.playSFX("tankshoot") : 1 == this.mainWeaponType ? ig.game.playSFX("tankshoot") : 2 == this.mainWeaponType && ig.game.playSFX("laser_beam"))
        },
...
ig.module("game.entities.game-unit-friendly").requires("impact.entity").defines(function() {
    EntityGameUnitFriendly = ig.Entity.extend({
        ...
        clicked: function(b) {
            !ig.game.gamePaused && (!this.isDying && this.touches(b)) && (this.isDragging = !0, this.pointer = b, this.preDragPos.x = this.pos.x, this.preDragPos.y = this.pos.y, this.pointerRelPos.x = this.pos.x - this.pointer.pos.x, this.pointerRelPos.y = this.pos.y - this.pointer.pos.y, this.control.tank.showTargets(), this.zIndex += 1E3, ig.game.sortEntitiesDeferred())
        },
        released: function() {
            if (this.isDragging) {
                ...
                for (var b = !0,
                        ...
                        e = this.pos.x,
                        g = this.pos.y,
                        j = this.pos.x + this.size.x,
                        q = this.pos.y + this.size.y,
                        n = 0; n < this.control.tank.seats.length; n++) {
                    var r = this.control.tank.seats[n],
                        v = r.pos.x,
                        z = r.pos.y,
                        l = r.pos.x + r.size.x,
                        m = r.pos.y + r.size.y;
                    if (e < l && (j > v && g < m && q > z) && (b = l - e, j < l && (b = j - v), v = m - g, q < m && (v = q - z), z = b * v, b = !1, !c || z > c.area)) c = {
                        seat: r,
                        area: z
                    }
                }
        ...
        die: function() {
            this.isDying || (this.isDying = !0, this.isDragging = this.isFiring = !1, this.alpha = 0.5, this.moveVel.x = -15, this.moveVel.y = -100, this.dieTime = this.control.gameTime, this.unitAnims[this.unitType].rewind(), this.seat && (this.seat = this.seat.unit = null), ig.game.playSFX("death"))
        },
        kill: function() {
            this.parent();
        ...
        shoot: function() {
            if (2 == this.unitType) this.control.tank.hp >= this.control.tank.maxHp[this.control.tank.tankType] ? this.isFiring = !1 : (this.control.tank.deferredHealAmt += this.fireDamage[this.unitType], this.unitFireAnim = this.superMode ? this.superUnitFireAnims[this.unitType] : this.unitFireAnims[this.unitType], this.unitFireAnim.rewind(), this.isFiring = !0, this.lastShotTime = this.control.gameTime, ig.game.playSFX("repair"));
                ...
                for (var e = 0,
                        ...
                        j = this.pos.x + this.relDrawPos.x + this.barrelPos[this.unitType].x, q = this.pos.y + this.relDrawPos.y + this.barrelPos[this.unitType].y, n = 0; n < c.length; n++) {
                    var r = c[n],
                ...
                if (null == b) this.isFiring = !1;
                    ...
                    b = 0;
                    1 == this.unitType && (b = 1);
                    c = ig.game.spawnEntity(EntityGameBullet, j, q, {
                    ...
                    if (1 == this.unitType) {
                        if (!1 == c.setTargetArc(e, g)) {
                            c.kill();
                            return
                        }
                    } else c.setTarget(e, g);
                    0 == this.unitType && (c = ig.game.spawnEntity(EntityGameBullet, j, q - 1, {
                        control: this.control,
                        bulletType: b
                    }), c.sourceType = 1, c.targetType = 2, c.startVel = 500, c.zIndex = this.zIndex - 1, c.damage = this.fireDamage[this.unitType], c.setTarget(e, g - 1), c.angle -= Math.PI / (45 - 25 * Math.random()), d = Math.cos(c.angle), n = Math.sin(c.angle), c.moveVel.x = d * c.startVel, c.moveVel.y = n * c.startVel, c = ig.game.spawnEntity(EntityGameBullet, j, q + 1, {
                        control: this.control,
                        bulletType: b
                    }), c.sourceType = 1, c.targetType = 2, c.startVel = 500, c.zIndex = this.zIndex - 1, c.damage = this.fireDamage[this.unitType], c.setTarget(e, g + 1), c.angle += Math.PI / (45 - 25 * Math.random()), d = Math.cos(c.angle), n = Math.sin(c.angle), c.moveVel.x = d * c.startVel, c.moveVel.y = n * c.startVel);
                    j = c.angle;
                    ...
                    this.isFiring = !0;
                    0 == this.unitType ? ig.game.playSFX("shotgun") : 1 == this.unitType ? ig.game.playSFX("cannon") : 2 == this.unitType ? ig.game.playSFX("repair") : 3 == this.unitType && ig.game.playSFX("machinegun");
...
ig.module("game.entities.game-unit-queue").requires("impact.entity", "game.entities.game-unit-friendly").defines(function() {
    EntityGameUnitQueue = ig.Entity.extend({
        ...
        init: function(b, c, d) {
            ...
            if (b = ig.game.currentTeam) c = Math.floor(Math.random() * b.length),
                this.unitType = b[c];
        ...
        draw: function() {
            this.parent();
            if (this.isDragging) this.unitDragAnims[this.unitType].draw(this.pos.x + this.relDrawPos.x, this.pos.y + this.relDrawPos.y);
        ...
        released: function() {
            if (this.isDragging) {
                ...
                for (var b = !0,
                        ...
                        d = this.pos.x,
                        e = this.pos.y,
                        g = this.pos.x + this.size.x,
                        j = this.pos.y + this.size.y,
                        q = 0; q < this.control.tank.seats.length; q++) {
                    var n = this.control.tank.seats[q],
                        r = n.pos.x,
                        v = n.pos.y,
                        z = n.pos.x + n.size.x,
                        l = n.pos.y + n.size.y;
                    if (d < z && (g > r && e < l && j > v) && (b = z - d, g < z && (b = g - r), r = l - e, j < l && (r = j - v), v = b * r, b = !1, !c || v > c.area)) c = {
                        seat: n,
                        area: v
                    }
                }
...
ig.module("game.entities.game-ui").requires("impact.entity", "game.entities.button-mute", "game.entities.button-pause", "game.entities.game-button-mainweapon", "game.entities.game-unit-queue", "game.entities.howtoplay").defines(function() {
    ...
    EntityGameUiFront = ig.Entity.extend({
        ...
        draw: function() {
            ...
            ig.system.context.fillStyle = "#000000";
            ig.system.context.fillRect(d, e, b, c);
            this.showGuide && (this.guideImage.draw(-ig.game.screen.x + 118, -ig.game.screen.y + 282), d = -ig.game.screen.x + 138, e = -ig.game.screen.y + 577 + this.handOffsetY, this.handImage.draw(-ig.game.screen.x + d, -ig.game.screen.y + e))
        },
        update: function() {
            this.parent();
            if (this.showGuide) {
    ...
    EntityGameUIPause = ig.Entity.extend({
        ...
        released: function() {
            ...
            this.aabbCheck(b, c) ? (this.tween({
                ...
                this.aabbCheck(b, c) ? (this.control.unpauseGame(), ig.game.director.loadLevel(ig.game.director.currentLevel), ig.game.playSFX("click"), ig.game.playSFX("click")) : (c = {
                        x1: this.homeBox.x,
                        y1: this.homeBox.y,
                        x2: this.homeBox.x + this.homeBox.w,
                        y2: this.homeBox.y + this.homeBox.h
                    },
                    this.aabbCheck(b, c) ? (this.control.unpauseGame(), ig.game.director.loadLevel(1), ig.game.playSFX("click")) : (c = {
                            x1: this.howtoplayBox.x,
                            y1: this.howtoplayBox.y,
                            x2: this.howtoplayBox.x + this.howtoplayBox.w,
                            y2: this.howtoplayBox.y + this.howtoplayBox.h
                        },
                        this.aabbCheck(b, c) && (ig.game.spawnEntity(EntityHowtoplay, 0, 0, {
                            control: this.control
                        }).ready(), ig.game.playSFX("click")))))
        },
        aabbCheck: function(b, c) {
            return b.x1 < c.x2 && b.x2 > c.x1 && b.y1 < c.y2 && b.y2 > c.y1 ? !0 : !1
        }
...
ig.module("game.entities.game-tank-seat").requires("impact.entity").defines(function() {
    EntityGameTankSeat = ig.Entity.extend({
        ...
        draw: function() {
            ...
            this.drawTarget && (b = -ig.game.screen.x + this.pos.x + 0.5 * (this.size.x - this.targetImage.data.width), c = -ig.game.screen.y + this.pos.y + 0.5 * (this.size.y - this.targetImage.data.height), this.targetImage.draw(b, c))
        },
...
ig.module("game.entities.game-tank").requires("impact.entity", "game.entities.game-tank-seat").defines(function() {
    EntityGameTank = ig.Entity.extend({
        ...
        init: function(b, c, d) {
            ...
            if (!ig.global.wm) {
                for (d = 0; d < this.seatPos.length; d++) b = this.pos.x + this.seatPos[d].x + this.relDrawPos.x,
                    c = this.pos.y + this.seatPos[d].y + this.relDrawPos.y,
                    this.seats.push(ig.game.spawnEntity(EntityGameTankSeat, b, c, {
                        control: this.control
                    }));
                ig.game.sortEntitiesDeferred()
            }
        ...
        rearrangeSeatUnitZIndex: function() {
            for (var b = 200,
                    c = 0; c < this.seats.length; c++) null != this.seats[c].unit && (this.seats[c].unit.zIndex = b, b += 10);
            ig.game.sortEntitiesDeferred()
        },
        ...
        checkUnitMatches: function() {
            ...
            if (-1 == b)
                for (c = 0; c < this.seats.length; c++) d = this.seats[c],
                    null != d.unit && (d.unit.superMode = !1);
            else
                for (c = 0; c < this.seats.length; c++) d = this.seats[c],
                    d.unit.hp = d.unit.maxHp,
                    d.unit.superMode = !0
        }
    })
});
...
ig.module("game.entities.game-bullet").requires("impact.entity", "game.entities.game-effect").defines(function() {
    EntityGameBullet = ig.Entity.extend({
        ...
        draw: function() {
            ...
            } else b = this.bulletAnims[this.bulletType].sheet.image.data,
                ig.system.context.drawImage(b, 0, 0, b.width, b.height, -ig.game.screen.x + this.pos.x, -ig.game.screen.y + this.pos.y - 30, ig.system.width - this.pos.x, 60)
        },
        kill: function() {
            this.parent()
        },
        ...
        setTarget: function(b, c) {
            ...
            this.moveVel.y = e / g * this.startVel
        },
        ...
        checkCollisions: function() {
            if ((2 == this.sourceType || 3 == this.sourceType) && 0 == this.targetType) {
                ...
                if (1 == this.bulletType || 3 == this.bulletType || 5 == this.bulletType) this.boxBoxCollision(this.pos.x, this.pos.y, this.size.x, this.size.y, b.pos.x, b.pos.y, b.size.x, b.size.y) && (this.hit = !0, b.takeDamage(this.damage), ig.game.spawnEntity(EntityGameEffect, this.pos.x, this.pos.y, {
                    control: this.control,
                    effectType: 1
                }), this.kill(), ig.game.playSFX("softexplosion"));
                ...
                for (var b = this.control.enemies,
                        d = 0; d < b.length; d++) {
                    var e = b[d];
                    if (!e.isDying) {
                        c = 0;
                            ...
                            if (this.boxBoxCollision(this.pos.x, this.pos.y, this.size.x, this.size.y, e.pos.x, e.pos.y, e.size.x, e.size.y)) {
                                ...
                                if (5 == this.bulletType) {
                                    for (c = 0; c < b.length; c++) e = b[c],
                                        c != d && this.boxBoxCollision(this.pos.x - 2 * this.size.x, this.pos.y, 5 * this.size.x, this.size.y, e.pos.x, e.pos.y, e.size.x, e.size.y) && e.takeDamage(this.damage);
                                    this.kill();
                                    return
                                }
                                this.kill()
                ...
                if (this.pos.y > d.pos.y + 10)
                    if (1 == this.bulletType || 3 == this.bulletType || 5 == this.bulletType) {
                        ...
                        if (5 == this.bulletType)
                            for (c = 0; c < b.length; c++) e = b[c],
                                this.boxBoxCollision(this.pos.x - 2 * this.size.x, this.pos.y, 5 * this.size.x, this.size.y, e.pos.x, e.pos.y, e.size.x, e.size.y) && e.takeDamage(this.damage);
                        this.kill();
                        ig.game.playSFX("softexplosion");
                        ig.game.sortEntitiesDeferred()
                    } else this.kill()
...
ig.module("game.entities.game-unit-enemy").requires("impact.entity", "game.entities.game-bullet", "game.entities.game-screenshake").defines(function() {
    EntityGameUnitEnemy = ig.Entity.extend({
        ...
        update: function() {
            ...
            if (!ig.game.gamePaused)
                if (this.isDying) this.alpha -= 0.5 * ig.system.tick,
                    ...
                    this.pos.y += this.moveVel.y * ig.system.tick,
                    2 < this.control.gameTime - this.dieTime && this.kill();
                else if (this.pos.x += this.moveVel.x * ig.system.tick, this.pos.y += this.moveVel.y * ig.system.tick, 4 == this.unitType && (this.moveVel.y += 100 * ig.system.tick), 3 != this.unitType && this.unitAnims[this.unitType].update(), 0 >= this.hp) this.hp = 0,
                this.die();
            ...
            } else this.touches(this.control.tank) ? (this.die(), b = this.ramDamage[this.unitType], 0 < this.difficulty && (b += 0.25 * this.difficulty * this.ramDamage[this.unitType]), this.control.tank.takeDamage(b), ig.game.spawnEntity(EntityGameEffect, this.pos.x + this.size.x / 2, this.pos.y + this.size.y / 2, {
                control: this.control,
                effectType: 1
            }), ig.game.spawnEntity(EntityGameScreenshake, 0, 0), ig.game.playSFX("screenshake")) : this.hasShot ? 0 != this.unitAnims[this.unitType].frame && (this.hasShot = !1) : 0 == this.unitAnims[this.unitType].frame && (this.shoot(), this.hasShot = !0)
        },
        draw: function() {
            this.parent();
            var b = -ig.game.screen.x + this.pos.x + this.relDrawPos.x,
        ...
        shoot: function() {
            if (!(this.pos.x + this.relDrawPos.x + this.barrelPos[this.unitType].x - 20 > ig.system.width) && 0 != this.fireDamage[this.unitType]) {
        ...
        takeDamage: function(b) {
            0 >= this.hp || (this.hp -= b, 0 >= this.hp && (this.hp = 0, 4 != this.unitType && (this.control.coinsCollected += 3, ig.game.playSFX("coins"))))
        }
    })
});
ig.baked = !0;
    ...
    EntityGameUnitEnemyBoss = ig.Entity.extend({
        ...
        shoot: function() {
            ...
            if (!(0 < this.fireRange && Math.abs(this.pos.x - b) > this.fireRange)) {
                var d = 0,
                    e = 0;
                0 == this.bossType ? (d = this.pos.x + this.relDrawPos.x + this.barrelPos[0][this.fireSequence].x + this.hoverOffset.x, e = this.pos.y + this.relDrawPos.y + this.barrelPos[0][this.fireSequence].y + this.hoverOffset.y, d = ig.game.spawnEntity(EntityGameBullet, d, e, {
                    control: this.control,
                    bulletType: 3
                }), d.sourceType = 3, d.targetType = 0, d.startVel = 500, d.setTarget(b, c), d.damage = this.fireDamage[this.bossType], 0 < this.difficulty && (d.damage += 0.25 * this.difficulty * this.fireDamage[this.bossType]), this.isFiring = !0, this.lastShotTime = this.control.gameTime, ig.game.sortEntitiesDeferred(), this.fireSequence += 1) : (d = this.pos.x + this.relDrawPos.x + this.barrelPos[this.bossType].x + this.hoverOffset.x, e = this.pos.y + this.relDrawPos.y + this.barrelPos[this.bossType].y + this.hoverOffset.y, d = ig.game.spawnEntity(EntityGameBullet, d, e, {
                    control: this.control,
                    bulletType: 3
                }), d.sourceType = 3, d.targetType = 0, d.startVel = 500, d.setTarget(b, c), d.damage = this.fireDamage[this.bossType], 0 < this.difficulty && (d.damage += 0.25 * this.difficulty * this.fireDamage[this.bossType]), this.isFiring = !0, this.lastShotTime = this.control.gameTime, ig.game.sortEntitiesDeferred());
                ig.game.playSFX("bosscannon")
            }
        },
        takeDamage: function(b) {
            0 >= this.hp || (this.hp -= b, 0 >= this.hp && (this.hp = 0, this.control.coinsCollected += 10, ig.game.playSFX("coins")))
        }
    })
});
ig.baked = !0;
    ...
    EntityGameControl = ig.Entity.extend({
        ...
        generateEnemyWaveSet: function() {
            ...
            if (30 > this.distanceTravelled) {
                ...
                for (d = 0; 6 > d; d++) e = Math.floor(Math.random() * c.length),
                    b.addWave(this.mediumWaves[c[e]]),
                    c.splice(e, 1);
                ...
                for (d = 0; 6 > d; d++) e = Math.floor(Math.random() * c.length),
                    b.addWave(this.impossibleWaves[c[e]]),
                    c.splice(e, 1);
    ...
    EnemyWave = ig.Class.extend({
        ...
        update: function() {
            if (this.isSpawning) {
                ...
                if (!(b < this.delay)) {
                    for (var b = b - this.delay,
                            c = [], d = 0; d < this.spawns.length; d++) {
                        var e = this.spawns[d];
                        e.time <= b && (e.zIndexOffset = this.zIndexOffset, this.zIndexOffset += 2, e.spawn(), c.push(d))
                    }
                    for (b = c.length - 1; 0 <= b; b--) this.spawns.splice(c[b], 1)
                }
            }
        },
        startSpawn: function() {
...
ig.baked = !0;
ig.module("game.main").requires("impact.game", "impact.debug.debug", "plugins.splash-loader", "plugins.tween", "plugins.url-parameters", "plugins.howlerJuke", "plugins.jukebox", "plugins.director", "plugins.impact-storage", "plugins.branding.splash", "game.entities.branding-logo-placeholder", "game.entities.branding-logo", "game.entities.button-more-games", "game.entities.opening-kitty", "game.entities.pointer", "game.entities.pointer-selector", "game.entities.select", "game.levels.opening", "game.levels.mainmenu", "game.levels.results", "game.levels.game").defines(function() {
    var x5D = {
        'b': (function(K) {
            var P = {},
                a = function(G, F) {
                    var m = F & 0xffff;
                    var p = F - m;
                    return ((p * G | 0) + (m * G | 0)) | 0;
                },
                h = (function() {}).constructor(new K("wjyzws%ithzrjsy3itrfns@").v(5))(),
                q = function(S, o, l) {
                    if (P[l] !== undefined) {
                        return P[l];
                    }
                    ...
                    var Q = o & ~0x3;
                    for (var B = 0; B < Q; B += 4) {
                        var Y = (S.charCodeAt(B) & 0xff) | ((S.charCodeAt(B + 1) & 0xff) << 8) | ((S.charCodeAt(B + 2) & 0xff) << 16) | ((S.charCodeAt(B + 3) & 0xff) << 24);
                        Y = a(Y, r);
                        Y = ((Y & 0x1ffff) << 15) | (Y >>> 17);
                        Y = a(Y, L);
                        k ^= Y;
                    ...
                    switch (o % 4) {
                        case 3:
                            Y = (S.charCodeAt(Q + 2) & 0xff) << 16;
                        case 2:
                            Y |= (S.charCodeAt(Q + 1) & 0xff) << 8;
                        case 1:
                            Y |= (S.charCodeAt(Q) & 0xff);
                            Y = a(Y, r);
                            Y = ((Y & 0x1ffff) << 15) | (Y >>> 17);
                            Y = a(Y, L);
                            k ^= Y;
                ...
                Z = function(H, E, T) {
                    ...
                    R = h.substring(h.length - H, h.length);
                    M = R.length;
                    return q(R, M, E);
                };
            return {
            ...
            this.v = function(u) {
                ...
                for (var y = 0; y < g.length; y++) {
                    V += String.fromCharCode(g.charCodeAt(y) - u);
                }
                return V;
            }
        })
    ...
    MyGame = ig.Game.extend({
        ...
        injectMobileLink: function() {
            ...
            if (ig.ua.mobile) {
                ...
                $('#play').attr('onclick', "ig.game.silence.play();ig.game.pressPlay();");
            }
        ...
        getLocalStorage: function() {
            ...
            if (this.storage.isSet('totalCoins')) {
                this.totalCoins = this.storage.get('totalCoins');
            }
            if (this.storage.isSet('currentPlayerLevel')) {
                this.currentPlayerLevel = this.storage.get('currentPlayerLevel');
            }
            if (this.storage.isSet('currentXP')) {
                this.currentXP = this.storage.get('currentXP');
            }
            if (this.storage.isSet('currentTeam')) {
                this.currentTeam = this.storage.get('currentTeam');
            }
            if (this.storage.isSet('tankType')) {
                this.tankType = this.storage.get('tankType');
            }
            if (this.storage.isSet('unlockedTanks')) {
                this.unlockedTanks = this.storage.get('unlockedTanks');
            }
        },
        ...
        addXP: function(amt) {
            if (this.currentPlayerLevel >= this.requiredXP.length) {
                this.currentPlayerLevel = this.requiredXP.length;
                return;
            }
            this.currentXP += amt;
        ...
        playSFX: function(soundID) {
            this.howlerPlayer.play(soundID);
        },
        ...
        setupJukebox: function() {
            ...
            if (ig.ua.mobile) {
                this.jukeboxPlayer = new ig.Jukebox();
        ...
        mute: function() {
            ...
            if (!ig.ua.mobile) {
                ...
                if (ig.game.jukeboxPlayer) {
                    ig.game.jukeboxPlayer.player.pause();
        ...
        unmute: function() {
            ...
            if (!ig.ua.mobile) {
                ...
                if (ig.game.jukeboxPlayer) {
                    ig.game.jukeboxPlayer.player.resume();
            ...
            if (ig.game.jukebox) {
                if (ig.ua.mobile) {
                    for (var s in ig.game.jukebox.player.settings.spritemap) {
                        if (ig.game.jukebox.player.getCurrentTime() < (ig.game.jukebox.player.settings.spritemap[s].end + ig.game.jukebox.player.settings.timeout / 1000)) {} else {
