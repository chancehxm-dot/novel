...
function getHiddenProp() {
    var e1 = null,
        ...
        Z = 'webkit',
        prefixes = [Z, E9, r, v];
    if (h1 in document) return h1;
    for (var i = o8V.L; i < prefixes.length; i++) {
        if ((prefixes[i] + s9) in document) return prefixes[i] + s9;
    }
    return e1;
}
...
function fnResume() {
    if (gameEngine) {
        if (!gameEngine.userStorage.isSoundsMute) Howler.mute(o8V.u);
        gameEngine.unpause();
    }
}
...
function isHidden() {
    ...
    if (!prop) return o8V.u;
    return document[prop];
}

function resize() {
    var widthToHeight = defaultWidth / defaultHeight,
        newWidthToHeight = window.innerWidth / window.innerHeight,
...
var assetsToInitloader = [o8V.E + artSuffix + o8V.J9, o8V.K1 + artSuffix + o8V.J9, o8V.Y9 + artSuffix + o8V.J9, o8V.P + artSuffix + o8V.J9],
    assetsLoading = [o8V.i1 + artSuffix + o8V.c1],
    assetsToLoader = [o8V.X + artSuffix + o8V.c1, o8V.T1 + artSuffix + o8V.c1, o8V.y9 + artSuffix + o8V.c1, o8V.B9 + artSuffix + o8V.J9, o8V.R9 + artSuffix + o8V.c1, o8V.o + artSuffix + o8V.c1, o8V.R9 + artSuffix + o8V.c1, o8V.W1 + artSuffix + o8V.c1, o8V.q9 + artSuffix + o8V.c1, o8V.r1 + artSuffix + o8V.c1, o8V.Q1 + artSuffix + o8V.c1, o8V.w + artSuffix + o8V.c1, o8V.L9 + artSuffix + o8V.c1, o8V.h + artSuffix + o8V.c1, o8V.q1 + artSuffix + o8V.J9, o8V.R + artSuffix + o8V.J9, o8V.j + artSuffix + o8V.J9, o8V.R1 + artSuffix + o8V.J9, o8V.n9 + artSuffix + o8V.J9, o8V.I1 + artSuffix + o8V.t, o8V.m9 + artSuffix + o8V.t, o8V.U9 + artSuffix + o8V.t, o8V.p + artSuffix + o8V.t, o8V.G1 + artSuffix + o8V.t, o8V.V9 + artSuffix + o8V.t, o8V.f9 + artSuffix + o8V.t, o8V.P1 + artSuffix + o8V.t, o8V.I9 + artSuffix + o8V.t, o8V.j9 + artSuffix + o8V.t, o8V.T + artSuffix + o8V.t, o8V.C9 + artSuffix + o8V.t, o8V.z1 + artSuffix + o8V.t, o8V.B1 + artSuffix + o8V.t, o8V.T9 + artSuffix + o8V.t, o8V.H1 + artSuffix + o8V.t, o8V.g + artSuffix + o8V.t, o8V.F1 + artSuffix + o8V.t, o8V.M9 + artSuffix + o8V.t, o8V.U1 + artSuffix + o8V.t, o8V.j1 + artSuffix + o8V.J9, o8V.N1 + artSuffix + o8V.J9, o8V.q + artSuffix + o8V.J9, o8V.e9 + artSuffix + o8V.J9, o8V.S1 + artSuffix + o8V.J9, o8V.b9 + artSuffix + o8V.J9, o8V.G9 + artSuffix + o8V.J9, o8V.F + artSuffix + o8V.J9, o8V.X1 + artSuffix + o8V.J9],
    assetsLoaded = o8V.L,
    widthToHeight = defaultWidth / defaultHeight,
    newWidthToHeight = window.innerWidth / window.innerHeight,
    gameWidth, gameHeight;
if (newWidthToHeight > widthToHeight) {
    gameWidth = defaultHeight * newWidthToHeight;
...
var menuMusic, gameMusic, gameoverMusic, limitMusic, sounds, soundsToLoad = o8V.B,
    soundsLoaded = o8V.L,
    SpilData = {
        id: o8V.S
    };
GameAPI.loadAPI(function(apiInstance) {
    ...
    if (logoData.image) assetsToInitloader.push(logoData.image);
