...
GAME.LoadingScene.prototype.appearQuestion = function() {
    var questionText = new PIXI.BitmapText(_("Please choose your preference") + ":", {
        font: "LoadingScene_FontWhite",
        align: "left"
    });
    ...
    TweenLite.to(questionText, 0.5, {
        alpha: 1.0,
        ease: Sine.easeOut,
        onCompleteScope: this,
        onComplete: this.appearOption
    });
}
...
GAME.LoadingScene.prototype.appearOption = function() {
    ...
    play.touchstart = function(touchData) {
        ...
        TweenLite.to(this.parent.scale, 0.6, {
            x: 1,
            y: 1,
    ...
    play.mouseup = play.touchend = function(touchData) {
        ...
        TweenLite.to(this.parent.scale, 0.2, {
            x: 0.9,
            y: 0.9,
            ease: Sine.easeInOut,
            overwrite: "all"
    ...
    var playText = new PIXI.BitmapText(_("Best effects"), {
        font: "LoadingScene_FontBlack",
        align: "left"
    });
    ...
    TweenLite.to(playContainer, 0.5, {
        alpha: 1.0,
        ease: Sine.easeOut
    });
    ...
    var playPerformanceText = new PIXI.BitmapText(_("Best performance"), {
        font: "LoadingScene_FontBlack",
        align: "left"
    });
    ...
    TweenLite.to(playPerformanceContainer, 0.5, {
        alpha: 1.0,
        ease: Sine.easeOut
    });
}
...
GAME.LoadingScene.prototype.readyToPlay = function() {
    if (gameEngine.isMobile.any()) {
        TweenLite.to(this.loadingBar, 0.3, {
            alpha: 0,
            ease: Sine.easeOut,
            overwrite: "all"
        });
        TweenLite.to(this.loadingBarBackground, 0.3, {
            alpha: 0,
            ease: Sine.easeOut,
            overwrite: "all"
        });
        TweenLite.to(this.logo, 0.3, {
            alpha: 0,
            ease: Sine.easeOut,
            overwrite: "all"
        });
        TweenLite.to(this.loadingCircle, 0.3, {
            alpha: 0,
            ease: Sine.easeOut,
            overwrite: "all",
            onCompleteScope: this,
            onComplete: this.appearQuestion
        });
    } else {
