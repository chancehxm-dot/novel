...
GAME.GameScene.prototype.hamsterLose = function() {
    if (this.state != GAMESCENE_STATE.HAMSTERLOSE) {
        ...
        TweenLite.to(this.cuadroRojo, 1.0, {
            alpha: 0,
            ease: Sine.easeInOut,
            overwrite: "all"
        });
        ...
        if (!this.limitMusicPlaying) {
            ...
            limitMusic.once("faded", function() {
                limitMusic.stop();
                limitMusic.volume(1.0);
                gameoverMusic.play();
            });
...
GAME.GameScene.prototype.levelUp = function() {
    ...
    this.tweenFlash = TweenLite.to(this.flashBlanco, 0.4, {
        alpha: 0,
        ease: Sine.easeIn,
        overwrite: "all"
    });
...
GAME.GameScene.prototype.explodeAllBubbles = function() {
    ...
    this.tweenFlash = TweenLite.to(this.rainbow, 10, {
        alpha: 0,
        ease: Sine.easeInOut,
        overwrite: "all"
    });
