...
GAME.BubbleManager.prototype.swap = function() {
    ...
    TweenLite.to(this.bubbleReadyMove.position, 0.2, {
        x: this.bubbleShowMove.position.x,
        y: this.bubbleShowMove.position.y,
        ease: Sine.easeInOut,
        overwrite: "all"
    });
    TweenLite.to(this.bubbleShowMove.position, 0.2, {
        x: this.bubbleReadyMove.position.x,
        y: this.bubbleReadyMove.position.y,
        ease: Sine.easeInOut,
        overwrite: "all",
        onCompleteScope: this,
        onComplete: this.swapBubbles
    });
}
