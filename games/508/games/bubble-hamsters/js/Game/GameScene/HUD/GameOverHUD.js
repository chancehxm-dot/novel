...
GAME.GameOverHUD = function(container) {
    ...
    this.title = new PIXI.BitmapText(_("Game Over"), {
        font: "GameScene_FuenteRoja",
        align: "left"
    });
    ...
    this.scoreLabelText = new PIXI.BitmapText(_("Score") + ":", {
        font: "GameScene_FuenteBlanca",
        align: "left"
    });
    ...
    this.bestLabelText = new PIXI.BitmapText(_("Best") + ":", {
        font: "GameScene_FuenteBlanca",
        align: "left"
    });
    ...
    this.bestText = new PIXI.BitmapText("0", {
        font: "GameScene_FuenteBlanca",
        align: "left"
    });
...
GAME.GameOverHUD.prototype.show = function(score) {
    ...
    TweenLite.to(this.cuadroNegro, 0.2, {
        alpha: 0.6,
        ease: Sine.easeInOut,
        overwrite: "all"
    });
    ...
    TweenLite.to(this.buttonsContainer.position, 0.3, {
        y: 0,
        delay: 0.1,
        ease: Circ.easeOut,
        overwrite: "all"
