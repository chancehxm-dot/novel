...
GAME.GameHUD = function(container) {
    ...
    //HITS
    this.hitsText = new PIXI.BitmapText("4 " + _("Hits"), {
        font: "GameScene_Hits",
        align: "left"
    });
    ...
    //Bonus TEXT
    this.bonusText = new PIXI.BitmapText(_("Bonus") + "", {
        font: "GameScene_BonusFont",
        align: "left"
    });
    ...
    this.bonusScoreText = new PIXI.BitmapText("+0", {
        font: "GameScene_BonusFont",
        align: "left"
    });
    ...
    this.scoreText = new PIXI.BitmapText("0 / 10000", {
        font: "GameScene_Nivel",
        align: "left"
    });
    ...
    this.levelText = new PIXI.BitmapText(_("Level") + " 1", {
        font: "GameScene_NumerosPuntaje",
        align: "left"
    });
    ...
    this.nivelText = new PIXI.BitmapText(_("Level") + " 1", {
        font: "GameScene_LevelFont",
        align: "left"
    });
    ...
    this.readyText = new PIXI.BitmapText(_("Ready"), {
        font: "GameScene_BonusFont",
        align: "left"
    });
...
GAME.GameHUD.prototype.showGo = function() {
    ...
    this.readyText.position.y = defaultHeight * 0.5 - this.readyText.textHeight * 0.5;
    this.readyText.alpha = 1.0;
    TweenLite.to(this.readyText, 1.5, {
        alpha: 0.0,
        ease: Sine.easeInOut,
        overwrite: "all"
    });
...
GAME.GameHUD.prototype.hitsShow = function(hits, isMatchBreak) {
    if (isMatchBreak) {
        ...
        TweenLite.to(this.hitsText, 0.1, {
            alpha: 1.0,
            ease: Sine.easeOut,
            overwrite: "all"
        });
        TweenLite.to(this.hitsText.position, 0.1, {
            y: defaultHeight * 0.72 - this.hitsText.textHeight * 0.5,
            ease: Sine.easeOut,
            overwrite: "all",
            onCompleteScope: this,
            onComplete: this.hideHits
        });

        this.cruzHits.alpha = 0.0;
        this.cruzHits.scale.x = this.cruzHits.scale.y = 2.0;
        TweenLite.to(this.cruzHits, 0.5, {
            alpha: 1.0,
            ease: Sine.easeOut,
            overwrite: "all"
        });
        TweenLite.to(this.cruzHits.scale, 0.5, {
            x: 1.0,
            y: 1.0,
            ease: Bounce.easeOut,
            overwrite: "all",
            onCompleteScope: this,
            onComplete: this.hideCruz
        });
    } else {
        this.hitsText.alpha = 0;
        this.hitsText.setText(hits + " " + _("Hits"));
...
GAME.GameHUD.prototype.hideHits = function() {
    ...
    TweenLite.to(this.hitsText.position, 0.1, {
        y: defaultHeight * 0.72 - this.hitsText.textHeight * 0.75,
        delay: 1.4,
        ease: Sine.easeOut,
        overwrite: "all"
    });
...
GAME.GameHUD.prototype.hideCruz = function() {
    TweenLite.to(this.cruzHits, 0.1, {
        alpha: 0.0,
        delay: 1.0,
        ease: Sine.easeInOut,
        overwrite: "all"
...
GAME.GameHUD.prototype.bonusShow = function(bonus) {
    ...
    TweenLite.to(this.bonusText, 0.4, {
        alpha: 0.0,
        ease: Sine.easeInOut,
        overwrite: "all",
        delay: 2.5
    ...
    TweenLite.to(this.bonusScoreText, 0.4, {
        alpha: 0.0,
        ease: Sine.easeInOut,
        overwrite: "all",
        delay: 2.5
...
GAME.GameHUD.prototype.levelUpdated = function(level) {
    ...
    TweenLite.to(this.nivelContainer.position, 0.2, {
        x: 0,
        ease: Sine.easeOut,
        overwrite: "all",
        onCompleteScope: this,
        onComplete: this.exitLevel
    });
}
...
GAME.GameHUD.prototype.exitLevel = function() {
    TweenLite.to(this.nivelContainer.position, 0.2, {
        ...
        overwrite: "all",
        delay: 1.4,
        onCompleteScope: this.nivelContainer,
