...
GAME.MenuScene = function(container, width, height) {
    ...
    this.play.position.y = defaultHeight * 0.8;
    ...
    this.play.touchstart = function(touchData) {
        ...
        TweenLite.to(this, 0.2, {
            rotation: Math.random() * Math.PI * 0.05 * plusOrMinus,
            ease: Sine.easeInOut,
            overwrite: "all"
        });
    ...
    this.hamstersTypes = ["Robert Jr.", //0
        "Missy", //1
        "Sir Siegfried", //2
        "Satoshi Tajiri", //3
        "Sussy Yo-ho", //4
    ...
    for (i = 0; i < this.hamstersTypes.length; i++) {
        ...
        var objectText = new PIXI.BitmapText(hamsterType, {
    ...
    this.unlockedMessage = new PIXI.BitmapText(_("Unlocked"), {
        font: "Tienda_Texto",
        align: "left"
    });
    ...
    this.conditionsText = new PIXI.BitmapText(_("Level needed"), {
        font: "Tienda_Texto",
        align: "left"
    });
    ...
    this.actualZombiesText = new PIXI.BitmapText(gameEngine.userStorage.score + "", {
    ...
    this.requiredZombiesText = new PIXI.BitmapText(" / " + this.conditionsBestScores[this.actualHamsterIndex], {
...
GAME.MenuScene.prototype.onEnter = function() {
    ...
    TweenLite.to(this.logoGrenades.scale, 0.9, {
        x: 1,
        y: 1,
        delay: 0.4,
        ease: Bounce.easeOut,
    ...
    TweenLite.to(this.logoGrenades, 0.3, {
        alpha: 1,
        delay: 0.4,
        ease: Circ.easeIn,
        overwrite: "all",
        onComplete: this.hamsterAppear,
...
GAME.MenuScene.prototype.hamsterAppear = function() {
    TweenLite.to(this.icon.position, 0.25, {
        y: defaultHeight * 0.5,
        ease: Sine.easeOut,
        overwrite: "all",
        onComplete: this.hamsterAppearStep,
        onCompleteScope: this
    });
...
GAME.MenuScene.prototype.hamsterAppearStep = function() {
    ...
    TweenLite.to(this.icon.position, 0.3, {
        y: defaultHeight * 0.43,
        ease: Sine.easeOut,
        overwrite: "all"
    });
}
...
GAME.MenuScene.prototype.selectHamster = function() {
    if (gameEngine.userStorage.level >= this.conditionsBestScores[this.actualHamsterIndex]) {
        ...
        TweenLite.to(this.flashBlanco, 0.4, {
            alpha: 0,
            ease: Sine.easeIn,
            overwrite: "all"
        });
...
GAME.MenuScene.prototype.goNext = function() {
    if (this.actualHamsterIndex < this.hamstersTypes.length - 1) {
        ...
        if (this.actualHamsterIndex == this.hamstersTypes.length - 1) {
            this.nextButton.filters = [new PIXI.GrayFilter()];
            this.nextButton.alpha = 0.3;
            TweenLite.to(this.nextButton, 0.4, {
                rotation: 0,
                ease: Sine.easeInOut,
                overwrite: "all"
            });
            TweenLite.to(this.nextButton.scale, 0.2, {
                x: 0.9,
                y: 0.9,
                ease: Sine.easeInOut,
                overwrite: "all"
        ...
        TweenLite.to(this.hamstersContainer.position, 0.4, {
            x: -this.actualHamsterIndex * defaultWidth,
            ease: Circ.easeOut,
            overwrite: "all",
            onComplete: this.hide,
            onCompleteScope: this.hamstersArray[this.actualHamsterIndex - 1]
        });
...
GAME.MenuScene.prototype.showConditions = function() {
    if (gameEngine.userStorage.level < this.conditionsBestScores[this.actualHamsterIndex]) {
        ...
        TweenLite.to(this.selectButton, 0.4, {
            rotation: 0,
            ease: Sine.easeInOut,
            overwrite: "all"
        });
        TweenLite.to(this.selectButton.scale, 0.2, {
            x: 0.9,
            y: 0.9,
            ease: Sine.easeInOut,
            overwrite: "all"
...
GAME.MenuScene.prototype.goBack = function() {
    if (this.actualHamsterIndex > 0) {
        ...
        if (this.actualHamsterIndex == 0) {
            this.backButton.filters = [new PIXI.GrayFilter()];
            this.backButton.alpha = 0.3;
            TweenLite.to(this.backButton, 0.4, {
                rotation: 0,
                ease: Sine.easeInOut,
                overwrite: "all"
            });
            TweenLite.to(this.backButton.scale, 0.2, {
                x: 0.9,
                y: 0.9,
                ease: Sine.easeInOut,
                overwrite: "all"
...
GAME.MenuScene.prototype.goShop = function() {
    ...
    this.tweenGoShop1 = TweenLite.to(this.homeContainer.position, 0.3, {
        x: -defaultWidth,
        ease: Circ.easeOut,
        overwrite: "all"
    });
    this.tweenGoShop2 = TweenLite.to(this.shopContainer.position, 0.3, {
        x: 0,
        ease: Circ.easeOut,
        overwrite: "all"
    });
...
GAME.MenuScene.prototype.goHome = function() {
    ...
    this.tweenGoHome1 = TweenLite.to(this.homeContainer.position, 0.3, {
        x: 0,
        ease: Circ.easeOut,
        overwrite: "all"
    });
    this.tweenGoHome2 = TweenLite.to(this.shopContainer.position, 0.3, {
        x: defaultWidth,
        ease: Circ.easeOut,
        overwrite: "all"
    });
...
GAME.MenuScene.prototype.touchInfo = function() {
    if (!this.infoContainer.visible) {
        ...
        TweenLite.to(this.infoMessage.position, 0.5, {
            y: 0,
            ease: Circ.easeOut,
            overwrite: "all"
        });
        TweenLite.to(this.cuadroNegro, 0.5, {
            alpha: 0.8,
            ease: Sine.easeInOut,
            overwrite: "all"
        });
