...
GAME.Engine.prototype.transitionScene = function(game_mode) {
    if (this.sideEffect) TweenLite.to(this.hamsterCortina.position, 0.7, {
        x: this.width * 0.5 + defaultWidth * 0.5 + this.hamsterCortina.width * 0.5,
        ease: Sine.easeOut,
        onStartScope: this,
        onStart: this.startTransitionScene,
        onStartParams: [game_mode],
        onCompleteScope: this,
        onComplete: this.endTranstition,
        overwrite: "all"
    });
    else TweenLite.to(this.hamsterCortina.position, 0.7, {
        x: this.width * 0.5 - defaultWidth * 0.5 - this.hamsterCortina.width * 0.5,
        ease: Sine.easeOut,
        onStartScope: this,
        onStart: this.startTransitionScene,
...
GAME.Engine.prototype.changeSceneTo = function(game_mode) {
    if (!this.inTransition) {
        ...
        TweenLite.to(this.hamsterCortina.position, 0.7, {
            x: this.width * 0.5,
            ease: Sine.easeIn,
            onCompleteScope: this,
            onCompleteParams: [game_mode],
            onComplete: this.transitionScene,
            overwrite: "all"
        });
