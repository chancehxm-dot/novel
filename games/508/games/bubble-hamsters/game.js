...
(function(e) {
    ...
    function n(e) {
        if (e = e || {}, this.IS_MASTER = e.isMaster || !1, !this.IS_MASTER)
            throw Error("The DataStore can only be instantiated by the Master");
        this.dataStore = {}
    }

    function i(e, t) {
        if (this.IS_MASTER = e && e.isMaster ? e.isMaster : !1, this.IS_SLAVE = !this.IS_MASTER, this.messenger = null, this.subscribers = {}, this.moduleReady = t ? t : !1, this.data = e.data || null, this.gameState = "resume", !e || !e.messenger)
    ...
    function f(e, n, l, c, d) {
        window.outerHeight - window.innerHeight, this.version = "0.17.4", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new e({
            isMaster: !0
    ...
    (function(e) {
        ...
        function A(e, t) {
            rt && (at.push(e), t && t.stack !==
                void 0 ? it.push(t.stack) : it.push("(no stack) " + t))
        }
                ...
                function e() {
                    for (; t.next;) {
                        ...
                        try {
                            ...
                            if (r)
                                throw a && a.exit(), setTimeout(e, 0), a && a.enter(), s;
                            setTimeout(function() {
                                throw s
                            }, 0)
                        }
        ...
        c.resetUnhandledRejections = b, c.getUnhandledReasons = function() {
        ...
        }, c.async = L, c.spawn = P, c["return"] = N, c.promised = G, c.dispatch = O, g.prototype.dispatch = function(e, t) {
            var n = this,
                i = d();
            return W(function() {
            ...
            "object" == typeof process && process && process.domain && (a = process.domain.bind(a)), r.then(
                void 0, a)
            ...
            var e = K(arguments);
            return e.unshift(this), c.denodeify.apply(
                void 0, e)
            ...
            var e = K(arguments, 0);
            return e.unshift(this), c.nbind.apply(
                void 0, e)
    ...
    v.argsToArray = function(e) {
            ...
            if (e) {
                ...
                t ? (window.onkeydown = this.disableKeys, this.trackGA(), n = {
                    IS_MASTER: !1,
                    IS_SLAVE: !0,
                    IS_STANDALONE: !1
            ...
            return
            void 0 !== (window.PhoneGap || window.cordova || window.Cordova)
    ...
    S.getGameConfig = function() {
        ...
        if (e ===
            void 0 || e.url ===
            void 0 || "string" != typeof e.url || e.action ===
            void 0 || "function" != typeof e.action)
            return e.callback !==
                void 0 || "function" == typeof e.callback ? (e.callback(),
                    void 0) :
                void 0;
        ...
        if (!this.moduleReady)
            throw Error("This method cannot be called before the API is loaded");
        this.IS_MASTER ? "function" == typeof SpilGames && SpilGames.Events !==
            void 0 && "function" == typeof SpilGames.Events.publish && SpilGames.Events.publish("portal.adjustheight", {
                height: e,
                onsuccess: function() {}
            }) : (this.messenger._postMessage(e,
                void 0, "gameapi.game.adjustHeight"), this.messenger._postMessage(["log.gameapi.game.adjustHeight", {
                origin: "slave",
                height: e
            }, null], null, "log"))
        ...
        if (!this.moduleReady)
            throw Error("This method cannot be called before the API is loaded");
        this.IS_MASTER ? "function" == typeof SpilGames && SpilGames.Portal !==
            void 0 && "function" == typeof SpilGames.Portal.forceAuthentication && SpilGames.Portal.forceAuthentication({
                onsuccess: function() {}
        ...
        if (!this.moduleReady)
            throw Error("This method cannot be called before the API is loaded");
        if (this.IS_MASTER)
            "function" == typeof SpilGames ? SpilGames(["JSLib"], function(e) {
            ...
            this.usercallback = e, t._postMessage({},
                void 0, "gameapi.user.getUser"), t._postMessage(["log.gameapi.user.getUser", {
                origin: "slave",
        ...
        if (!this.moduleReady)
            throw Error("This method cannot be called before the API is loaded");
        this.IS_MASTER ? "function" == typeof SpilGames && SpilGames.Events !==
            void 0 && "function" == typeof SpilGames.Events.publish && SpilGames.Events.publish("invitefriends.request") : (this.messenger._postMessage({},
        ...
        if (this.IS_MASTER) {
            ...
            "function" == typeof e && (this.friendscallback = e), t._postMessage({},
                void 0, "gameapi.friends.getFriends"), t._postMessage(["log.gameapi.friends.getFriends", {
                origin: "slave"
            }, null], null, "log")
    }, r.prototype._getFriendsFromPortal = function(e, t) {
        ...
        if ("function" == typeof SpilGames) {
            ...
            SpilGames("api.friend.list", {
                ...
                e.error ? n._postMessage(i,
                    void 0, "gameapi.friends.getFriendsResponse") : (i = i.concat(e.friendList), e.pageControl && e.pageControl.totalPages > t ? a._getFriendsFromPortal(i, t + 1) : n._postMessage({
                        friendList: i
                    },
                    void 0, "gameapi.friends.getFriendsResponse"))
            })
        ...
        if (this.IS_MASTER) {
            ...
            this.messenger._postMessage(e,
                void 0, "gameapi.score"), this.messenger._postMessage(["log.gameapi.score.submit", {
                origin: "slave",
                score: e
            }, null], null, "log");
        return {
        ...
        if (this.IS_MASTER) {
            ...
            this.messenger._postMessage(e,
                void 0, "gameapi.award"), this.messenger._postMessage(["log.gameapi.award.submit", {
                origin: "slave",
                award: t
            }, null], null, "log");
        return {
        ...
        this.isMaster ? (SpilGames(["JSLib"], function(t) {
            t.subscribe("ad.request.accepted", function(t) {
                !0 === t && (SpilGames("game.ad.accepted", !0), e._postMessage(!0,
                    void 0, "ad.request.accepted"))
        ...
        if (!this.moduleReady)
            throw Error("This method cannot be called before the API is loaded");
        this._callbacks.pause = e, this._callbacks.resume = t, this.messenger._postMessage(
            void 0,
            void 0, "game.ad.request"), this.isMaster || this.messenger._postMessage(["log.gameapi.ad.requested", {
            origin: "slave"
        ...
        this._validateEvent(e) ? this.IS_MASTER ? "function" == typeof SWFtoJS && SWFtoJS({
            ...
            void 0, "gameapi.gameevent"), this.messenger._postMessage(["log.gameapi.gameevent.emit", {
            origin: "slave",
            evt: e
        ...
        return this.IS_STANDALONE ? v.submitData("/ut/", t, n) : this.messenger && (this.IS_SLAVE || v.isWrapped()) && this.messenger.post("tracker.event." + e, t, n), t
        ...
        var t, n, i, a, r = this,
            s = new p(e.data);
        if (s)
            if (t = s.type, n = s.callbackId, i = s.data, a = this._callbacks[n] || !1, this.IS_MASTER)
                switch (t) {
                    case "jslib":
            ...
            this.IS_SLAVE && ("function" == typeof a ? (
                delete this._callbacks[n], a(i)) : "datachange" === t || "jslib" !== t && this.publish(t, i));
        return !1
    }, g.prototype._handleUGARequest = function(e) {
        var t, n, i, a = this,
            r = new p(e.data);
        if (r)
            switch (t = r.data[0], n = r.callbackId, i = r.data[1] ? r.data[1] : null, t) {
                case "GameAPI.data":
        ...
        if (t !==
            void 0 && t.id !==
            void 0 && "576742227280293562" === t.id && (window.onkeydown = null), "function" != typeof e)
