function CMenu() {
    ...
    this._init = function () {
        ...
        _oButPlay = new CGfxButton(CANVAS_WIDTH / 2, 900, oSpritePlay);
        ...
        createjs.Tween.get(_oLogo).wait(300).to({y: CANVAS_HEIGHT_HALF - 200}, 1000, createjs.Ease.bounceOut)
        ...
        _ositelogo = new CTextButton((CANVAS_WIDTH/2),CANVAS_HEIGHT -300,oSprite,' ',"blackplotan","#ffffff",130);
        _ositelogo.addEventListener(ON_MOUSE_UP, this._onSiteLogoRelease, this);
    };

    this._onSiteLogoRelease = function(){
		CreateLinksInGame('Tetris-Cube','pregame','logo');
    };
