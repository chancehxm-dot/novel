...
(function(d) {
    ...
    (egret = {}));
var __extends = this.__extends || function(d, f) {
    function e() {
        this.constructor = d
    }
...
(function(d) {
    function f(c) {
        ...
        if (a = d.egret_string_code[c])
            for (var g = b.length, w = 0; w < g; w++) a = a.replace("{" + w + "}", b[w]);
        return a
    }
    ...
    var e = function() {
        ...
        c.openLogByType = function(b) {
            ...
            switch (b) {
                ...
                case c.WARN:
                    console.info = function() {}, console.log =
                        function() {};
                case c.INFO:
        ...
        c.fatalWithErrorId = function(b) {
            ...
            a.unshift(b);
            (a = f.apply(null, a)) ? c.fatal(a): c.warning(f(-1, b))
        };
        c.infoWithErrorId = function(b) {
            for (var a = [], g = 1; g < arguments.length; g++) a[g - 1] = arguments[g];
            a.unshift(b);
            (a = f.apply(null, a)) ? c.info(a): c.warning(f(-1, b))
        };
        c.warningWithErrorId = function(b) {
            for (var a = [], g = 1; g < arguments.length; g++) a[g - 1] = arguments[g];
            a.unshift(b);
            (a = f.apply(null, a)) ? c.warning(a): c.warning(f(-1,
                b))
        };
        c.traceToConsole = function(b, a, g) {
            console.log(d.Logger.getTraceCode(b, a, g))
        };
        c.getTraceCode = function(b, a, g) {
            return "[" + b + "]" + a + (null == g ? "" : ":" + g)
        };
        c.ALL = "all";
        c.DEBUG = "debug";
...
(function(d) {
    var f = function(d) {
        ...
        b.push = function(a) {
            var g = this.objectPool; -
            1 == g.indexOf(a) && (g.push(a), a.__recycle && a.__recycle(), this._length++, 0 == this.frameCount &&
...
(function(d) {
    var f = function() {
        ...
        e.push = function(b, a) {
            var g;
            g = e.__freeList.length ? e.__freeList.pop() : new d.RenderCommand;
            g.callback = b;
            g.thisObject = a;
            d.MainContext.__DRAW_COMMAND_LIST.push(g)
        };
        e.__freeList = [];
        return e
    }();
...
(function(d) {
    var f = function(e) {
        ...
        c._dispatchByTarget = function(a, g, b, c, e, f) {
            void 0 === e && (e = !1);
            void 0 === f && (f = !1);
            ...
            m._cancelable = f;
            if (c)
                for (var l in c) m[l] = c[l], null !== m[l] && (c[l] = null);
            a = g.dispatchEvent(m);
            h.push(m);
            return a
        };
...
(function(d) {
    var f = function(e) {
        function c(a, g, b, c, d, f, h, m, l, n) {
            void 0 === g && (g = !0);
            void 0 === b && (b = !0);
            void 0 === c && (c = 0);
            void 0 === d && (d = 0);
        ...
        c.dispatchTouchEvent = function(a,
            ...
            n.shiftKey = m;
            n.touchDown = l;
            d.Event._dispatchByTarget(c, a, g, n, !0, !0)
        };
...
(function(d) {
    var f = function(e) {
        ...
        __extends(c, e);
        c.dispatchTextEvent = function(b, a, g) {
            var w = d.Event._getPropertyData(c);
            w.text = g;
            d.Event._dispatchByTarget(c, b, a, w)
        };
        c.LINK = "link";
        return c
    }(d.Event);
...
(function(d) {
    var f = function(e) {
        ...
        __extends(c, e);
        c.dispatchProgressEvent = function(b, a, g, w) {
            void 0 === g && (g = 0);
            void 0 === w && (w = 0);
            d.Event._dispatchByTarget(c, b, a, {
                bytesLoaded: g,
...
(function(d) {
    var f = function(e) {
        ...
        b.addEventListener = function(a, g, b, c, e) {
            ...
            g || d.Logger.fatalWithErrorId(1010);
            ...
            var f = c[a];
            f || (f = c[a] = []);
            this._insertEventBin(f, g, b, e)
        };
        b._insertEventBin = function(a, g, b, c, d) {
            void 0 === d && (d = void 0);
            for (var e = -1, f = a.length, m = 0; m < f; m++) {
                var l = a[m];
                if (l.listener == g && l.thisObject == b && l.display == d) return !1; -
                1 == e && l.priority < c && (e = m)
            }
            g = {
                listener: g,
                thisObject: b,
        ...
        b._removeEventBin = function(a, g, b, c, d) {
            ...
            for (var e = a.length; d < e; d++) {
                var f = a[d];
                if (f.listener == g && f.thisObject == b && f.display == c) return a.splice(d, 1), !0
            }
            return !1
        };
        ...
        b.dispatchEventWith = function(a, g, b) {
            void 0 === g && (g = !1);
            d.Event.dispatchEvent(this, a, g, b)
        };
        return c
    }(d.HashObject);
    d.EventDispatcher = f;
    ...
    var f = function(e) {
        ...
        b.renderLoop =
            function(a) {
                if (0 < d.__callLaterFunctionList.length) {
                    var g = d.__callLaterFunctionList;
                    d.__callLaterFunctionList = [];
                    var b = d.__callLaterThisList;
                    d.__callLaterThisList = [];
                    var s = d.__callLaterArgsList;
                    d.__callLaterArgsList = []
                }
                a = this.stage;
                var e = c.cachedEvent;
                ...
                e._type = d.Event.FINISH_UPDATE_TRANSFORM;
                this.dispatchEvent(e);
                c.__use_new_draw ? this._draw(g) : a._draw(g);
                e._type = d.Event.FINISH_RENDER;
                this.dispatchEvent(e);
                this._profileInstance._isRunning && this._profileInstance._drawProfiler(g);
                g.onRenderFinish()
            };
        b._draw = function(a) {
            for (var g = c.__DRAW_COMMAND_LIST, b = g.length, d = 0; d < b; d++) {
                var e = g[d];
                e.call(a);
                e.dispose()
            }
        ...
        b.broadcastEnterFrame =
            function(a) {
                ...
                for (var g = d.DisplayObject._enterFrameCallBackList.concat(), b = g.length, c = 0; c < b; c++) {
                    var e = g[c];
                    a._target = e.display;
                    a._currentTarget = e.display;
                    e.listener.call(e.thisObject, a)
                }
                g = d.Recycler._callBackList;
                for (c = g.length - 1; 0 <= c; c--) g[c]._checkFrame()
            };
        b.broadcastRender = function() {
            var a = this.reuseEvent;
            a._type = d.Event.RENDER;
            for (var g = d.DisplayObject._renderCallBackList.concat(), b = g.length, c = 0; c < b; c++) {
                var e = g[c],
                    f = e.display;
                a._target = f;
                a._currentTarget = f;
...
(function(d) {
    var f = function(e) {
        ...
        b.setTimeout = function(a, g, b) {
            ...
            d.setTimeout.apply(null, [a, g, b].concat(c))
        };
...
(function(d) {
    ...
    d.getDefinitionByName = function(d) {
        ...
        var c = f[d];
        if (c) return c;
        for (var b = d.split("."), a = b.length, c = __global, g = 0; g < a; g++)
            if (c = c[b[g]], !c) return null;
        return f[d] = c
    }
})(egret || (egret = {}));
...
(function(d) {
    ...
    var e = {},
        c = 0;
    d.setTimeout = function(b, a, g) {
        for (var w = [], s = 3; s < arguments.length; s++) w[s - 3] = arguments[s];
        w = {
            listener: b,
            thisObject: a,
            delay: g,
        ...
        0 == c && d.Ticker.getInstance().register(f, null);
        c++;
        e[c] = w;
        return c
    };
    ...
    var f = function(e) {
        ...
        b.append = function(a, g, b, c, d, e) {
            var f = this.a,
                ...
                l = this.c,
                n = this.d;
            if (1 != a || 0 != g || 0 != b || 1 != c) this.a = a * f + g * l, this.b = a * m + g * n, this.c = b * f + c * l, this.d = b * m + c * n;
            this.tx = d * f + e * l + this.tx;
            this.ty = d * m + e * n + this.ty;
            return this
        };
        b.prependTransform = function(a, g, b, c, e, f, h, m, l) {
            if (e % 360) {
                var n = d.NumberUtils.cos(e);
                e = d.NumberUtils.sin(e)
            } else n = 1, e = 0;
            if (m || l) this.tx -= m, this.ty -= l;
            f || h ? (this.prepend(n * b, e * b, -e * c, n * c, 0, 0), this.prepend(d.NumberUtils.cos(h), d.NumberUtils.sin(h), -d.NumberUtils.sin(f), d.NumberUtils.cos(f),
                a, g)) : this.prepend(n * b, e * b, -e * c, n * c, a, g);
            return this
        };
        b.appendTransform = function(a, g, b, c, e, f, h, m, l) {
            if (e % 360) {
                var n = d.NumberUtils.cos(e);
                e = d.NumberUtils.sin(e)
            } else n = 1, e = 0;
            f || h ? (this.append(d.NumberUtils.cos(h), d.NumberUtils.sin(h), -d.NumberUtils.sin(f), d.NumberUtils.cos(f), a, g), this.append(n * b, e * b, -e * c, n * c, 0, 0)) : this.append(n * b, e * b, -e * c, n * c, a, g);
            if (m || l) this.tx -= m * this.a + l * this.c, this.ty -= m * this.b + l * this.d;
            return this
        };
        b.rotate = function(a) {
            var g = Math.cos(a);
        ...
        b.skew = function(a, g) {
            this.append(d.NumberUtils.cos(g), d.NumberUtils.sin(g), -d.NumberUtils.sin(a), d.NumberUtils.cos(a), 0, 0);
            return this
        };
        ...
        c.transformCoords = function(a, g, b) {
            var c = d.Point.identity;
            c.x = a.a * g + a.c * b + a.tx;
            c.y = a.d * b + a.b * g + a.ty;
            return c
        };
    ...
    var f = function(e) {
        ...
        b.parserXML = function(a) {
            ...
            this._isSupportDOMParser ?
                g = this._parser.parseFromString(a, "text/xml") : (g = new ActiveXObject("Microsoft.XMLDOM"), g.async = "false", g.loadXML(a));
            null == g && d.Logger.infoWithErrorId(1015);
            return g
        };
        c._instance = null;
        return c
...
(function(d) {
    ...
    var c = function() {
        ...
        c._setupContainer = function() {
            var a = document.body,
                g;
            a && (g = a.style) && (g.paddingTop = g.paddingTop || "0px", g.paddingRight = g.paddingRight || "0px", g.paddingBottom =
                g.paddingBottom || "0px", g.paddingLeft = g.paddingLeft || "0px", g.borderTop = g.borderTop || "0px", g.borderRight = g.borderRight || "0px", g.borderBottom = g.borderBottom || "0px", g.borderLeft = g.borderLeft || "0px", g.marginTop = g.marginTop || "0px", g.marginRight = g.marginRight || "0px", g.marginBottom = g.marginBottom || "0px", g.marginLeft = g.marginLeft || "0px")
        };
        return a
    }();
    ...
    e = function() {
        ...
        b.init = function(a) {};
        b._apply = function(a, g, b) {};
        b.setEgretSize = function(a, g, b, c, w, e) {
            void 0 === e && (e = 0);
            d.StageDelegate.getInstance()._stageWidth = Math.round(a);
            d.StageDelegate.getInstance()._stageHeight = Math.round(g);
            a = document.getElementById(f.canvas_div_name);
            g = document.getElementById(f.egret_root_div);
            a || (a = d.Browser.getInstance().$new("div"),
                a.id = f.canvas_div_name, g.appendChild(a));
            a.style.width = b + "px";
            a.style.height = c + "px";
            g.style.width = b + "px";
            g.style.height = c + "px";
        ...
        b.prototype._apply =
            function(a, g, b) {
                ...
                var c = this._getClientHeight(),
                    ...
                    w = g / d,
                    e = 1;
                0 != this.minWidth && (e = Math.min(1, w / this.minWidth));
                this.setEgretSize(w / e, b, g, c * e);
                a._scaleX = d * e;
                a._scaleY = d * e
            };
        return b
    ...
    a = function(a) {
        ...
        b.prototype._apply = function(a, g, b) {
            ...
            this.setEgretSize(g, w / e, b * e, c, b * (1 - e) / 2);
            a._scaleX = d * e;
            a._scaleY = d * e
        };
        return b
    ...
    a = function(a) {
        ...
        b.prototype._apply = function(a, g, b) {
            ...
            this.setEgretSize(g, b / 1, 1 * w, e, c, a._offSetY);
            a._scaleX = 1 * f;
            a._scaleY = 1 * f
        };
        return b
...
(function(d) {
    var f = function(e) {
        ...
        b.drawImage = function(a, g, b, e, f, k, h, m, l, n, p) {
            void 0 === p && (p = void 0);
            h = h || 0;
            m = m || 0;
            var r = g._texture_to_render;
            if (null != r && 0 != k && 0 != f && 0 != l && 0 != n) {
                ...
                if (0 != this._drawAreaList.length && d.MainContext.instance.rendererContext._cacheCanvasContext) {
                    q = d.DisplayObject.getTransformBounds(g._getSize(c.identityRectangle), g._worldTransform);
                    ...
                    for (var u = this.getDrawAreaList(), x = 0; x < u.length; x++)
                        if (!this.ignoreRender(g, u[x], q.destX, q.destY)) {
                            a.drawImage(r, b, e, f, k, h, m, l, n, p);
                            break
                        }
                } else a.drawImage(r, b, e, f, k, h, m, l, n, p)
            }
        };
...
(function(d) {
    var f = function() {
        ...
        e.getInstance = function(c, b) {
            ...
            if (g) return g = new g, this.mapValueDic[a] = g, delete this.mapClassDic[a], g;
...
(function(d) {
    var f = function(e) {
        ...
        Object.defineProperty(b, "scaleY", {
            ...
            set: function(a) {
                d.NumberUtils.isNumber(a) &&
                    this._scaleY != a && (this._scaleY = a, this._setDirty(), this._setParentSizeDirty())
            },
            enumerable: !0,
            configurable: !0
        });
        ...
        Object.defineProperty(b, "anchorOffsetY", {
            ...
            set: function(a) {
                d.NumberUtils.isNumber(a) && this._anchorOffsetY !=
                    a && (this._anchorOffsetY = a, this._setDirty(), this._setParentSizeDirty())
            },
            enumerable: !0,
            configurable: !0
        });
        ...
        Object.defineProperty(b, "rotation", {
            ...
            set: function(a) {
                d.NumberUtils.isNumber(a) && this._rotation !=
                    a && (this._rotation = a, this._setDirty(), this._setParentSizeDirty())
            },
            enumerable: !0,
            configurable: !0
        });
        ...
        Object.defineProperty(b, "skewX", {
            ...
            set: function(a) {
                d.NumberUtils.isNumber(a) && this._skewX != a && (this._skewX = a, this._setDirty(),
        ...
        b._draw = function(a) {
            if (this._visible && !this.drawCacheTexture(a)) {
                var g = d.MainContext.__use_new_draw && this._isContainer;
                this._filter && !g && a.setGlobalFilter(this._filter);
                this._colorTransform && !g && a.setGlobalColorTransform(this._colorTransform.matrix);
                ...
                this._render(a);
                b && !g && a.popMask();
                this._colorTransform && !g && a.setGlobalColorTransform(null);
                this._filter && !g && a.setGlobalFilter(null)
            }
        ...
        b.drawCacheTexture = function(a) {
            ...
            var g = this.getBounds(d.Rectangle.identity);
            if (this._cacheDirty || null == this._texture_to_render || 1 < g.width - this._texture_to_render._textureWidth ||
                1 < g.height - this._texture_to_render._textureHeight) this._cacheDirty = !this._makeBitmapCache();
            ...
            a.setAlpha(this.worldAlpha, this.blendMode);
            a.setTransform(this._worldTransform);
            d.RenderFilter.getInstance().drawImage(a, this, 0, 0, e, b, g, c, e, b);
            return !0
        };
        b._updateTransform = function() {
            this._visible && (this._calculateWorldTransform(), "updateTransform" ==
                d.MainContext._renderLoopPhase && (this.needDraw || this._texture_to_render || this._cacheAsBitmap) && d.RenderCommand.push(this._draw, this))
        };
        b._calculateWorldTransform = function() {
            var a = this._worldTransform,
                g = this._parent;
            a.identityMatrix(g._worldTransform);
            this._getMatrix(a);
            var b = this._scrollRect;
            b && a.append(1, 0, 0, 1, -b.x, -b.y);
            this.worldAlpha = g.worldAlpha * this._alpha
        };
        b._render = function(a) {};
        b.getBounds = function(a, g) {
            void 0 === g && (g = !0);
            var b = this._measureBounds(),
                c = this._hasWidthSet ? this._explicitWidth :
                b.width,
            ...
            var f = b.x,
                ...
                h = 0,
                m = 0;
            g && (0 != this._anchorX || 0 != this._anchorY ? (h = c * this._anchorX, m = e * this._anchorY) : (h = this._anchorOffsetX, m = this._anchorOffsetY));
            this._cacheBounds.initialize(f - h, b - m, c, e);
            c = this._cacheBounds;
            a || (a = new d.Rectangle);
        ...
        b.destroyCacheBounds = function() {
            ...
            this._cacheBounds.width =
                0;
            this._cacheBounds.height = 0
        };
        b._getConcatenatedMatrix = function() {
            for (var a = c.identityMatrixForGetConcatenated.identity(), g = this; null != g;) {
                if (0 != g._anchorX || 0 != g._anchorY) {
                    var b = g._getSize(d.Rectangle.identity);
                    a.prependTransform(g._x, g._y, g._scaleX, g._scaleY, g._rotation, g._skewX, g._skewY, b.width * g._anchorX, b.height * g._anchorY)
                } else a.prependTransform(g._x, g._y, g._scaleX, g._scaleY, g._rotation, g._skewX, g._skewY, g._anchorOffsetX, g._anchorOffsetY);
                g._scrollRect && a.prepend(1, 0, 0, 1, -g._scrollRect.x, -g._scrollRect.y);
                g = g._parent
            }
            return a
        };
        ...
        b.hitTestPoint = function(a, g, b) {
            ...
            return b ? (this._hitTestPointTexture || (this._hitTestPointTexture = new d.RenderTexture),
                b = this._hitTestPointTexture, b.drawToTexture(this), 0 != b.getPixel32(a.x - this._hitTestPointTexture._offsetX, a.y - this._hitTestPointTexture._offsetY)[3] ? !0 : !1) : !!this.hitTest(a.x, a.y, !0)
        };
        b._getMatrix = function(a) {
            ...
            c ? (a.append(c.a, c.b, c.c, c.d, c.tx, c.ty), a.append(1, 0, 0, 1, -g, -b)) : a.appendTransform(this._x, this._y, this._scaleX, this._scaleY, this._rotation, this._skewX, this._skewY, g, b);
            return a
        };
        b._getSize =
            function(a) {
        ...
        b._measureBounds = function() {
            return d.Rectangle.identity.initialize(0,
                0, 0, 0)
        };
        b._getOffsetPoint = function() {
            var a = this._anchorOffsetX,
                g = this._anchorOffsetY;
            if (0 != this._anchorX || 0 != this._anchorY) g = this._getSize(d.Rectangle.identity), a = this._anchorX * g.width, g = this._anchorY * g.height;
        ...
        b.addEventListener = function(a, g, b, s, f) {
            void 0 === s && (s = !1);
            void 0 === f && (f = 0);
            e.prototype.addEventListener.call(this, a, g, b, s, f);
            ((s = a == d.Event.ENTER_FRAME) || a == d.Event.RENDER) && this._insertEventBin(s ? c._enterFrameCallBackList : c._renderCallBackList, g, b, f, this)
        };
        b.removeEventListener = function(a, g, b, s) {
            void 0 === s && (s = !1);
            e.prototype.removeEventListener.call(this, a, g, b, s);
            ((s = a == d.Event.ENTER_FRAME) || a == d.Event.RENDER) && this._removeEventBin(s ?
                c._enterFrameCallBackList : c._renderCallBackList, g, b, this)
        };
        b.dispatchEvent = function(a) {
            if (!a._bubbles) return e.prototype.dispatchEvent.call(this, a);
            for (var g = [], b = this; b;) g.push(b), b = b._parent;
            a._reset();
        ...
        b._dispatchPropagationEvent = function(a, g, b) {
            ...
            if (!a._isPropagationStopped && !a._isPropagationImmediateStopped)
                for (c = 3, d = 1; d < b && (e = g[d], a._currentTarget = e, a._target = this, a._eventPhase = c, e._notifyListener(a), !a._isPropagationStopped && !a._isPropagationImmediateStopped); d++);
        };
        b.willTrigger = function(a) {
            for (var g = this; g;) {
        ...
        Object.defineProperty(b, "cacheAsBitmap", {
            ...
            set: function(a) {
                (this._cacheAsBitmap =
                    a) ? d.callLater(this._makeBitmapCache, this): this._texture_to_render = null
            },
            enumerable: !0,
            configurable: !0
        });
        ...
        c.getTransformBounds = function(a, g) {
            var b = a.x,
                c = a.y,
                d = a.width,
                e = a.height;
            (b || c) && g.appendTransform(0, 0, 1, 1, 0, 0, 0, -b, -c);
            var f = d * g.a,
                d =
                d * g.b,
                m = e * g.c,
                ...
                u = n;
            (b = f + l) < p ? p = b : b > r && (r = b);
            (b = f + m + l) < p ? p = b : b > r && (r = b);
            (b = m + l) < p ? p = b : b > r && (r = b);
            (c = d + n) < q ? q = c : c > u && (u = c);
            (c = d + e + n) < q ? q = c : c > u && (u = c);
            (c = e + n) < q ? q = c : c > u && (u = c);
            return a.initialize(p, q, r - p, u - q)
        };
    ...
    f = function() {
        ...
        d.prototype.updateColor = function(c, b, a, g, d, e, f, k) {};
        return d
    }();
    d.ColorTransform = f;
...
(function(d) {
    var f = function(e) {
        ...
        b._doAddChild = function(a, g, b) {
            void 0 === b && (b = !0);
            if (a == this) return a;
            if (0 > g || g > this._children.length) return d.Logger.fatalWithErrorId(1007), a;
            var e = a._parent;
            if (e ==
                this) return this.doSetChildIndex(a, g), a;
            if (e) {
            ...
            if (this._stage)
                for (a._onAddToStage(), g = c.__EVENT__ADD_TO_STAGE_LIST; 0 < g.length;) e = g.shift(), b && e.dispatchEventWith(d.Event.ADDED_TO_STAGE);
            a._setDirty();
            this._setSizeDirty();
            return a
        };
        ...
        b._doRemoveChild = function(a, g) {
            ...
            var b = this._children,
                e = b[a];
            g && e.dispatchEventWith(d.Event.REMOVED, !0);
            if (this._stage) {
                e._onRemoveFromStage();
                for (var f = c.__EVENT__REMOVE_FROM_STAGE_LIST; 0 < f.length;) {
                    var k = f.shift();
                    g && k.dispatchEventWith(d.Event.REMOVED_FROM_STAGE);
                    k._stage = null
                }
            }
        ...
        b.swapChildrenAt = function(a, g) {
            0 <= a && a < this._children.length && 0 <= g && g < this._children.length ? this._swapChildrenAt(a, g) : d.Logger.fatalWithErrorId(1007)
        };
        b.swapChildren = function(a, g) {
            var b = this._children.indexOf(a),
                c = this._children.indexOf(g); -
            1 == b || -1 == c ? d.Logger.fatalWithErrorId(1008) : this._swapChildrenAt(b,
                c)
        };
        ...
        b._updateTransform = function() {
            if (this._visible) {
                ...
                a && d.RenderCommand.push(this._pushMask,
                    this);
                e.prototype._updateTransform.call(this);
                if (!this._cacheAsBitmap || !this._texture_to_render)
                    for (var g = 0, b = this._children, c = b.length; g < c; g++) b[g]._updateTransform();
        ...
        b._render = function(a) {
            if (!d.MainContext.__use_new_draw)
                for (var g = 0, b = this._children, c = b.length; g < c; g++) b[g]._draw(a)
        };
        b._measureBounds = function() {
            for (var a =
                    0, g = 0, b = 0, c = 0, e = this._children, f = e.length, h = 0; h < f; h++) {
                var m = e[h];
                if (m._visible) {
                    var l = m.getBounds(d.Rectangle.identity, !1),
                        n = l.x,
                        p = l.y,
                        r = l.width,
                        l = l.height,
                        m = m._getMatrix(),
                        m = d.DisplayObject.getTransformBounds(d.Rectangle.identity.initialize(n, p, r, l), m),
                        n = m.x,
                        p = m.y,
                        r = m.width + m.x,
                        m = m.height + m.y;
            ...
            return d.Rectangle.identity.initialize(a, b, g - a, c - b)
        };
        b.hitTest = function(a, g, b) {
            void 0 === b && (b = !1);
            var c;
            ...
            if (this._scrollRect) {
                if (a <
                    this._scrollRect.x || g < this._scrollRect.y || a > this._scrollRect.x + this._scrollRect.width || g > this._scrollRect.y + this._scrollRect.height) return null
            } else if (this.mask && (this.mask.x > a || a > this.mask.x + this.mask.width || this.mask.y > g || g > this.mask.y + this.mask.height)) return null;
            for (var f = this._children, k = this._touchChildren, h = f.length - 1; 0 <= h; h--) {
                var m = f[h],
                    l = m._getMatrix(),
                    n = m._scrollRect;
                n && l.append(1, 0, 0, 1, -n.x, -n.y);
                l.invert();
                l = d.Matrix.transformCoords(l, a, g);
                if (m = m.hitTest(l.x, l.y, !0)) {
                    if (!k) return this;
                    if (m._touchEnabled && k) return m;
                    c = this
                }
            }
            return c ? c : this._texture_to_render ? e.prototype.hitTest.call(this, a, g, b) : null
        };
        b._onAddToStage = function() {
            e.prototype._onAddToStage.call(this);
            for (var a = this._children.length, g = 0; g < a; g++) this._children[g]._onAddToStage()
        };
        b._onRemoveFromStage = function() {
            e.prototype._onRemoveFromStage.call(this);
            for (var a = this._children, g = a.length, b = 0; b < g; b++) a[b]._onRemoveFromStage()
        };
        b.getChildByName = function(a) {
            for (var g = this._children, b = g.length, c, d = 0; d < b; d++)
                if (c = g[d], c.name ==
                    a) return c;
            return null
        };
...
(function(d) {
    var f = function(e) {
        ...
        b.setResolutionPolicy = function() {
            ...
            var g = new d.EqualToFrame,
                a = new d.ResolutionPolicy(g, a);
        ...
        b.hitTest = function(a, g, b) {
            ...
            for (var e = b.length - 1; 0 <= e; e--) {
                ...
                f.invert();
                f = d.Matrix.transformCoords(f, a, g);
        ...
        c.registerScaleMode = function(a, g, b) {
            c.SCALE_MODE_ENUM[a] && !b ? d.Logger.warningWithErrorId(1009, a) : c.SCALE_MODE_ENUM[a] = g
        };
...
(function(d) {
    var f = function(e) {
        ...
        b._validatePosition = function(a, g) {
            ...
            g && (b = this.width, c = this._getContentWidth(),
                this._scrollLeft = Math.max(this._scrollLeft, (0 - b) / 2), this._scrollLeft = Math.min(this._scrollLeft, c > b ? c - b / 2 : b / 2))
        };
        b._setWidth = function(a) {
        ...
        b._checkScrollPolicy = function() {
            ...
            this._hCanScroll = a;
            var g = this.__checkScrollPolicy(this._verticalScrollPolicy, this._getContentHeight(), this.height);
            this._vCanScroll = g;
            return a || g
        };
        ...
        b._addEvents = function() {
            ...
            this.addEventListener(d.TouchEvent.TOUCH_BEGIN,
                this._onTouchBeginCapture, this, !0);
        ...
        b._onTouchBegin = function(a) {
            !a._isDefaultPrevented && this._checkScrollPolicy() && (this._touchStartPosition.x = a.stageX, this._touchStartPosition.y =
        ...
        b.dispatchPropagationEvent = function(a) {
            for (var g = [], b = a._target, c = 0; b;) b == this && (c = g.length), g.push(b), b = b.parent;
            b = g.slice(0, c);
            b = b.reverse();
            g = b.concat(g);
        ...
        b._onTouchMove = function(a) {
            if (this._lastTouchPosition.x != a.stageX || this._lastTouchPosition.y != a.stageY) {
                if (!this._scrollStarted) {
                    var g = a.stageX - this._touchStartPosition.x,
        ...
        b._calcVelocitys = function(a) {
            var g = d.getTimer();
            if (0 ==
                this._lastTouchTime) this._lastTouchTime = g;
            else {
                var b = this._getPointChange(a),
                    g = g - this._lastTouchTime;
                b.x /= g;
                b.y /= g;
        ...
        b._moveAfterTouchEnd = function() {
            if (0 != this._velocitys.length) {
                for (var a = 0, g = 0, b = 0, d = 0; d < this._velocitys.length; d++) var e = this._velocitys[d],
                    f = c.weight[d],
                    a = a + e.x * f,
                    g = g + e.y * f,
                    b = b + f;
                ...
                a = 0.02 < e ? this.getAnimationDatas(a,
                    this._scrollLeft, f) : {
                    position: this._scrollLeft,
                    duration: 1
                };
                g = 0.02 < b ? this.getAnimationDatas(g, this._scrollTop, d) : {
        ...
        b.setScrollTop = function(a, g) {
            ...
            if (0 == g) return this.scrollTop = b, null;
        ...
        b.setScrollLeft = function(a, g) {
            ...
            if (0 == g) return this.scrollLeft = b, null;
            var c = d.Tween.get(this).to({
                scrollLeft: a
            }, g, d.Ease.quartOut);
            b != a && c.to({
        ...
        b.getAnimationDatas = function(a, g, b) {
            var c = Math.abs(a),
                ...
                e = g + 500 * a;
            if (0 > e || e > b)
                for (e = g; Infinity != Math.abs(a) &&
                    0.02 < Math.abs(a);) e += a, a = 0 > e || e > b ? 0.998 * a * 0.95 : 0.998 * a, d++;
        ...
        b.cloneTouchEvent = function(a) {
            var g = new d.TouchEvent(a._type, a._bubbles, a.cancelable);
        ...
        b.hitTest = function(a, g, b) {
            void 0 === b && (b = !1);
            var c = e.prototype.hitTest.call(this, a, g, b);
            return c ? c : d.DisplayObject.prototype.hitTest.call(this, a, g, b)
        };
...
(function(d) {
    var f = function(e) {
        ...
        b._render = function(a) {
            var g = this._texture;
            g ? (this._texture_to_render = g, c._drawBitmap(a, this._hasWidthSet ? this._explicitWidth :
                g._textureWidth, this._hasHeightSet ? this._explicitHeight : g._textureHeight, this)) : this._texture_to_render = null
        };
        c._drawBitmap = function(a, g, b, d) {
            var e = d._texture_to_render;
            if (e) {
                var f = e._textureWidth,
                    h = e._textureHeight;
                if ("scale" == d.fillMode) {
                    var m = d.scale9Grid || e.scale9Grid;
                    if (m && f - m.width < g && h - m.height < b) c.drawScale9GridImage(a, d, m, g, b);
                    else {
                        var m = e._offsetX,
                            l = e._offsetY,
                            n = e._bitmapWidth || f,
                        ...
                        l = Math.round(l * b);
                        b = Math.round(p * b);
                        c.renderFilter.drawImage(a,
                            d, e._bitmapX, e._bitmapY, n, p, m, l, g, b)
                    }
                } else c.drawRepeatImage(a, d, g, b, d.fillMode)
            }
        };
        c.drawRepeatImage = function(a, g, b, c, e) {
            ...
            if (f) {
                var h = f._textureWidth,
                    ...
                    p = f._offsetX,
                    f = f._offsetY;
                d.RenderFilter.getInstance().drawImage(a, g, l, n, h, m, p, f, b, c, e)
            }
        };
        c.drawScale9GridImage = function(a, g, b, c, e) {
            ...
            if (h && b) {
                ...
                c -= m - r;
                e -= l - q;
                if (!a.drawImageScale9(h, n, p, r, q, h._offsetX, h._offsetY, c, e, b)) {
                    m = h._offsetX / f;
                    l = h._offsetY / f;
                    h = d.RenderFilter.getInstance();
                    b = d.Rectangle.identity.initialize(b.x - Math.round(m), b.y - Math.round(m), b.width, b.height);
                    m = Math.round(m);
                    l = Math.round(l);
                    ...
                    var u = n + b.x / f,
                        ...
                        q = e - (q - b.bottom),
                        r = c - (r - b.right);
                    h.drawImage(a, g, n, p, b.x, b.y, m, l, b.x, b.y);
                    h.drawImage(a, g, u, p, b.width, b.y, A, l, r - b.x, b.y);
                    h.drawImage(a, g, x, p, v, b.y, m + r, l, c - r, b.y);
                    h.drawImage(a, g, n, y, b.x, b.height, m, B, b.x, q - b.y);
                    h.drawImage(a, g, u, y, b.width, b.height, A, B, r - b.x, q - b.y);
                    h.drawImage(a, g, x, y, v, b.height, m + r, B, c - r, q - b.y);
                    h.drawImage(a, g, n, f, b.x, z, m, l + q, b.x, e - q);
                    h.drawImage(a, g, u, f, b.width, z, A, l + q, r - b.x, e - q);
                    h.drawImage(a, g, x, f, v, z, m + r, l + q, c - r, e - q)
                }
            }
        };
        b._measureBounds = function() {
...
(function(d) {
    var f = function(e) {
        ...
        b._render = function(a) {
            var g = this._getTextLines(),
                b = g.length;
            if (0 != b) {
                for (var e = this._font, f = e._getFirstCharHeight(), f = Math.ceil(f * c.EMPTY_FACTOR), k = 0, h = this._hasHeightSet ? this._explicitHeight : Number.POSITIVE_INFINITY, m = this._lineHeights,
                        l = 0; l < b; l++) {
                    var n = m[l];
                    if (0 < l && k + n > h) break;
                    for (var p = g[l], r = p.length, q = 0, u = 0; u < r; u++) {
                        var x = p.charAt(u),
                            v = e.getTexture(x);
                        if (v) {
                            var x = v._bitmapWidth || v._textureWidth,
                                y = v._bitmapHeight || v._textureHeight;
                            this._texture_to_render = v;
                            d.RenderFilter.getInstance().drawImage(a, this, v._bitmapX, v._bitmapY, x, y, q + v._offsetX, k + v._offsetY, x, y);
                            q += v._textureWidth
                        } else " " == x ? q += f : d.Logger.warningWithErrorId(1011, x)
                    }
                    k += n
                }
        ...
        b._measureBounds = function() {
            return 0 == this._getTextLines().length ?
                d.Rectangle.identity.initialize(0, 0, 0, 0) : d.Rectangle.identity.initialize(this._textOffsetX, this._textOffsetY, this._textWidth - this._textOffsetX, this._textHeight - this._textOffsetY)
        };
        b._getTextLines = function() {
            ...
            for (var b = 0, e = 0, f = 0, k = 0, h = this._hasWidthSet, m = this._hasWidthSet ? this._explicitWidth : Number.POSITIVE_INFINITY, l = this._font, n = l._getFirstCharHeight(),
                    p = Math.ceil(n * c.EMPTY_FACTOR), r = this._text.split(/(?:\r\n|\r|\n)/), q = r.length, u = !0, x = 0; x < q; x++) {
                for (var v = r[x], y = v.length, z = 0, A = 0, B = !0, D = 0; D < y; D++) {
                    var C = v.charAt(D),
                        F, G = 0,
                        H = 0,
                        E = l.getTexture(C);
                    ...
                    B && (B = !1, f = Math.min(G, f));
                    u && (k = Math.min(H, k));
                    h && 0 < D && A + C > m ? (a.push(v.substring(0, D)), g.push(z), e += z, b = Math.max(A, b), v = v.substring(D), y = v.length, D = 0, A = C, z =
                        F) : (A += C, z = Math.max(F, z))
                }
                u && (u = !1);
                a.push(v);
                g.push(z);
...
(function(d) {
    var f = function() {
        ...
        c.drawRect = function(b, a, g, c) {
            this.checkRect(b, a, g, c)
        };
        c.drawCircle = function(b, a, g) {
            this.checkRect(b - g, a - g, 2 * g, 2 * g)
        };
        c.drawRoundRect = function(b,
            a, g, c, d, e) {
            this.checkRect(b, a, g, c)
        };
        c.drawEllipse = function(b, a, g, c) {
            this.checkRect(b - g, a - c, 2 * g, 2 * c)
        };
        c.lineStyle = function(b, a, g, c, d, e, f, h) {};
        c.lineTo = function(b, a) {
            this.checkPoint(b, a)
        };
        c.curveTo = function(b, a, g, c) {
            this.checkPoint(b, a);
            this.checkPoint(g, c)
        };
        ...
        c.endFill = function() {};
        c._draw = function(b) {};
        c.checkRect = function(b, a, g, c) {
            this._firstCheck ? (this._firstCheck = !1,
                this._minX = b, this._minY = a, this._maxX = b + g, this._maxY = a + c) : (this._minX = Math.min(this._minX, b), this._minY = Math.min(this._minY, a), this._maxX = Math.max(this._maxX, b + g), this._maxY = Math.max(this._maxY, a + c))
        };
...
(function(d) {
    var f = function(e) {
        ...
        b._measureBounds = function() {
            for (var a = 0, b = 0, c = 0, e = 0, f = this._children.length, k = 0; k < f; k++) {
                var h = this._children[k];
                if (h._visible) {
                    var m =
                        h.getBounds(d.Rectangle.identity, !1),
                        l = m.x,
                        n = m.y,
                        p = m.width,
                        m = m.height,
                        h = h._getMatrix(),
                        h = d.DisplayObject.getTransformBounds(d.Rectangle.identity.initialize(l, n, p, m), h),
                        l = h.x,
                        n = h.y,
                        p = h.width + h.x,
                        h = h.height + h.y;
    ...
    var f = function() {
        ...
        e._getHalign = function(c) {
            var b = c._getLinesArr(),
                a = 0;
            c._properties._textAlign == d.HorizontalAlign.CENTER ? a = 0.5 : c._properties._textAlign == d.HorizontalAlign.RIGHT &&
                (a = 1);
        ...
        e._getValign = function(c) {
            var b = e._getTextHeight(c);
            return c._properties._type == d.TextFieldType.INPUT ? c._properties._multiline ? 0 : 0.5 : c._hasHeightSet && b < c._explicitHeight ? (b = 0, c._properties._verticalAlign ==
                d.VerticalAlign.MIDDLE ? b = 0.5 : c._properties._verticalAlign == d.VerticalAlign.BOTTOM && (b = 1), b) : 0
        };
        ...
        e._getHit = function(c, b, a) {
            ...
            for (var d = 0, e = 0, f = 0; f < g.length; f++) {
                var k = g[f];
                if (e + k.height >= a) {
                    d = f + 1;
                    break
                } else e += k.height;
                if (e + c._properties._lineSpacing >
                    a) return null;
                e += c._properties._lineSpacing
            }
            if (0 === d) return null;
            c = g[d - 1];
            for (f = a = 0; f < c.elements.length; f++)
                if (g = c.elements[f], a + g.width < b) a += g.width;
                else return {
                    lineIndex: d - 1,
                    textElementIndex: f
                };
...
(function(d) {
    var f = function(e) {
        ...
        b._setVerticalAlign = function(a) {
            this._properties._verticalAlign !=
                a && (this._setTextDirty(), this._properties._verticalAlign = a)
        };
        ...
        b.fillBackground = function() {
            var a = this._bgGraphics,
                b = this._properties;
            a && a.clear();
            if (b._background || b._border) null == a && (a = this._bgGraphics = new d.Graphics), b._background && a.beginFill(b._backgroundColor, 1), b._border && a.lineStyle(1, b._borderColor), a.drawRect(0, 0, this._getWidth(), this._getHeight()), a.endFill()
        };
        b.setFocus =
            function() {
        ...
        b._updateBaseTransform = function() {
            this._getLinesArr();
            0 == this._properties._textMaxWidth && this._properties._type != d.TextFieldType.INPUT ||
                e.prototype._updateTransform.call(this)
        };
        b._updateTransform = function() {
        ...
        b._getLinesArr = function() {
            ...
            this._isArrayChanged = !1;
            var b = this._textArr,
                c = d.MainContext.instance.rendererContext;
            ...
            for (var e = this._linesArr, f = 0, k = 0, h = 0, m = 0, l, n = 0, p = b.length; n < p; n++) {
                var r = b[n];
                r.style = r.style || {};
                for (var q = r.text.toString().split(/(?:\r\n|\r|\n)/), u = 0, x = q.length; u < x; u++) {
                    null == e[m] && (l = {
                        width: 0,
                        height: 0,
                        elements: [],
                    ...
                    var h = a._type == d.TextFieldType.INPUT ? a._size : Math.max(h, r.style.size || a._size),
                        v = !0;
                    if ("" == q[u]) u == x - 1 && (v = !1);
                    else {
                        this._isFlow && c.setupFont(this, r.style);
                        var y = c.measureText(q[u]);
                        if (this._hasWidthSet)
                            if (f + y <= this._explicitWidth) l.elements.push({
                                width: y,
                                text: q[u],
                                style: r.style
                            }), f += y, k += q[u].length, u == x - 1 && (v = !1);
                            else {
                                for (var z = v = 0, A = q[u], B = A.length; v < B; v++) {
                                    y = c.measureText(A.charAt(v));
                                    if (f + y > this._explicitWidth && 0 != f + v) break;
                                    z += y;
                                    f += y;
                                    k += 1
                                }
                        ...
                        else f += y, k += q[u].length, l.elements.push({
                            width: y,
                            text: q[u],
                            style: r.style
                        }), u == x - 1 && (v = !1)
                    ...
                    v && (k++, l.hasNextLine = !0);
                    u < q.length - 1 && (l.width =
                        f, l.height = h, l.charNum = k, a._textMaxWidth = Math.max(a._textMaxWidth, f), a._textMaxHeight += h, m++)
                }
                n == b.length - 1 && l && (l.width = f, l.height = h, l.charNum = k, a._textMaxWidth = Math.max(a._textMaxWidth, f), a._textMaxHeight += h)
            }
        ...
        b.drawText = function(a) {
            ...
            if (0 != b._textMaxWidth) {
                var e = this._hasWidthSet ? this._explicitWidth : b._textMaxWidth,
                    f = d.TextFieldUtils._getTextHeight(this),
                    k = 0,
                    h = d.TextFieldUtils._getStartLine(this);
                if (this._hasHeightSet && this._explicitHeight >
                    f) var m = d.TextFieldUtils._getValign(this),
                    k = k + m * (this._explicitHeight - f);
                for (var k = Math.round(k), f = d.TextFieldUtils._getHalign(this), m = 0, l = h, n = b._numLines; l < n; l++) {
                    var p = c[l],
                        r = p.height,
                        k = k + r / 2;
                    if (l != h) {
                        if (b._type == d.TextFieldType.INPUT && !b._multiline) break;
                        if (this._hasHeightSet && k > this._explicitHeight) break
                    }
                    for (var m = Math.round((e - p.width) * f), q = 0, u = p.elements.length; q < u; q++) {
                        var x = p.elements[q];
                        a.drawText(this, x.text, m, k + (r - (x.style.size || b._size)) / 2, x.width, x.style);
                        m += x.width
                    }
    ...
    var f = function() {
        ...
        c.addToResultArr = function(b) {
            if ("" != b) {
                ...
                a.push(["&quot;", '"']);
                a.push(["&apos;;", "'"]);
                for (var g = 0; g < a.length; g++) b.replace(new RegExp(a[g][0], "g"), a[g][1]);
        ...
        c.changeStringToObject = function(b) {
            var a = {};
            b = b.replace(/( )+/g, " ").split(" ");
            for (var g = 0; g < b.length; g++) this.addProperty(a, b[g]);
            return a
        };
        c.addProperty = function(b, a) {
            var g = a.replace(/( )*=( )*/g, "=").split("=");
            g[1] && (g[1] = g[1].replace(/(\"|\')/g,
                ""));
            switch (g[0].toLowerCase()) {
                case "color":
                    g[1] = g[1].replace(/#/, "0x");
                    b.textColor = parseInt(g[1]);
                    break;
                case "strokecolor":
                    g[1] = g[1].replace(/#/, "0x");
                    b.strokeColor = parseInt(g[1]);
                    break;
                case "stroke":
                    b.stroke = parseInt(g[1]);
                    break;
                case "b":
                    b.bold = "true" == (g[1] || "true");
                    break;
                case "i":
                    b.italic = "true" == (g[1] || "true");
                    break;
                case "size":
                    b.size = parseInt(g[1]);
                    break;
...
(function(d) {
    var f = function(e) {
        ...
        b.createTexture = function(a, b, c, e, f, k, h, m, l) {
            void 0 === k && (k = 0);
            void 0 === h && (h = 0);
            "undefined" === typeof m && (m = k + e);
            "undefined" === typeof l && (l = h + f);
            var n = this.texture._clone(),
                p = d.MainContext.instance.rendererContext._texture_scale_factor;
        ...
        b._updateProperties = function() {
            if (!this._isFocus) {
                ...
                if (null == a) this.stageText._setVisible(!1);
                    ...
                    for (var b = this._text, c = b._visible; c;) {
                        b = b.parent;
                        if (b == a) break;
                        c = b._visible
                    }
    ...
    var f = function(e) {
        ...
        b._render = function(a) {
            ...
            if (this._texture_to_render = b) {
                var d = Math.round(b._offsetX),
                    ...
                    h = Math.round(f),
                    m = Math.round(k);
                c.renderFilter.drawImage(a, this, b._bitmapX, b._bitmapY, f, k, d, e, h, m)
            }
        };
        b._measureBounds = function() {
            ...
            if (!(1 > b)) {
                for (; 1 <= b;) {
                    ...
                    if (this._nextFrameNum > this._totalFrames)
                        if (-1 == this._playTimes) this._eventPool.push(d.Event.LOOP_COMPLETE), this._nextFrameNum = 1;
        ...
        b._handlePendingEvent = function() {
            if (0 != this._eventPool.length) {
                ...
                for (var a = this._eventPool, b = a.length, c = !1, e = !1, f = 0; f < b; f++) {
                    var k = a.pop();
                    k == d.Event.LOOP_COMPLETE ? e = !0 : k == d.Event.COMPLETE ? c = !0 : this.dispatchEventWith(k)
                }
                e && this.dispatchEventWith(d.Event.LOOP_COMPLETE);
                c && this.dispatchEventWith(d.Event.COMPLETE)
            }
        };
        ...
        b._fillFrameLabelsData = function(a) {
            if (a) {
                ...
                if (0 < b) {
                    ...
                    for (var c = 0; c < b; c++) {
                        var e = a[c];
                        this.labels.push(new d.FrameLabel(e.name, e.frame))
                    }
                }
            }
        };
...
(function(d) {
    var f = function(e) {
        ...
        b.drawToTexture = function(a, b, e) {
            var f = b || a.getBounds(d.Rectangle.identity);
            ...
            var t = f.x,
                ...
                h = f.width,
                f = f.height,
                m, l, n = d.MainContext.instance.rendererContext._texture_scale_factor;
            m = h / n;
            l = f / n;
            m = Math.round(m);
            l = Math.round(l);
            ...
            e = a._anchorOffsetX;
            n = a._anchorOffsetY;
            if (0 != a._anchorX || 0 != a._anchorY) e = a._anchorX * m, n = a._anchorY * l;
            this._offsetX = t + e;
            this._offsetY = k + n;
            ...
            if (a instanceof d.DisplayObjectContainer)
                for (b = a._children, t = 0, k = b.length; t <
                    k; t++) b[t]._updateTransform();
            ...
            (k = a.mask || a._scrollRect) && this.renderContext.pushMask(k);
            ...
            c.identityRectangle.width = m;
            c.identityRectangle.height = l;
            b.addDrawArea(c.identityRectangle);
            this.renderContext.onRenderFinish();
            b._drawAreaList = t;
            this._sourceWidth = m;
            this._sourceHeight = l;
            this._textureWidth = h;
            this._textureHeight = f;
            this.end();
            return !0
        };
        b.setSize =
...
(function(d) {
    var f = function(e) {
        ...
        b.clearRect = function(a,
            b, c, d) {};
        b.drawImage = function(a, b, c, d, e, f, h, m, l, n) {
            this.profiler.onDrawImage()
        };
        b.drawImageScale9 = function(a, b, c, d, e, f, h, m, l, n) {
            return !1
        };
        ...
        c.deleteTexture = function(a) {
            ...
            if (a = a._bitmapData) {
                ...
                if (c && b)
                    for (var e in c) b.deleteTexture(c[e]);
                a.webGLTexture = null
            }
        };
        ...
        c.registerBlendModeForGL = function(a, b, e, f) {
            c.blendModesForGL[a] && !f ? d.Logger.warningWithErrorId(1005, a) : c.blendModesForGL[a] = [b, e]
        };
...
(function(d) {
    var f = function(e) {
        ...
        b.onTouchEnd = function(a, b, c) {
            var e = this.touchingIdentifiers.indexOf(c); -
            1 != e && (this.touchingIdentifiers.splice(e, 1), e = d.MainContext.instance.stage.hitTest(a, b)) && (a = this.getTouchData(c, a, b), delete this.touchDownTarget[c], c = a.beginTarget, a.target = e, this.dispatchEvent(d.TouchEvent.TOUCH_END, a), c == e ? this.dispatchEvent(d.TouchEvent.TOUCH_TAP, a) : a.beginTarget && (a.target =
                a.beginTarget, this.dispatchEvent(d.TouchEvent.TOUCH_RELEASE_OUTSIDE, a)), delete this._currentTouchTarget[a.identifier])
        };
        return c
    }(d.HashObject);
    d.TouchContext = f;
...
(function(d) {
    var f = function(e) {
        ...
        c._getUrl = function(a) {
            var b = a.url; -
            1 == b.indexOf("?") && a.method == d.URLRequestMethod.GET && a.data && a.data instanceof d.URLVariables && (b = b + "?" + a.data.toString());
            return b
        };
...
(function(d) {
    var f = function(e) {
        ...
        b.$ = function(a) {
            var b = document;
            if (a = a instanceof HTMLElement ? a : b.querySelector(a)) a.find = a.find || this.$, a.hasClass = a.hasClass || function(a) {
...
(function(d) {
    var f = function() {
        ...
        e.parse = function(c) {
            ...
            for (var b = c.childNodes.length, a = !1, g = 0; g < b; g++) {
                var f = c.childNodes[g];
                if (1 == f.nodeType) {
                    a = !0;
                    break
                }
        ...
        e.parseNode = function(c) {
            ...
            for (var a = c.attributes, g = a.length, d = 0; d < g; d++) {
                var f =
                    a[d],
                    t = f.name;
                0 != t.indexOf("xmlns:") && (b["$" + t] = f.value)
            }
            a = c.childNodes;
            g = a.length;
            for (d = 0; d < g; d++)
                if (f = e.parseNode(a[d])) b.children || (b.children = []), f.parent = b, b.children.push(f);
        ...
        e.findByPath = function(c, b, a) {
            var g = b.indexOf("."),
                d; -
            1 == g ? (d = b, g = !0) : (d = b.substring(0, g), b = b.substring(g + 1), g = !1);
            if (c = c.children)
                for (var f = c.length, t = 0; t < f; t++) {
                    var k = c[t];
                    k.localName ==
                        d && (g ? a.push(k) : e.findByPath(k, b, a))
                }
        };
...
(function(d) {
    ...
    var e = function() {
        ...
        b.encodeUTF8 = function(a) {
            ...
            for (var c = []; a.length > b;) {
                ...
                if (this.inRange(d, 55296, 57343)) this.encoderError(d);
                    ...
                    var e, f;
                    this.inRange(d, 128, 2047) ? (e = 1, f = 192) : this.inRange(d, 2048, 65535) ? (e = 2, f = 224) : this.inRange(d, 65536,
                        1114111) && (e = 3, f = 240);
        ...
        b.decodeUTF8 = function(a) {
            for (var b = 0, c = "", d, e = 0, f = 0, h = 0, m = 0; a.length > b;) {
                d = a[b++];
                if (d === this.EOF_byte) d = 0 !== f ? this.decoderError(!1) : this.EOF_code_point;
                else if (0 === f) this.inRange(d, 0, 127) || (this.inRange(d, 194, 223) ? (f = 1, m = 128, e = d - 192) : this.inRange(d, 224, 239) ? (f = 2, m = 2048, e = d - 224) : this.inRange(d, 240, 244) ? (f = 3, m = 65536, e = d - 240) : this.decoderError(!1),
                    e *= Math.pow(64, f), d = null);
                else if (this.inRange(d, 128, 191))
                    if (h += 1, e += (d - 128) * Math.pow(64, f - h), h !== f) d = null;
                    else {
                        var l = e,
                            n = m,
                            m = h = f = e = 0;
                ...
                else m = h = f = e = 0, b--, d = this.decoderError(!1, d);
        ...
        b.stringToCodePoints = function(a) {
            for (var b = [], c = 0, d = a.length; c < a.length;) {
                ...
                if (this.inRange(e, 55296, 57343))
                    if (this.inRange(e, 56320, 57343)) b.push(65533);
...
(function(d) {
    var f = function(e) {
        ...
        c.removeTweens = function(a) {
            if (a.tween_count) {
                for (var b =
                        c._tweens, d = b.length - 1; 0 <= d; d--) b[d]._target == a && (b[d].paused = !0, b.splice(d, 1));
                a.tween_count = 0
            }
        };
        c.pauseTweens = function(a) {
            if (a.tween_count)
                for (var b = d.Tween._tweens, c = b.length - 1; 0 <= c; c--) b[c]._target == a && (b[c].paused = !0)
        };
        c.resumeTweens = function(a) {
            if (a.tween_count)
                for (var b = d.Tween._tweens, c = b.length - 1; 0 <= c; c--) b[c]._target == a && (b[c].paused = !1)
        };
        c.tick = function(a, b) {
            void 0 === b && (b = !1);
        ...
        c._register = function(a, b) {
            var e = a._target,
                f = c._tweens;
            if (b) e && (e.tween_count = 0 < e.tween_count ? e.tween_count + 1 : 1), f.push(a), c._inited || (d.Ticker.getInstance().register(c.tick, null), c._inited = !0);
            else
        ...
        b.initialize = function(a, b, d) {
            ...
            b && (this._useTicks = b.useTicks, this.ignoreGlobalPause =
                b.ignoreGlobalPause, this.loop = b.loop, b.onChange && this.addEventListener("change", b.onChange, b.onChangeObj), b.override && c.removeTweens(a));
            this.pluginData = d || {};
            this._curQueueProps = {};
            ...
            for (var h in this._initQueueProps) {
                ...
                if (k = c._plugins[h])
                    for (var l = 0, n = k.length; l < n; l++) {
                        var p = k[l].tween(this, h, f, d, e, b, !!a && d == e, !a);
                        p == c.IGNORE ? m = !0 : f = p
                    }
                m || (this._target[h] = f)
            }
        ...
        b._appendQueueProps = function(a) {
            ...
            for (h in a)
                if (void 0 ===
                    this._initQueueProps[h]) {
                    d = this._target[h];
                    if (b = c._plugins[h])
                        for (e = 0, f = b.length; e < f; e++) d = b[e].init(this, h, d);
                    this._initQueueProps[h] = this._curQueueProps[h] = void 0 === d ? null : d
                }
            for (h in a) {
                d = this._curQueueProps[h];
                if (b = c._plugins[h])
                    for (k = k || {}, e = 0, f = b.length; e < f; e++) b[e].step && b[e].step(this, h, d, a[h], k);
    ...
    var f = function() {
        ...
        e.getElasticIn = function(c, b) {
            ...
            return function(d) {
                ...
                return -(c * Math.pow(2, 10 * (d -= 1)) * Math.sin((d - e) * a / b))
            }
        };
        e.getElasticOut =
            function(c, b) {
                ...
                return function(d) {
                    if (0 == d || 1 == d) return d;
                    var e = b / a * Math.asin(1 / c);
                    return c * Math.pow(2, -10 * d) * Math.sin((d - e) * a / b) + 1
                }
            };
        e.getElasticInOut = function(c, b) {
            ...
            return function(d) {
                var e = b / a * Math.asin(1 / c);
                return 1 > (d *= 2) ? -0.5 * c * Math.pow(2, 10 * (d -= 1)) * Math.sin((d - e) * a / b) : c * Math.pow(2, -10 * (d -= 1)) * Math.sin((d - e) * a / b) * 0.5 + 1
            }
        };
...
Function.prototype.bind || (Function.prototype.bind = function(d) {
    ...
    var f = Array.prototype.slice.call(arguments, 1),
        ...
        c = function() {},
        b = function() {
            return e.apply(this instanceof c && d ? this : d, f.concat(Array.prototype.slice.call(arguments)))
        };
...
(function(d) {
    var f = function(e) {
        ...
        b.registerListener = function() {
            ...
            var t, k;
            "undefined" !== typeof document.hidden ? (t = "hidden", k = "visibilitychange") : "undefined" !== typeof document.mozHidden ? (t = "mozHidden", k = "mozvisibilitychange") : "undefined" !== typeof document.msHidden ? (t = "msHidden", k = "msvisibilitychange") : "undefined" !== typeof document.webkitHidden ?
                (t = "webkitHidden", k = "webkitvisibilitychange") : "undefined" !== typeof document.oHidden && (t = "oHidden", k = "ovisibilitychange");
    ...
    var f = function(e) {
        function c(a, b) {
            ...
            var c = this.drawCanvasContext.setTransform,
                d = this;
            this.drawCanvasContext.setTransform = function(a, b, g, e, f, n) {
                d._matrixA = a;
                d._matrixB = b;
                d._matrixC = g;
                d._matrixD = e;
                d._matrixTx = f;
                d._matrixTy = n;
                c.call(d.drawCanvasContext, a, b, g, e, f, n)
            };
            this._matrixA = 1;
        ...
        b.clearScreen = function() {
            for (var a = d.RenderFilter.getInstance().getDrawAreaList(), b = 0,
                    c = a.length; b < c; b++) {
                var e = a[b];
        ...
        b.drawImage = function(a, b, c, f, t, k, h, m, l, n) {
            void 0 === n && (n = void 0);
            var p = a._bitmapData;
            k += this._transformTx;
            h += this._transformTy;
            var r = d.getTimer();
            void 0 === n ? this.drawCanvasContext.drawImage(p, b, c, f, t, k, h, m, l) : this.drawRepeatImage(a,
                b, c, f, t, k, h, m, l, n);
            e.prototype.drawImage.call(this, a, b, c, f, t, k, h, m, l, n);
            this.renderCost += d.getTimer() - r
        };
        b.drawRepeatImage = function(a, b, c, e, f, k, h, m, l, n) {
            if (void 0 === a.pattern) {
                var p = d.MainContext.instance.rendererContext._texture_scale_factor,
                    r = a._bitmapData,
                    q = r;
                if (r.width != e || r.height != f || 1 != p) q = document.createElement("canvas"), q.width = e * p, q.height = f * p, q.getContext("2d").drawImage(r, b, c, e, f, 0, 0, e * p, f * p);
                b = this.drawCanvasContext.createPattern(q, n);
                a.pattern = b
            }
            this.drawCanvasContext.fillStyle = a.pattern;
            this.drawCanvasContext.translate(k, h);
            this.drawCanvasContext.fillRect(0, 0, m, l);
            this.drawCanvasContext.translate(-k, -h)
        };
        b.setTransform = function(a) {
        ...
        b.initBlendMode = function() {
            ...
            this.blendModes[d.BlendMode.ERASE] =
                "destination-out";
        ...
        b.drawText = function(a, b, c, f, t, k) {
            void 0 === k && (k = null);
            this.setupFont(a, k);
            k = k || {};
            var h = a._properties,
                m;
            m = null != k.textColor ? d.toColorString(k.textColor) : h._textColorString;
            var l;
            l = null != k.strokeColor ? d.toColorString(k.strokeColor) : h._strokeColorString;
            var h = null != k.stroke ? k.stroke : h._stroke,
                n = this.drawCanvasContext;
            n.fillStyle = m;
            n.strokeStyle = l;
            h && (n.lineWidth = 2 * h, n.strokeText(b, c + this._transformTx, f + this._transformTy, t || 65535));
            n.fillText(b, c + this._transformTx, f + this._transformTy, t || 65535);
            e.prototype.drawText.call(this,
                a, b, c, f, t, k)
        };
        b.strokeRect = function(a, b, c, d, e) {
        ...
        b.onRenderFinish = function() {
            ...
            if (this.useCacheCanvas)
                for (var a = this._cacheCanvas.width, b = this._cacheCanvas.height, c = d.RenderFilter.getInstance().getDrawAreaList(), e = 0, f = c.length; e < f; e++) {
                    var k = c[e],
                        h = k.x,
                        m = k.y,
                        l = k.width,
                    ...
                    h + l > a && (l = a - h);
                    m + k > b && (k = b - m);
                    0 < l && 0 < k && this.canvasContext.drawImage(this._cacheCanvas, h, m, l, k, h, m, l, k)
                }
        };
        b.drawCursor = function(a, b, c, d) {
...
(function(d) {
    d.beginFill = function(d, c) {
        ...
        this._pushCommand(new f(this._setStyle, this, [b]))
    };
    d.drawRect = function(d, c, b, a) {
        this._pushCommand(new f(function(a, b, c, d) {
    ...
    d.drawRoundRect = function(d, c, b, a, g, w) {
        this._pushCommand(new f(function(a, b, c, d, g, e) {
            ...
            this.canvasContext.quadraticCurveTo(c,
                d, c - g, d);
            this.canvasContext.lineTo(a + g, d);
            this.canvasContext.quadraticCurveTo(a, d, a, d - e);
            this.canvasContext.lineTo(a, b + e);
            this.canvasContext.quadraticCurveTo(a, b, a + g, b);
            this.canvasContext.lineTo(c - g, b);
            this.canvasContext.quadraticCurveTo(c, b, c, b + e);
    ...
    d.lineStyle = function(d, c, b, a, g, w, s, t) {
        void 0 === d && (d = NaN);
        void 0 === c && (c = 0);
        void 0 === b && (b = 1);
        void 0 === a && (a = !1);
    ...
    d.lineTo = function(d, c) {
        this._pushCommand(new f(function(b, a) {
            ...
            this.canvasContext.lineTo(c._transformTx + b, c._transformTy + a)
        }, this, [d, c]));
    ...
    d._fill = function() {
        this.fillStyleColor && (this.createEndFillCommand(),
            this._pushCommand(this.endFillCommand), this.fillStyleColor = null);
...
(function(d) {
    var f = function(e) {
        ...
        b.initAll = function() {
            c.isInit || (c.isInit = !0, egret_webgl_graphics.init(),
                d.TextField.prototype._makeBitmapCache = function() {
                    this.renderTexture || (this.renderTexture = new d.RenderTexture);
                    var a = this.getBounds(d.Rectangle.identity);
                    ...
                    var b = a.width,
                        a = a.height,
                        c, e, f = d.MainContext.instance.rendererContext._texture_scale_factor;
                    c = b / f;
                    e = a / f;
                    c = Math.round(c);
                    e = Math.round(e);
                    ...
                    this._worldTransform.a = 1 / f;
                    this._worldTransform.d = 1 / f;
                ...
                }, d.RenderTexture.prototype.init =
                function() {
                    this._bitmapData = document.createElement("canvas");
                    ...
                    if (this._webglBitmapData) {
                        ...
                        this.renderContext.viewportScale =
                            d.MainContext.instance.rendererContext._texture_scale_factor
                    }
                    ...
                    "undefined" == typeof c && (c = 1);
                    this._bitmapData || (this._bitmapData = document.createElement("canvas"), this.canvasContext = this._bitmapData.getContext("2d"), d.RenderTexture.WebGLCanvas || (d.RenderTexture.WebGLCanvas = document.createElement("canvas"), d.RenderTexture.WebGLRenderer =
                        new d.WebGLRenderer(d.RenderTexture.WebGLCanvas)), this._webglBitmapData = d.RenderTexture.WebGLCanvas, this.renderContext = d.RenderTexture.WebGLRenderer);
                    var f = e.x,
                        k = e.y,
                        h = e.width,
                        e = e.height,
                    ...
                    n = a._anchorOffsetY;
                    if (0 != a._anchorX ||
                        0 != a._anchorY) l = a._anchorX * h, n = a._anchorY * e;
                    this._offsetX = f + l;
                    this._offsetY = k + n;
                    a._worldTransform.append(1, 0, 0, 1, -this._offsetX, -this._offsetY);
                    ...
                    d.MainContext.__use_new_draw = !1;
                    if (a instanceof d.DisplayObjectContainer)
                        for (f = a._children, k = 0, l = f.length; k < l; k++) f[k]._updateTransform();
                    this.renderContext.setTransform(a._worldTransform);
                    f = d.RenderFilter.getInstance();
                    k = f._drawAreaList.concat();
                    f._drawAreaList.length = 0;
                    ...
                    this.renderContext.onRenderFinish();
                    f._drawAreaList = k;
                    this._sourceWidth = h / m * c;
                    this._sourceHeight = e / m * c;
                    this._textureWidth = h * c;
                    this._textureHeight = e * c;
                    this.canvasContext.drawImage(this._webglBitmapData, 0, 0, h, e, 0, 0, this._sourceWidth,
                        this._sourceHeight);
                    return !0
                })
        };
        ...
        b.onResize = function() {
            var a = document.getElementById(d.StageDelegate.canvas_div_name);
            this.canvas && (this.canvas.width = d.MainContext.instance.stage.stageWidth,
                this.canvas.height = d.MainContext.instance.stage.stageHeight, this.canvas.style.width = a.style.width, this.canvas.style.height = a.style.height, this.projectionX = this.canvas.width / 2, this.projectionY = -this.canvas.height / 2);
        ...
        b.initWebGL = function() {
            for (var a = {}, b, e = ["experimental-webgl", "webgl"], f = 0; f < e.length; f++) {
                try {
        ...
        b.start = function() {
            if (!this.contextLost) {
                ...
                var b;
                b = this.colorTransformMatrix ? this.shaderManager.colorTransformShader :
        ...
        b.drawRepeatImage = function(a, b, c, e, f, k, h, m, l,
            n) {
            n = d.MainContext.instance.rendererContext._texture_scale_factor;
            e *= n;
            for (f *= n; k < m; k += e)
                for (var p = h; p < l; p += f) {
                    var r = Math.min(e, m - k),
                        q = Math.min(f, l - p);
                    this.drawImage(a, b, c, r / n, q / n, k, p, r, q)
                }
        };
        b.drawImage = function(a, b, c, d, e, f, h, m, l, n) {
            void 0 === n && (n = void 0);
            if (!this.contextLost)
                if (void 0 !== n) this.drawRepeatImage(a, b, c, d, e, f, h, m, l, n);
                else {
                    this.createWebGLTexture(a);
                    n = a._bitmapData.webGLTexture[this.glID];
                    if (n !== this.currentBaseTexture || this.currentBatchSize >= this.size - 1) this._drawWebGL(), this.currentBaseTexture =
                        n;
                    ...
                    1 == d / m && 1 == e / l || p.append(m / d, 0, 0, l / e, 0, 0);
                    f = p.a;
                    h = p.b;
                    m = p.c;
                    l = p.d;
        ...
        b.createWebGLTexture = function(a) {
            ...
            if (!a.webGLTexture[this.glID]) {
                ...
                b.texImage2D(b.TEXTURE_2D,
                    0, b.RGBA, b.RGBA, b.UNSIGNED_BYTE, a);
        ...
        b.getScissorRect = function(a) {
            var b = this.maskList[this.maskList.length - 1],
                c, e, f;
            b ? b.intersects(b) ? (c = Math.max(a.x + this.worldTransform.tx, b.x), e = Math.max(a.y + this.worldTransform.ty, b.y), f = Math.min(a.x + this.worldTransform.tx + a.width, b.x + b.width) - c, a = Math.min(a.y + this.worldTransform.ty + a.height, b.y + b.height) - e) : a = f = e = c = 0 : (c = a.x + this.worldTransform.tx, e = a.y + this.worldTransform.ty, f = a.width, a = a.height);
            (b = this.maskDataFreeList.pop()) ? (b.x = c, b.y = e, b.width = f, b.height = a) : b = new d.Rectangle(c, e, f, a);
            return b
        };
        b.popMask = function() {
            this._drawWebGL();
        ...
        b.scissor = function(a, b, c, e) {
            ...
            0 > c && (c = 0);
            0 > e && (e = 0);
            f.scissor(a, -b + d.MainContext.instance.stage.stageHeight - e, c, e)
        };
        b.setGlobalColorTransform = function(a) {
        ...
        b.updateGraphics = function(a) {
            ...
            b.bufferData(b.ELEMENT_ARRAY_BUFFER,
                new Uint16Array(this.graphicsIndices), b.STATIC_DRAW)
        };
...
(function(d) {
    d.beginFill = function(d, c) {
        void 0 === c && (c = 1);
        this._pushCommand(new f(this._setStyle, this, [(d >> 16) / 255, ((d & 65280) >> 8) / 255, (d & 255) / 255, c]))
    };
    d.drawRect = function(d, c, b, a) {
        this._pushCommand(new f(function(a) {
    ...
    d.drawCircle = function(d, c, b) {};
    d.drawRoundRect = function(d, c, b, a, g, f) {};
    d.drawEllipse = function(d, c, b, a) {};
    d.lineStyle = function(d, c, b, a, g, f, s, t) {};
    d.lineTo = function(d, c) {};
    d.curveTo = function(d, c, b,
        a) {};
    d.moveTo = function(d, c) {};
    d.clear = function() {
    ...
    d._draw = function(d) {
        var c = this.commandQueue.length;
        if (0 != c)
            for (this.renderContext = d, d = 0; d < c; d++) {
...
(function(d) {
    var f = function() {
        ...
        e.compileProgram = function(c, b, a) {
            ...
            var g = c.createProgram();
            c.attachShader(g, b);
            c.attachShader(g, a);
            c.linkProgram(g);
            c.getProgramParameter(g, c.LINK_STATUS) || d.Logger.infoWithErrorId(1020);
            return g
        };
...
(function(d) {
    var f = function() {
        ...
        c.init = function() {
            ...
            for (var c in this.uniforms) this.uniforms[c].uniformLocation = b.getUniformLocation(a,
                c);
            this.initUniforms();
            this.program = a
        };
...
(function(d) {
    var f = function() {
        ...
        c.setAttribs = function(b) {
            ...
            for (a = 0; a < c; a++) this.attribState[a] !== this.tempAttribState[a] && (this.attribState[a] = this.tempAttribState[a],
...
(function(d) {
    var f = function(e) {
        ...
        b.proceed = function(a) {
            function b() {
                if (4 == e.readyState)
                    if (e.status != a._status && (a._status = e.status, d.HTTPStatusEvent.dispatchHTTPStatusEvent(a, e.status)), 400 <= e.status || 0 == e.status) d.IOErrorEvent.dispatchIOErrorEvent(a);
                    else {
                        switch (a.dataFormat) {
            ...
            if (a.dataFormat == d.URLLoaderDataFormat.TEXTURE) this.loadTexture(a);
                ...
                var f = d.NetContext._getUrl(c);
                e.open(c.method, f, !0);
                this.setResponseType(e, a.dataFormat);
                c.method != d.URLRequestMethod.GET && c.data ? c.data instanceof d.URLVariables ? (e.setRequestHeader("Content-Type",
                    "application/x-www-form-urlencoded"), e.send(c.data.toString())) : (e.setRequestHeader("Content-Type", "multipart/form-data"), e.send(c.data)) : e.send()
            }
        };
    ...
    var f = function(e) {
        ...
        b.getLocation = function(a, b) {
            ...
            "function" === typeof a.getBoundingClientRect ?
                (k = a.getBoundingClientRect(), f = k.left, k = k.top) : k = f = 0;
            f += e.pageXOffset - c.clientLeft;
            k += e.pageYOffset - c.clientTop;
            null != b.pageX ? (c = b.pageX, e = b.pageY) : (f -= document.body.scrollLeft, k -= document.body.scrollTop, c = b.clientX, e = b.clientY);
            var h = d.Point.identity;
            h.x = (c - f) / d.StageDelegate.getInstance().getScaleX();
            h.y = (e - k) / d.StageDelegate.getInstance().getScaleY();
            return h
        };
        return c
    }(d.TouchContext);
...
(function(d) {
    var f = function(c) {
        ...
        a.executeShow = function() {
            ...
            0 < this._textfield._properties._maxChars ?
                this.inputElement.setAttribute("maxlength", this._textfield._properties._maxChars) : this.inputElement.removeAttribute("maxlength");
    ...
    var e = function() {
        ...
        b.initStageDelegateDiv = function() {
            ...
            b || (b = d.Browser.getInstance().$new("div"), b.id = "StageDelegateDiv", document.getElementById(d.StageDelegate.egret_root_div).appendChild(b), a.initValue(b),
...
(function(d) {
    var f = function(d) {
        ...
        __extends(c, d);
        c.dispatchResourceEvent = function(b, a, d, e, f, t) {
            void 0 === d && (d = "");
            void 0 === e && (e = null);
            void 0 === f && (f = 0);
            void 0 === t && (t = 0);
            var k = egret.Event._getPropertyData(c);
            k.groupName = d;
            k.resItem = e;
            k.itemsLoaded = f;
            k.itemsTotal = t;
            egret.Event._dispatchByTarget(c, b, a, k)
        };
        ...
        c.createGroup = function(b, a, c) {
            ...
            for (var d = [], e = a.length, f = 0; f <
                ...
                if (h)
                    ...
                    } else(l = this.keyMap[k]) ? -1 == d.indexOf(l) && d.push(l) : egret.Logger.warningWithErrorId(2E3, k)
            }
            ...
            if (b) {
                ...
                if (c = b.groups)
                    for (d = c.length, e = 0; e < d; e++) {
                        for (var k = c[e], h = [], m = k.keys.split(","), l = m.length,
                                n = 0; n < l; n++) f = m[n].trim(), (f = this.keyMap[f]) && -1 == h.indexOf(f) && h.push(f);
...
(function(d) {
    var f = function(e) {
        ...
        b.getOneResourceItem = function() {
            ...
            if (!a || 0 == a.length) return 0 == this.lazyLoadList.length ?
        ...
        b.onItemComplete = function(a) {
            ...
            if (b) {
                ...
                c == e && (a = this.groupErrorDic[b], this.removeGroupName(b), delete this.groupTotalDic[b], delete this.numLoadedDic[b], delete this.itemListDic[b], delete this.groupErrorDic[b], a ? d.ResourceEvent.dispatchResourceEvent(this, d.ResourceEvent.GROUP_LOAD_ERROR,
    ...
    var f = function(d) {
        ...
        b.getTexturePath = function(a, b) {
            var c = "",
                d = b.split("\n")[2],
                e = d.indexOf('file="'); -
            1 != e && (d = d.substring(e + 6), e = d.indexOf('"'), c = d.substring(0, e));
            a = a.split("\\").join("/");
            e = a.lastIndexOf("/");
...
(function(d) {
    ...
    d.addEventListener = function(c, b, a, d, f) {
        void 0 === d && (d = !1);
        void 0 === f && (f = 0);
        e.addEventListener(c, b, a, d, f)
    };
    ...
    var f = function(c) {
        ...
        a.startLoadConfig = function() {
            ...
            for (var c = a.length, e = [], f = 0; f < c; f++) {
                var k = a[f],
                    k = new d.ResourceItem(k.url, k.url, k.type);
                e.push(k)
            }
        ...
        a.loadGroup = function(a, b) {
            ...
            if (-1 != this.loadedGroups.indexOf(a)) d.ResourceEvent.dispatchResourceEvent(this,
                d.ResourceEvent.GROUP_COMPLETE, a);
        ...
        a.getResAsync = function(a, b, c) {
            ...
            (e = this.getAnalyzerByType(e).getRes(a)) ? b.call(c, e): (a = {
                ...
                compFunc: b,
                thisObject: c
            }, this.asyncDic[f] ? this.asyncDic[f].push(a) : (this.asyncDic[f] = [a], f =
        ...
        a.removeLoadedGroupsByItemName = function(a) {
            for (var b = this.loadedGroups, c = b.length, d = 0; d < c; d++)
                for (var e = this.resConfig.getRawGroupByName(b[d]), f = e.length, m = 0; m < f; m++)
                    if (e[m].name == a) {
                        b.splice(d, 1);
                        d--;
                        c = b.length;
...
var App = function(d) {
    ...
    e.onFrameworkInfoHandler = function(c) {
        f.frameworkInfo = c.data;
        f.frameworkInfo && (console.log("AppVersion: " + f.version), console.log("App.frameworkInfo",
            f.frameworkInfo));
        f.gamename = f.frameworkInfo.gamename;
        f.nameid = f.frameworkInfo.nameid;
        f.language = f.frameworkInfo.language;
        f.sharemsgs = f.frameworkInfo.sharemsgs;
        f.showmsgs = f.frameworkInfo.showmsgs;
        f.HasScreenshot = !!f.frameworkInfo.HasScreenshot;
        for (var b in f.sharemsgs) "app_" == b.substr(0, 4) ? f.apps.push(b) : f.platforms.push(b);
        f.platforms.sort();
        f.apps.sort();
        f.frameworkInfo.miniLogoUrl && (f.miniLogoUrl = f.frameworkInfo.miniLogoUrl, RES.getResByUrl(f.miniLogoUrl, f.instance.onMiniLogoLoaded, f.instance));
        f.frameworkInfo.debug && egret.Profiler.getInstance().run()
    };
    e.onMiniLogoLoaded = function(c, b) {
        this._miniLogoBmp.texture = c;
        this.stage.addChild(this._miniLogoBmp);
        this.setMiniLogo(f.LogoAlign);
        this._miniLogoBmp.touchEnabled = !0;
        this._miniLogoBmp.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onClickMiniLogoHandler, this)
    };
    e.onClickMiniLogoHandler = function(c) {
        MGDelegate.dispatcherEvent(new MGEvent(MGEvent.CLICK_MINILOGO))
    };
    f.ShowWin = function() {
        f.Pause();
        CreditsManager.setAlignCredisButton(CreditsManager.align);
    ...
    f.screenshot = function(c, b, a, d) {
        c || (c = new egret.Rectangle(0, 0, f.stage.stageWidth, f.stage.stageHeight));
        b || (b = "");
        a || (a = function() {
        ...
        if (MGDelegate.isApp) {
            var e = new MGEvent(MGEvent.SCREENSHOT);
            e.data = {
                rect: c,
                msg: b,
                success: a,
        ...
        var s = egret.Browser.getInstance().$("#screenshootCanvas");
        s ? (s.getContext("2d").clearRect(0, 0, s.width, s.height), s.width = c.width, s.height = c.height) : (e = f.Doc.getElementById(egret.StageDelegate.canvas_div_name), s = egret.Browser.getInstance().$new("canvas"), s.id = "screenshootCanvas", s.style.display = "none", s.width = c.width, s.height = c.height, e.appendChild(s));
        setTimeout(function() {
            try {
                var e = f.Doc.getElementById(egret.StageDelegate.canvas_name).getContext("2d").getImageData(c.x,
                    c.y, c.width, c.height);
                s.getContext("2d").putImageData(e, 0, 0, 0, 0, c.width, c.height);
                var k = new MGEvent(MGEvent.SCREENSHOT);
                k.data = {
                    rect: c,
                    msg: b,
                    success: a,
                ...
                MGDelegate.dispatcherEvent(k)
            } catch (h) {
                console.error("Security Error", h.message)
            }
        }, 60)
    };
    e.onAddToStageHandler = function(c) {
        if (!f.stage) {
            f._stage = this.stage;
            MGDelegate.isApp = !1;
            try {
                ...
                MGDelegate.isApp = !0, this._defaultLoading = new DefaultLoading, this.stage.addChild(this._defaultLoading), this._defaultLoading.init()
            }
            this.removeEventListener(egret.Event.ADDED_TO_STAGE,
                this.onAddToStageHandler, this);
            RES.addEventListener(RES.ResourceEvent.CONFIG_COMPLETE, this.onConfigComplete, this);
            RES.loadConfig("resource/resource.json", "resource/");
            this._miniLogoBmp || (this._miniLogoBmp = new egret.Bitmap);
            MGDelegate.addEventListener(MGEvent.FRAMEWORK_INFO_RESPONSE, this.onFrameworkInfoHandler, this);
            MGDelegate.addEventListener(MGEvent.ENTER_GAME, this.enterGame, this);
            c = new MGEvent(MGEvent.FRAMEWORK_INFO_REQUEST);
            c.data = {
                AppVersion: f.version
            };
            MGDelegate.dispatcherEvent(c);
            MGDelegate.dispatcherEvent(new MGEvent(MGEvent.ADDED_TO_STAGE))
        }
    };
    e.onConfigComplete = function(c) {
        ...
        var b = f.platforms.length,
            a = f.apps.length,
            d = "",
            e, d = "";
        if (0 != b)
            for (c = 0; c < b; c++) d = f.platforms[c], e = "resource/platform/" + d + ".png",
                d = "$platform_" + d, e = new RES.ResourceItem(d, e, RES.ResourceItem.TYPE_IMAGE), RES.configInstance.addItemToKeyMap(e), RES.configInstance.groupDic.preload.push(e);
        if (0 != a)
            for (c = 0; c < a; c++) d = f.apps[c], e = "resource/app/" + d + ".png", d = "$" + d, e = new RES.ResourceItem(d, e, RES.ResourceItem.TYPE_IMAGE), RES.configInstance.addItemToKeyMap(e), RES.configInstance.groupDic.preload.push(e);
        b = "".split(" ");
        a = b.length;
        for (c = 0; c < a; c++) d = b[c], e = "resource/credits/" + d + ".png", d = "$" + d, e =
            new RES.ResourceItem(d, e, RES.ResourceItem.TYPE_IMAGE), RES.configInstance.addItemToKeyMap(e), RES.configInstance.groupDic.preload.push(e);
        RES.loadGroup("preload");
        console.log("onConfigComplete");
        MGDelegate.dispatcherEvent(new MGEvent(MGEvent.LOAD_START))
    };
    e.onResourceLoadComplete = function(c) {
        "preload" == c.groupName && (RES.removeEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.onResourceLoadComplete, this), RES.removeEventListener(RES.ResourceEvent.GROUP_LOAD_ERROR, this.onResourceLoadError, this), RES.removeEventListener(RES.ResourceEvent.GROUP_PROGRESS,
            this.onResourceProgress, this), console.log("onResourceLoadComplete"), MGDelegate.dispatcherEvent(new MGEvent(MGEvent.LOAD_COMPLETE)))
    };
    e.setMiniLogo = function(c) {
        c = c.toLocaleUpperCase();
        if ("NONE" == c) this._miniLogoBmp.visible = !1;
        else {
            f.LogoAlign = c;
            ...
            switch (c) {
                case "TL":
                    ...
                    break;
                case "TM":
                    b = (f.stage.stageWidth - this._miniLogoBmp.width) / 2;
                    a = 0;
                    break;
                case "TR":
                    b = f.stage.stageWidth - this._miniLogoBmp.width;
                    a = 0;
                    break;
                case "BL":
                    b = 0;
                    a = f.stage.stageHeight - this._miniLogoBmp.height;
                    break;
                case "BM":
                    b = (f.stage.stageWidth - this._miniLogoBmp.width) / 2;
                    a = f.stage.stageHeight - this._miniLogoBmp.height;
                ...
                case "MM":
                    b = (f.stage.stageWidth - this._miniLogoBmp.width) / 2;
                    a = (f.stage.stageHeight - this._miniLogoBmp.height) / 2;
                    break;
                default:
                    c = c.split(","), b = parseFloat(c[0]), a = parseFloat(c[1])
            }
            this._miniLogoBmp.x = b;
            this._miniLogoBmp.y = a
        }
    };
    e.onResourceLoadError = function(c) {
        console.warn("Group:" +
            c.groupName + " \u4e2d\u6709\u52a0\u8f7d\u5931\u8d25\u7684\u9879\u76ee");
        MGDelegate.dispatcherEvent(new MGEvent(MGEvent.LOAD_ERROR));
        this.onResourceLoadComplete(c)
    };
    e.onResourceProgress = function(c) {
        if ("preload" == c.groupName) {
            var b = new MGEvent(MGEvent.LOAD_PROGRESS);
            b.data = {
                itemsLoaded: c.itemsLoaded,
                itemsTotal: c.itemsTotal,
                percent: Math.floor(c.itemsLoaded / c.itemsTotal * 100)
            };
            MGDelegate.dispatcherEvent(b);
            this._defaultLoading && this._defaultLoading.loadProgress(c.itemsLoaded / c.itemsTotal)
        }
    };
    e.enterGame =
        function(c) {
            f.state = f.INGAME;
            f.instance.createGameScene()
        };
    ...
    e._createGameSwf = function() {
        var c = RES.getRes("game_swf"),
            b = new starlingswf.SwfAssetManager;
        if (RES.hasRes("game_json")) {
            var a = RES.getRes("game_json");
            b.addSpriteSheet("game_json", a)
        }
        var a = RES.getGroupByName("preload"),
            d = a.length;
        if (3 < d)
            for (var e = 0; e < d; e++) {
                var s = a[e];
                "game_json" != s.name && "game_png" != s.name &&
                    "game_swf" != s.name && b.addTexture(s.name, RES.getRes(s.name))
            }
        f._swf = new starlingswf.Swf(c, b, 24)
    };
    f.Share = function(c, b, a, d) {
        void 0 === b && (b = 0);
        void 0 === a && (a = 0);
        void 0 === d && (d = 0);
        if (f.sharemsgs[c]) {
            var e = f.sharemsgs[c],
                e = e.replace(/\{nameid\}/g, f.nameid),
                e = e.replace(/\{gamename\}/g, f.gamename),
                e = e.replace(/\{score\}/g, b + ""),
                e = e.replace(/\{level\}/g, a + ""),
                e = e.replace(/\{percent\}/g, d + "");
            b = new MGEvent(MGEvent.SHARE);
            b.data = {
                platform: c,
                gamename: f.gamename,
                nameid: f.nameid,
            ...
            MGDelegate.dispatcherEvent(b)
        } else console.warn("Can not found platform msg: " +
            c)
    };
    f.GetShowMsg = function(c, b, a, d) {
        void 0 === c && (c = f.language);
        void 0 === b && (b = 0);
        void 0 === a && (a = 0);
        void 0 === d && (d = 0);
        if (f.showmsgs[c]) return f.Share("weixin", b, a, d), c = f.showmsgs[c], c = c.replace(/\{nameid\}/g, f.nameid), c = c.replace(/\{gamename\}/g, f.gamename), c = c.replace(/\{score\}/g, b + ""), c = c.replace(/\{percent\}/g, d + "");
        console.warn("can not found show msg: " + c)
    };
    f.DownloadApp = function(c) {
        var b = new MGEvent(MGEvent.DOWNLOAD_APP);
        b.data = {
            platform: c
        };
        MGDelegate.dispatcherEvent(b)
    ...
    f.Start = function() {
        CreditsManager.setAlignCredisButton("NONE");
        MGDelegate.dispatcherEvent(new MGEvent(MGEvent.START_GAME))
    };
    f.Pause = function() {
        CreditsManager.setAlignCredisButton(CreditsManager.align);
        MGDelegate.dispatcherEvent(new MGEvent(MGEvent.PAUSE_GAME))
    };
    f.ClickMore = function() {
        // MGDelegate.dispatcherEvent(new MGEvent(MGEvent.CLICK_MORE))
        //  window.open(wcb_ad.more_games_url)
    };
    f.version = "2.1.9";
    f.frameworkInfo = null;
    f.Doc = null;
    f.miniLogoUrl = "";
    f.PLATFORM_FACEBOOK = "facebook";
    f.PLATFORM_TWITTER = "twitter";
    f.PLATFORM_WEIXIN = "weixin";
    f.PLATFORM_QQ = "qq";
    f.PLATFORM_WEIBO = "weibo";
    f.PLATFORM_GOOGLE_PLUS =
        "google_plus";
    f.gamename = "-1";
    f.nameid = "-1";
    f.sharemsgs = {};
...
var CreditsManager = function() {
    function d() {
        this._email = "miagame.com@gmail.com";
        this._website = "http://miagame.com";
        d._instance = this
    }
    ...
    f.init = function() {
        this._creditsButton = new egret.Bitmap;
        this._creditsButton.texture = RES.getRes("$c_button");
        this._creditsPanel = new egret.Sprite;
        this._bgBMP = new egret.Bitmap;
        this._bgBMP.texture = RES.getRes("$c_bg");
        this._creditsPanel.addChild(this._bgBMP);
        this._logoBMP = new egret.Bitmap;
        this._logoBMP.texture = RES.getRes("$c_logo");
        this._creditsPanel.addChild(this._logoBMP);
        this._logoBMP.x = 80;
        this._logoBMP.y = 101;
        this._emailBMP = new egret.Bitmap;
        this._emailBMP.texture = RES.getRes("$c_email");
        this._creditsPanel.addChild(this._emailBMP);
        this._emailBMP.x = 107;
        this._emailBMP.y = 235;
        this._websiteBMP = new egret.Bitmap;
        this._websiteBMP.texture = RES.getRes("$c_website");
        this._creditsPanel.addChild(this._websiteBMP);
        this._websiteBMP.x = 128;
        this._websiteBMP.y = 278;
        this._closeBtn =
            new egret.Bitmap;
        this._closeBtn.texture = RES.getRes("$c_close");
        this._creditsPanel.addChild(this._closeBtn);
        this._closeBtn.x = 212;
        this._closeBtn.y = 319;
        this._creditsButton.touchEnabled = !0;
        this._closeBtn.touchEnabled = !0;
        this._websiteBMP.touchEnabled = !0;
        this._emailBMP.touchEnabled = !0;
        this._creditsButton.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchCreditsButtonHandler, this);
        this._closeBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchCloseHandler, this);
        this._emailBMP.addEventListener(egret.TouchEvent.TOUCH_TAP,
            this.onTouchEmailHandler, this);
        this._websiteBMP.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onToucWebsiteHandler, this);
        this._creditsPanel.x = (App.stage.stageWidth - this._creditsPanel.width) / 2;
        this._creditsPanel.y = this.hideY = (App.stage.stageHeight - this._creditsPanel.height) / 2;
        this.showY = this.hideY - 10;
        this._creditsPanel.alpha = 0;
        this._creditsPanel.touchChildren = !0
    };
    f.onTouchEmailHandler = function(d) {
        d = new MGEvent(MGEvent.OPEN_EMAIL);
        d.data = {
            email: this._email
        };
        MGDelegate.dispatcherEvent(d)
    };
    f.onToucWebsiteHandler =
        function(d) {
            d = new MGEvent(MGEvent.OPEN_URL);
            d.data = {
                url: this._website
            };
            MGDelegate.dispatcherEvent(d)
        };
    f.onTouchCloseHandler = function(e) {
        d.hidePanel()
    };
    f.onTouchCreditsButtonHandler = function(e) {
        d.showPanel();
        MGDelegate.dispatcherEvent(new MGEvent(MGEvent.CLICK_CREDITS))
    };
    d.showPanel = function() {
        d.instance._creditsPanel || d.instance.init();
        if (!d.instance._creditsPanel.parent) {
            App.stage.addChild(d.instance._creditsPanel);
            var e = d.instance.showY;
            egret.Tween.get(d.instance._creditsPanel).to({
                    alpha: 1,
                    y: e
                },
                500)
    ...
    d.hidePanel = function() {
        d.instance._creditsPanel || d.instance.init();
        if (d.instance._creditsPanel.parent) {
            var e = d.instance.hideY;
            egret.Tween.get(d.instance._creditsPanel).to({
                alpha: 0,
                y: e
            }, 500).call(function() {
                App.stage.removeChild(d.instance._creditsPanel)
            })
        }
    };
    d.setAlignCredisButton = function(e) {
        e = e.toLocaleUpperCase();
        d.instance._creditsButton || d.instance.init();
        d.instance._creditsButton.parent || App.stage.addChild(d.instance._creditsButton);
        if ("NONE" == e) d.instance._creditsButton.visible = !1;
        else {
            d.align =
                e;
            d.instance._creditsButton.visible = !0;
            var c = 0,
                b = 0;
            switch (e) {
                case "TL":
                    ...
                    break;
                case "TM":
                    c = (App.stage.stageWidth - d.instance._creditsButton.width) / 2;
                    b = 0;
                    break;
                case "TR":
                    c = App.stage.stageWidth - d.instance._creditsButton.width;
                    b = 0;
                    break;
                case "BL":
                    c = 0;
                    b = App.stage.stageHeight - d.instance._creditsButton.height;
                    break;
                case "BM":
                    c = (App.stage.stageWidth - d.instance._creditsButton.width) / 2;
                    b = App.stage.stageHeight - d.instance._creditsButton.height;
                ...
                case "MM":
                    c = (App.stage.stageWidth - d.instance._creditsButton.width) / 2;
                    b = (App.stage.stageHeight - d.instance._creditsButton.height) / 2;
                    break;
                default:
                    e = e.split(","), c = parseFloat(e[0]), b = parseFloat(e[1])
            }
            d.instance._creditsButton.x = c;
            d.instance._creditsButton.y = b
        }
    };
    d.align = "";
    d.linkable = !0;
...
CreditsManager.prototype.__class__ = "CreditsManager";
var DefaultLoading = function(d) {
    function f() {
        d.call(this);
        this.bgUrl = "resource/assets/app/bg.png";
        this.logoUrl = "resource/assets/app/logo.png";
        this.loadPercent = 0
    }
    ...
    e.init = function() {
        ...
        this.logoContainer = new egret.Sprite;
        ...
        this.logo.alpha = 0;
        this.doResize();
        RES.getResByUrl(this.bgUrl, this.onResLoaded,
            this);
        RES.getResByUrl(this.logoUrl, this.onResLoaded, this)
    };
    e.onResLoaded = function(c, b) {
        var a;
        b == this.bgUrl && (a = this.bg);
        b == this.logoUrl && (a = this.logo);
        a.texture = c;
        egret.Tween.get(a).to({
            alpha: 1
        }, 500);
        egret.callLater(this.doResize, this)
    };
    e.loadProgress = function(c) {
        this.loadPercent = c;
        1 == c && egret.Tween.get(this).wait(500).to({
            alpha: 0
        }, 800).call(this.onTweenComplete, this)
    };
    e.doResize = function() {
        this.bg.texture && (this.bg.width = App.stage.stageWidth, this.bg.height = App.stage.stageHeight);
        this.logo.texture &&
            (this.logo.x = -this.logo.width / 2, this.logo.y = -this.logo.height / 2);
        this.logoContainer.x = App.stage.stageWidth / 2;
        this.logoContainer.y = App.stage.stageHeight / 2
    };
    e.onTweenComplete = function() {
        this.parent && this.parent.removeChild(this)
    };
    return f
}(egret.DisplayObjectContainer);
DefaultLoading.prototype.__class__ = "DefaultLoading";
var starlingswf;
(function(d) {
    var f = function(d) {
        function c() {
        ...
        __extends(c, d);
        var b = c.prototype;
        b.getTextField = function(a) {
            return this.getChildByName(a)
        };
        b.getMovie = function(a) {
            return this.getChildByName(a)
        };
        b.getSprite = function(a) {
            return this.getChildByName(a)
        };
    ...
    d.SwfSprite = f;
    f.prototype.__class__ = "starlingswf.SwfSprite"
...
(function(d) {
    var f = function(e) {
        function c() {
            e.call(this);
            this.initSkin();
            this.spr.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onClickHandler, this)
        }

        __extends(c, e);
        var b = c.prototype;
        b.initSkin = function() {};
        b.onClickHandler = function(a) {
            ...
            switch (a.target.name) {
                case "more_btn":
                    ...
                    break;
                case "play_btn":
                    this.dispatchEventWith(d.GameEventType.INDEX_START_CLICK, !1, 1);
                    break;
                case "yiv_btn":
                    App.ClickMore()
            }
...
(function(d) {
    var f = function(e) {
        function c() {
            ...
            this.lvArray = [];
            this.initSkin();
            this.spr.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.onTouchDownHandler, this)
        }

        __extends(c, e);
        var b = c.prototype;
        b.initSkin = function() {};
        b.onTouchDownHandler = function(a) {
            "hit" == a.target.name ? (a = a.target.parent, a = a.name, a = a.substring(a.lastIndexOf("_") + 1), a = parseInt(a), this.dispatchEventWith(d.GameEventType.LEVEL_SELECT_CHANGE, !1, a), App.Start()) : "back_btn" == a.target.name ? this.dispatchEventWith(d.GameEventType.LEVEL_BACK_CLICK) :
                "yiv_btn" == a.target.name && App.ClickMore()
        };
        b.onTouchMoveHandler = function(a) {};
        b.onTouchUpHandler = function(a) {};
        b.showMap = function() {
            var a = d.getStorageData(d.GameConfig.GAME_LEVEL_LOCAL_NAME),
                a = a ? parseInt(a) : 0;
            d.GameConfig.PASSED_LEVEL = a;
            for (var b, c = 0; c < this.lvArray.length; c++) b = this.spr.getSprite("lv_" + (c + 1)), b.getImage("hit").touchEnabled = !1, c > a ? (b.getImage("cur").visible = !1, b.getSprite("past").visible = !1, b.getImage("lock").visible = !0) : a == c ? (b.getImage("hit").touchEnabled = !0, b.getImage("cur").visible = !0, b.getSprite("past").visible = !1, b.getImage("lock").visible = !1) : c < a && (b.getImage("hit").touchEnabled = !0, b.getImage("cur").visible = !1, b.getSprite("past").visible = !0, b.getImage("lock").visible = !1);
            App.Pause()
        };
        return c
    }(egret.Sprite);
    d.GameMapBase = f;
    f.prototype.__class__ = "xxhd.GameMapBase"
})(xxhd || (xxhd = {}));
(function(d) {
    var f = function(e) {
        function c() {
            e.call(this);
            this.initSkin();
            this.spr.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onPageClickHandler, this)
        }

        __extends(c, e);
        var b = c.prototype;
        b.initSkin = function() {};
        b.onPageClickHandler = function(a) {
            switch (a.target.name) {
                case "facebook_btn":
                ...
                case "twitter_btn":
                    ...
                    break;
                case "map_btn":
                    this.dispatchEventWith(d.GameEventType.GAME_MAP_SELECT);
                    break;
                case "next_btn":
                    this.dispatchEventWith(d.GameEventType.GAME_NEXT_LEVEL_CLICK);
                    break;
                case "more_btn":
                    App.ClickMore();
                    break;
                case "replay_btn":
                    this.dispatchEventWith(d.GameEventType.GAME_REPLAY_CLICK)
            }
        };
        b.showResult = function(a) {
            void 0 === a && (a = !0);
            a ? (a = (a = d.getStorageData(d.GameConfig.GAME_LEVEL_LOCAL_NAME)) ? parseInt(a) : 0, d.GameConfig.CURRENT_LEVEL > a && (d.GameConfig.PASSED_LEVEL = d.GameConfig.CURRENT_LEVEL), d.saveStorageData(d.GameConfig.GAME_LEVEL_LOCAL_NAME, d.GameConfig.PASSED_LEVEL.toString()), this.winHandler()) : this.loseHandler();
            this.beatPer = Math.min(99, Math.round(100 * Math.sqrt(d.GameConfig.CURRENT_PASS_LEVEL /
                d.GameConfig.MAX_LEVEL)));
            this.scoreStr = d.GameConfig.CURRENT_SCORE.toString();
            this.levelStr = d.GameConfig.CURRENT_LEVEL.toString();
            this.shareStr = App.GetShowMsg(App.language, d.GameConfig.CURRENT_SCORE, d.GameConfig.CURRENT_LEVEL, this.beatPer);
            this.shareText.text = this.shareStr;
            this.scoreText.text = this.scoreStr;
            this.levelText.text = this.levelStr
        };
        b.onFaceBookShare = function() {
            App.GetShowMsg(App.language, d.GameConfig.CURRENT_SCORE, d.GameConfig.CURRENT_LEVEL, this.beatPer);
            App.Share("facebook", d.GameConfig.CURRENT_SCORE,
                d.GameConfig.CURRENT_LEVEL, this.beatPer)
        };
        b.onTwitterShare = function() {
            App.GetShowMsg(App.language, d.GameConfig.CURRENT_SCORE, d.GameConfig.CURRENT_LEVEL, this.beatPer);
            App.Share("twitter", d.GameConfig.CURRENT_SCORE, d.GameConfig.CURRENT_LEVEL, this.beatPer)
        };
        b.winHandler = function() {
            App.ShowWin()
        };
        b.loseHandler = function() {
            App.ShowLose()
        };
        b.closeResult = function() {};
        b.removeAll = function() {};
        return c
    }(egret.Sprite);
    d.GameResultPanelBase = f;
    f.prototype.__class__ = "xxhd.GameResultPanelBase"
})(xxhd || (xxhd = {}));
var GameIndex = function(d) {
    function f() {
        d.call(this)
    }

    __extends(f, d);
    f.prototype.initSkin = function() {
        this.spr = App.swf.createSprite("spr_index");
        this.addChild(this.spr);
        this.playButton = this.spr.getImage("play_btn");
        this.moreButton = this.spr.getImage("more_btn");
        this.spr.getImage("yiv_btn").touchEnabled = !0;
        this.spr.getImage("yiv_btn").visible = !1;
        this.playButton.alpha = 0;
        this.moreButton.alpha = 0;
        this.playButton.touchEnabled = !0;
        this.moreButton.touchEnabled = !0;
        this.spr.touchEnabled = !0
    };
    return f
}(xxhd.GameIndexBase);
GameIndex.prototype.__class__ = "GameIndex";
var GameMap = function(d) {
    function f() {
        d.call(this)
    }
    ...
    var e = f.prototype;
    e.initSkin = function() {
        this.spr = App.swf.createSprite("spr_map");
        this.spr.getImage("back_btn").touchEnabled = !0;
        this.spr.getImage("yiv_btn").touchEnabled = !0;
        this.spr.getImage("yiv_btn").visible = !1;
        this.addChild(this.spr);
        for (var c, b, a = 1; 9 > a; a++) b = this.spr.getSprite("lv_" + a), c = b.getImage("hit"), b.getTextField("txt").visible = !1, c.alpha = 0, this.lvArray.push(b)
    };
    e.showMap = function() {
        var c = xxhd.getStorageData(xxhd.GameConfig.GAME_LEVEL_LOCAL_NAME),
            c = c ? parseInt(c) : 0;
        xxhd.GameConfig.PASSED_LEVEL = c;
        var b;
        b = 0;
        for (var a, d = 0; d < this.lvArray.length; d++) a = this.spr.getSprite("lv_" + (d + 1)), a.getImage("hit").touchEnabled = !1, b = (b = xxhd.getStorageData(Game.CURRENT_LEVEL_MAX_SCORE_NAME + (d + 1).toString())) ? parseInt(b) : 0, a.getTextField("txt").visible = !1, d > c ? (a.getImage("cur").visible = !1, a.getSprite("past").visible = !1, a.getImage("lock").visible = !0) : c == d ? (a.getImage("hit").touchEnabled = !0, a.getImage("cur").visible = !0, a.getSprite("past").visible = !1, a.getImage("lock").visible = !1) : d < c && (a.getImage("hit").touchEnabled = !0, a.getImage("cur").visible = !1, a.getSprite("past").visible = !0, a.getImage("lock").visible = !1, a.getTextField("txt").visible = !0, a.getTextField("txt").text = b.toString());
        App.Pause()
    };
    return f
}(xxhd.GameMapBase);
...
(function(d) {
    var f = function() {
        function e(b, a, c) {
            ...
            this.swfUpdateManager = d.SwfUpdateManager.createSwfUpdateManager(c)
        }

        var c = e.prototype;
        c.createSprite = function(b, a, c) {
            void 0 === a && (a = null);
            void 0 === c && (c = null);
            null == c && (c = this._swfData[e.dataKey_Sprite][b]);
            b = new d.SwfSprite;
            for (var f = c.length, s, t, k = 0; k < f; k++) s = c[k], t = this._createDisplayFuns[s[1]], null != t && (t = t.apply(this, [s[0], s]), t.name = s[9], t.x = s[2], t.y = s[3], s[1] != e.dataKey_Scale9 && s[1] != e.dataKey_ShapeImg && (t.scaleX = s[4], t.scaleY = s[5]), t.skewX = s[6], t.skewY = s[7], t.alpha = s[8], b.addChild(t));
            null !=
                a && d.SwfBlendMode.setBlendMode(b, a[11]);
            return b
        };
        c.createMovie = function(b, a) {
            void 0 === a && (a = null);
            var c = this._swfData[e.dataKey_MovieClip][b],
                f = c.objCount,
                s = {},
                t, k, h, m, l;
            for (l in f) {
                ...
                h = f[l][1];
                t = null == s[l] ? [] : s[l];
                for (var n = 0; n < h; n++) m = this._createDisplayFuns[k], null != m && t.push(m.apply(this, [l, null]));
                s[l] = t
            }
            f = new d.SwfMovieClip(c.frames, c.labels, s, this, c.frameEvents);
            f.loop = c.loop;
            null != a && d.SwfBlendMode.setBlendMode(f, a[11]);
            return f
        };
        c.createImage = function(b, a) {
            void 0 === a && (a = null);
            var c =
                this._swfData[e.dataKey_Image][b],
                f = this._assetManager.createBitmap(b);
            f.anchorOffsetX = c[0];
            f.anchorOffsetY = c[1];
            null != a && d.SwfBlendMode.setBlendMode(f, a[11]);
            return f
        };
        c.createS9Image = function(b, a) {
            void 0 === a && (a = null);
            var c = this._swfData[e.dataKey_Scale9][b],
                f = this._assetManager.createBitmap(b);
            f.scale9Grid = new egret.Rectangle(c[0], c[1], c[2], c[3]);
            null != a && (f.width = a[10], f.height = a[11], d.SwfBlendMode.setBlendMode(f, a[13]));
            return f
        };
        c.createShapeImage = function(b, a) {
            void 0 === a && (a = null);
            var c = this._assetManager.createBitmap(b);
            c.fillMode = egret.BitmapFillMode.REPEAT;
            null != a && (c.width = a[10], c.height = a[11], d.SwfBlendMode.setBlendMode(c, a[13]));
            return c
        };
        c.createTextField = function(b, a) {
            void 0 === a && (a = null);
            var c = new egret.TextField;
            null != a && (c.width = a[10], c.height = a[11], c.fontFamily = a[12], c.textColor = a[13], c.size = a[14], c.textAlign = a[15], c.text = a[18], d.SwfBlendMode.setBlendMode(c, a[20]));
            return c
        };
    ...
    d.Swf = f;
    f.prototype.__class__ = "starlingswf.Swf"
})(starlingswf || (starlingswf = {}));
(function(d) {
    var f = function() {
        function d() {}

        d.setBlendMode = function(c, b) {
            d.modes[b] && (c.blendMode = b)
        };
        d.modes = {
            normal: !0,
            add: !0
    ...
    d.SwfBlendMode = f;
    f.prototype.__class__ = "starlingswf.SwfBlendMode"
})(starlingswf || (starlingswf = {}));
(function(d) {
    var f = function() {
        function d() {}
        ...
        d.MAX_SCORE = 0;
        d.GAME_NAME = null;
        d.CURRENT_PASS_LEVEL = 0;
        return d
    }();
    d.GameConfig = f;
    f.prototype.__class__ = "xxhd.GameConfig"
})(xxhd || (xxhd = {}));
(function(d) {
    var f = function() {
        function d() {}

        d.INDEX_START_CLICK = "INDEX_START_CLICK";
        d.LEVEL_SELECT_CHANGE = "LEVEL_SELECT_CHANGE";
        d.LEVEL_BACK_CLICK = "LEVEL_BACK_CLICK";
        d.GAME_PAUSE_CLICK = "GAME_PAUSE_CLICK";
        d.GAME_RESUME_CLICK = "GAME_RESUME_CLICK";
        d.GAME_MAP_SELECT = "GAME_MAP_SELECT";
        d.GAME_NEXT_LEVEL_CLICK = "GAME_NEXT_LEVEL_CLICK";
        d.GAME_REPLAY_CLICK = "GAME_REPLAY_CLICK";
        d.GAME_MORE_CLICK = "GAME_MORE_CLICK";
        d.GAME_FACEBOOK_CLICK = "GAME_FACEBOOK_CLICK";
        d.GAME_TWITTER_CLICK = "GAME_TWITTER_CLICK";
        d.GAME_RESULT_SHOW =
            "GAME_RESULT_SHOW";
        return d
    }();
    d.GameEventType = f;
    f.prototype.__class__ = "xxhd.GameEventType"
})(xxhd || (xxhd = {}));
(function(d) {
    d.Random = function(d, e) {
        return Math.floor(Math.random() * (e - d) + d)
    };
    d.RandomNumber = function(d, e) {
        return Math.random() * (e - d) + d
    };
    d.getStorageData = function(d) {
        return egret.localStorage.getItem(d)
    };
    d.saveStorageData = function(d, e) {
        egret.localStorage.setItem(d, e)
    };
    d.HitTestObject = function(d, e) {
        var c = d.getBounds(),
            b = e.getBounds(),
            a = d.parent.localToGlobal(d.x, d.y),
            g = e.parent.localToGlobal(e.x, e.y);
        c.x = a.x;
        c.y = a.y;
        b.x = g.x;
        b.y = g.y;
...
var Blood = function(d) {
    ...
    e.render = function() {
        0 < this.vx && (this.vx -= 0.04);
        0 >= this.vx && (this.vx = 0);
        5 > this.vy && (this.vy += 0.5);
        5 < this.vy && (this.vy = 5);
        this.x -= this.vx;
        this.y += this.vy
    };
...
Blood.prototype.__class__ = "Blood";
var Game = function(d) {
    function f() {
        d.call(this);
        f._instance = this
    ...
    e.createGameScene = function() {
        App.LogoAlign = "TL";
        CreditsManager.align = "TR";
        d.prototype.createGameScene.call(this);
        xxhd.GameConfig.GAME_NAME = App.gamename;
        xxhd.GameConfig.MAX_LEVEL = 8;
        xxhd.GameConfig.GAME_LEVEL_LOCAL_NAME = "HandGame_level";
        xxhd.GameConfig.GAME_SCORE_LOCAL_NAME = "HandGame_score";
        this.gameIndex =
            new GameIndex;
        this.addChild(this.gameIndex);
        this.gameIndex.addEventListener(xxhd.GameEventType.INDEX_START_CLICK, this.onIndexClickStart, this);
        this.gameMap = new GameMap;
        this.gameMap.addEventListener(xxhd.GameEventType.LEVEL_BACK_CLICK, this.onBackToIndex, this);
        this.gameMap.addEventListener(xxhd.GameEventType.LEVEL_SELECT_CHANGE, this.onLevelSelectHandler, this);
        this.gameMain = new HandGame;
        this.gameMain.addEventListener(xxhd.GameEventType.GAME_MAP_SELECT, this.onResultMapSelectHandler, this)
    };
    e.onResultMapSelectHandler =
        function(c) {
            for (; 0 < this.numChildren;) this.removeChildAt(0);
            this.gameMap.showMap();
            this.addChild(this.gameMap)
        };
    e.onLevelSelectHandler = function(c) {
        for (; 0 < this.numChildren;) this.removeChildAt(0);
        App.Start();
        this.gameMain.setNewGame(c.data);
        this.addChild(this.gameMain)
    };
    e.onBackToIndex = function(c) {
        for (; 0 < this.numChildren;) this.removeChildAt(0);
        this.addChild(this.gameIndex)
    };
    e.onIndexClickStart = function(c) {
        for (; 0 < this.numChildren;) this.removeChildAt(0);
        this.gameMap.showMap();
        this.addChild(this.gameMap)
    };
    f.CURRENT_LEVEL_MAX_SCORE_NAME = "CURRENT_LEVEL_MAX_SCORE_NAME";
    return f
}(App);
...
var Money = function(d) {
    ...
    e.init = function() {
        this.y = -this.height;
        this.vy = xxhd.Random(4, 8);
        this.vr = xxhd.RandomNumber(0.2, 0.4)
    };
    e.render = function() {
        this.y += this.vy;
        this.rotation += this.vr;
        10 < this.rotation ? this.vr *= -1 : -10 > this.rotation && (this.vr *= -1)
    };
    return f
}(egret.Bitmap);
Money.prototype.__class__ = "Money";
var SharePlatform = function(d) {
    function f(c) {
        void 0 === c && (c = "H");
        d.call(this);
        this.beatPer = this.lv = this.score = 0;
        this.shareBtns = [];
        this.appBtns = [];
        this.app_gap = this.share_gap = 8;
        this.alignType = "H";
        this.alignType = c;
        this.init()
    }
    ...
    e.init = function() {
        var c = "",
            b = "",
            a = 0;
        this.shareContainer = new egret.Sprite;
        this.addChild(this.shareContainer);
        for (var d = 0; d < App.platforms.length; d++) c = App.platforms[d], b = "$platform_" + c, console.log("Share platform name:", c), RES.getRes(b) ? (a++, b = new egret.Bitmap(RES.getRes(b)),
            b.name = c, b.touchEnabled = !0, b.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onClick, this), this.shareContainer.addChild(b), this.shareBtns.push(b)) : console.warn("Can not found platform [" + b + "] image!!");
        this.appContainer = new egret.Sprite;
        this.appContainer.y = 69;
        this.addChild(this.appContainer);
        for (d = a = 0; d < App.apps.length; d++) c = App.apps[d], b = "$" + c, console.log("Download platform name:", c), RES.getRes(b) ? (a++, b = new egret.Bitmap(RES.getRes(b)), b.name = c, b.touchEnabled = !0, b.addEventListener(egret.TouchEvent.TOUCH_TAP,
            this.onClick, this), this.appContainer.addChild(b), this.appBtns.push(b)) : console.warn("Can not found platform [" + b + "] image!!");
        this.resetAppBtnsUI();
        this.resetShareBtnsUI()
    };
    e.onClick = function(c) {
        console.log("onClick:", c.target.name);
        c = c.target.name;
        "app_" == c.substr(0, 4) ? App.DownloadApp(c) : App.Share(c, this.score, this.lv, this.beatPer)
    };
    e.setData = function(c, b, a, d) {
        void 0 === c && (c = 0);
        void 0 === b && (b = 0);
        void 0 === a && (a = 0);
        void 0 === d && (d = 8);
    ...
    e.resetShareBtnsUI = function(c) {
        void 0 === c && (c = "H");
        this.alignType = c;
        for (c = 0; c < this.shareBtns.length; c++) {
            var b = this.shareBtns[c];
            this.alignType = "H";
            b.x = (b.width + this.share_gap) * c;
            b.y = 0
        }
    };
    e.resetAppBtnsUI = function(c) {
        void 0 === c && (c = "H");
        this.alignType = c;
        for (c = 0; c < this.appBtns.length; c++) {
            var b = this.appBtns[c];
            this.alignType = "H";
            b.x = (b.width + this.app_gap) * c;
            b.y = 0
        }
    };
    return f
...
(function(d) {
    var f = function(e) {
        ...
        b.setCurrentFrame = function(a) {
            this._children.length = 0;
            this._currentFrame = a;
            this.__frameInfos = this._frames[this._currentFrame];
            for (var b, c, e = this.__frameInfos.length, f = 0; f < e; f++) {
                a = this.__frameInfos[f];
                b = a[10];
                b = this._displayObjects[a[0]][b];
                b._skewX = a[6];
                b._skewY = a[7];
                b._alpha = a[8];
                b.name = a[9];
                ...
                b._y = a[3];
                switch (a[1]) {
                    case d.Swf.dataKey_Scale9:
                        b.width = a[11];
                        b.height = a[12];
                        d.SwfBlendMode.setBlendMode(b, a[13]);
                        break;
                    case d.Swf.dataKey_ShapeImg:
                        b.width = a[11];
                        b.height = a[12];
                        d.SwfBlendMode.setBlendMode(b, a[13]);
                        break;
                    case d.Swf.dataKey_TextField:
                        c = b;
                        c.width = a[11];
                        c.height = a[12];
                        c.fontFamily = a[13];
                        ...
                        d.SwfBlendMode.setBlendMode(c, a[20]);
                        break;
                    default:
                        b._scaleX = a[4], b._scaleY = a[5], d.SwfBlendMode.setBlendMode(b,
                            a[11])
                }
            ...
            if (a) {
                ...
                for (b in this._displayObjects)
                    if (0 == b.indexOf(d.Swf.dataKey_MovieClip)) {
                        ...
                        e = c.length;
                        for (var f = 0; f < e; f++) c[f].stop(a)
                    }
            }
        };
        b.gotoAndStop = function(a, b) {
            void 0 === b && (b = !0);
            this.goTo(a);
            this.stop(b)
        };
        ...
        b.goTo = function(a) {
            "string" == typeof a ? (a = this.getLabelData(a), this._currentLabel = a[0], this._currentFrame = this._startFrame = a[1], this._endFrame =
                a[2]) : "number" == typeof a && (this._currentFrame = this._startFrame = a, this._endFrame = this._frames.length - 1);
            this.setCurrentFrame(this._currentFrame)
        };
        b.getLabelData = function(a) {
            for (var b = this._labels.length, c, d = 0; d < b; d++)
                if (c = this._labels[d], c[0] == a) return c;
            return null
        };
        b.isPlay = function() {
            return this._isPlay
        };
        b.totalFrames = function() {
            return this._frames.length
        };
        b.currentLabel = function() {
        ...
        b.hasLabel = function(a) {
            return -1 != this.labels().indexOf(a)
        };
        b.addEventListener = function(a, b, c, d, f) {
            void 0 === d && (d = !1);
            void 0 === f && (f = 0);
            e.prototype.addEventListener.call(this, a, b, c, d, f);
            this._hasCompleteListener = this.hasEventListener(egret.Event.COMPLETE)
        };
        b.removeEventListener = function(a, b, c, d) {
            void 0 === d && (d = !1);
            e.prototype.removeEventListener.call(this, a, b, c, d);
            this._hasCompleteListener = this.hasEventListener(egret.Event.COMPLETE)
        };
        return c
    }(d.SwfSprite);
...
var Cutter = function(d) {
    function f(c) {
        d.call(this);
        this.stY = 20;
        this.edY = 353;
        this.inCut = !1;
        this.countGap = this.count = 0;
        this.timeFrom = 80;
        this.timeEnd = 100;
        this.spr = c;
        this.spr.y = this.stY;
        this.hitArea.alpha = 0;
        this.bloodView = this.spr.getImage("blood_cut");
        this.bloodView.visible = !1
    }

    __extends(f, d);
    var e = f.prototype;
    e.removeAll = function() {};
    e.setCutRange = function(c, b) {
        this.timeFrom = c;
        this.timeEnd = b
    };
    e.init = function() {
    ...
    e.cutHand = function() {
        this.bloodView.visible = !0
    };
    e.checkCut = function() {
        !0 == HandGame.getInstance().onShow || this.inCut || (0 == this.countGap && (this.countGap = xxhd.Random(this.timeFrom, this.timeEnd)), this.count++, this.count >= this.countGap && (this.count = 0, this.cut(), this.countGap = xxhd.Random(this.timeFrom, this.timeEnd)))
    };
    e.cut = function() {
        if (!this.inCut) {
            this.inCut = !0;
            egret.Tween.removeTweens(this.spr);
            this.spr.y = this.stY;
            var c = this;
            egret.Tween.get(this.spr).to({
                y: this.edY
            }, 100).call(function() {
                c.dispatchEventWith("cutDown");
                egret.Tween.get(c.spr).to({
                        y: c.stY
                    },
                    100);
                c.inCut = !1
    ...
    Object.defineProperty(e, "hitArea", {
        get: function() {
            return this.spr.getImage("cut_hit")
        },
        enumerable: !0,
        configurable: !0
    });
    Object.defineProperty(e, "hitXpos", {
        get: function() {
            return this.hitArea.parent.localToGlobal(this.hitArea.x, this.hitArea.y).x
        },
        enumerable: !0,
        configurable: !0
    });
...
Cutter.prototype.__class__ = "Cutter";
var Dianju = function(d) {
    function f() {
        d.call(this);
        this.vx = 0;
        this.vy = 3;
        ...
        this._time = 0;
        this.needShowWin = !1;
        var c = App.swf.createImage("img_juzi");
        this.addChild(c);
        c = RES.getRes("whitefont");
        this.timeText = new egret.BitmapText;
        this.timeText.font = c;
        this.timeText.scaleX = this.timeText.scaleY = 0.3;
        this.timeText.text = "27";
        this.timeText.x = -30;
        this.timeText.y = 0 - 60 * this.timeText.scaleX;
    ...
    Object.defineProperty(e, "time", {
        ...
        set: function(c) {
            this._time = c;
            this.timeText.text = c.toString();
            this.timeText.x = 3 == this.timeText.text.length ? -40 : 2 == this.timeText.text.length ? -25 : -15
        },
        enumerable: !0,
        configurable: !0
    });
    ...
    e.showWin = function() {
        0 < this.time ? this.time -= 1 : (this.needShowWin = !1, this.dispatchEventWith("moneyBoundComplete"))
    };
    e.render = function() {
        !0 == this.needShowWin && this.showWin()
    };
    return f
}(egret.Sprite);
Dianju.prototype.__class__ = "Dianju";
var GameResult = function(d) {
    function f() {
        d.call(this);
    ...
    __extends(f, d);
    var e = f.prototype;
    e.showResult = function(c) {
        void 0 === c && (c = !0);
        c ? (c = (c = xxhd.getStorageData(xxhd.GameConfig.GAME_LEVEL_LOCAL_NAME)) ? parseInt(c) : 0, xxhd.GameConfig.CURRENT_LEVEL > c && (xxhd.GameConfig.PASSED_LEVEL = xxhd.GameConfig.CURRENT_LEVEL), xxhd.saveStorageData(xxhd.GameConfig.GAME_LEVEL_LOCAL_NAME, xxhd.GameConfig.PASSED_LEVEL.toString()), this.winHandler()) : this.loseHandler();
        (c = xxhd.getStorageData(Game.CURRENT_LEVEL_MAX_SCORE_NAME +
            xxhd.GameConfig.CURRENT_LEVEL)) ? (c = parseInt(c), c < xxhd.GameConfig.CURRENT_SCORE && (c = xxhd.GameConfig.CURRENT_SCORE, xxhd.saveStorageData(Game.CURRENT_LEVEL_MAX_SCORE_NAME + xxhd.GameConfig.CURRENT_LEVEL, c.toString()))) : (c = xxhd.GameConfig.CURRENT_SCORE, xxhd.saveStorageData(Game.CURRENT_LEVEL_MAX_SCORE_NAME + xxhd.GameConfig.CURRENT_LEVEL, c.toString()));
        this.totalMaxScore = this.getTotalScore();
        this.beatPer = Math.min(99, Math.round(100 * Math.sqrt(this.totalMaxScore / 4E4)));
        this.scoreStr = xxhd.GameConfig.CURRENT_SCORE.toString();
        this.levelStr = xxhd.GameConfig.CURRENT_LEVEL.toString();
        this.sharePlatform.setData(this.totalMaxScore, xxhd.GameConfig.CURRENT_LEVEL, this.beatPer);
        this.uireset();
        this.shareStr = App.GetShowMsg(App.language, this.totalMaxScore, xxhd.GameConfig.CURRENT_LEVEL, this.beatPer);
        this.shareText.text = this.shareStr;
        this.scoreText.text = this.scoreStr;
        this.levelText.text = this.levelStr;
        this.maxText.text = c.toString();
        this.totalText.text = this.totalMaxScore.toString()
    };
    e.getTotalScore = function() {
        for (var c = xxhd.getStorageData(xxhd.GameConfig.GAME_LEVEL_LOCAL_NAME),
                c = c ? parseInt(c) : 0, b, a = b = 0, d = 0; d < c; d++) b = (b = xxhd.getStorageData(Game.CURRENT_LEVEL_MAX_SCORE_NAME + (d + 1).toString())) ? parseInt(b) : 0, a += b;
        return a
    };
    e.initSkin = function() {
        ...
        this.spr = App.swf.createSprite("spr_result");
        this.spr.getImage("facebook_btn").touchEnabled = !0;
        this.spr.getImage("twitter_btn").touchEnabled = !0;
        this.spr.getImage("facebook_btn").visible = !1;
        this.spr.getImage("twitter_btn").visible = !1;
        this.shareText = this.spr.getTextField("share_txt");
        this.scoreText = this.spr.getTextField("score_txt");
        this.levelText = this.spr.getTextField("level_txt");
        this.maxText = this.spr.getTextField("max_txt");
        this.totalText = this.spr.getTextField("total_txt");
        this.stateView = this.spr.getMovie("state_mc");
        this.addChild(this.spr);
        this.uireset()
    };
    e.uireset = function() {
        this.sharePlatform || (this.sharePlatform = new SharePlatform, this.addChild(this.sharePlatform));
        this.sharePlatform.visible = App.HasScreenshot;
        this.sharePlatform.shareContainer.x =
            (App.stage.stageWidth - this.sharePlatform.shareContainer.width) / 2;
        this.sharePlatform.appContainer.x = (App.stage.stageWidth - this.sharePlatform.appContainer.width) / 2;
        this.sharePlatform.shareContainer.y = 480;
        this.sharePlatform.appContainer.y = 700
    };
    e.winHandler = function() {
        xxhd.GameConfig.CURRENT_PASS_LEVEL = xxhd.GameConfig.CURRENT_LEVEL;
        xxhd.GameConfig.CURRENT_LEVEL >= xxhd.GameConfig.MAX_LEVEL - 1 ? (this.stateView.gotoAndStop(1), this.stateView.getImage("map_btn").touchEnabled = !0, this.stateView.getImage("more_btn").touchEnabled = !0, this.stateView.getImage("replay_btn").visible = !0) : (this.stateView.gotoAndStop(0), this.stateView.getImage("map_btn").touchEnabled = !0, this.stateView.getImage("next_btn").touchEnabled = !0, this.stateView.getImage("more_btn").touchEnabled = !0, this.stateView.getImage("replay_btn").visible = !1);
        d.prototype.winHandler.call(this);
        App.ShowWin()
    };
    e.loseHandler = function() {
        xxhd.GameConfig.CURRENT_PASS_LEVEL = xxhd.GameConfig.CURRENT_LEVEL - 1;
        this.stateView.gotoAndStop(2);
        this.stateView.getImage("replay_btn").visible = !0;
        this.stateView.getImage("map_btn").touchEnabled = !0;
        this.stateView.getImage("replay_btn").touchEnabled = !0;
        this.stateView.getImage("more_btn").touchEnabled = !0;
        d.prototype.loseHandler.call(this);
        App.ShowLose()
    };
    e.onFaceBookShare = function() {
        App.Share("facebook", this.totalMaxScore, xxhd.GameConfig.CURRENT_PASS_LEVEL, this.beatPer)
    };
    e.onTwitterShare = function() {
        App.Share("twitter", this.totalMaxScore, xxhd.GameConfig.CURRENT_PASS_LEVEL, this.beatPer)
    };
    return f
}(xxhd.GameResultPanelBase);
GameResult.prototype.__class__ = "GameResult";
var Hand = function(d) {
    function f(c) {
        d.call(this);
        this.bloodCreateCount = this.bloodTimeCount = this._money = 0;
        this.bloodMaxCount = Number.MAX_VALUE;
        this.stopCretea = !1;
        this.mc = c;
        this.disp = App.swf.createMovie("mc_hand");
        this.bloodDict = [];
        this.bloodContainer = new egret.Sprite;
        App.stage.addChild(this.bloodContainer)
    }

    __extends(f, d);
    var e = f.prototype;
    e.removeAll = function() {
        for (this.mc.mask = null; 0 < this.bloodContainer.numChildren;) this.bloodDict.push(this.bloodContainer.removeChildAt(0));
        this.hurtHand && this.hurtHand.parent &&
            this.hurtHand.parent.removeChild(this.hurtHand);
        this.hurtHand = null
    };
    e.init = function() {
        this.money = 0;
        this.stopCretea = !0;
        this.bloodCreateCount = 0;
        this.bloodTimeCount = this.hitArea.alpha = 0;
        this.bloodMaxCount = Number.MAX_VALUE
    };
    e.render = function() {
        this.moveHurtHand();
    ...
    Object.defineProperty(e, "money", {
        get: function() {
            return this._money
        },
        set: function(c) {
            this._money = c;
            0 >= c ? this.mc.gotoAndStop(0) : this.mc.gotoAndStop(1)
        },
        enumerable: !0,
        configurable: !0
    });
    ...
    e.chechHandCut = function(c) {
        var b = this.mc.parent.localToGlobal(this.mc.x, this.mc.y),
            a = c - b.x;
        return 20 < a ? (this.mc.gotoAndStop(0), this.mc.mask = new egret.Rectangle(a, 0, 582 - a, 200), this.createHandHurt(c, b.y, a), !0) : !1
    };
    e.createHandHurt = function(c, b, a) {
        f.hurtWidth = a;
        var d = new egret.RenderTexture,
            e = new egret.Rectangle(0, 0, a, 200);
        this.disp.gotoAndStop(this.mc.getCurrentFrame());
        d.drawToTexture(this.disp,
            e) && (this.hurtHand = new egret.Bitmap(d), this.hurtHand.x = c - a, this.hurtHand.y = b, App.stage.addChild(this.hurtHand))
    };
    e.getBlood = function() {
        return 0 < this.bloodDict.length ? this.bloodDict.pop() : new Blood(RES.getRes("img_blood"))
    };
    e.createBlood = function() {
        if (!this.stopCretea && (this.bloodTimeCount++, 0 == this.bloodTimeCount % 2 && this.bloodCreateCount < this.bloodMaxCount)) {
            var c = this.mc.parent.localToGlobal(this.mc.x, this.mc.y),
                b = c.x + f.hurtWidth,
                a = this.getBlood();
            a.init();
            a.x = b;
            a.y = c.y + 50;
            this.bloodContainer.addChild(a);
            this.bloodCreateCount++
        }
    };
    e.moveBlood = function() {
        for (var c, b = this.bloodContainer.numChildren - 1; 0 <= b; b--) c = this.bloodContainer.getChildAt(b), c.render(), c.y > App.stage.stageHeight && c.parent && (this.bloodContainer.removeChild(c), this.bloodDict.push(c))
    };
    e.moveHurtHand = function() {
        this.hurtHand && (this.hurtHand.x -= 5, this.hurtHand.y += 10, this.hurtHand.rotation -= 2, this.hurtHand.y > App.stage.stageHeight && (this.hurtHand.parent && this.hurtHand.parent.removeChild(this.hurtHand), this.hurtHand = null))
    };
    f.hurtWidth = 0;
    return f
}(egret.EventDispatcher);
Hand.prototype.__class__ = "Hand";
var MoneyDesk = function() {
    function d(d) {
        this.moneyDict = [];
        this.spr = d;
    ...
    f.removeAll = function() {
        for (; 0 < this.container.numChildren;) this.moneyDict.push(this.container.removeChildAt(0))
    };
    f.init = function() {};
    f.render = function() {};
    f.moneyCreate = function() {
        if (!(20 < this.container.numChildren)) {
            var d = this.getMoney();
            d.x = 0;
            d.y = -4 * this.container.numChildren;
            this.container.addChild(d)
        }
    };
    f.getMoney = function() {
        return 0 < this.moneyDict.length ?
            this.moneyDict.pop() : App.swf.createImage("img_money2")
    };
    return d
}();
MoneyDesk.prototype.__class__ = "MoneyDesk";
var MoneyPool = function(d) {
    function f() {
        d.call(this);
        this.createTimeGap = 80;
        this.timeCount = 0;
        this.stopCretea = !1;
        this.moneyDict = []
    }
    ...
    var e = f.prototype;
    e.removeAll = function() {
        for (; 0 < this.numChildren;) this.moneyDict.push(this.removeChildAt(0))
    };
    e.init = function() {
        this.timeCount = 0;
        this.stopCretea = !1
    ...
    e.moneyCreate = function() {
        if (!0 != this.stopCretea && (this.timeCount++, 0 == this.timeCount % this.createTimeGap)) {
            var c = this.getMoney();
            c.init();
            this.addChild(c);
            this.timeCount = 0;
            this.createTimeGap = xxhd.Random(82, 100)
        }
    };
    e.moneyMove = function() {
        for (var c, b = 0; b < this.numChildren; b++) c = this.getChildAt(b), c.render(), c.y > App.stage.stageHeight + c.height && (this.removeChild(c), this.moneyDict.push(c))
    };
    e.removeMoney = function(c) {
        this.removeChild(c);
        this.moneyDict.push(c)
    };
    e.checkMoneyHit = function(c) {
        for (var b, a = 0; a < this.numChildren; a++)
            if (b = this.getChildAt(a), xxhd.HitTestObject(b, c)) return b;
        return null
    };
    e.getMoney = function() {
        return 0 < this.moneyDict.length ?
            this.moneyDict.pop() : new Money(RES.getRes("img_money"))
    };
    return f
}(egret.Sprite);
MoneyPool.prototype.__class__ = "MoneyPool";
var HandGame = function(d) {
    function f() {
        d.call(this);
        this.onShow = this.isGameWin = !1;
        this.score = 0;
        ...
        this.boundScore = 0;
        f._instance = this;
        this.spr = App.swf.createSprite("spr_game");
        this.spr.getImage("yiv_btn").touchEnabled = !0;
        this.spr.getImage("yiv_btn").visible = !1;
        this.spr.getImage("yiv_btn").addEventListener(egret.TouchEvent.TOUCH_TAP, this.onClickMore, this);
        this.addChild(this.spr);
        this.arm = new Arm(this.spr.getSprite("arm_spr"));
        this.arm.addEventListener("moneyCatched",
            this.checkMoneyCatched, this);
        this.hand = new Hand(this.spr.getSprite("arm_spr").getMovie("hand_mc"));
        this.hand.hitArea = this.spr.getSprite("arm_spr").getImage("hand_hit");
        this.cutter = new Cutter(this.spr.getSprite("dao_mc"));
        this.cutter.addEventListener("cutDown", this.onCutDownHandler, this);
        this.moneyPool = new MoneyPool;
        this.addChild(this.moneyPool);
        this.moneyPool.addEventListener("onMoneyClick", this.onMoneyClickHandler, this);
        this.moneyDesk = new MoneyDesk(this.spr.getSprite("desk_spr"));
        this.juzi = new Dianju;
        this.juzi.x = 432;
        this.juzi.y = 98;
        this.addChild(this.juzi);
        this.juzi.addEventListener("moneyBoundComplete", this.onMoneyBoundComplete, this);
        this.lvText = new egret.TextField;
        this.lvText.width = 44;
        this.lvText.height = 27;
        this.lvText.verticalAlign = egret.VerticalAlign.MIDDLE;
        this.lvText.textAlign = egret.HorizontalAlign.CENTER;
        this.lvText.text = "0";
        this.lvText.x = 216;
        this.lvText.y = 666;
        ...
        this.scoreText.height = 38;
        this.scoreText.textColor =
            10420224;
        this.scoreText.verticalAlign = egret.VerticalAlign.MIDDLE;
        this.scoreText.textAlign = egret.HorizontalAlign.CENTER;
        this.scoreText.text = "100/1000";
        this.scoreText.x = 200;
        this.scoreText.y = 732;
        this.addChild(this.scoreText);
        this.gameResult = new GameResult;
        this.gameResult.visible = !1;
        this.addChild(this.gameResult);
        this.gameResult.addEventListener(xxhd.GameEventType.GAME_NEXT_LEVEL_CLICK, this.onSelectNextLevel, this);
        this.gameResult.addEventListener(xxhd.GameEventType.GAME_REPLAY_CLICK, this.onSelectReplay,
            this);
        this.gameResult.addEventListener(xxhd.GameEventType.GAME_MAP_SELECT, this.onSelectMap, this);
        this.gameTimer = new egret.Timer(10);
        this.gameTimer.addEventListener(egret.TimerEvent.TIMER, this.onEnterFrameHandler, this);
        this.addEventListener(xxhd.GameEventType.GAME_RESULT_SHOW, this.onResultHandler, this);
        this.addText = new egret.TextField;
        this.addText.verticalAlign = egret.VerticalAlign.MIDDLE;
        this.addText.textAlign = egret.HorizontalAlign.CENTER;
    ...
    __extends(f,
        d);
    var e = f.prototype;
    e.onClickMore = function(c) {
        App.ClickMore()
    };
    e.onSelectMap = function(c) {
        -1 < this.showTime && (clearTimeout(this.showTime), this.showTime = -1);
        this.gameResult.visible = !1;
        this.onShow = this.isGameWin = this.juzi.needMove = !1;
        this.removeAll();
        this.dispatchEventWith(xxhd.GameEventType.GAME_MAP_SELECT)
    };
    e.onSelectNextLevel = function(c) {
        this.setNewGame(xxhd.GameConfig.CURRENT_LEVEL + 1)
    };
    e.onSelectReplay = function(c) {
        this.setNewGame(xxhd.GameConfig.CURRENT_LEVEL)
    };
    e.setNewGame = function(c) {
        this.removeAll(); -
        1 < this.showTime && (clearTimeout(this.showTime), this.showTime = -1);
        xxhd.GameConfig.CURRENT_LEVEL = c;
        this.gameTime = 0;
        this.levelTime = 100;
        var b = 10 * (xxhd.GameConfig.MAX_LEVEL - c) + 10;
        this.cutter.setCutRange(b, b + 20);
        this.targetScore = 1E3 * c;
        this.score = 0;
        this.lvText.text = c.toString();
        this.playNewGame()
    };
    e.playNewGame = function() {
        this.scoreText.text = this.score + " / " + this.targetScore;
        this.gameResult.visible = !1;
        this.juzi.needMove = !1;
        this.juzi.visible = !0;
        this.juzi.time = this.levelTime;
        this.onShow = this.isGameWin = !1;
        this.juzi.init();
        this.arm.init();
        this.hand.init();
        this.moneyPool.init();
        this.cutter.init();
        App.stage.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onMoneyClickHandler, this);
        this.gameTimer.start();
        App.Start()
    };
    e.onEnterFrameHandler = function(c) {
        this.moneyPool.render();
        this.checkMoneyHit();
        this.cutter.render();
        this.hand.render();
        this.arm.render();
        this.juzi.render();
        this.onGameTimeCheck();
        this.moveJuzi()
    };
    e.onGameTimeCheck = function() {
        if (!this.onShow) {
            var c;
            this.gameTime += this.gameTimer.delay;
            0 == this.gameTime %
                1E3 && (c = Math.floor(this.gameTime / 1E3), this.juzi.time = this.levelTime - c);
            this.gameTime >= 1E3 * this.levelTime && (this.juzi.time = 0, this.juzi.needMove = !0)
        }
    };
    e.moveJuzi = function() {
        if (!0 == this.juzi.needMove && (this.juzi.y += 30, this.juzi.y > App.stage.stageHeight && (this.juzi.needMove = !1), !1 == this.onShow)) {
            var c = this.spr.localToGlobal(400, this.arm.spr.y);
            if (this.juzi.y > c.y && this.hand.chechHandCut(400)) this.onHandCutShow()
        }
    };
    e.onMoneyClickHandler = function(c) {
        "yiv_btn" != c.target.name && 0 == this.hand.money && this.arm.catchMoney(c.stageX,
            c.stageY)
    };
    e.checkMoneyHit = function() {
        var c = this.moneyPool.checkMoneyHit(this.hand.hitArea);
        c && 0 >= this.hand.money && !1 == this.onShow && (this.hand.money = 100, this.moneyPool.removeMoney(c))
    };
    e.checkMoneyCatched = function(c) {
        if (0 != this.hand.money && (this.moneyDesk.moneyCreate(), this.score += this.hand.money, this.scoreText.text = this.score + " / " + this.targetScore, this.hand.money = 0, this.score >= this.targetScore)) this.onWinShow()
    };
    e.onCutDownHandler = function(c) {
        this.hand.chechHandCut(this.cutter.hitXpos) && (this.cutter.cutHand(),
            this.onHandCutShow())
    };
    e.onHandCutShow = function() {
        App.stage.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.onMoneyClickHandler, this);
        this.onShow = !0;
        this.isGameWin = !1;
        this.hand.stopCretea = !1;
        this.moneyPool.stopCretea = !0;
        this.arm.removeAll();
        this.arm.armState = Arm.ARM_CUT;
        var c = this;
        this.showTime = setTimeout(function() {
            -1 < c.showTime && (clearTimeout(c.showTime), c.showTime = -1);
            c.gameOver()
        }, 3E3)
    };
    e.onWinShow = function() {
        App.stage.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.onMoneyClickHandler,
            this);
        this.onShow = this.isGameWin = !0;
        this.moneyPool.stopCretea = !0;
        this.hand.stopCretea = !0;
        this.arm.removeAll();
        this.updateScore();
        var c = this;
        egret.Tween.get(this.juzi).to({
            x: 200,
            y: 400
        }, 300).call(function() {
            c.juzi.needShowWin = !0;
            console.log("kkk")
        })
    };
    e.onMoneyBoundComplete = function(c) {
        this.addText.y = 320;
        this.addText.x = 150;
        this.addText.textColor = 65280;
        this.addText.text = "+ " + this.boundScore.toString();
        this.addText.width = 100;
        this.addText.height = 30;
        this.addText.alpha = 1;
        this.scoreText.text = this.score + " / " +
            this.targetScore;
        var b = this;
        egret.Tween.get(this.addText).to({
            y: 280,
            alpha: 0
        }, 500).call(function() {
            b.gameWin()
    ...
    e.gameOver = function() {
        this.updateScore();
        this.removeAll();
        this.dispatchEventWith(xxhd.GameEventType.GAME_RESULT_SHOW, !1, !1)
        console.log(123);
        try {
    ...
    e.gameWin = function() {
        this.removeAll();
        this.dispatchEventWith(xxhd.GameEventType.GAME_RESULT_SHOW, !1, !0)
    };
    e.updateScore = function() {
        this.isGameWin && (this.boundScore = xxhd.GameConfig.CURRENT_LEVEL * this.juzi.time * 10, this.score += this.boundScore);
        xxhd.GameConfig.CURRENT_SCORE =
            this.score
    };
    e.removeAll = function() {
        this.gameTimer.stop();
        this.addText.alpha = 0;
        this.onShow = !1;
        this.addText.text = "";
        this.hand.stopCretea = !0;
        this.moneyPool.stopCretea = !0;
        this.moneyPool.removeAll();
        this.cutter.removeAll();
        this.hand.removeAll();
        this.arm.removeAll();
        this.moneyDesk.removeAll();
        App.stage.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.onMoneyClickHandler, this)
    };
    e.onResultHandler = function(c) {
        this.gameResult.showResult(c.data);
        this.gameResult.visible = !0
    };
...
HandGame.prototype.__class__ = "HandGame";
var Arm = function(d) {
    function f(c) {
        d.call(this);
        this.preX = 0;
    ...
    __extends(f, d);
    var e = f.prototype;
    Object.defineProperty(e, "armState", {
        set: function(c) {
            this.stopMovie = !0;
            this._armState = c;
            c == f.WAIT_CATCH ? (this.spr.x = this.stX, this.spr.y = this.stY, this.spr.rotation = 5, this.vx = 0.2, this.ra = this.vy = 0) : c == f.CATCH_MONEY ? (this.spr.x = this.stX, this.spr.y = this.stY, this.spr.rotation =
                5, this.vx = -40) : c != f.PUT_MONEY && c == f.ARM_CUT && (this.vx = 1, this.vy = 0.2, this.ra = 2, this.animationCount = 0);
            this.stopMovie = !1
        },
        enumerable: !0,
        configurable: !0
    });
    e.catchMoney = function(c, b) {
        var a = this.spr.parent.globalToLocal(c, b);
        this.toX = a.x;
        this.toY = a.y;
        this.armState = f.CATCH_MONEY
    };
    e.rotationToTarget = function(c, b) {
        var a = this.spr.x - c,
            d = this.spr.y - b;
        Math.atan2(d, a);
        a = 180 * Math.atan2(d, a) / Math.PI;
        this.spr.rotation = a
    };
    e.removeAll = function() {
        this.stopMovie = !0
    ...
    e.init = function() {
        this.armState = f.WAIT_CATCH;
        this.stopMovie = !1
    };
    e.onShowWin = function() {
        !0 == HandGame.getInstance().onShow && HandGame.getInstance()
    };
    e.render = function() {
        this.stopMovie || (this.onShowWait(), this.showCatchMoney(), this.onShowLose(), this.onShowWin())
    };
    e.showCatchMoney = function() {
        this._armState == f.CATCH_MONEY && (this.spr.x += this.vx, this.spr.x - 810 <= this.toX && (this.vx = 50), this.spr.x >= this.stX && (this.vx = 0, this.dispatchEventWith("moneyCatched")), this.rotationToTarget(this.toX, this.toY + 80), -10 > this.spr.rotation && (this.spr.rotation = -10), 15 < this.spr.rotation &&
            (this.spr.rotation = 15))
    };
    e.onShowWait = function() {
        this._armState == f.WAIT_CATCH && (this.spr.x += this.vx, this.spr.x < this.stX - 5 ? this.vx = 0.2 : this.spr.x > this.stX + 5 && (this.vx = -0.2))
    };
    e.onShowLose = function() {
        if (this._armState == f.ARM_CUT && !0 == HandGame.getInstance().onShow && !1 == HandGame.getInstance().isGameWin && (this.animationCount++, 0 == this.animationCount % 2)) {
            this.spr.x < this.stX && (this.spr.x += this.vx);
            var c = this.spr.rotation + this.ra;
            5 > c && (c = 5, this.ra = 1.5);
            20 < c && (c = 20, this.ra = -1.5);
            this.spr.rotation = c;
            this.spr.x =
                this.stX - Hand.hurtWidth
        }
    };
    f.WAIT_CATCH = "wait_catch";
    f.CATCH_MONEY = "catch_money";
    f.PUT_MONEY = "put_money";
    f.ARM_CUT = "arm_cut";
    return f
}(egret.EventDispatcher);
Arm.prototype.__class__ = "Arm";
(function(d) {
    var f = function() {
        function d() {
            this._sheets = {};
        ...
        var c = d.prototype;
        c.addSpriteSheet = function(b, a) {
            this._sheets[b] = a
        };
        c.addTexture = function(b, a) {
            this._textures[b] = a
        };
        c.createBitmap = function(b) {
            var a, c;
            for (c in this._sheets)
                if (a = this._sheets[c], a = a.getTexture(b), null != a) break;
            null == a && (a = this._textures[b]);
    ...
    d.SwfAssetManager = f;
    f.prototype.__class__ = "starlingswf.SwfAssetManager"
})(starlingswf || (starlingswf = {}));
(function(d) {
    var f = function() {
        function d() {}
        ...
        var c = d.prototype;
        d.createSwfUpdateManager = function(b) {
            var a = new d;
            a._animations = [];
            a._addQueue = [];
            a._removeQueue = [];
            a._currentTime = 0;
            a.setFps(b);
            egret.Ticker.getInstance().register(a.update, a);
            return a
        };
        c.setFps = function(b) {
            this._fps = b;
        ...
        c.addSwfAnimation = function(b) {
            this._addQueue.push(b)
        };
        c.removeSwfAnimation = function(b) {
            this._removeQueue.push(b)
        };
        c.updateAdd = function() {
            for (var b = this._addQueue.length, a, c, d = 0; d < b; d++) c = this._addQueue.pop(), a =
                this._animations.indexOf(c), -1 == a && this._animations.push(c)
        };
        c.updateRemove = function() {
            for (var b = this._removeQueue.length, a, c = 0; c < b; c++) a = this._removeQueue.pop(), a = this._animations.indexOf(a), -1 != a && this._animations.splice(a, 1)
        };
        c.update = function(b) {
            this._currentTime += b;
            if (!(this._currentTime < this._fpsTime)) {
                ...
                this.updateRemove();
                this.updateAdd();
                b = this._animations.length;
                for (var a = 0; a < b; a++) this._animations[a].update()
            }
        };
        return d
    }();
    d.SwfUpdateManager = f;
    f.prototype.__class__ = "starlingswf.SwfUpdateManager"
})(starlingswf || (starlingswf = {}));