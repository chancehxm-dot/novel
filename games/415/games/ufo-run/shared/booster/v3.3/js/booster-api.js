(function() {
    ...
    window.Zepto = Zepto, window.$ === undefined && (window.$ = Zepto),
        ...
        function() {
            ...
            return '<div id="booster-orientation-screen-<%= orientation %>">\n  <div id="logo"></div>\n  <p id="rotation-text">Please rotate your device.<!-- TODO: make text external -->\n</div>'
            ...
            var i = ["UA-34318136-1"],
                s = n.Model.extend({
                    ...
                    initialize: function(t) {
                        this.gameId = t.gameId, this.name = t.gameName, this.developer = t.developer, this.category = t.gameCategory, t.gameAnalyticsId && i.push(t.gameAnalyticsId);
                        var n = document.createElement("script");
                        n.type = "text/javascript", n.async = !0, n.src = "";
                        var r = e("script").get(0);
                        r.parentNode.insertBefore(n, r);
                        var s = document.createElement("script");
                        s.type = "text/javascript", s.async = !0, s.src = "";
                        var r = e("script").get(0);
                        r.parentNode.insertBefore(s, r), this._setVariables()
                    },
                    gamePlay: function() {
                    ...
                    levelFailed: function(e) {
                        this._trackEventGoogle("level failed", parseInt(e)), window._HoneyTracksTracking.push(function() {
                            HoneyTracks_Tracker_Library.TrackFeatureUsage("level failed", null, null, e, 1)
                        })
                    },
                    adDisplay: function() {
                        this._trackEventGoogle("adDisplay"), window._HoneyTracksTracking.push(function() {
                            HoneyTracks_Tracker_Library.TrackFeatureUsage("adDisplay", null, null, null, 1)
                        })
                    },
                    adClick: function() {
                        this._trackEventGoogle("adClick"), window._HoneyTracksTracking.push(function() {
                            HoneyTracks_Tracker_Library.TrackFeatureUsage("adClick", null, null, null, 1)
                        })
                    },
                    adSkip: function() {
                        this._trackEventGoogle("adSkip"), window._HoneyTracksTracking.push(function() {
                            HoneyTracks_Tracker_Library.TrackFeatureUsage("adSkip", null, null, null, 1)
                        })
                    },
                    adTimerPassed: function() {
                        this._trackEventGoogle("adTimerPassed"), window._HoneyTracksTracking.push(function() {
                            HoneyTracks_Tracker_Library.TrackFeatureUsage("adTimerPassed", null, null, null, 1)
                        })
                    },
                    customEvent: function(e, t) {
                        if (t == undefined) this._trackEventGoogle(e), window._HoneyTracksTracking.push(function() {
                            HoneyTracks_Tracker_Library.TrackFeatureUsage(e, null, null, null, 1)
                        });
                        else try {
                            this._trackEventGoogle(e, t), window._HoneyTracksTracking.push(function() {
                    ...
                    moreGames: function() {
                        this._trackEventGoogle("more games"), window._HoneyTracksTracking.push(function() {
                    ...
                    _trackEventGoogle: function(e, t) {
                        for (var n = 0; n < i.length; n++) window._gaq.push(["b._setAccount", i[n]]), typeof t == "number" ? window._gaq.push(["b._trackEvent", this.gameId, e, null, t]) : typeof t == "undefined" ? window._gaq.push(["b._trackEvent", this.gameId, e, null]) : window._gaq.push(["b._trackEvent", this.gameId, e, String(t)])
                    },
                    _trackPageGoogle: function(e) {
                        for (var t = 0; t < i.length; t++) window._gaq.push(["b._setAccount", i[t]]), window._gaq.push(["b._trackPageview", "/ingame/" + this.category + "/" + this.developer + "/" + this.gameId + "/" + this.name + "/" + e])
                    }
                });
            return s
        });
    ...
    (function(e, t, n) {
        ...
        function() {
            ...
            return n
        }), define("views/highscore.frame", ["zepto", "underscore", "backbone", "postmessage", "models/highscore", "text!templates/highscore.html", "utils/url", "utils/cookie"], function(e, t, n, r, i, s, o, u) {
            var a = n.View.extend({
                ...
                scoreSubmit: function(t, n) {
                    var r = new o;
                    this.callback = t.callback, e("iframe#booster-highscore-popup").removeClass("hide"), pm({
                        target: window.frames["booster-highscore-popup"],
            ...
            var f = n.View.extend({
                ...
                _render: function() {
                    ...
                    e("body").append(n), 0, e("#booster-tab-logo").css("top", this.getPosition() + "%"), e("#booster-tab").css("top", this.getPosition() + "%"), e("#booster-tab").addClass("hide"), e("#booster-tab-logo").addClass("hide"), this.community = new i({
        ...
        function(e) {
        ...
        }(window.Zepto), define("magnificpopup", function() {}), define("models/ad.model", ["backbone"], function(e) {
            var t = 0,
                n = e.Model.extend({
                    defaults: {
                        interval: 0,
            ...
            var n, r, i, s, o, u, a, f = e.Model.extend({
                defaults: {
                    ad_client: "ca-games-pub-7203084817284772"
                },
                initialize: function() {},
                ...
                requestAds: function(e) {
                    ...
                    n.adTagUrl = "" + this.get("ad_client") + "&channel=" + e, console.log(n.adTagUrl), n.linearAdSlotWidth = 300, n.linearAdSlotHeight = 250, n.nonLinearAdSlotWidth = 300, n.nonLinearAdSlotHeight = 250, r.requestAds(n)
                },
                ...
                onAdEvent: function(e) {
                    ...
                    switch (e.type) {
                        ...
                        case google.ima.AdEvent.Type.USER_CLOSE:
                            try {
                                clearInterval(s), t.magnificPopup.close(), window.onAdSkip()
                            } catch (o) {
                ...
                d = n.View.extend({
                    ...
                    initialize: function(e) {
                        ...
                        pm.bind("iframeClose", function(e) {
                            ...
                            window.onTimerPassed(), t._close()
                        }), pm.bind("callbackUserCloseAd", function(e) {
                            window.onAdSkip(), t._close()
                    ...
                    appendAdvertisement: function() {
                        ...
                        if (p.getURLParameter("bm.source") != "null" && p.getURLParameter("bm.gameid") != "null") e("iframe#booster-advertisement-popup").removeClass("hide");
                            ...
                            e(".interstitial-popup").magnificPopup({
                                ...
                                callbacks: {
                                    afterClose: function() {
                                        e("#adHolder").remove(), e("#advertisementLink").remove(), t.callback != undefined && t.callback.call()
                                    },
                                    open: function() {
                    ...
                    _close: function() {
                        e("iframe#booster-advertisement-popup").remove(), this.callback != undefined && this.callback.call()
                    },
                    ...
                    showAdvertising: function(e) {
                        var t = r.getInstance();
                        e != undefined && (this.callback = e.callback), t.showAdvertising(this.interval) ? (this.getAdSize(this.size), this.render(this.type, c, h, this.site, this.zone), this.appendAdvertisement()) : this.callback.call()
                    }
                });
            return d
        }), define("models/moregames.model", ["backbone", "utils/url", "models/analytics"], function(e, t, n) {
            var r = e.Model.extend({
                initialize: function() {},
                redirect: function() {
                    var e = new t,
                        n = e.getURLParameter("bm.source");
                    // window.onMoreGames(), n === "null" ? (n = "www.52h5game.com", window.top.location = e.addHTTP(n)) : window.top.location = e.addHTTP(n)
                }
            });
            return r
        }), require.config({
        ...
        }), require(["zepto", "booster", "models/analytics", "views/booster.tab", "views/highscore.frame", "magnificpopup", "views/advertisement", "models/moregames.model"], function(e, t, n, r, i, s, o, u) {
