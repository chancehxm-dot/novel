function CGame(iLevel, iScore, iLives) {
    ...
    this._initGrid = function() {
        ...
        _oScoreNum = new createjs.Text(TEXT_SCORE + ": " + _iScore, "30px " + FONT, "#ffb557");
        _oScoreNum.x = 20;
        _oScoreNum.y = oSpriteScoreBg.height / 2 - 22;
        _oScoreNum.textAlign = "left";
        _oScoreNum.textBaseline = "middle";
        _oContainerScore.addChild(_oScoreNum);

        _oLevelText = new createjs.Text(TEXT_LEVEL + " " + _iCurLevel, "26px " + FONT, "#deecf8");
        _oLevelText.x = 20;
        _oLevelText.y = oSpriteScoreBg.height / 2 + 8;
        _oLevelText.textAlign = "left";
        _oLevelText.textBaseline = "middle";
        _oContainerScore.addChild(_oLevelText);
    ...
    this.refreshScore = function(iAmount) {
        ...
        _oScoreNum.text = TEXT_SCORE + ": " + _iScore;
    };
