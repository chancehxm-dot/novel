...
fg_api.prototype.adsModule = function() {
    ...
    module.prototype.showClick2PlayOverlay = function(callback, force) {
        ...
        if (M.adcount < 1) {
            var gameLanguages = famobi.gametranslation.getSupportedLanguages();
            ...
            if (typeof gameLanguages != 'undefined' && gameLanguages.length > 0) {
                ...
                for (var i = 0; i < gameLanguages.length; i++) {
                    ...
                    gameLanguageLis += '<li data-switch-lang="' + gameLanguages[i] + '"' + currentLanguageClass + '><a href="javascript:void(0);"><img src="http://img.cdn.famobi.com/flags/flag_' + gameLanguages[i] + '.png" alt="' + gameLanguages[i] + '"></a></li>';
                }
            ...
            var findActiveGamePosition = crosspromotionGames.indexOf(famobi_gameID);

            if (findActiveGamePosition + 1 < crosspromotionGames.length) {
                nextGamePosition = findActiveGamePosition + 1;
            }

            M.nextGame.innerHTML = '<a href="//play.famobi.com/' + crosspromotionGames[nextGamePosition] + '/' + self.config.aid + '">Play next game</a>';
        }
        ...
        function startVideoCallback() {
            ...
            try {
                if (M.show_initial && !detection.is.pc && !self.debug && self.hasFeature('fullscreen')) {
            ...
            switch (adEvent.type) {
                ...
                case google.ima.AdEvent.Type.STARTED:
                    ...
                    if (ad.isLinear() && M.adsManager.getRemainingTime() > 0) {
                        ...
                        //self.modal.setDimensions(parseInt(M.adWidth), parseInt(M.adWidth) * 0.625 + 50);
                    } else {
...
fg_api.prototype.sdkModule = function() {
    ...
    function hasLocalStorageKeys() {
        ...
        for (var key in window.localStorage)
            if (key.indexOf(aid) === 0 || key.indexOf(package_id) === 0) return true;
