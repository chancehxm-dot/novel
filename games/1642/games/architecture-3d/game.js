...
(function(e) {
    ...
    function S(e, n, d, g, f) {
        window.outerHeight - window.innerHeight, this.version = "0.27.5", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new e({
            isMaster: !0
        ...
        this.AppToken = new i(v, !1), this.GameState = new a(this._addAppToken(v), !1), this.Branding = new d(v, !1), this.GameBreak = new f(m, !1), this.Game = new s(m, !1), this.Award = new c(S, !1), this.Secondscreen = new u(S, !1), this.User = new r(v, !1), this.Score = new l(this._addAppToken(S), !1), this.Friends = new p(v, !1), this.GameEvent = new h(v, !1), this.Localization = new o(v, !1)
    }
        ...
        function(e) {
            ...
            function u() {
                ...
                if (s.promiseDispatch = function(e, a, s) {
                        var o = Q(arguments);
                        n ? (n.push(o), "when" === a && s[1] && i.push(s[1])) : c.nextTick(function() {
            ...
            function T(e, t) {
                rt && ("object" == typeof process && "function" == typeof process.emit && c.nextTick.runAfter(function() {
            ...
            function E(e) {
                if (rt) {
                    var t = $(st, e); - 1 !== t && ("object" == typeof process && "function" == typeof process.emit && c.nextTick.runAfter(function() {
                ...
                return function() {
                    function t(e, t) {
                        ...
                        if ("undefined" == typeof StopIteration) {
                            ...
                            return o.done ? c(o.value) : f(o.value, a, s)
                        }
                        try {
                            o = i[e](t)
                        } catch (r) {
                            return n(r) ? c(r.value) : w(r)
                        }
                        return f(o, a, s)
                    }
            ...
            function D(e) {
                if (0 === e.length) return c.resolve();
                var t = c.defer(),
                    n = 0;
                return K(e, function(i, a, s) {
                    function o(e) {
            ...
            function C(e) {
                return f(e, function(e) {
                    return e = Y(e, c), f(O(Y(e, function(e) {
                        return f(e, W, W)
                    })), function() {
                        return e
                    })
            ...
            c.resolve = c, c.nextTick = z, c.longStackSupport = !1, "object" == typeof process && process && process.env && process.env.Q_DEBUG && (c.longStackSupport = !0), c.defer = u, u.prototype.makeNodeResolver = function() {
                var e = this;
                return function(t, n) {
                    t ? e.reject(t) : arguments.length > 2 ? e.resolve(Q(arguments, 1)) : e.resolve(n)
                }
            }, c.Promise = d, c.promise = d, d.race = h, d.all = O, d.reject = w, d.resolve = c, c.passByCopy = function(e) {
                return e
            ...
            c.resetUnhandledRejections = A, c.getUnhandledReasons = function() {
                ...
                A(), rt = !1
            }, A(), c.reject = w, c.fulfill = k, c.master = R, c.spread = M, g.prototype.spread = function(e, t) {
                return this.all().then(function(t) {
                    return e.apply(void 0, t)
                }, t)
            }, c.async = x, c.spawn = L, c["return"] = G, c.promised = P, c.dispatch = N, g.prototype.dispatch = function(e, t) {
                var n = this,
                    i = u();
                return c.nextTick(function() {
                ...
                return c(e).dispatch("post", [t, Q(arguments, 2)])
                ...
                return c(e).dispatch("apply", [void 0, Q(arguments, 1)])
                ...
                return O(this)
            }, c.any = D, g.prototype.any = function() {
                return D(this)
            }, c.allResolved = l(C, "allResolved", "allSettled"), g.prototype.allResolved = function() {
                return C(this)
            }, c.allSettled = j, g.prototype.allSettled = function() {
            ...
            }, c.progress = U, g.prototype.progress = function(e) {
            ...
            }, c.nodeify = H, g.prototype.nodeify = function(e) {
    ...
    A.getGameConfig = function() {
        ...
        return n = this._getLink(""), e && "object" == typeof e && (i = b.validateSchema(a, e), i.error && (n.error = i.error)), n
    ...
    }, f.prototype._displaySpilBanner = function() {
        var e = "banner_mds",
            t = !1,
            n = "";
        navigator.userAgent.match(/Android/i) ? (e = "banner_mds_android", n = this._getLink("banner_mds_android").image, t = !0) : (navigator.userAgent.match(/webOS/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i)) && (e = "banner_mds_ios", n = this._getLink("banner_mds_ios").image, t = !0), this.components.displayBanner({
            action: this._getLink(e).action,
            image: this._getLink(e).image,
            isMobile: t,
        ...
        return n = "string" == typeof t ? t : "", i = "brandedgames_" + (r > 0 && 500 > r ? "internal" : "external"), a = ["utm_medium=" + i, "utm_campaign=" + o.applicationId, "utm_source=" + s.host, "utm_content=" + n].join("&"), e += e.indexOf("?") > -1 ? "&" : "?", e + a
        ...
        var t, n, i, a, s = this,
            o = new m(e.data);
        if (o)
            if (t = o.type, n = o.callbackId, i = o.data, a = this._callbacks[n] || !1, this.IS_MASTER) switch (t) {
                case "jslib":
        ...
        function r() {
            l.__.messenger.requestFromParent("GameAPI.isReady", {}, function(e) {
                p && clearTimeout(p), e.isready ? s() : 5 > u ? (u++, setTimeout(r, 500)) : (b.log("GameAPI:checkMasterReady not ready but reached max wait"), s())
            })
        }
        var p, l = this,
        ...
        return !0 === this.isReady ? (b.log("WARNING: Detected multiple executions of GameAPI.loadAPI(). This method should only be executed once per page load!"), e(l)) : (this.__.messenger._postMessage(["log.gameapi.loadapi.start",
            ...
            null
        ], null, "log"), this.IS_STANDALONE ? o() : this.IS_MASTER ? A.getGameConfig().then(function(e) {
