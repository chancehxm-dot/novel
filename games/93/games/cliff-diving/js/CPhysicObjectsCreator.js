function CPhysicObjectsCreator(oWorld) {
    ...
    this.addPlayer = function(oContainer) {
        ...
        var oPlayerPhysic = {
            ...
            leftArm: oLeftArm,
            rightArm: oRightArm,
            leftTopLeg: oLeftTopLeg,
            leftBottomLeg: oLeftBottomLeg,
            rightTopLeg: oRightTopLeg,
            rightBottomLeg: oRightBottomLeg,
            rightFoot: oRightFoot,
            leftFoot: oLeftFoot,
            leftShoulder: oLeftShoulder,
            rightShoulder: oRightShoulder,
            leftPelvis: oLeftPelvis,
            rightPelvis: oRightPelvis,
            neck: oNeck,
            rightKnee: oRightKnee,
            leftKnee: oLeftKnee,
            rightAnkle: oRightAnkle,
            leftAnkle: oLeftAnkle
        };
