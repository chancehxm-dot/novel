function CPlayer(oPlayerPhysic, oParentContainer) {
    ...
    this.movePlayerOnTrampoline = function() {
        ...
        _oStartHeadPosition = {
            x: _oHeadBody.GetPosition().x,
            y: _oHeadBody.GetPosition().y
        };
    ...
    this.resetBodiesVelocities = function() {
        _oHeadBody.SetLinearVelocity({
            x: 0,
            y: 0
        });
        _oTorsoBody.SetLinearVelocity({
            x: 0,
            y: 0
        });
        _oLeftBottomLegBody.SetLinearVelocity({
            x: 0,
            y: 0
        });
        _oRightBottomLegBody.SetLinearVelocity({
            x: 0,
            y: 0
        });
        _oLeftTopLegBody.SetLinearVelocity({
            x: 0,
            y: 0
        });
        _oRightTopLegBody.SetLinearVelocity({
            x: 0,
            y: 0
        });
        _oLeftArmBody.SetLinearVelocity({
            x: 0,
            y: 0
        });
        _oRightArmBody.SetLinearVelocity({
            x: 0,
            y: 0
        });
        _oLeftFootBody.SetLinearVelocity({
            x: 0,
            y: 0
        });
        _oRightFootBody.SetLinearVelocity({
            x: 0,
            y: 0
        });
    ...
    this.movePlayerToPosition = function(iX, iY) {
        s_oPhysicsController.setElementBodyPosition(_oHeadBody, {
            x: iX + HEAD_OFFSET.x * WORLD_SCALE,
            y: iY + HEAD_OFFSET.y * WORLD_SCALE
        });
        s_oPhysicsController.setElementBodyPosition(_oTorsoBody, {
            x: iX + TORSO_OFFSET.x * WORLD_SCALE,
            y: iY + TORSO_OFFSET.y * WORLD_SCALE
        });
        s_oPhysicsController.setElementBodyPosition(_oLeftBottomLegBody, {
            x: iX + LEFTBOTTOMLEG_OFFSET.x * WORLD_SCALE,
            y: iY + LEFTBOTTOMLEG_OFFSET.y * WORLD_SCALE
        });
        s_oPhysicsController.setElementBodyPosition(_oRightBottomLegBody, {
            x: iX + RIGHTBOTTOMLEG_OFFSET.x * WORLD_SCALE,
            y: iY + RIGHTBOTTOMLEG_OFFSET.y * WORLD_SCALE
        });
        s_oPhysicsController.setElementBodyPosition(_oLeftTopLegBody, {
            x: iX + LEFTTOPLEG_OFFSET.x * WORLD_SCALE,
            y: iY + LEFTTOPLEG_OFFSET.y * WORLD_SCALE
        });
        s_oPhysicsController.setElementBodyPosition(_oRightTopLegBody, {
            x: iX + RIGHTTOPLEG_OFFSET.x * WORLD_SCALE,
            y: iY + RIGHTTOPLEG_OFFSET.y * WORLD_SCALE
        });
        s_oPhysicsController.setElementBodyPosition(_oLeftArmBody, {
            x: iX + LEFTARM_OFFSET.x * WORLD_SCALE,
            y: iY + LEFTARM_OFFSET.y * WORLD_SCALE
        });
        s_oPhysicsController.setElementBodyPosition(_oRightArmBody, {
            x: iX + RIGHTARM_OFFSET.x * WORLD_SCALE,
            y: iY + RIGHTARM_OFFSET.y * WORLD_SCALE
        });
        s_oPhysicsController.setElementBodyPosition(_oLeftFootBody, {
            x: iX + LEFTFOOT_OFFSET.x * WORLD_SCALE,
            y: iY + LEFTFOOT_OFFSET.y * WORLD_SCALE
        });
        s_oPhysicsController.setElementBodyPosition(_oRightFootBody, {
            x: iX + RIGHTFOOT_OFFSET.x * WORLD_SCALE,
            y: iY + RIGHTFOOT_OFFSET.y * WORLD_SCALE
        });
        this._moveSpritePosOnPhysicPos();
    };
