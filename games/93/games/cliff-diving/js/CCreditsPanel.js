function CCreditsPanel() {
    ...
    this._init = function() {
        ...
        _oLink = new createjs.Text("www.yiv.com", FONT_SIZE_CREDITS + PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        _oLink.textAlign = "center";
        _oLink.textBaseline = "alphabetic";
        _oLink.x = CANVAS_WIDTH_HALF;
        _oLink.y = CANVAS_HEIGHT_HALF + 120;
    ...
    this._onLogoButRelease = function() {
        CreateLinksInGame('Cliff-Diving', 'game', 'logo');
    };
